...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    public DlgPermintaanLaboratorium(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={
            "P","Item Pemeriksaan Laboratorium","Satuan","Nilai Rujukan","id_template"};
...
//                column.setPreferredWidth(100);
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(560, 239));
        ...
        BtnCari1.setBounds(507, 72, 28, 23);
        ...
        jLabel4.setBounds(541, 70, 98, 23);
        ...
        TNoPermintaan.setBounds(642, 70, 130, 23);
            ...
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        if (Sequel.menyimpantf("permintaan_lab", "?,?,?,?,?,?,?,?,?", "No.Permintaan", 9, new String[]{
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
   try{
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        form.isCek("Ralan", TNoRw.getText());
    ...
    */
    ...
    private void isRawat(){
        ...
        if (!kamar.equals("")) {
            ...
            diagnosa = Sequel.cariIsi("select ifnull(diagnosa_awal,'-') diagnos from kamar_inap where no_rawat=?", TNoRw.getText());

        } else if (kamar.equals("")) {
            kamar = "Poliklinik";
            namakamar = Sequel.cariIsi("select nm_poli from poliklinik inner join reg_periksa on poliklinik.kd_poli=reg_periksa.kd_poli "
                    + "where reg_periksa.no_rawat=?", TNoRw.getText());
            diagnosa = Sequel.cariIsi("select IFNULL(diagnosa,'-') diag_resum from pemeriksaan_ralan where no_rawat=?", TNoRw.getText());
        }
