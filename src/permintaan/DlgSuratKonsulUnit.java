...
public class DlgSuratKonsulUnit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TtglMinta.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-10-2024" }));
        ...
        cmbUnitKe.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Anestesi", "VCT" }));
        ...
        cmbUnitDari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Anestesi", "VCT" }));
