...
public class DlgSuratKeteranganDokter extends javax.swing.JDialog {
    ...
    public DlgSuratKeteranganDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No. Rawat", "No. Surat", "No. RM", "Nama Pasien", "Tempat Lahir", "Tgl. Lahir",
            ...
            "nip_dokter", "kdpoli", "hasil_pemeriksaan", "diagnosa"
        };
    ...
    private void initComponents() {
        ...
        MnSuratKetDokter.setBackground(new java.awt.Color(255, 255, 255));
        MnSuratKetDokter.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSuratKetDokter.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MnSuratKetDokter.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        MnSuratKetDokterManual.setBackground(new java.awt.Color(255, 255, 255));
        MnSuratKetDokterManual.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSuratKetDokterManual.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MnSuratKetDokterManual.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(44, 335));
        ...
        jLabel8.setBounds(285, 38, 147, 23);
        ...
        TTempLahr.setBounds(434, 38, 240, 23);
        ...
        Ttgl_no_surat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-07-2023" }));
        ...
        jLabel15.setBounds(0, 299, 105, 23);
        ...
        Tnmdokter.setBounds(105, 299, 540, 23);
        ...
        BtnDokter.setBounds(645, 299, 28, 23);
        ...
        Tpermintaan.setBounds(105, 122, 570, 23);
        ...
        Ttgl_surat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-07-2023" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRW.getText().trim().equals("")) {
            ...
            Sequel.menyimpan("surat_keterangan_dokter", "'" + TNoRW.getText() + "','" + TNoSurat.getText() + "',"
                    ...
                    + "'" + Thasil.getText() + "','" + Tdiagnosa.getText() + "','" + TPasien.getText() + "'", "Surat Keterangan Dokter");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRW.getText().trim().equals("")) {
            ...
            if (tbSurat.getSelectedRow() > -1) {
                Sequel.mengedit("surat_keterangan_dokter", "no_rawat=?", "tgl_surat=?, pekerjaan=?, tempat_tinggal=?, permintaan_dari=?, "
                        + "no_surat_dari=?, ada_tgl_nosurat=?, tgl_surat_dari=?, pemeriksaan_dinyatakan=?, keperluan=?, lama_berlaku=?, "
                        + "satuan_lama=?, bb=?, tb=?, gol_darah=?, nip_dokter=?, tmpt_lahir=?, hasil_pemeriksaan=?, diagnosa=?, nm_pasien=?", 20, new String[]{
                            Valid.SetTgl(Ttgl_surat.getSelectedItem() + ""), TPekerjaan.getText(), TAlamat.getText(), Tpermintaan.getText(),
                            Tno_surat_dari.getText(), cekTgl, Valid.SetTgl(Ttgl_no_surat.getSelectedItem() + ""),
    ...
    private void MnSuratKetDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratKetDokterActionPerformed
        if (TNoRW.getText().equals("")) {
            ...
            if (tbSurat.getSelectedRow() > -1) {
                ...
                param.put("nosurat", TNoSurat.getText());
    ...
    */
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT rp.no_rawat, CONCAT('KP.12.09 / ',sk.no_surat) nosrt, p.no_rkm_medis, sk.nm_pasien, sk.tmpt_lahir, "
                    ...
                    + "sk.hasil_pemeriksaan, sk.diagnosa FROM reg_periksa rp INNER JOIN surat_keterangan_dokter sk ON sk.no_rawat = rp.no_rawat "
                    + "INNER JOIN pasien p ON p.no_rkm_medis = rp.no_rkm_medis INNER JOIN pegawai pg ON pg.nik = sk.nip_dokter WHERE "
