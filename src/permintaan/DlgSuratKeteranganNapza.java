...
public class DlgSuratKeteranganNapza extends javax.swing.JDialog {
    ...
    private String nosurat = "", thc = "", bzo = "", met = "", mop = "", coc = "", tte = "",
    ...
    public DlgSuratKeteranganNapza(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No. Rawat", "No. Surat", "No. RM", "Nama Pasien", "Jns. Kelamin", "Tempat Lahir", "Tgl. Lahir",
            ...
            "Jns. Permintaan", "Nama Penyidik", "NRP", "Keadaan Indikasi"
        };
        ...
        tabMode3 = new DefaultTableModel(null, new Object[]{
            "nama_pemeriksaan", "titik_dua", "hasil"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
        };
        tbHasilTes.setModel(tabMode3);
        tbHasilTes.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbHasilTes.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 3; i++) {
            TableColumn column = tbHasilTes.getColumnModel().getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(150);
            } else if (i == 1) {
        ...
        tbHasilTes.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        MnTTDcs = new javax.swing.JMenuItem();
        MnTTEcs = new javax.swing.JMenuItem();
        MnCetakSuratKepolisian1 = new javax.swing.JMenu();
        MnTTDcsk = new javax.swing.JMenuItem();
        MnTTEcsk = new javax.swing.JMenuItem();
        ...
        ChkOPI = new widget.CekBox();
        cmbOPI = new widget.ComboBox();
        jLabel23 = new widget.Label();
        cmbJnsPermintaan = new widget.ComboBox();
        jLabel24 = new widget.Label();
        Tpenyidik = new widget.TextBox();
        jLabel25 = new widget.Label();
        Tnrp = new widget.TextBox();
        jLabel26 = new widget.Label();
        cmbIndikasi = new widget.ComboBox();
        ...
        MnCetakSurat1.setText("Cetak Surat Keterangan NAPZA/Narkoba");
        ...
        MnCetakSurat1.setOpaque(true);
        MnCetakSurat1.setPreferredSize(new java.awt.Dimension(300, 26));

        MnTTDcs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTDcs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTDcs.setText("TTD Basah");
        MnTTDcs.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTTDcs.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTTDcs.setIconTextGap(5);
        MnTTDcs.setName("MnTTDcs"); // NOI18N
        MnTTDcs.setPreferredSize(new java.awt.Dimension(120, 26));
        MnTTDcs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTDcsActionPerformed(evt);
            }
        });
        MnCetakSurat1.add(MnTTDcs);

        MnTTEcs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTEcs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTEcs.setText("TTE (QRCode)");
        MnTTEcs.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTTEcs.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTTEcs.setIconTextGap(5);
        MnTTEcs.setName("MnTTEcs"); // NOI18N
        MnTTEcs.setPreferredSize(new java.awt.Dimension(120, 26));
        MnTTEcs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTEcsActionPerformed(evt);
            }
        });
        MnCetakSurat1.add(MnTTEcs);

        jPopupMenu1.add(MnCetakSurat1);

        MnCetakSuratKepolisian1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratKepolisian1.setText("Cetak Surat Keterangan NAPZA/Narkoba (Kepolisian)");
        MnCetakSuratKepolisian1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratKepolisian1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakSuratKepolisian1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakSuratKepolisian1.setIconTextGap(5);
        MnCetakSuratKepolisian1.setName("MnCetakSuratKepolisian1"); // NOI18N
        MnCetakSuratKepolisian1.setOpaque(true);
        MnCetakSuratKepolisian1.setPreferredSize(new java.awt.Dimension(300, 26));

        MnTTDcsk.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTDcsk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTDcsk.setText("TTD Basah");
        MnTTDcsk.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTTDcsk.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTTDcsk.setIconTextGap(5);
        MnTTDcsk.setName("MnTTDcsk"); // NOI18N
        MnTTDcsk.setPreferredSize(new java.awt.Dimension(120, 26));
        MnTTDcsk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTDcskActionPerformed(evt);
            }
        });
        MnCetakSuratKepolisian1.add(MnTTDcsk);

        MnTTEcsk.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTEcsk.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTEcsk.setText("TTE (QRCode)");
        MnTTEcsk.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTTEcsk.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnTTEcsk.setIconTextGap(5);
        MnTTEcsk.setName("MnTTEcsk"); // NOI18N
        MnTTEcsk.setPreferredSize(new java.awt.Dimension(120, 26));
        MnTTEcsk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTEcskActionPerformed(evt);
            }
        });
        MnCetakSuratKepolisian1.add(MnTTEcsk);

        jPopupMenu1.add(MnCetakSuratKepolisian1);
        ...
        TNoSurat.setBounds(315, 38, 180, 23);
        ...
        TPasien.setBounds(345, 10, 360, 23);
        ...
        jLabel8.setBounds(275, 66, 88, 23);
        ...
        TPekerjaan.setBounds(135, 94, 570, 23);
        ...
        Ttmpt_tinggal.setBounds(135, 122, 570, 23);
        ...
        Ttgl_surat.setBounds(1137, 290, 90, 23);

        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("Dokter Pemeriksa : ");
        jLabel15.setName("jLabel15"); // NOI18N
        panelGlass7.add(jLabel15);
        jLabel15.setBounds(0, 295, 135, 23);
        ...
        Tnmdokter.setBounds(135, 295, 540, 23);
        ...
        BtnDokter.setBounds(675, 295, 28, 23);
        ...
        TtglLahir.setBounds(135, 66, 140, 23);

        jLabel16.setForeground(new java.awt.Color(0, 0, 0));
        jLabel16.setText("Penyidik : ");
        jLabel16.setName("jLabel16"); // NOI18N
        panelGlass7.add(jLabel16);
        jLabel16.setBounds(0, 178, 135, 23);
        ...
        TPermintaanDari.setBounds(320, 150, 385, 23);

        jLabel17.setForeground(new java.awt.Color(0, 0, 0));
        jLabel17.setText("No. Surat Dari : ");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass7.add(jLabel17);
        jLabel17.setBounds(0, 206, 135, 23);
        ...
        TtglSuratDari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-01-2026" }));
        ...
        TtglSuratDari.setBounds(605, 206, 100, 23);

        jLabel18.setForeground(new java.awt.Color(0, 0, 0));
        jLabel18.setText("Keperluan : ");
        jLabel18.setName("jLabel18"); // NOI18N
        panelGlass7.add(jLabel18);
        jLabel18.setBounds(0, 234, 135, 23);
        ...
        Scroll7.setBounds(135, 234, 570, 55);
        ...
        jLabel13.setBounds(730, 10, 130, 23);
        ...
        ChkTHC.setBounds(730, 38, 143, 23);
        ...
        ChkBZO.setBounds(730, 66, 143, 23);
        ...
        ChkMET.setBounds(730, 94, 143, 23);
        ...
        ChkMOP.setBounds(730, 122, 143, 23);
        ...
        ChkCOC.setBounds(730, 150, 143, 23);
        ...
        ChkAMP.setBounds(730, 178, 143, 23);
        ...
        cmbTHC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbTHCActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbTHC);
        cmbTHC.setBounds(880, 38, 85, 23);
        ...
        cmbBZO.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbBZOActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbBZO);
        cmbBZO.setBounds(880, 66, 85, 23);
        ...
        cmbMET.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbMETActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbMET);
        cmbMET.setBounds(880, 94, 85, 23);
        ...
        cmbMOP.setBounds(880, 122, 85, 23);
        ...
        cmbCOC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbCOCActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbCOC);
        cmbCOC.setBounds(880, 150, 85, 23);
        ...
        cmbAMP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbAMPActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbAMP);
        cmbAMP.setBounds(880, 178, 85, 23);
        ...
        ChkSemuaTes.setBounds(730, 234, 130, 23);
        ...
        cmbKesHasil.setBounds(880, 262, 85, 23);
        ...
        ChkTglSurat.setBounds(494, 206, 110, 23);
        ...
        TnoDokumen.setBounds(135, 38, 131, 23);
        ...
        BtnDokumen.setBounds(267, 38, 28, 23);

        ChkOPI.setBackground(new java.awt.Color(255, 255, 250));
        ChkOPI.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 250)));
        ChkOPI.setForeground(new java.awt.Color(0, 0, 0));
        ChkOPI.setText("Opiates (OPI)");
        ChkOPI.setBorderPainted(true);
        ChkOPI.setBorderPaintedFlat(true);
        ChkOPI.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ChkOPI.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkOPI.setName("ChkOPI"); // NOI18N
        ChkOPI.setOpaque(false);
        ChkOPI.setPreferredSize(new java.awt.Dimension(175, 23));
        ChkOPI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkOPIActionPerformed(evt);
            }
        });
        panelGlass7.add(ChkOPI);
        ChkOPI.setBounds(730, 206, 143, 23);

        cmbOPI.setForeground(new java.awt.Color(0, 0, 0));
        cmbOPI.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "Negatif (-)", "Positif (+)" }));
        cmbOPI.setName("cmbOPI"); // NOI18N
        cmbOPI.setPreferredSize(new java.awt.Dimension(55, 28));
        cmbOPI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbOPIActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbOPI);
        cmbOPI.setBounds(880, 206, 85, 23);

        jLabel23.setForeground(new java.awt.Color(0, 0, 0));
        jLabel23.setText("Jenis Permintaan : ");
        jLabel23.setName("jLabel23"); // NOI18N
        panelGlass7.add(jLabel23);
        jLabel23.setBounds(0, 150, 135, 23);

        cmbJnsPermintaan.setForeground(new java.awt.Color(0, 0, 0));
        cmbJnsPermintaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lainnya", "Kepolisian" }));
        cmbJnsPermintaan.setName("cmbJnsPermintaan"); // NOI18N
        cmbJnsPermintaan.setPreferredSize(new java.awt.Dimension(55, 28));
        cmbJnsPermintaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbJnsPermintaanActionPerformed(evt);
            }
        });
        panelGlass7.add(cmbJnsPermintaan);
        cmbJnsPermintaan.setBounds(135, 150, 80, 23);

        jLabel24.setForeground(new java.awt.Color(0, 0, 0));
        jLabel24.setText("Permintaan Dari : ");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass7.add(jLabel24);
        jLabel24.setBounds(215, 150, 105, 23);

        Tpenyidik.setForeground(new java.awt.Color(0, 0, 0));
        Tpenyidik.setName("Tpenyidik"); // NOI18N
        Tpenyidik.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TpenyidikKeyPressed(evt);
            }
        });
        panelGlass7.add(Tpenyidik);
        Tpenyidik.setBounds(135, 178, 400, 23);

        jLabel25.setForeground(new java.awt.Color(0, 0, 0));
        jLabel25.setText("NRP : ");
        jLabel25.setName("jLabel25"); // NOI18N
        panelGlass7.add(jLabel25);
        jLabel25.setBounds(535, 178, 40, 23);

        Tnrp.setForeground(new java.awt.Color(0, 0, 0));
        Tnrp.setName("Tnrp"); // NOI18N
        Tnrp.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TnrpKeyPressed(evt);
            }
        });
        panelGlass7.add(Tnrp);
        Tnrp.setBounds(575, 178, 130, 23);

        jLabel26.setForeground(new java.awt.Color(0, 0, 0));
        jLabel26.setText("Indikasi Keadaan : ");
        jLabel26.setName("jLabel26"); // NOI18N
        panelGlass7.add(jLabel26);
        jLabel26.setBounds(730, 290, 145, 23);

        cmbIndikasi.setForeground(new java.awt.Color(0, 0, 0));
        cmbIndikasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "TERINDIKASI NARKOBA", "TIDAK TERINDIKASI NARKOBA" }));
        cmbIndikasi.setName("cmbIndikasi"); // NOI18N
        cmbIndikasi.setPreferredSize(new java.awt.Dimension(55, 28));
        panelGlass7.add(cmbIndikasi);
        cmbIndikasi.setBounds(880, 290, 180, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRW.getText().trim().equals("")) {
            ...
            if (ChkTHC.isSelected() == true && cmbTHC.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkTHC.getText() + " ...!!");
                cmbTHC.requestFocus();
            } else if (ChkBZO.isSelected() == true && cmbBZO.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkBZO.getText() + " ...!!");
                cmbBZO.requestFocus();
            } else if (ChkMET.isSelected() == true && cmbMET.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkMET.getText() + " ...!!");
                cmbMET.requestFocus();
            } else if (ChkMOP.isSelected() == true && cmbMOP.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkMOP.getText() + " ...!!");
                cmbMOP.requestFocus();
            } else if (ChkCOC.isSelected() == true && cmbCOC.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkCOC.getText() + " ...!!");
                cmbCOC.requestFocus();
            } else if (ChkAMP.isSelected() == true && cmbAMP.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkAMP.getText() + " ...!!");
                cmbAMP.requestFocus();
            } else if (ChkOPI.isSelected() == true && cmbOPI.getSelectedIndex() == 0) {
                JOptionPane.showMessageDialog(null, "Pilih dulu salah satu hasil pemeriksaan " + ChkOPI.getText() + " ...!!");
                cmbOPI.requestFocus();
            } else {
                autoNomorSurat();
                cekData();
                ...
                if (tbSurat.getSelectedRow() > -1) {
                    if (Sequel.mengedittf("surat_keterangan_napza", "no_rawat=?", "tgl_surat=?,pekerjaan=?,tempat_tinggal=?,permintaan_dari=?,no_surat_dari=?,"
                            ...
                            + "nm_penyidik=?, nrp=?, indikasi=?", 32, new String[]{
                                ...
                                cmbKesHasil.getSelectedItem().toString(), Tkeperluan.getText(), kddokter, tglsurat, TPasien.getText(), TTempLahr.getText(),
    ...
    private void TPermintaanDariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TPermintaanDariKeyPressed
        if (cmbJnsPermintaan.getSelectedIndex() == 1) {
            Valid.pindah(evt, cmbJnsPermintaan, Tpenyidik);
        } else {
            Valid.pindah(evt, cmbJnsPermintaan, TnoSuratDari);
        }        
    ...
    private void cmbTHCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbTHCActionPerformed
        cekConteng();
    }//GEN-LAST:event_cmbTHCActionPerformed

    private void cmbBZOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBZOActionPerformed
        cekConteng();
    }//GEN-LAST:event_cmbBZOActionPerformed

    private void cmbMETActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMETActionPerformed
        cekConteng();
    }//GEN-LAST:event_cmbMETActionPerformed
    ...
    private void cmbCOCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbCOCActionPerformed
        cekConteng();
    }//GEN-LAST:event_cmbCOCActionPerformed

    private void cmbAMPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbAMPActionPerformed
        cekConteng();
    }//GEN-LAST:event_cmbAMPActionPerformed

    private void cmbOPIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbOPIActionPerformed
        cekConteng();
    }//GEN-LAST:event_cmbOPIActionPerformed

    private void cmbJnsPermintaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbJnsPermintaanActionPerformed
        Tpenyidik.setText("");
        Tnrp.setText("");
        cmbIndikasi.setSelectedIndex(0);
        if (cmbJnsPermintaan.getSelectedIndex() == 1) {
            Tpenyidik.setEnabled(true);
            Tnrp.setEnabled(true);
            cmbIndikasi.setEnabled(true);
        } else {
            Tpenyidik.setEnabled(false);
            Tnrp.setEnabled(false);
            cmbIndikasi.setEnabled(false);
        }
    }//GEN-LAST:event_cmbJnsPermintaanActionPerformed

    private void TpenyidikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TpenyidikKeyPressed
        Valid.pindah(evt, TPermintaanDari, Tnrp);
    }//GEN-LAST:event_TpenyidikKeyPressed

    private void TnrpKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TnrpKeyPressed
        Valid.pindah(evt, Tpenyidik, TnoSuratDari);
    }//GEN-LAST:event_TnrpKeyPressed

    private void MnTTDcsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTDcsActionPerformed
        if (TNoRW.getText().equals("")) {
    ...
    }//GEN-LAST:event_MnTTDcsActionPerformed

    private void MnTTEcsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTEcsActionPerformed
        if (TNoRW.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silahkan pilih dulu salah satu datanya pada tabel...!!!!");
            tbSurat.requestFocus();
        } else if (Sequel.cariInteger("select count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "'") == 0) {
    ...
    }//GEN-LAST:event_MnTTEcsActionPerformed

    private void MnTTDcskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTDcskActionPerformed
        if (TNoRW.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silahkan pilih dulu salah satu datanya pada tabel...!!!!");
            tbSurat.requestFocus();
        } else if (Sequel.cariInteger("select count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "'") == 0) {
            JOptionPane.showMessageDialog(null, "Data surat keterangan NAPZA pasien yg. bernama " + TPasien.getText() + "    \n"
                    + "dg. no. rawat " + TNoRW.getText() + " belum tersimpan...!!!!");
        } else if (!tbSurat.getValueAt(tbSurat.getSelectedRow(), 37).toString().equals("Kepolisian")) {
            JOptionPane.showMessageDialog(null, "Data pemeriksaan narkoba pasien ini bukan dari permintaan kepolisian...!!!!");
            tbSurat.requestFocus();
        } else {
            tte = "";
            tte = "tidak";
            cetakMnCetakSuratKepolisian();
        }
    }//GEN-LAST:event_MnTTDcskActionPerformed

    private void MnTTEcskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnTTEcskActionPerformed
        if (TNoRW.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silahkan pilih dulu salah satu datanya pada tabel...!!!!");
            tbSurat.requestFocus();
        } else if (Sequel.cariInteger("select count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "'") == 0) {
    ...
    }//GEN-LAST:event_MnTTEcskActionPerformed
    ...
    private javax.swing.JMenu MnCetakSuratKepolisian1;
    private javax.swing.JMenuItem MnTTDcs;
    private javax.swing.JMenuItem MnTTDcsk;
    private javax.swing.JMenuItem MnTTEcs;
    private javax.swing.JMenuItem MnTTEcsk;
    ...
    private widget.TextBox Tnrp;
    private widget.TextBox Tpenyidik;
    ...
    private widget.ComboBox cmbIndikasi;
    ...
    private widget.ComboBox cmbOPI;
    ...
    private widget.Table tbHasilTes;
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT rp.no_rawat, sk.no_surat, p.no_rkm_medis, sk.nm_pasien, IF(p.jk='L','Laki-laki','Perempuan') jk, sk.tmpt_lahir, "
                    ...
                    + "sk.opi, sk.hasil_opi, sk.nomor_surat, sk.jns_permintaan, sk.nm_penyidik, sk.nrp, sk.indikasi FROM reg_periksa rp "
                    ...
                    + "sk.tgl_surat BETWEEN ? AND ? AND sk.jns_permintaan LIKE ? OR "
                    + "sk.tgl_surat BETWEEN ? AND ? AND sk.nm_penyidik LIKE ? OR "
                    + "sk.tgl_surat BETWEEN ? AND ? AND sk.indikasi LIKE ? OR "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("jns_permintaan"),
                        rs.getString("nm_penyidik"),
                        rs.getString("nrp"),
    ...
    public void emptTeks() {
        ...
        cmbJnsPermintaan.setSelectedIndex(0);
        Tpenyidik.setText("");
        Tnrp.setText("");
        cmbIndikasi.setSelectedIndex(0);
        Tpenyidik.setEnabled(false);
    ...
    private void getData() {
        ...
        if (tbSurat.getSelectedRow() != -1) {
            ...
            opi = tbSurat.getValueAt(tbSurat.getSelectedRow(), 34).toString();
            ...
            cmbOPI.setSelectedItem(tbSurat.getValueAt(tbSurat.getSelectedRow(), 35).toString());
            ...
            cmbJnsPermintaan.setSelectedItem(tbSurat.getValueAt(tbSurat.getSelectedRow(), 37).toString());
            Tpenyidik.setText(tbSurat.getValueAt(tbSurat.getSelectedRow(), 38).toString());
            Tnrp.setText(tbSurat.getValueAt(tbSurat.getSelectedRow(), 39).toString());
            cmbIndikasi.setSelectedItem(tbSurat.getValueAt(tbSurat.getSelectedRow(), 40).toString());
            dataCek();
            cekConteng();
        }
    }
    ...
    private void cekConteng() {
        Valid.tabelKosong(tabMode3);
        
        if (ChkTHC.isSelected() == true) {
            ChkTHC.setSelected(true);
            tabMode3.addRow(new String[]{ChkTHC.getText(), ":", cmbTHC.getSelectedItem().toString()});
            cmbTHC.setEnabled(true);
        } else {
            ChkTHC.setSelected(false);
            cmbTHC.setEnabled(false);
        ...
        if (ChkBZO.isSelected() == true) {
            ChkBZO.setSelected(true);
            tabMode3.addRow(new String[]{ChkBZO.getText(), ":", cmbBZO.getSelectedItem().toString()});
            cmbBZO.setEnabled(true);
        } else {
            ChkBZO.setSelected(false);
            cmbBZO.setEnabled(false);
        ...
        if (ChkMET.isSelected() == true) {
            ChkMET.setSelected(true);
            tabMode3.addRow(new String[]{ChkMET.getText(), ":", cmbMET.getSelectedItem().toString()});
            cmbMET.setEnabled(true);
        } else {
            ChkMET.setSelected(false);
            cmbMET.setEnabled(false);
        ...
        if (ChkMOP.isSelected() == true) {
            ChkMOP.setSelected(true);
            tabMode3.addRow(new String[]{ChkMOP.getText(), ":", cmbMOP.getSelectedItem().toString()});
            cmbMOP.setEnabled(true);
        } else {
            ChkMOP.setSelected(false);
            cmbMOP.setEnabled(false);
        ...
        if (ChkCOC.isSelected() == true) {
            ChkCOC.setSelected(true);
            tabMode3.addRow(new String[]{ChkCOC.getText(), ":", cmbCOC.getSelectedItem().toString()});
            cmbCOC.setEnabled(true);
        } else {
            ChkCOC.setSelected(false);
            cmbCOC.setEnabled(false);
        ...
        if (ChkAMP.isSelected() == true) {
            ChkAMP.setSelected(true);
            tabMode3.addRow(new String[]{ChkAMP.getText(), ":", cmbAMP.getSelectedItem().toString()});
            cmbAMP.setEnabled(true);
        } else {
            ChkAMP.setSelected(false);
            cmbAMP.setEnabled(false);
        ...
        if (ChkOPI.isSelected() == true) {
            ChkOPI.setSelected(true);
            tabMode3.addRow(new String[]{ChkOPI.getText(), ":", cmbOPI.getSelectedItem().toString()});
            cmbOPI.setEnabled(true);
        } else {
            ChkOPI.setSelected(false);
            cmbOPI.setEnabled(false);
    ...
    private void cetakMnCetakSurat() {
        cekNarkoba = "";
        String isi = "";
        ...
        if (tbSurat.getSelectedRow() > -1) {
            ...
            for (n = 0; n < tbHasilTes.getRowCount(); n++) {
                cekNarkoba = cekNarkoba + String.valueOf(n + 1) + ". "
                        + tbHasilTes.getValueAt(n, 0).toString() + " "
                        + tbHasilTes.getValueAt(n, 1).toString() + " "
                        + tbHasilTes.getValueAt(n, 2).toString() + "\n";
            }

            param.put("hasil_tes", cekNarkoba);

            if (tte.equals("tidak")) {
                if (Sequel.cariInteger("SELECT count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "' and thc='ya' and bzo='ya' "
                        + "and met='ya' and mop='ya' and coc='ya' and amp='ya' and opi='ya'") == 0
                        || Sequel.cariInteger("SELECT count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "' and (thc='ya' or bzo='ya' "
                                + "or met='ya' or mop='ya' or coc='ya' or amp='ya' or opi='ya')") == 0) {
                ...
                if (kddokter.equals("") || kddokter.equals("-") || kddokter.equals("--")) {
                    ...
                    isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                            + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='002'"),
                                    "Surat Keterangan NAPZA/Narkoba", Tnmdokter.getText(),
                                    Sequel.cariIsi("select date_format(tgl_surat,'%d/%m/%Y') from surat_keterangan_napza where "
                    ...
                    if (Sequel.cariInteger("SELECT count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "' and thc='ya' and bzo='ya' "
                            ...
                            || Sequel.cariInteger("SELECT count(-1) from surat_keterangan_napza where no_rawat='" + TNoRW.getText() + "' and (thc='ya' or bzo='ya' "
                                    + "or met='ya' or mop='ya' or coc='ya' or amp='ya' or opi='ya')") == 0) {
                        Valid.MyReport("rptSuratNarkobaQr.jasper", "report", "::[ Surat Keterangan Narkoba ]::",
                                "SELECT now() tgl", param);
                    } else {
                        Valid.MyReport("rptSuratNapzaQr.jasper", "report", "::[ Surat Keterangan NAPZA ]::",
                                "SELECT now() tgl", param);
                    }
    ...
    private void cetakMnCetakSuratKepolisian() {
        cekNarkoba = "";
        String isi = "";
        ...
        if (tbSurat.getSelectedRow() > -1) {
            ...
            param.put("nosurat", "NOMOR : " + TnoDokumen.getText() + " / " + TNoSurat.getText());
            param.put("nama", TPasien.getText());
            param.put("ttl", TTempLahr.getText() + ", " + TtglLahir.getText() + " (" + Sequel.cariIsi("select concat(umurdaftar,' tahun') from reg_periksa where no_rawat='" + TNoRW.getText() + "'") + ")");
            param.put("jk", Tjk.getText());
            param.put("pekerjaan", TPekerjaan.getText());
            param.put("tempattinggal", Ttmpt_tinggal.getText());
            param.put("permintaandari", TPermintaanDari.getText());
            param.put("kesimpulan", cmbKesHasil.getSelectedItem().toString());
            param.put("keperluan", Tkeperluan.getText() + "\n\n");
            param.put("penyidik", Tpenyidik.getText());
            param.put("nrp", Tnrp.getText());
            param.put("indikasi", cmbIndikasi.getSelectedItem().toString());
            param.put("nosuratdari", TnoSuratDari.getText());
            param.put("tglsuratdari", Valid.SetTglINDONESIA(tbSurat.getValueAt(tbSurat.getSelectedRow(), 32).toString()));
            ...
            param.put("suku", Sequel.cariIsi("select s.nama_suku_bangsa from pasien p inner join suku_bangsa s on s.id=p.suku_bangsa "
                    + "where p.no_rkm_medis='" + TNoRM.getText() + "'"));
            param.put("pendidikan", Sequel.cariIsi("select pnd from pasien where no_rkm_medis='" + TNoRM.getText() + "'"));
            param.put("tglsurat", Ttgl_surat.getSelectedItem().toString().substring(0, 2) + " "
                    + Sequel.bulanINDONESIA("select date_format(tgl_surat,'%m') from surat_keterangan_napza where "
                            + "no_rawat='" + TNoRW.getText() + "'") + " " + Ttgl_surat.getSelectedItem().toString().substring(6, 10));
            param.put("nmdokter", Tnmdokter.getText());
            ...
            for (n = 0; n < tbHasilTes.getRowCount(); n++) {
                cekNarkoba = cekNarkoba + "* "
                        + tbHasilTes.getValueAt(n, 0).toString() + " "
                        + tbHasilTes.getValueAt(n, 1).toString() + " "
                        + tbHasilTes.getValueAt(n, 2).toString() + "\n";
            }

            param.put("hasil_tes", "Catatan :\n" + cekNarkoba);
            
            if (tte.equals("tidak")) {
                Valid.MyReport("rptSuratNarkobaKepolisian.jasper", "report", "::[ Surat Keterangan Narkoba (Kepolisian) ]::",
                        "SELECT now() tgl", param);
                TCari.setText(TNoRW.getText());
                tbSurat.requestFocus();
                emptTeks();
                ...
                if (kddokter.equals("") || kddokter.equals("-") || kddokter.equals("--")) {
                    ...
                    isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                            + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='002'"),
                                    "Surat Keterangan Pemeriksaan Narkoba", Tnmdokter.getText(),
                                    Sequel.cariIsi("select date_format(tgl_surat,'%d/%m/%Y') from surat_keterangan_napza where "
                                            + "no_rawat='" + TNoRW.getText() + "' and no_surat='" + TNoSurat.getText() + "'"),
                                    Sequel.cariIsi("select jam_reg from reg_periksa where no_rawat='" + TNoRW.getText() + "'")) + "') from kalimat_tte where kode='002'");
                    ...
                    Valid.MyReport("rptSuratNarkobaKepolisianQr.jasper", "report", "::[ Surat Keterangan Narkoba (Kepolisian) ]::",
                            "SELECT now() tgl", param);
                    Sequel.hapusIisiFolder(Sequel.cariFolderTte() + File.separator);
                    TCari.setText(TNoRW.getText());
                    tbSurat.requestFocus();
