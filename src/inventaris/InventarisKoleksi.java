...
public final class InventarisKoleksi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppBarcode.setForeground(new java.awt.Color(0, 0, 0));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Aset Inventaris ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        nm_ruangcari.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnRuang1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        no_inventaris.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nm_merk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kode_barang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        tgl_pengadaan.setForeground(new java.awt.Color(0, 0, 0));
        tgl_pengadaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-08-2017" }));
        tgl_pengadaan.setDisplayFormat("dd-MM-yyyy");
        tgl_pengadaan.setName("tgl_pengadaan"); // NOI18N
        tgl_pengadaan.setOpaque(false);
        tgl_pengadaan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tgl_pengadaanMouseClicked(evt);
            }
        });
        ...
        status_barang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        status_barang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                status_barangMouseClicked(evt);
            }
        });
        ...
        nm_kategori.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nm_jenis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nm_produsen.setForeground(new java.awt.Color(0, 0, 0));
        ...
        asal_barang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        asal_barang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                asal_barangMouseClicked(evt);
            }
        });
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "Posisi Inventaris Di :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        nm_ruang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        id_ruang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        no_box.setForeground(new java.awt.Color(0, 0, 0));
        ...
        no_box.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                no_boxMouseClicked(evt);
            }
        });
        ...
        no_rak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        no_rak.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                no_rakMouseClicked(evt);
            }
        });
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptInv.jasper","report","::[ Data Inv Barang ]::","select inventaris.no_inventaris,inventaris_barang.kode_barang, inventaris_barang.nama_barang, "+
...
private void ppBarcodeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBarcodeBtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            param.put("propinsirs",akses.getpropinsirs());
            param.put("kontakrs",akses.getkontakrs()); 
            Valid.MyReport("rptBarcodeInventaris.jasper","report","::[ Data Barang ]::","select inventaris.no_inventaris,inventaris_barang.kode_barang, inventaris_barang.nama_barang, "+
                   "inventaris_barang.nama_barang, inventaris_merk.nama_merk, inventaris_barang.thn_produksi, inventaris_barang.isbn, "+
                   "inventaris_kategori.nama_kategori, inventaris_jenis.nama_jenis,inventaris.asal_barang,inventaris.tgl_pengadaan, "+
                   "inventaris.harga,inventaris.status_barang,inventaris_ruang.nama_ruang,inventaris.no_rak,inventaris.no_box "+
                   "from inventaris inner join inventaris_barang inner join inventaris_ruang "+
    ...
    private void status_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_status_barangMouseClicked
        status_barang.setEditable(false);
    }//GEN-LAST:event_status_barangMouseClicked

    private void tgl_pengadaanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tgl_pengadaanMouseClicked
        tgl_pengadaan.setEditable(false);
    }//GEN-LAST:event_tgl_pengadaanMouseClicked

    private void asal_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_asal_barangMouseClicked
        asal_barang.setEditable(false);
    }//GEN-LAST:event_asal_barangMouseClicked

    private void no_rakMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_no_rakMouseClicked
        no_rak.setEditable(false);
    }//GEN-LAST:event_no_rakMouseClicked

    private void no_boxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_no_boxMouseClicked
        no_box.setEditable(false);
    }//GEN-LAST:event_no_boxMouseClicked
