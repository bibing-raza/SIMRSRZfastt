...
public class InventarisSirkulasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        merk.setForeground(new java.awt.Color(0, 0, 0));
        merk.setName("merk"); // NOI18N
        internalFrame2.add(merk);
        merk.setBounds(450, 55, 235, 23);

        peminjam.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nama_petugas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LblTgl1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        InventarisCari.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusCari.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusCari.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                StatusCariMouseClicked(evt);
            }
        });
        ...
        TglPinjam2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TglPinjam2MouseClicked(evt);
            }
        });
        ...
        TglPinjam1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TglPinjam1MouseClicked(evt);
            }
        });
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptSirkulasiInventaris.jasper","report","::[ Data KSirkulasi Inventaris ]::","select inventaris_peminjaman.no_inventaris,"+
...
private void tlpKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tlpKeyPressed
    ...
    private void StatusCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StatusCariMouseClicked
        StatusCari.setEditable(false);
    }//GEN-LAST:event_StatusCariMouseClicked

    private void TglPinjam2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TglPinjam2MouseClicked
        TglPinjam2.setEditable(false);
    }//GEN-LAST:event_TglPinjam2MouseClicked

    private void TglPinjam1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TglPinjam1MouseClicked
        TglPinjam1.setEditable(false);
    }//GEN-LAST:event_TglPinjam1MouseClicked
