...
public final class DlgBarangIPSRS extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Barang Non Medis dan Penunjang ( Lab & RO ) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        kode_brng.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nama_brng.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kode_sat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nama_sat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdjenis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmjenis.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kode_brng.getText().trim().equals("")) {
            ...
            Sequel.mengedit("ipsrsbarang", "kode_brng=?", "kode_brng=?,nama_brng=?,kode_sat=?,jenis=?,stok=?,harga=?", 7, new String[]{
                kode_brng.getText(), nama_brng.getText(), kode_sat.getText(), kdjenis.getText(), stok.getText(), 
                harga.getText(), tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(), 0).toString()
            });
            //----------------------------------------------------------
            kode_brng.requestFocus();
            tampil();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptBarangIpsrs.jasper", "report", "::[ Data Barang Non Medis, Radiologi, Loundry, ATK, Dapur, IPSRS ]::",
