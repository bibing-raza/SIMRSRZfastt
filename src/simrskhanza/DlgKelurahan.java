...
public class DlgKelurahan extends javax.swing.JDialog {
    ...
    public DlgKelurahan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Nama Kelurahan", "kd_kelurahan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Data Kelurahan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().equals("")) {
            ...
            if (akses.getkode().equals("Admin Utama")) {
                ...
                JOptionPane.showMessageDialog(null, "Hanya Admin Utama yang berhak menambah data");
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (akses.getkode().equals("Admin Utama")) {
            ...
            JOptionPane.showMessageDialog(null, "Hanya Admin Utama yang berhak menghapus data");
        }
    ...
    public void isCek() {
        cek_akses = 0;
        cek_akses = Sequel.cariInteger("select count(*) from set_alamat_pasien where kelurahan='true'");
