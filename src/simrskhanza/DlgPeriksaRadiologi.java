...
public final class DlgPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private int jml = 0, i = 0, index = 0, cekBhp = 0, x = 0;
    ...
    public DlgPeriksaRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            sb.append("select beri_bhp_radiologi.kode_brng,ipsrsbarang.nama_brng,beri_bhp_radiologi.kode_sat,beri_bhp_radiologi.jumlah, ");
            sb.append("beri_bhp_radiologi.total from beri_bhp_radiologi inner join ipsrsbarang on ipsrsbarang.kode_brng=beri_bhp_radiologi.kode_brng ");
            sb.append("where beri_bhp_radiologi.no_rawat like ? and beri_bhp_radiologi.tgl_periksa like ? and beri_bhp_radiologi.jam like ?");
            ps2 = koneksi.prepareStatement(sb.toString());
            
            StringBuilder sb1 = new StringBuilder();
            sb1.append("select periksa_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,reg_periksa.umurdaftar umur,petugas.nama,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,");
            sb1.append("periksa_radiologi.dokter_perujuk,periksa_radiologi.kd_dokter,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,pasien.alamat,dokter.nm_dokter from periksa_radiologi inner join reg_periksa inner join pasien inner join petugas  inner join dokter ");
            sb1.append("on periksa_radiologi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and periksa_radiologi.nip=petugas.nip and periksa_radiologi.kd_dokter=dokter.kd_dokter where ");
            sb1.append("periksa_radiologi.tgl_periksa like ? and periksa_radiologi.jam like ? and periksa_radiologi.no_rawat like ? group by concat(periksa_radiologi.no_rawat,periksa_radiologi.tgl_periksa,periksa_radiologi.jam)");
            ...
            sb3.append("select periksa_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,CONCAT(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur_thn,petugas.nama,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,");
            sb3.append("periksa_radiologi.dokter_perujuk,periksa_radiologi.kd_dokter,dokter.nm_dokter,reg_periksa.status_lanjut, periksa_radiologi.nip, penjab.png_jawab, reg_periksa.kd_pj from periksa_radiologi ");
            sb3.append("inner join reg_periksa inner join pasien inner join petugas inner join dokter inner join penjab on periksa_radiologi.no_rawat=reg_periksa.no_rawat and ");
            sb3.append("reg_periksa.no_rkm_medis=pasien.no_rkm_medis and periksa_radiologi.kd_dokter=dokter.kd_dokter and periksa_radiologi.nip=petugas.nip and reg_periksa.kd_pj=penjab.kd_pj where ");
            sb3.append("periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.no_rawat like ? and reg_periksa.no_rkm_medis like ? ");
            sb3.append("and petugas.nip like ? and pasien.nm_pasien like ? or ");
            sb3.append("periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.no_rawat like ? and reg_periksa.no_rkm_medis like ? ");
            sb3.append("and petugas.nip like ? and petugas.nama like ? or ");
            sb3.append("periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.no_rawat like ? and reg_periksa.no_rkm_medis like ? ");
            sb3.append("and petugas.nip like ? and reg_periksa.no_rkm_medis like ? or ");
            sb3.append("periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.no_rawat like ? and reg_periksa.no_rkm_medis like ? ");
            sb3.append("and petugas.nip like ? and reg_periksa.no_rawat like ? or ");
            sb3.append("periksa_radiologi.tgl_periksa between ? and ? and periksa_radiologi.no_rawat like ? and reg_periksa.no_rkm_medis like ? ");
            sb3.append("and petugas.nip like ? and dokter.nm_dokter like ? ");
            sb3.append("group by concat(periksa_radiologi.no_rawat,periksa_radiologi.tgl_periksa,periksa_radiologi.jam) order by periksa_radiologi.tgl_periksa desc, periksa_radiologi.jam desc");
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(237, 242, 232)), ".: Pemeriksaan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(237, 242, 232)), ".: Permintaan Pemeriksaan Radiologi", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
        ...
        chkPermintaan.setText("Conteng semua");
        ...
        Scroll1.setViewportView(tbPermintaan);

        jPanel4.add(Scroll1, java.awt.BorderLayout.CENTER);

        jPanel1.add(jPanel4);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(237, 242, 232)), ".: BHP Radiologi", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
...
private void ChkJlnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJlnActionPerformed
    ...
    private void chkPermintaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkPermintaanActionPerformed
        for (i = 0; i < tbPermintaan.getRowCount(); i++) {
            if (chkPermintaan.isSelected() == true) {
                tbPermintaan.setValueAt(Boolean.TRUE, i, 0);
            }
        }

        for (i = 0; i < tbPermintaan.getRowCount(); i++) {
            if (chkPermintaan.isSelected() == false) {
                tbPermintaan.setValueAt(Boolean.FALSE, i, 0);
            }
        }
        ...
        try {
            for (i = 0; i < tbPermintaan.getRowCount(); i++) {
                if (tbPermintaan.getValueAt(i, 0).toString().equals("true")) {
                    if (tbPermintaan.getValueAt(i, 1).toString().equals("Diterima")) {
                        cekPeriksa = "Belum";
                    } else {
                        cekPeriksa = "Diterima";
                    }
    ...
    public void setNoRm(String norwt, String posisi, String proses, String tglPerik, String jamPerik) {
        TNoRw.setText(norwt);
        sttsProses = proses;
        tglperiksa = tglPerik;
        jamperiksa = jamPerik;
            ...
            try {
                ...
                while (rs1.next()) {
                    tabMode1.addRow(new Object[]{
                        ...
                        rs1.getString("dari_unit"),
                        rs1.getString("no_rawat")
                    });
                }
                this.setCursor(Cursor.getDefaultCursor());
            } catch (Exception e) {
                System.out.println("simrskhanza.DlgPeriksaRadiologi.tampilMinta() : " + e);
            } finally {
                if (rs1 != null) {
                    rs1.close();
                }
    ...
    private void simpan() {
        if (akses.getadmin() == true) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if (sttsProses.equals("perbaikan")) {
                    hapusPeriksaRadiologi();
                }
                
                tglperiksa = "";
                jamperiksa = "";
                tglperiksa = Valid.SetTgl(Tanggal.getSelectedItem() + "");
                jamperiksa = CmbJam.getSelectedItem() + ":" + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem();
                ...
                for (i = 0; i < tbBHPRadiologi.getRowCount(); i++) {
                    if (Valid.SetAngka(tbBHPRadiologi.getValueAt(i, 0).toString()) > 0) {
                        if (Sequel.menyimpantf2("beri_bhp_radiologi", "?,?,?,?,?,?,?,?", "BHP", 8, new String[]{
                            TNoRw.getText(), tglperiksa, jamperiksa,
                ...
                if (status.equals("Ranap")) {
                    ...
                    jur.simpanJurnal(TNoRw.getText(), tglperiksa, "U", "PEMERIKSAAN RADIOLOGI RAWAT INAP PASIEN " + TPasien.getText() + " DIPOSTING OLEH " + akses.getkode());
                }
...
//                }
    ...
    private void hapusPeriksaRadiologi() {
        try {
            Sequel.AutoComitFalse();
            status = "";
            ttljmdokter = 0;
            ...
            ttlpendapatan = 0;
            ttlbhp = 0;
            ttljmdokter = Sequel.cariIsiAngka("select sum(tarif_perujuk)+sum(tarif_tindakan_dokter) from periksa_radiologi where no_rawat='" + TNoRw.getText() + "' and tgl_periksa='" + tglperiksa + "' and jam='" + jamperiksa + "'");
            ttljmpetugas = Sequel.cariIsiAngka("select sum(tarif_tindakan_petugas) from periksa_radiologi where no_rawat='" + TNoRw.getText() + "' and tgl_periksa='" + jamperiksa + "' and jam='" + tglperiksa + "'");
            ttlkso = Sequel.cariIsiAngka("select sum(kso) from periksa_radiologi where no_rawat='" + TNoRw.getText() + "' and tgl_periksa='" + tglperiksa + "' and jam='" + jamperiksa + "'");
            ttlpendapatan = Sequel.cariIsiAngka("select sum(biaya) from periksa_radiologi where no_rawat='" + TNoRw.getText() + "' and tgl_periksa='" + tglperiksa + "' and jam='" + jamperiksa + "'");
            status = Sequel.cariIsi("select status from periksa_radiologi where no_rawat='" + TNoRw.getText() + "' and tgl_periksa='" + tglperiksa + "' and jam='" + jamperiksa + "'");
            ...
            if (Sequel.queryu2tf("delete from periksa_radiologi where no_rawat=? and tgl_periksa=? and jam=?", 3, new String[]{
                ...
                ttlbhp = Sequel.cariIsiAngka("select sum(total) from beri_bhp_radiologi where no_rawat='" + TNoRw.getText() + "' and tgl_periksa='" + tglperiksa + "' and jam='" + jamperiksa + "'");
                ...
                if (status.equals("Ranap")) {
                    ...
                    jur.simpanJurnal(TNoRw.getText(), Sequel.cariIsi("select current_date()"), "U", "PEMBATALAN PEMERIKSAAN RADIOLOGI RAWAT INAP PASIEN OLEH " + akses.getkode());
                }
            }
            Sequel.AutoComitTrue();
        } catch (Exception e) {
    ...
    private void cetakNota() {
        try {
            ...
            while (rs5.next()) {
                ...
                ttl = 0;
                while (rs4.next()) {
                    item = rs4.getDouble("biaya") + Sequel.cariIsiAngka("select sum(biaya_item) from template_laboratorium where kd_jenis_prw=?", rs4.getString("kd_jenis_prw"));
                    ttl = ttl + item;
                    Sequel.menyimpan("temporary", "'0','" + rs4.getString("nm_perawatan") + "','" + item + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''", "Transaksi Biaya Rad");
                }
                ...
                param.put("tglNota", "Martapura, " + Tanggal.getSelectedItem().toString());
