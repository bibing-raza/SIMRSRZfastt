...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private double ttljmdokter=0,ttljmpetugas=0,ttlpendapatan=0,ttlbhp=0, cekOperasi;
    ...
    public DlgCariTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Tgl. Operasi",
                      "No. Rawat",
                      "Pasien",
                      "Jns. Anstsi.","Jns. Operasi","Dokter Operator","","","","","","","","","Dokter Anastesi","","","","","","","","","","","","","","","","","","",""};
            ...
            public void windowClosed(WindowEvent e) {
                if(dokter.getTable().getSelectedRow()!= -1){                    
                    if (pilihan == 1) {
                        ...
                        TCari.setText(kddokter.getText());
                        
                        kddokter1.setText("");
                        TDokter1.setText("");
                        jnsOperasi.setSelectedIndex(0);
                        spes.setSelectedIndex(0);
                    } else if (pilihan == 9) {
                        ...
                        TCari.setText(kddokter1.getText());
    ...
    private void initComponents() {
        ...
        MnRekapPembedahan = new javax.swing.JMenuItem();
        MnRekapPerJenis = new javax.swing.JMenuItem();
        MnRekapPerDokterOper = new javax.swing.JMenuItem();
        MnRekapPerDokterAnas = new javax.swing.JMenuItem();
        MnRekapPerSpes = new javax.swing.JMenuItem();
        ...
        jnsOperasi = new widget.ComboBox();
        jLabel4 = new widget.Label();
        spes = new widget.ComboBox();
        ...
        MnUbahOperatorPetugas.setPreferredSize(new java.awt.Dimension(200, 26));
        ...
        MnDataOperasi.setIconTextGap(5);
        MnDataOperasi.setName("MnDataOperasi"); // NOI18N
        MnDataOperasi.setPreferredSize(new java.awt.Dimension(230, 26));
        MnDataOperasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnDataOperasiActionPerformed(evt);
            }
        });
        ...
        MnRekapPembedahan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapPembedahan.setIconTextGap(5);
        MnRekapPembedahan.setName("MnRekapPembedahan"); // NOI18N
        MnRekapPembedahan.setPreferredSize(new java.awt.Dimension(230, 26));
        MnRekapPembedahan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapPembedahanActionPerformed(evt);
            }
        });
        ...
        MnRekapPerJenis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapPerJenis.setIconTextGap(5);
        MnRekapPerJenis.setName("MnRekapPerJenis"); // NOI18N
        MnRekapPerJenis.setPreferredSize(new java.awt.Dimension(230, 26));
        MnRekapPerJenis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapPerJenisActionPerformed(evt);
            }
        });
        ...
        MnRekapPerDokterOper.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapPerDokterOper.setIconTextGap(5);
        MnRekapPerDokterOper.setName("MnRekapPerDokterOper"); // NOI18N
        MnRekapPerDokterOper.setPreferredSize(new java.awt.Dimension(230, 26));
        MnRekapPerDokterOper.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapPerDokterOperActionPerformed(evt);
            }
        });
        ...
        MnRekapPerDokterAnas.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapPerDokterAnas.setIconTextGap(5);
        MnRekapPerDokterAnas.setName("MnRekapPerDokterAnas"); // NOI18N
        MnRekapPerDokterAnas.setPreferredSize(new java.awt.Dimension(230, 26));
        MnRekapPerDokterAnas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapPerDokterAnasActionPerformed(evt);
            }
        });
        ...
        MnRekapPerSpes.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapPerSpes.setIconTextGap(5);
        MnRekapPerSpes.setName("MnRekapPerSpes"); // NOI18N
        MnRekapPerSpes.setPreferredSize(new java.awt.Dimension(230, 26));
        MnRekapPerSpes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapPerSpesActionPerformed(evt);
            }
        });
        MnLaporan.add(MnRekapPerSpes);
        ...
        kdoperator1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmoperator1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnOperator1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdasistoperator1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmasistoperator1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnAsis1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdoperator2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmoperator2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnOperator2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdoperator3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmoperator3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdanestesi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmanestesi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnAnastesi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kddranak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmdranak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnAnak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnAsis2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmasistoperator2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdasistoperator2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnAsis3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nminstrumen.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdInstrumen.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnPrwRes.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmprwresust.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdprwresust.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdasistanestesi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmasistanestesi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnAsnes.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdprwluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmprwluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnPrwLuar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmbidan2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdbidan2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdbidan3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmbidan3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnBidan3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdonloop1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmonloop1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnOnloop1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnOnloop2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmonloop2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdonloop2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnOnloop3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmonloop3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdonloop3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdpjanak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmpjanak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btndrpjanak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kddrumum.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmdrumum.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btndrumum.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdasistoperator3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmasistoperator3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnAsis4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdasistanestesi2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmasistanestesi2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnAsnes1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdonloop4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmonloop4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnOnloop4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnOnloop5.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmonloop5.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdonloop5.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnCloseIn4.setBounds(690, 340, 90, 30);
        ...
        cekDokter.setName("cekDokter"); // NOI18N
        cekDokter.setPreferredSize(new java.awt.Dimension(207, 23));
        ...
        label13.setBounds(305, 10, 50, 23);
        ...
        BtnCari5.setBounds(685, 10, 28, 23);
        ...
        jLabel13.setText("Dokter Operator : ");
        jLabel13.setName("jLabel13"); // NOI18N
        panelisi3.add(jLabel13);
        jLabel13.setBounds(310, 40, 90, 23);
        ...
        btnCariDokter.setBounds(731, 40, 28, 23);

        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Jenis Operasi : ");
        jLabel5.setName("jLabel5"); // NOI18N
        panelisi3.add(jLabel5);
        jLabel5.setBounds(765, 10, 82, 23);
        ...
        jLabel14.setText("Dokter Anastesi : ");
        jLabel14.setName("jLabel14"); // NOI18N
        panelisi3.add(jLabel14);
        jLabel14.setBounds(310, 68, 90, 23);
        ...
        panelisi3.add(TDokter1);
        TDokter1.setBounds(505, 68, 220, 23);
        ...
        panelisi3.add(btnCariDokter1);
        btnCariDokter1.setBounds(731, 68, 28, 23);
    ...
    if(tbDokter.getSelectedRow()>-1){
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
            if(akses.getkode().equals("Admin Utama")){
                ...
                cekOperasi=0;
                cekDataOperasi = "select count(1) from operasi where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1)+"' and stts_bayar = 'Belum' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +"'";
                if(Sequel.cariIsiAngka(cekDataOperasi) == 0){
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    ...
    private void MnDataOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataOperasiActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptOperasi.jasper", "report", "::[ Transaksi Operasi ]::",
    ...
    }//GEN-LAST:event_MnDataOperasiActionPerformed

    private void MnRekapPembedahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapPembedahanActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            TCari.requestFocus();
        } else if (tabMode.getRowCount() != 0) {
            ...
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            param.put("periode", "Periode Tgl. " + Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
            Valid.MyReport("rptLRKegiatanPembedahan.jasper", "report", "::[ Laporan Rekap Kegiatan Pembedahan ]::",
                    " SELECT r.no_rkm_medis, p.nm_pasien, DATE_FORMAT(o.tgl_operasi,'%d-%m-%Y') tgl_ops, DATE_FORMAT(o.tgl_operasi,'%H:%i:%s') jam, "
                    + " IF(o.kategori='','-',o.kategori) jns_ops, d.nm_dokter dr_oper, e.nm_dokter dr_anas, IFNULL(o.spesialisasi_operasi,'-') spes_ops FROM operasi o "
                    + " INNER JOIN reg_periksa r ON r.no_rawat=o.no_rawat INNER JOIN pasien p ON p.no_rkm_medis=r.no_rkm_medis "
                    + " INNER JOIN dokter d ON d.kd_dokter=o.operator1 INNER JOIN dokter e ON e.kd_dokter=o.dokter_anestesi "
                    + " WHERE o.tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' "
                    + " AND r.stts_daftar<> 'batal' ORDER BY o.tgl_operasi", param);
        }
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnRekapPembedahanActionPerformed

    private void MnRekapPerJenisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapPerJenisActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            TCari.requestFocus();
        } else if (jnsOperasi.getSelectedItem().equals("-")) {
            JOptionPane.showMessageDialog(null, "Silakan pilih salah satu jenis operasinya dulu...!!!!");
            Tgl1.requestFocus();
        } else if (tabMode.getRowCount() != 0) {
            Map<String, Object> param = new HashMap<>();
            param.put("namars", akses.getnamars());
            ...
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            param.put("periode", "Periode Tgl. " + Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
            Valid.MyReport("rptLRKegiatanPembedahan1.jasper", "report", "::[ Laporan Rekap Kegiatan Pembedahan PerJenis Operasi ]::",
                    ...
                    + " INNER JOIN dokter d ON d.kd_dokter=o.operator1 INNER JOIN dokter e ON e.kd_dokter=o.dokter_anestesi "
                    + " WHERE o.tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' "
                    + " AND r.stts_daftar<> 'batal' and o.kategori LIKE '%" + jnsOperasi.getSelectedItem() + "%' ORDER BY o.tgl_operasi", param);
        }
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnRekapPerJenisActionPerformed

    private void MnRekapPerDokterOperActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapPerDokterOperActionPerformed
        Sequel.cariIsi("select operator1 from operasi where tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' and operator1=? ", cekDokter, kddokter.getText());
        
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            TCari.requestFocus();
        } else if (kddokter.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silakan pilih salah satu dokter operatornya dulu...!!!!");
            Tgl1.requestFocus();
        } else if (cekDokter.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Tidak ditemukan data " + TDokter.getText() + " sebagai dokter operator tindakan operasi pada tanggal tersebut...!!!");
            btnCariDokter.requestFocus();
        } else if ((tabMode.getRowCount() != 0) && (!cekDokter.getText().equals(""))) {
            Map<String, Object> param = new HashMap<>();
            param.put("namars", akses.getnamars());
            param.put("alamatrs", akses.getalamatrs());
            param.put("kotars", akses.getkabupatenrs());
            ...
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            param.put("periode", "Periode Tgl. " + Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
            Valid.MyReport("rptLRKegiatanPembedahan2.jasper", "report", "::[ Laporan Rekap Kegiatan Pembedahan PerDokter Operator ]::",
                    " SELECT r.no_rkm_medis, p.nm_pasien, DATE_FORMAT(o.tgl_operasi,'%d-%m-%Y') tgl_ops, IF(o.kategori='','-',o.kategori) jns_ops, "
                    + " d.nm_dokter dr_oper, e.nm_dokter dr_anas, IFNULL(o.spesialisasi_operasi,'-') spes_ops FROM operasi o "
                    + " INNER JOIN reg_periksa r ON r.no_rawat=o.no_rawat INNER JOIN pasien p ON p.no_rkm_medis=r.no_rkm_medis "
                    + " INNER JOIN dokter d ON d.kd_dokter=o.operator1 INNER JOIN dokter e ON e.kd_dokter=o.dokter_anestesi "
                    + " WHERE o.tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' "
                    + " AND r.stts_daftar<> 'batal' and o.operator1='" + kddokter.getText() + "' ORDER BY o.tgl_operasi", param);
        }
        this.setCursor(Cursor.getDefaultCursor());
        cekDokter.setText("");
    }//GEN-LAST:event_MnRekapPerDokterOperActionPerformed

    private void MnRekapPerSpesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapPerSpesActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            TCari.requestFocus();
        } else if (spes.getSelectedItem().equals("-")) {
            JOptionPane.showMessageDialog(null, "Silakan pilih salah satu jenis spesialisasi operasinya dulu...!!!!");
            Tgl1.requestFocus();
        } else if (tabMode.getRowCount() != 0) {
            Map<String, Object> param = new HashMap<>();
            param.put("namars", akses.getnamars());
            ...
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            param.put("periode", "Periode Tgl. " + Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
            Valid.MyReport("rptLRKegiatanPembedahan4.jasper", "report", "::[ Laporan Rekap Kegiatan Pembedahan PerSpesialisasi Operasi ]::",
                    " SELECT r.no_rkm_medis, p.nm_pasien, DATE_FORMAT(o.tgl_operasi,'%d-%m-%Y') tgl_ops, IF(o.kategori='','-',o.kategori) jns_ops, "
                    + " d.nm_dokter dr_oper, e.nm_dokter dr_anas, IFNULL(o.spesialisasi_operasi,'-') spes_ops FROM operasi o "
                    + " INNER JOIN reg_periksa r ON r.no_rawat=o.no_rawat INNER JOIN pasien p ON p.no_rkm_medis=r.no_rkm_medis "
                    + " INNER JOIN dokter d ON d.kd_dokter=o.operator1 INNER JOIN dokter e ON e.kd_dokter=o.dokter_anestesi "
                    + " WHERE o.tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' "
                    + " AND r.stts_daftar<> 'batal' and o.spesialisasi_operasi like '%" + spes.getSelectedItem() + "%' ORDER BY o.tgl_operasi", param);
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnRekapPerDokterAnasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapPerDokterAnasActionPerformed
        Sequel.cariIsi("select dokter_anestesi from operasi where tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' and dokter_anestesi=? ", cekDokter, kddokter1.getText());        
        
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            TCari.requestFocus();
        } else if (kddokter1.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Silakan pilih salah satu dokter anastesinya dulu...!!!!");
            Tgl1.requestFocus();
        } else if (cekDokter.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Tidak ditemukan data " + TDokter1.getText() + " sebagai dokter anastesi tindakan operasi pada tanggal tersebut...!!!");
            btnCariDokter.requestFocus();
        } else if ((tabMode.getRowCount() != 0) && (!cekDokter.getText().equals(""))) {
            Map<String, Object> param = new HashMap<>();
            param.put("namars", akses.getnamars());
            ...
            param.put("logo", Sequel.cariGambar("select logo from setting"));
            param.put("periode", "Periode Tgl. " + Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
            Valid.MyReport("rptLRKegiatanPembedahan3.jasper", "report", "::[ Laporan Rekap Kegiatan Pembedahan PerDokter Anastesi ]::",
                    " SELECT r.no_rkm_medis, p.nm_pasien, DATE_FORMAT(o.tgl_operasi,'%d-%m-%Y') tgl_ops, IF(o.kategori='','-',o.kategori) jns_ops, "
                    + " d.nm_dokter dr_oper, e.nm_dokter dr_anas, IFNULL(o.spesialisasi_operasi,'-') spes_ops FROM operasi o "
                    + " INNER JOIN reg_periksa r ON r.no_rawat=o.no_rawat INNER JOIN pasien p ON p.no_rkm_medis=r.no_rkm_medis "
                    + " INNER JOIN dokter d ON d.kd_dokter=o.operator1 INNER JOIN dokter e ON e.kd_dokter=o.dokter_anestesi "
                    + " WHERE o.tgl_operasi BETWEEN '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' "
                    + " AND r.stts_daftar<> 'batal' and o.dokter_anestesi='" + kddokter1.getText() + "' ORDER BY o.tgl_operasi", param);
        }
        this.setCursor(Cursor.getDefaultCursor());
        cekDokter.setText("");
    }//GEN-LAST:event_MnRekapPerDokterAnasActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnDataOperasi;
    ...
    private javax.swing.JMenuItem MnRekapPembedahan;
    private javax.swing.JMenuItem MnRekapPerDokterAnas;
    private javax.swing.JMenuItem MnRekapPerDokterOper;
    private javax.swing.JMenuItem MnRekapPerJenis;
    private javax.swing.JMenuItem MnRekapPerSpes;
    ...
    private widget.TextBox cekDokter;
    ...
    private widget.ComboBox jnsOperasi;
    ...
    private void tampil() {
        ...
        if ((TCari.getText().equals("-")) || (TCari.getText().equals(""))) {
        ...
        } else if ((!TCari.getText().equals("-")) || (!TCari.getText().equals(""))) {
            String sql = "select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,operasi.jenis_anasthesi,"
                    + " operasi.tgl_operasi from operasi inner join reg_periksa inner join pasien "
                    + " on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + " where " + tanggal + mem + norawat + " and operasi.no_rawat like '%" + TCari.getText() + "%' or "
                    ...
                    + tanggal + mem + norawat + " and pasien.nm_pasien like '%" + TCari.getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.tgl_operasi like '%" + TCari.getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.operator1 like '%" + TCari.getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.dokter_anestesi like '%" + TCari.getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.kategori like '%" + TCari.getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.spesialisasi_operasi like '%" + TCari.getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.jenis_anasthesi like '%" + TCari.getText() + "%' "
                    + " group by operasi.no_rawat,operasi.tgl_operasi order by operasi.tgl_operasi,operasi.no_rawat ";
            prosesCari(sql);
        }
        ...
        try{
            ...
            while(rs.next()){
                ...
                tabMode.addRow(new Object[]{rs.getString("tgl_operasi"),
                               ...
                               "No. RM : "+rs.getString("no_rkm_medis")+", Nama : "+rs.getString("nm_pasien"),
    ...
    public void isCek(){
        ...
        MnLaporan.setEnabled(akses.getoperasi());
    }
