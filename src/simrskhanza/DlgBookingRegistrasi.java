...
public class DlgBookingRegistrasi extends javax.swing.JDialog {
    ...
    private BPJSCekReferensiPoli poliBPJS;
    private DlgCariPoli poli;
    private DlgCariDokter2 dokter;    
    private BPJSCekReferensiPenyakit penyakit;
    private BPJSCekReferensiDokterDPJP dpjp;
    private BPJSCekReferensiFaskes faskes;
    private BPJSCekReferensiPropinsi provinsi;
    private BPJSCekReferensiKabupaten kabupaten;
    private BPJSCekReferensiKecamatan kecamatan;
    private BPJSSuratKontrol surat_suratan;
...
//                user = akses.getnamauser();
    ...
    private void initComponents() {
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2026" }));
        ...
        tbBoking.getTableHeader().setReorderingAllowed(false);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2026" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2026" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2026" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2026" }));
        ...
        TanggalKejadian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2026" }));
...
//                NmPpkRujukan.setText(response.path("provPerujuk").path("nama").asText());
    ...
    private void simpanBooking() {
        ...
        if ((kdpnj.getText().equals("B01") || kdpnj.getText().equals("A03")) && kuotaJkn > 0 && jumlahJkn >= kuotaJkn) {
            ...
            return;
        } else if (!(kdpnj.getText().equals("B01") || kdpnj.getText().equals("A03")) && kuotaNonJkn > 0 && jumlahNonJkn >= kuotaNonJkn) {
            JOptionPane.showMessageDialog(rootPane, "Jumlah kunjungan pasien Non JKN yang mendaftar dipoliklinik " + NmPoli.getText() + " pada tgl. " + Valid.SetTglINDONESIA(Valid.SetTgl(TanggalPeriksa.getSelectedItem() + ""))
                    + "         \nsudah terpenuhi sesuai kuota layanan terjadwal, Silahkan informasikan/jadwalkan ke hari lain.");
            return;
        } else if (Sequel.cariInteger("select count(1) from booking_registrasi where kd_poli='" + KdPoli.getText() + "' and tanggal_periksa='" + Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' "
                + "and no_reg='" + NoReg.getText() + "'") > 0) {
            JOptionPane.showMessageDialog(rootPane, "No. Reg. " + NoReg.getText() + " untuk poli " + NmPoli.getText() + " pada tgl. " + Valid.SetTglINDONESIA(Valid.SetTgl(TanggalPeriksa.getSelectedItem() + ""))
                    + " sudah digunakan.\nSilahkan klik simpan ulang lagi ....");
            isNomer();
            return;
        } else {
    ...
    public void tampilKunjungan() {
        ...
        try {
            ps3 = koneksi.prepareStatement("SELECT r.no_rkm_medis, DATE_FORMAT(r.tgl_registrasi,'%d-%m-%Y') tglReg, IF(r.status_lanjut='Ralan','R. Jalan','R. Inap') status_lanjut, "
                    ...
                    + "r.no_rkm_medis = '" + TNoRM.getText() + "' ORDER BY r.tgl_registrasi DESC LIMIT 25");
            try {
    ...
    private void initPenyakit() {
        if (penyakit == null) {
            penyakit = new BPJSCekReferensiPenyakit(null, false);
    ...
    private void initDpjp() {
        if (dpjp == null) {
            dpjp = new BPJSCekReferensiDokterDPJP(null, false);
    ...
    private void initProvinsi() {
        if (provinsi == null) {
            provinsi = new BPJSCekReferensiPropinsi(null, false);
    ...
    private void initSurat() {
        if (surat_suratan == null) {
            surat_suratan = new BPJSSuratKontrol(null, false);
    ...
    private void initDokter() {
        if (dokter == null) {
            dokter = new DlgCariDokter2(null, false);
    ...
    private void initPoliBpjs() {
        if (poliBPJS == null) {
            poliBPJS = new BPJSCekReferensiPoli(null, false);
