...
public final class DlgCariPerawatanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Tarif Tagihan/Perawatan/Tindakan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(710, 125));
        FormInput.setLayout(null);

        DTPTgl.setEditable(false);
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-12-2019" }));
        ...
        DTPTgl.setBounds(522, 63, 100, 23);
        ...
        ChkJln.setBounds(781, 63, 23, 23);

        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Dokter : ");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(0, 63, 80, 23);
        ...
        kddokter.setBounds(80, 63, 100, 23);
        ...
        nmdokter.setBounds(183, 63, 250, 23);
        ...
        btnDokter.setBounds(436, 63, 28, 23);

        LblPetugas.setForeground(new java.awt.Color(0, 0, 0));
        LblPetugas.setText("Petugas : ");
        LblPetugas.setName("LblPetugas"); // NOI18N
        FormInput.add(LblPetugas);
        LblPetugas.setBounds(0, 92, 80, 23);
        ...
        KdPtg2.setBounds(80, 92, 100, 23);

        NmPtg2.setEditable(false);
        NmPtg2.setForeground(new java.awt.Color(0, 0, 0));
        NmPtg2.setHighlighter(null);
        NmPtg2.setName("NmPtg2"); // NOI18N
        FormInput.add(NmPtg2);
        NmPtg2.setBounds(183, 92, 250, 23);
        ...
        btnPetugas.setBounds(436, 92, 28, 23);

        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("Tanggal :");
        jLabel6.setName("jLabel6"); // NOI18N
        FormInput.add(jLabel6);
        jLabel6.setBounds(470, 63, 50, 23);

        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("No.Rawat : ");
        jLabel3.setName("jLabel3"); // NOI18N
        FormInput.add(jLabel3);
        jLabel3.setBounds(0, 7, 80, 23);
        ...
        TPasien1.setBounds(295, 7, 500, 23);

        jLabel36.setForeground(new java.awt.Color(0, 0, 0));
        jLabel36.setText("Ruang Rawat : ");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 35, 80, 23);
        ...
        TRuangan.setBounds(80, 35, 420, 23);

        jLabel37.setForeground(new java.awt.Color(0, 0, 0));
        jLabel37.setText("Tgl. Rawat : ");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(503, 35, 70, 23);
        ...
        Ttgl_rawat.setBounds(575, 35, 90, 23);

        jLabel38.setForeground(new java.awt.Color(0, 0, 0));
        jLabel38.setText("Jam : ");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(672, 35, 30, 23);
        ...
        Tjam_rawat.setBounds(705, 35, 90, 23);
...
private void ppDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDokterActionPerformed
    ...
    FormInput.setPreferredSize(new Dimension(WIDTH, 125));
    tampil();
...
private void ppPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPetugasActionPerformed
    ...
    */
    ...
    public void setPasien(String no_rwt, String noRM, String namaPX, String ruangan, String tglMsk, String jam) {
        TNoRw1.setText(no_rwt);
        TNoRM.setText(noRM);
        TPasien1.setText(namaPX);
        TRuangan.setText(ruangan);
        Ttgl_rawat.setText(tglMsk);
