...
//                }
    ...
    private void initComponents() {
        ...
        MnCetakBuktiReg.setIconTextGap(5);
        ...
        tanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-01-2026" }));
        ...
        tglNota.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-01-2026" }));
...
private void tbPeriksaRadiologiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPeriksaRadiologiKeyPressed
    ...
    private void MnBeratBadanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBeratBadanActionPerformed
        if (NoRawat.getText().equals("") || NoRawat.getText().equals("Cara Bayar") || NoRawat.getText().equals("Berat Badan")) {
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (Kd2.getText().equals("")) {
                ...
                form.jaminanTrans(tbPeriksaRadiologi.getValueAt(tbPeriksaRadiologi.getSelectedRow(), 3).toString(),
                        ...
                        nmmem.getText(), dokterRad.getText());
                form.dataKirim();
                form.setVisible(true);
                form.toFront();
                form.requestFocus();
