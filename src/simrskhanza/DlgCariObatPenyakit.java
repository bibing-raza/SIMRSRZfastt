                ...
                for(int r=0;r<row;r++){ 
                    if(Valid.SetAngka(tabMode.getValueAt(r,4).toString())>0){
                        if(Sequel.menyimpantf("detail_pemberian_obat","'"+DTPBeri.getSelectedItem()+"','"+
                            ...
                            Trackobat.catatRiwayat(tabMode.getValueAt(r,0).toString(),0,Valid.SetAngka(tabMode.getValueAt(r,4).toString()),"Pemberian Obat",akses.getkode(),bangsal,"Simpan",Valid.SetTgl(DTPBeri.getSelectedItem() + ""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem());
