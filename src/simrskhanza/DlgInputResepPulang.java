...
public final class DlgInputResepPulang extends javax.swing.JDialog {
    ...
    private double x = 0, y = 0, z = 0, stokbarang = 0, kenaikan = 0, stokbarang2;
    ...
    private void initComponents() {
        ...
        ppOrder.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppOrderKode.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppOrderNama.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppHapusObat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Input Resep Pulang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    if (TNoRw.getText().trim().equals("") || TKdPny.getText().trim().equals("")) {
        ...
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if ((tbKamar.getValueAt(i, 0).toString()) == null || (tbKamar.getValueAt(i, 0).toString()).equals("")) {
                y = 0;
            } else {
                y = Double.parseDouble(tbKamar.getValueAt(i, 0).toString());
            }
            isStok(tbKamar.getValueAt(i, 1).toString());
            stokbarang2 = Double.parseDouble(TStok.getText());

            if (stokbarang2 < y || TStok.getText().equals("")) {
                JOptionPane.showMessageDialog(rootPane, "Maaf stok tidak mencukupi..!!");
                tbKamar.setValueAt("", tbKamar.getSelectedRow(), 1);
                ppBersihkanActionPerformed(evt);
            } else {
                if (Valid.SetAngka(tbKamar.getValueAt(i, 0).toString()) > 0) {
                    if (Sequel.menyimpantf("resep_pulang", "?,?,?,?,?,?", "data", 6, new String[]{
                        ...
                        isRawat();
                        Trackobat.catatRiwayat2(tbKamar.getValueAt(i, 1).toString(), 0, Valid.SetAngka(tbKamar.getValueAt(i, 0).toString()), "Resep Pulang", akses.getkode(), bangsal, "Simpan");
                        Trackobat.catatRiwayatObat2(tbKamar.getValueAt(i,1).toString(),0,Double.parseDouble(tbKamar.getValueAt(i,0).toString()),"Resep Pulang",akses.getkode(),bangsal,"Simpan",TNoRm.getText(),TNoRw.getText());
