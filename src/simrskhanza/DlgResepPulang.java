...
public final class DlgResepPulang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-07-2017" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-07-2017" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (stokbarang2 < Double.parseDouble(Jml.getText()) || TStok.getText().equals("")) {
                ...
                Trackobat.catatRiwayat2(KdBarang.getText(),0,Valid.SetAngka(Jml.getText()),"Resep Pulang",akses.getkode(),bangsal,"Simpan");
                Trackobat.catatRiwayatObat2(KdBarang.getText(), 0, Valid.SetAngka(Jml.getText()), "Resep Pulang", akses.getkode(), bangsal, "Simpan", TNoRM.getText(), TNoRw.getText());
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
           ...
           //Trackobat.catatRiwayatObat(KdBarang.getText(), 0, Valid.SetAngka(Jml.getText()), "Resep Pulang", var.getkode(), bangsal, "Hapus", TNoRM.getText(), TNoRw.getText());
           Sequel.menyimpan("gudangbarang","'"+KdBarang.getText()+"','"+bangsal+"','"+Jml.getText()+"'", 
                            "stok=stok+'"+Jml.getText()+"'","kode_brng='"+KdBarang.getText()+"' and kd_bangsal='"+bangsal+"'");                               
           tampil();
        }
