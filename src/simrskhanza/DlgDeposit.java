...
public class DlgDeposit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Deposit/Titipan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbDeposit.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbDeposit.setComponentPopupMenu(jPopupMenu1);
        ...
        Scroll.setViewportView(tbDeposit);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2018" }));
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Maaf, Gagal menghapus. Pilih dulu data yang mau dihapus.\nKlik data pada tabel untuk memilih...!!!!");
        } else if (!(TPasien.getText().trim().equals(""))) {
            try {
                Sequel.queryu2("delete from deposit where no_rawat=? and tgl_deposit=?", 2, new String[]{
                    tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 0).toString(), tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 2).toString()
                });
                tampil();
                BtnBatalActionPerformed(evt);
            } catch (Exception e) {
  ...
  isForm();                
    ...
    */
    ...
    private void getData() {
        if (tbDeposit.getSelectedRow() != -1) {
            TNoRw.setText(tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 0).toString());
            TPasien.setText(tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 1).toString());
            Valid.SetTgl(DTPTgl, tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 2).toString().substring(0, 10));
            cmbJam.setSelectedItem(tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 2).toString().substring(11, 13));
            cmbMnt.setSelectedItem(tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 2).toString().substring(14, 16));
            cmbDtk.setSelectedItem(tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 2).toString().substring(17, 19));
            BesarDeposit.setText(tbDeposit.getValueAt(tbDeposit.getSelectedRow(), 3).toString());
        }
    }
