...
public final class DlgCariPerawatanRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Tagihan/Perawatan/Tindakan Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TCariTindakan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnCariTindakan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnAllTindakan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnTambahTindakan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnSimpanTindakan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Nip2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnPetugas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/download24.png"))); // NOI18N
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-01-2019" }));
...
private void BtnSimpanTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanTindakanActionPerformed
    if (TNoRw.getText().trim().equals("") || kddokter.getText().trim().equals("") || nmdokter.getText().trim().equals("")) {
        ...
        try {
            ...
            if (pilihtable.equals("rawat_jl_drpr")) {
                        ...
                        try {
                                if (Nip2.getText().trim().equals("") || NmPetugas2.getText().trim().equals("")) {
                                        ...
                                        try {
                                            ...
                                            pssimpandokterperawat.setString(14, "Belum");
                                            pssimpandokterperawat.setString(15, "-");
...
//                            switch (pilihtable) {
//                                case "rawat_jl_dr":
//                                    JOptionPane.showMessageDialog(null, "Silakan Pilih Penanganan Dokter dan Petugas...!!!!");
...
private void ppPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPetugasActionPerformed
    ...
    public void isiNmPrwtn(){
        TCariTindakan.setText(validasi.getNmPrwtn());
    }
}
