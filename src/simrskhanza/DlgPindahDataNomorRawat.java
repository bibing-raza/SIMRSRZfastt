...
public class DlgPindahDataNomorRawat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-08-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-08-2026" }));
        ...
        ChkRMigd.setText("Semua Rekam Medis IGD/Ponek");
        ...
        ChkRMigd.setBounds(380, 122, 190, 23);
    ...
    */
    ...
    private void RMigdGantiNoRawat() {
        if (pilihan == 1) {
            ...
            Sequel.mengedit("lembar_observasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("detail_lembar_observasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_pra_sedasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_pra_sedasi_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("triase_pediatrik", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("triase_ponek", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_awal_kebidanan1", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            ...
            Sequel.mengedit("serah_terima_pasien_pasca_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("informasi_tindakan_pembiusan_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("evaluasi_pra_anestesi_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            ...
            Sequel.mengedit("masalah_keperawatan_hipotermia", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("masalah_keperawatan_hipovolemia", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("register_cancer", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("masalah_keperawatan_bersihan_jln_nafas_tdk_efektif", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("masalah_keperawatan_ketidakstabilan_glukosa_darah", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("surat_pernyataan_dnr", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("instruksi_dokter_untuk_dnr", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("formulir_site_marking_operasi_odontogram", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            ...
            Sequel.mengedit("lembar_observasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("detail_lembar_observasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_pra_sedasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_pra_sedasi_histori", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("triase_pediatrik", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("triase_ponek", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_awal_kebidanan1", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            ...
            Sequel.mengedit("serah_terima_pasien_pasca_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("informasi_tindakan_pembiusan_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("evaluasi_pra_anestesi_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            ...
            Sequel.mengedit("masalah_keperawatan_hipotermia", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("masalah_keperawatan_hipovolemia", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("register_cancer", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("masalah_keperawatan_bersihan_jln_nafas_tdk_efektif", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("masalah_keperawatan_ketidakstabilan_glukosa_darah", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("surat_pernyataan_dnr", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("instruksi_dokter_untuk_dnr", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("formulir_site_marking_operasi_odontogram", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
        }
    }
    ...
    private void RMranapGantiNoRawat() {
        if (pilihan == 1) {
            ...
            Sequel.mengedit("skrining_gizi_ulang", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("monev_asuhan_gizi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("assesmen_gizi_ulang", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("lembar_observasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("detail_lembar_observasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("transfer_sebelum_tindakan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("transfer_sesudah_tindakan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_pra_sedasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_pra_sedasi_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ceklis_pra_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ceklis_kesiapan_anestesi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_pre_induksi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_pre_induksi_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_keperawatan_perioperatif", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("hitungan_asesmen_keperawatan_perioperatif", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("perencanaan_pulang_ranap", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("ceklis_keselamatan_operasi1", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ceklis_keselamatan_operasi2", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ceklis_keselamatan_operasi3", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("catatan_material_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_medik_bedah_ranap", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_medik_bedah_ranap_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("asesmen_medik_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_medik_perinatologi_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_keperawatan_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("skor_apgar_downe_cap_jari_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("pengamatan_menyusui_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("rekonsiliasi_obat", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("rekonsiliasi_obat_igd", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("serah_terima_bayi_pulang_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("pemberian_informasi_edukasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("penilaian_informasi_edukasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("triase_ponek", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("monitoring_ews_obsgyn", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("perubahan_dpjp_ranap", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("general_consent", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("persetujuan_ranap", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ttd_erm_keluarga_pasien", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("surat_pernyataan_ranap_bpjs", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("surat_pernyataan_naik_kelas_bpjs", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("surat_pernyataan_bukan_kll", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");            
            Sequel.mengedit("surat_pernyataan_bayar_denda", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            ...
            Sequel.mengedit("surat_pernyataan_dnr", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("instruksi_dokter_untuk_dnr", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_pasien_terminal", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("formulir_site_marking_operasi_odontogram", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            ...
            Sequel.mengedit("skrining_gizi_ulang", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("monev_asuhan_gizi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("assesmen_gizi_ulang", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("lembar_observasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("detail_lembar_observasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("transfer_sebelum_tindakan", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("transfer_sesudah_tindakan", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("asesmen_pra_sedasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_pra_sedasi_histori", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ceklis_pra_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ceklis_kesiapan_anestesi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("asesmen_pre_induksi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_pre_induksi_histori", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("asesmen_keperawatan_perioperatif", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("hitungan_asesmen_keperawatan_perioperatif", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("perencanaan_pulang_ranap", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("ceklis_keselamatan_operasi1", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ceklis_keselamatan_operasi2", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ceklis_keselamatan_operasi3", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("catatan_material_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("asesmen_medik_bedah_ranap", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_medik_bedah_ranap_histori", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("asesmen_medik_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_medik_perinatologi_histori", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_keperawatan_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("skor_apgar_downe_cap_jari_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("pengamatan_menyusui_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("rekonsiliasi_obat", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("rekonsiliasi_obat_igd", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("serah_terima_bayi_pulang_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("pemberian_informasi_edukasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("penilaian_informasi_edukasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("triase_ponek", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("monitoring_ews_obsgyn", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("perubahan_dpjp_ranap", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("general_consent", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("persetujuan_ranap", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ttd_erm_keluarga_pasien", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("surat_pernyataan_ranap_bpjs", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("surat_pernyataan_naik_kelas_bpjs", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("surat_pernyataan_bukan_kll", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");            
            Sequel.mengedit("surat_pernyataan_bayar_denda", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            ...
            Sequel.mengedit("surat_pernyataan_dnr", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("instruksi_dokter_untuk_dnr", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("asesmen_pasien_terminal", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("formulir_site_marking_operasi_odontogram", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
        }
    }
    ...
    private void tampil() {
        ...
        try {
            ...
            if (cmbJnsTran.getSelectedIndex() == 1) {
                ...
                //skrining gizi ulang
            } else if (cmbJnsTran.getSelectedIndex() == 43) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_skrining tgl, jam_skrining jam, jenis_skrining data "
                        + "from skrining_gizi_ulang where no_rawat ='" + TNoRwTerpilih.getText() + "'");                
                //monev asuhan gizi
            } else if (cmbJnsTran.getSelectedIndex() == 44) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_monev tgl, time(now()) jam, evaluasi_tindak_lanjut data "
                        + "from monev_asuhan_gizi where no_rawat ='" + TNoRwTerpilih.getText() + "'");
                //asesmen ulang gizi ranap
            } else if (cmbJnsTran.getSelectedIndex() == 45) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_assesmen tgl, time(now()) jam, ruang_rawat data "
                        + "from assesmen_gizi_ulang where no_rawat ='" + TNoRwTerpilih.getText() + "'");
                //lembar observasi pasien
            } else if (cmbJnsTran.getSelectedIndex() == 46) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_observasi tgl, jam_observasi jam, ruang_rawat data "
                        + "from lembar_observasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by tgl_observasi desc, jam_observasi desc limit 1");
                //transfer pasien untuk tindakan
            } else if (cmbJnsTran.getSelectedIndex() == 47) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_tindakan tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from transfer_sebelum_tindakan where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pra sedasi
            } else if (cmbJnsTran.getSelectedIndex() == 48) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_pra_sedasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ceklis pra operasi
            } else if (cmbJnsTran.getSelectedIndex() == 49) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from ceklis_pra_operasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ceklis kesiapan anestesi
            } else if (cmbJnsTran.getSelectedIndex() == 50) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from ceklis_kesiapan_anestesi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pre induksi
            } else if (cmbJnsTran.getSelectedIndex() == 51) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, ruang_rawat data "
                        + "from asesmen_pre_induksi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen keperawatan perioperatif
            } else if (cmbJnsTran.getSelectedIndex() == 52) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_keperawatan_perioperatif where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //perencanaan pulang
            } else if (cmbJnsTran.getSelectedIndex() == 53) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_surat tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from perencanaan_pulang_ranap where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ceklis keselamatan operasi
            } else if (cmbJnsTran.getSelectedIndex() == 54) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from ceklis_keselamatan_operasi1 where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //catatan pemakaian obat & meterial operasi
            } else if (cmbJnsTran.getSelectedIndex() == 55) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_catatan tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from catatan_material_operasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen medik bedah ranap
            } else if (cmbJnsTran.getSelectedIndex() == 56) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, ruang_rawat data "
                        + "from asesmen_medik_bedah_ranap where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen medik perinatologi
            } else if (cmbJnsTran.getSelectedIndex() == 57) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, ruang_rawat data "
                        + "from asesmen_medik_perinatologi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen keperawatan perinatologi
            } else if (cmbJnsTran.getSelectedIndex() == 58) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_keperawatan_perinatologi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //skor apgar, downe, cap jari ibu & bayi
            } else if (cmbJnsTran.getSelectedIndex() == 59) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from skor_apgar_downe_cap_jari_perinatologi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //lembaran bantuan pengamatan menyusui
            } else if (cmbJnsTran.getSelectedIndex() == 60) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from pengamatan_menyusui_perinatologi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //rekonsiliasi obat
            } else if (cmbJnsTran.getSelectedIndex() == 61) {
                ps1 = koneksi.prepareStatement("select no_rawat, tanggal tgl, time(waktu_simpan) jam, '-' data "
                        + "from rekonsiliasi_obat where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //triase pediatrik
            } else if (cmbJnsTran.getSelectedIndex() == 62) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, '-' data "
                        + "from triase_pediatrik where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //serah terima bayi pulang
            } else if (cmbJnsTran.getSelectedIndex() == 63) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from serah_terima_bayi_pulang_perinatologi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //pemberian informasi & edukasi
            } else if (cmbJnsTran.getSelectedIndex() == 64) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from pemberian_informasi_edukasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //triase ponek
            } else if (cmbJnsTran.getSelectedIndex() == 65) {
                ps1 = koneksi.prepareStatement("select no_rawat, tanggal tgl, pukul jam, 'data pasien ponek' data "
                        + "from triase_ponek where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //monitoring ews obsgyn
            } else if (cmbJnsTran.getSelectedIndex() == 66) {
                ps1 = koneksi.prepareStatement("select no_rawat, tanggal tgl, jam, total_skor data "
                        + "from monitoring_ews_obsgyn where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //perubahan dpjp
            } else if (cmbJnsTran.getSelectedIndex() == 67) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_pergantian tgl, time(waktu_simpan) jam, keterangan data "
                        + "from perubahan_dpjp_ranap where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen awal kebidanan
            } else if (cmbJnsTran.getSelectedIndex() == 68) {
                ps1 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, diagnosis_sementara data "
                        + "from asesmen_awal_kebidanan1 where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //general consent
            } else if (cmbJnsTran.getSelectedIndex() == 69) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from general_consent where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //persetujuan rawat inap
            } else if (cmbJnsTran.getSelectedIndex() == 70) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from persetujuan_ranap where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan ranap peserta bpjs
            } else if (cmbJnsTran.getSelectedIndex() == 71) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_ranap_bpjs where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan kenaikan kelas rawat bpjs
            } else if (cmbJnsTran.getSelectedIndex() == 72) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_naik_kelas_bpjs where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan bukan kasus kll
            } else if (cmbJnsTran.getSelectedIndex() == 73) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_bukan_kll where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan pembayaran denda                
            } else if (cmbJnsTran.getSelectedIndex() == 74) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_bayar_denda where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan ranap non bpjs
            } else if (cmbJnsTran.getSelectedIndex() == 75) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_ranap_non_bpjs where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //observasi kala 1 kebidanan
            ...
            } else if (cmbJnsTran.getSelectedIndex() == 82) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from serah_terima_pasien_pasca_operasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //informasi tindakan pembiusan
            } else if (cmbJnsTran.getSelectedIndex() == 83) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from informasi_tindakan_pembiusan_operasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //evaluasi pra anestesi
            } else if (cmbJnsTran.getSelectedIndex() == 84) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from evaluasi_pra_anestesi_operasi where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pra sedasi konsep iar
            } else if (cmbJnsTran.getSelectedIndex() == 85) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_pra_sedasi_konsep_iar where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
            ...
            } else if (cmbJnsTran.getSelectedIndex() == 89) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_hipotermia where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ringkasan pulang/resume rawat jalan
            } else if (cmbJnsTran.getSelectedIndex() == 90) {
                ps1 = koneksi.prepareStatement("select r.no_rawat, rp.tgl_registrasi tgl, rp.jam_reg jam, pl.nm_poli data "
                        + "from ringkasan_pulang_ralan r inner join reg_periksa rp on rp.no_rawat=r.no_rawat inner join poliklinik pl on pl.kd_poli=rp.kd_poli where "
                        + "r.no_rawat ='" + TNoRwTerpilih.getText() + "' order by r.no_rawat desc limit 1");
                //masalah keperawatan hipovolemia
            } else if (cmbJnsTran.getSelectedIndex() == 91) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_hipovolemia where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //register cancer
            } else if (cmbJnsTran.getSelectedIndex() == 92) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from register_cancer where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //masalah keperawatan bersihan jalan nafas tidak efektif
            } else if (cmbJnsTran.getSelectedIndex() == 93) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_bersihan_jln_nafas_tdk_efektif where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //masalah keperawatan ketidakstabilan glukosa darah
            } else if (cmbJnsTran.getSelectedIndex() == 94) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_ketidakstabilan_glukosa_darah where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan dnr
            } else if (cmbJnsTran.getSelectedIndex() == 95) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from surat_pernyataan_dnr where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //instruksi dokter untuk dnr
            } else if (cmbJnsTran.getSelectedIndex() == 96) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from instruksi_dokter_untuk_dnr where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pasien terminal dan keluarganya
            } else if (cmbJnsTran.getSelectedIndex() == 97) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_pasien_terminal where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //formulir site marking odontogram
            } else if (cmbJnsTran.getSelectedIndex() == 98) {
                ps1 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from formulir_site_marking_operasi_odontogram where no_rawat ='" + TNoRwTerpilih.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
            }
    ...
    private void tampilTujuan() {
        ...
        try {
            ...
            if (cmbJnsTran.getSelectedIndex() == 1) {
                ...
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_skrining tgl, jam_skrining jam, jenis_skrining data "
                        + "from skrining_gizi_ulang where no_rawat ='" + TNoRwTujuan.getText() + "'");                
                //monev asuhan gizi
            } else if (cmbJnsTran.getSelectedIndex() == 44) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_monev tgl, time(now()) jam, evaluasi_tindak_lanjut data "
                        + "from monev_asuhan_gizi where no_rawat ='" + TNoRwTujuan.getText() + "'");                
                //asesmen ulang gizi ranap
            } else if (cmbJnsTran.getSelectedIndex() == 45) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_assesmen tgl, time(now()) jam, ruang_rawat data "
                        + "from assesmen_gizi_ulang where no_rawat ='" + TNoRwTujuan.getText() + "'");                
                //lembar observasi pasien
            } else if (cmbJnsTran.getSelectedIndex() == 46) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_observasi tgl, jam_observasi jam, ruang_rawat data "
                        + "from lembar_observasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by tgl_observasi desc, jam_observasi desc limit 1");           
                //transfer pasien untuk tindakan
            } else if (cmbJnsTran.getSelectedIndex() == 47) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_tindakan tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from transfer_sebelum_tindakan where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pra sedasi
            } else if (cmbJnsTran.getSelectedIndex() == 48) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_pra_sedasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ceklis pra operasi
            } else if (cmbJnsTran.getSelectedIndex() == 49) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from ceklis_pra_operasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ceklis kesiapan anestesi
            } else if (cmbJnsTran.getSelectedIndex() == 50) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from ceklis_kesiapan_anestesi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pre induksi
            } else if (cmbJnsTran.getSelectedIndex() == 51) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, ruang_rawat data "
                        + "from asesmen_pre_induksi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen keperawatan perioperatif
            } else if (cmbJnsTran.getSelectedIndex() == 52) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_keperawatan_perioperatif where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //perencanaan pulang
            } else if (cmbJnsTran.getSelectedIndex() == 53) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_surat tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from perencanaan_pulang_ranap where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ceklis keselamatan operasi
            } else if (cmbJnsTran.getSelectedIndex() == 54) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from ceklis_keselamatan_operasi1 where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //catatan pemakaian obat & material operasi
            } else if (cmbJnsTran.getSelectedIndex() == 55) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_catatan tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from catatan_material_operasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen medik bedah ranap
            } else if (cmbJnsTran.getSelectedIndex() == 56) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, ruang_rawat data "
                        + "from asesmen_medik_bedah_ranap where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen medik perinatologi
            } else if (cmbJnsTran.getSelectedIndex() == 57) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, ruang_rawat data "
                        + "from asesmen_medik_perinatologi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen keperawatan perinatologi
            } else if (cmbJnsTran.getSelectedIndex() == 58) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_keperawatan_perinatologi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //skor apgar, downe, cap jari ibu & bayi
            } else if (cmbJnsTran.getSelectedIndex() == 59) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from skor_apgar_downe_cap_jari_perinatologi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //lembaran bantuan pengamatan menyusui
            } else if (cmbJnsTran.getSelectedIndex() == 60) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from pengamatan_menyusui_perinatologi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //rekonsiliasi obat
            } else if (cmbJnsTran.getSelectedIndex() == 61) {
                ps2 = koneksi.prepareStatement("select no_rawat, tanggal tgl, time(waktu_simpan) jam, '-' data "
                        + "from rekonsiliasi_obat where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //triase pediatrik
            } else if (cmbJnsTran.getSelectedIndex() == 62) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, '-' data "
                        + "from triase_pediatrik where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //serah terima bayi pulang
            } else if (cmbJnsTran.getSelectedIndex() == 63) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from serah_terima_bayi_pulang_perinatologi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //pemberian informasi & edukasi
            } else if (cmbJnsTran.getSelectedIndex() == 64) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from pemberian_informasi_edukasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //triase ponek
            } else if (cmbJnsTran.getSelectedIndex() == 65) {
                ps2 = koneksi.prepareStatement("select no_rawat, tanggal tgl, pukul jam, 'data pasien ponek' data "
                        + "from triase_ponek where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //monitoring ews obsgyn
            } else if (cmbJnsTran.getSelectedIndex() == 66) {
                ps2 = koneksi.prepareStatement("select no_rawat, tanggal tgl, jam, total_skor data "
                        + "from monitoring_ews_obsgyn where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //perubahan dpjp
            } else if (cmbJnsTran.getSelectedIndex() == 67) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_pergantian tgl, time(waktu_simpan) jam, keterangan data "
                        + "from perubahan_dpjp_ranap where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen awal kebidanan
            } else if (cmbJnsTran.getSelectedIndex() == 68) {
                ps2 = koneksi.prepareStatement("select no_rawat, tgl_asesmen tgl, jam_asesmen jam, diagnosis_sementara data "
                        + "from asesmen_awal_kebidanan1 where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //general consent
            } else if (cmbJnsTran.getSelectedIndex() == 69) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from general_consent where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //persetujuan rawat inap
            } else if (cmbJnsTran.getSelectedIndex() == 70) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from persetujuan_ranap where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan ranap peserta bpjs
            } else if (cmbJnsTran.getSelectedIndex() == 71) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_ranap_bpjs where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan kenaikan kelas rawat bpjs
            } else if (cmbJnsTran.getSelectedIndex() == 72) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_naik_kelas_bpjs where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan bukan kasus kll
            } else if (cmbJnsTran.getSelectedIndex() == 73) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_bukan_kll where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan pembayaran denda
            } else if (cmbJnsTran.getSelectedIndex() == 74) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_bayar_denda where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan ranap non bpjs
            } else if (cmbJnsTran.getSelectedIndex() == 75) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, nm_berttd data "
                        + "from surat_pernyataan_ranap_non_bpjs where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //observasi kala 1 kebidanan
            } else if (cmbJnsTran.getSelectedIndex() == 76) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                ...
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from serah_terima_pasien_pasca_operasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //informasi tindakan pembiusan
            } else if (cmbJnsTran.getSelectedIndex() == 83) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from informasi_tindakan_pembiusan_operasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //evaluasi pra anestesi
            } else if (cmbJnsTran.getSelectedIndex() == 84) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from evaluasi_pra_anestesi_operasi where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pra sedasi konsep iar
            } else if (cmbJnsTran.getSelectedIndex() == 85) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_pra_sedasi_konsep_iar where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //catatan sedasi / anestesi
            } else if (cmbJnsTran.getSelectedIndex() == 86) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                ...
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_hipotermia where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //ringkasan pulang/resume rawat jalan
            } else if (cmbJnsTran.getSelectedIndex() == 90) {
                ps2 = koneksi.prepareStatement("select r.no_rawat, rp.tgl_registrasi tgl, rp.jam_reg jam, pl.nm_poli data "
                        + "from ringkasan_pulang_ralan r inner join reg_periksa rp on rp.no_rawat=r.no_rawat inner join poliklinik pl on pl.kd_poli=rp.kd_poli where "
                        + "r.no_rawat ='" + TNoRwTujuan.getText() + "' order by r.no_rawat desc limit 1");
                //masalah keperawatan hipovolemia
            } else if (cmbJnsTran.getSelectedIndex() == 91) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_hipovolemia where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //register cancer
            } else if (cmbJnsTran.getSelectedIndex() == 92) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from register_cancer where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //masalah keperawatan bersihan jalan nafas tidak efektif
            } else if (cmbJnsTran.getSelectedIndex() == 93) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_bersihan_jln_nafas_tdk_efektif where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //masalah keperawatan ketidakstabilan glukosa darah
            } else if (cmbJnsTran.getSelectedIndex() == 94) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from masalah_keperawatan_ketidakstabilan_glukosa_darah where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //surat pernyataan dnr
            } else if (cmbJnsTran.getSelectedIndex() == 95) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from surat_pernyataan_dnr where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //instruksi dokter untuk dnr
            } else if (cmbJnsTran.getSelectedIndex() == 96) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from instruksi_dokter_untuk_dnr where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //asesmen pasien terminal dan keluarganya
            } else if (cmbJnsTran.getSelectedIndex() == 97) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from asesmen_pasien_terminal where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
                //formulir site marking odontogram
            } else if (cmbJnsTran.getSelectedIndex() == 98) {
                ps2 = koneksi.prepareStatement("select no_rawat, date(waktu_simpan) tgl, time(waktu_simpan) jam, ruang_rawat data "
                        + "from formulir_site_marking_operasi_odontogram where no_rawat ='" + TNoRwTujuan.getText() + "' "
                        + "order by waktu_simpan desc limit 1");
            }
    ...
    private void tranAsesMedikBedahRanap() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_medik_bedah_ranap", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_medik_bedah_ranap_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void tranAsesMedikPerinatolgi() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_medik_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_medik_perinatologi_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void tranAsesKeperawatanPerinatolgi() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_keperawatan_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("asesmen_keperawatan_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void SkorApgarDownePerinatolgi() {
        if (pilihan == 1) {
            Sequel.mengedit("skor_apgar_downe_cap_jari_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("skor_apgar_downe_cap_jari_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void PengamatanMenyusui() {
        if (pilihan == 1) {
            Sequel.mengedit("pengamatan_menyusui_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("pengamatan_menyusui_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void SerahTerimaBayiPulang() {
        if (pilihan == 1) {
            Sequel.mengedit("serah_terima_bayi_pulang_perinatologi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("serah_terima_bayi_pulang_perinatologi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void pemberianInformasiEdukasi() {
        if (pilihan == 1) {
            Sequel.mengedit("pemberian_informasi_edukasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("penilaian_informasi_edukasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void monitoringEwsObsgyn() {
        if (pilihan == 1) {
            Sequel.mengedit("monitoring_ews_obsgyn", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("monitoring_ews_obsgyn", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void suratPernyataanBukanKasusKll() {
        if (pilihan == 1) {
            Sequel.mengedit("surat_pernyataan_bukan_kll", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("surat_pernyataan_bukan_kll", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void suratPernyataanPembayaranDenda() {
        if (pilihan == 1) {
            Sequel.mengedit("surat_pernyataan_bayar_denda", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("peserta_bpjs_bayar_denda", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void suratPernyataanNaikKelasBpjs() {
        if (pilihan == 1) {
            Sequel.mengedit("surat_pernyataan_naik_kelas_bpjs", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("surat_pernyataan_naik_kelas_bpjs", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void suratPernyataanRanapBpjs() {
        if (pilihan == 1) {
            Sequel.mengedit("surat_pernyataan_ranap_bpjs", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("surat_pernyataan_ranap_bpjs", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void suratPernyataanRanapNonBpjs() {
        if (pilihan == 1) {
            Sequel.mengedit("surat_pernyataan_ranap_non_bpjs", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("surat_pernyataan_ranap_non_bpjs", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void maskepBersihanJalanNafasTidakEfektif() {
        if (pilihan == 1) {
            Sequel.mengedit("masalah_keperawatan_bersihan_jln_nafas_tdk_efektif", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("masalah_keperawatan_bersihan_jln_nafas_tdk_efektif", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void maskepKetidakstabilanGlukosaDarah() {
        if (pilihan == 1) {
            Sequel.mengedit("masalah_keperawatan_ketidakstabilan_glukosa_darah", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("masalah_keperawatan_ketidakstabilan_glukosa_darah", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void suratPernyataanDNR() {
        if (pilihan == 1) {
            Sequel.mengedit("surat_pernyataan_dnr", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("surat_pernyataan_dnr", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void instruksiDokterUntukDNR() {
        if (pilihan == 1) {
            Sequel.mengedit("instruksi_dokter_untuk_dnr", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("instruksi_dokter_untuk_dnr", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void asesmenPasienTerminal() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_pasien_terminal", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("asesmen_pasien_terminal", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void formulirSiteMarkingOdontogram() {
        if (pilihan == 1) {
            Sequel.mengedit("formulir_site_marking_operasi_odontogram", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("formulir_site_marking_operasi_odontogram", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void maskepPerfusiHipovolemia() {
        if (pilihan == 1) {
            Sequel.mengedit("masalah_keperawatan_hipovolemia", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("masalah_keperawatan_hipovolemia", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void ringkasanPulangRalan() {
        if (pilihan == 1) {
            Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ringkasan_pulang_ralan_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
            Sequel.mengedit("ringkasan_pulang_ralan_histori", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
        }
    ...
    private void catatanSedasiAnestesi() {
        if (pilihan == 1) {
            Sequel.mengedit("catatan_sedasi_anestesi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("detail_catatan_sedasi_anestesi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void asesmenPraSedasiKonsepIar() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_pra_sedasi_konsep_iar", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("asesmen_pra_sedasi_konsep_iar", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void evaluasiPraAnestesi() {
        if (pilihan == 1) {
            Sequel.mengedit("evaluasi_pra_anestesi_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("evaluasi_pra_anestesi_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void informasiTindakanPembiusan() {
        if (pilihan == 1) {
            Sequel.mengedit("informasi_tindakan_pembiusan_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("informasi_tindakan_pembiusan_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void serahTerimaPascaOps() {
        if (pilihan == 1) {
            Sequel.mengedit("serah_terima_pasien_pasca_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("serah_terima_pasien_pasca_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void asesmenAwalKebidanan() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_awal_kebidanan1", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_awal_kebidanan2", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("inspeksi_ginekologi_awal_kebidanan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
    ...
    private void tranSkriningGiziUlang() {
        if (pilihan == 1) {
            Sequel.mengedit("skrining_gizi_ulang", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("skrining_gizi_ulang", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void tranMonevAsuhanGizi() {
        if (pilihan == 1) {
            Sequel.mengedit("monev_asuhan_gizi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("monev_asuhan_gizi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void tranAsesmenUlangGizi() {
        if (pilihan == 1) {
            Sequel.mengedit("assesmen_gizi_ulang", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("assesmen_gizi_ulang", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void tranLembarObservasi() {
        if (pilihan == 1) {
            Sequel.mengedit("lembar_observasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("detail_lembar_observasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void transferPasienUntukTindakan() {
        if (pilihan == 1) {
            Sequel.mengedit("transfer_sebelum_tindakan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("transfer_sesudah_tindakan", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void asesmenKeperawatanPerioperatif() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_keperawatan_perioperatif", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("hitungan_asesmen_keperawatan_perioperatif", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void perencanaanPulangRanap() {
        if (pilihan == 1) {
            Sequel.mengedit("perencanaan_pulang_ranap", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("perencanaan_pulang_ranap", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void asesmenPreInduksi() {
        if (pilihan == 1) {
            Sequel.mengedit("asesmen_pre_induksi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("asesmen_pre_induksi_histori", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
    ...
    private void ceklisKesiapanAnestesi() {
        if (pilihan == 1) {
            Sequel.mengedit("ceklis_kesiapan_anestesi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("ceklis_kesiapan_anestesi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void ceklisKeselamatanOperasi() {
        if (pilihan == 1) {
            Sequel.mengedit("ceklis_keselamatan_operasi1", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ceklis_keselamatan_operasi2", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
            Sequel.mengedit("ceklis_keselamatan_operasi3", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
    ...
    private void catatanPemakaianObatMaterialOperasi() {
        if (pilihan == 1) {
            Sequel.mengedit("catatan_material_operasi", "no_rawat='" + TNoRwTerpilih.getText() + "'", "no_rawat='" + TNoRwTujuan.getText() + "'");
        } else if (pilihan == 2) {
            Sequel.mengedit("catatan_material_operasi", "no_rawat='" + TNoRwTujuan.getText() + "'", "no_rawat='" + TNoRwTerpilih.getText() + "'");
    ...
    private void pindahData() {
        if (cmbJnsTran.getSelectedIndex() == 1) {
            ...
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                asesmenKeperawatanPerioperatif();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 53) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                perencanaanPulangRanap();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 54) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                ceklisKeselamatanOperasi();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 55) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                catatanPemakaianObatMaterialOperasi();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 56) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                tranAsesMedikBedahRanap();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 57) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                tranAsesMedikPerinatolgi();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 58) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                tranAsesKeperawatanPerinatolgi();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 59) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                SkorApgarDownePerinatolgi();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 60) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
            ...
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                SerahTerimaBayiPulang();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 64) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                pemberianInformasiEdukasi();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 65) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
            ...
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                suratPernyataanRanapBpjs();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 72) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                suratPernyataanNaikKelasBpjs();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 73) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                suratPernyataanBukanKasusKll();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 74) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                suratPernyataanPembayaranDenda();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 75) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                suratPernyataanRanapNonBpjs();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 76) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
            ...
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                ringkasanPulangRalan();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 90) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                maskepPerfusiHipovolemia();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 91) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
            ...
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                maskepBersihanJalanNafasTidakEfektif();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 93) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                maskepKetidakstabilanGlukosaDarah();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 94) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
            ...
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                instruksiDokterUntukDNR();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 96) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                asesmenPasienTerminal();
            }
        } else if (cmbJnsTran.getSelectedIndex() == 97) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data " + cmbJnsTran.getSelectedItem().toString() + " yang dipilih akan dipindah nomor rawatnya..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                formulirSiteMarkingOdontogram();
            }
        }
    }
}