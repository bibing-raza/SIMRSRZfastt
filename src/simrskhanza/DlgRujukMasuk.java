...
public final class DlgRujukMasuk extends javax.swing.JDialog {
    ...
    public DlgRujukMasuk(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P","Perujuk/Rujukan","Alamat Perujuk","No.Rujuk","No.Rawat","No.R.M.",
                  ...
                  "Diagnosa Akhir","Status","Dokter Perujuk","Kategori Rujuk","Poli Rujukan",
                  "No.Balasan","Keterangan","Kode Penyakit","Nama Penyakit","kode_rujukan"};
        ...
        //Perujuk
        Object[] row2={"No. ","Kode Faskes","Nama Faskes","Alamatnya","kode_rujukan"};
    ...
    private void initComponents() {
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Puskesmas/Faskes/Klinik/Dokter Praktek ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        internalFrame6.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TCariPerujuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnKeluar1.setPreferredSize(new java.awt.Dimension(80, 23));
        ...
        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-02-2019" }));
        ...
        kode_rujukanya.setPreferredSize(new java.awt.Dimension(312, 23));
        ...
        btnCariRujuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NoRujuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KategoriRujuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NoBalasan.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        Sequel.cariIsi("select no_rawat from rujuk_masuk where no_rawat=? ", cek_rujukan, TNoRw.getText());
        ...
        if(TRujukan.getText().trim().equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Untuk rujukan masuk pasien ini datanya sudah tersimpan sesuai kunjungannya...!!!");
            emptTeks();
        }else{
            Sequel.menyimpan("rujuk_masuk","'"+TNoRw.getText()+"','"+TRujukan.getText()+"','"+TAlamat.getText()+"',"+
                             ...
                             "'"+KategoriRujuk.getSelectedItem().toString()+"','"+Keterangan.getText()+"','"+NoBalasan.getText()+"','"+kode_rujukanya.getText()+"'","No.Rujuk");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TRujukan.getText().trim().equals("")){
            ...
            Sequel.mengedit("rujuk_masuk", "no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 4).toString() + "'",
                    ...
                    + "no_balasan='" + NoBalasan.getText() + "',kd_rujukan='" + kode_rujukanya.getText() + "'");
...
private void TAlamatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAlamatKeyPressed
    ...
    */
    ...
    public void tampil() {        
        ...
        try{
            pstampil=koneksi.prepareStatement(
                    ...
                    "pasien.nm_pasien,reg_periksa.almt_pj,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,reg_periksa.tgl_registrasi,"+
                    "rujuk_masuk.jm_perujuk,rujuk_masuk.dokter_perujuk,rujuk_masuk.kd_penyakit,penyakit.nm_penyakit,rujuk_masuk.kategori_rujuk,"+
                    "rujuk_masuk.keterangan,rujuk_masuk.no_balasan,poliklinik.nm_poli, rujuk_masuk.kd_rujukan "+
    ...
    public void tampil2() {        
        ...
        try{
            psperujuk=koneksi.prepareStatement("SELECT kode_faskes_bpjs, nama_rujukan, alamat_faskes, kd_rujukan FROM master_nama_rujukan WHERE "+
                    "(nama_rujukan like ? or kode_faskes_bpjs like ? or alamat_faskes like ?) and status='1' order by nama_rujukan");
            try {
    ...
    private void getData2() {
        if(tbPerujuk.getSelectedRow()!= -1){
            TRujukan.setText(tbPerujuk.getValueAt(tbPerujuk.getSelectedRow(),2).toString());
            TAlamat.setText(tbPerujuk.getValueAt(tbPerujuk.getSelectedRow(),3).toString());
            kode_rujukanya.setText(tbPerujuk.getValueAt(tbPerujuk.getSelectedRow(),4).toString());
        }
    }
