 ...
 * @author dosen
 */
public class DlgRingkasanPulangRalan extends javax.swing.JDialog {
    private final DefaultTableModel tabMode, tabMode2, tabMode3, tabModeResiko, tabModeLis, tabModeHasilLab, 
            tabModeHasilCopy, tabModeRad, tabModeJangMed, tabModePembaca, tabModePembaca1;
    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private validasi Valid = new validasi();
    private Properties prop = new Properties();
    private PreparedStatement ps, ps2, ps3, ps6, ps7, ps8, ps9, ps10, psPasien, psdiag, pspros, psLaprm, psFakIGD, psRes, 
            psLab1, psLabA, psLabB, psLabC, psRad, psFile, psRDO, psRDU, psRDD, psRDM;
    private ResultSet rs, rs2, rs3, rs6, rs7, rs8, rs9, rs10, rs11, rsPasien, rsdiag, rspros, rsLaprm, rsFakIGD, rsRes,
            rsLab1, rsLabA, rsLabB, rsLabC, rsRad, rsDok, rsFile, rsDiag, rsDiag1, rsObat, rsTHT, rsLISMaster, rsLIS1, rsLIS2, rsLIS3, rsDiabet,
            rsRDO, rsRDU, rsRDD, rsRDM;
    ...
    private String kontrolPoli = "", cekTgl = "", diagnosa = "", tindakan = "", skorAsesIGD = "", kesimpulanGZanak = "",
            ...
            debri = "", modernDres = "", idFileTtd = "", idParameterTtd = "", URL = "", usernya = "", pwdnya = "", requestJson12 = "", stringbalik = "",
            host_port = "";
    private String noLIS = "", cekLIS = "", ketLIS = "", tglLIS = "", jamLIS = "", drpengirim = "", tglPeriksaLIS = "", jamPeriksaLIS = "", 
            hasilDipilih = "", kdItem = "", norawat = "", tglhasil = "", jamhasil = "", nmpemeriksaan = "", link = "", nipDpjpAwal = "", nipPenyimpan = "",
            nipExecutor = "";
     ...
     * @param parent
     * @param modal */
    public DlgRingkasanPulangRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            "No. Rawat", "No. RM", "Nama Pasien", "Tgl. Lahir", "Jns. Kelamin", "Tgl. Masuk", "Tgl. Pulang", "Poliklinik/Instalasi",
            ...
            "Nama DPJP Pasien", "cektgl", "edukasi", "png_jawab_px", "nip_penyimpan", "hasil_pemeriksaan", "Data Resume Disimpan Oleh", "saturasi",
            "id_file_penanggung_jwb_pasien"
        }) {
            @Override
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgRingkasanPulangRalan")) {
                    if (dokter.getTable().getSelectedRow() != -1) {
                        if (pilihan == 1) {
                            TNmDokter.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 1).toString());
                        } else if (pilihan == 2) {
                            nipDpjpAwal = dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 0).toString();
        ...
        try {
            ...
            System.out.println("simrskhanza.DlgRingkasanPulangRalan.<init>() : " + e);
        }
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2026" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2026" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Ringkasan Pulang Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        TnmPoli.setForeground(new java.awt.Color(0, 0, 0));
        TnmPoli.setToolTipText("");
        TnmPoli.setHighlighter(null);
        TnmPoli.setName("TnmPoli"); // NOI18N
        panelisi1.add(TnmPoli);
        TnmPoli.setBounds(105, 64, 260, 23);
        ...
        TglKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2026" }));
        ...
        jLabel82.setText("Saturasi :");
        jLabel82.setName("jLabel82"); // NOI18N
        panelisi1.add(jLabel82);
        jLabel82.setBounds(1135, 828, 60, 23);

        Tsaturasi.setForeground(new java.awt.Color(0, 0, 0));
        Tsaturasi.setToolTipText("");
        ...
        panelisi1.add(Tsaturasi);
        Tsaturasi.setBounds(1200, 828, 70, 23);

        jLabel83.setForeground(new java.awt.Color(0, 0, 0));
        jLabel83.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel83.setText("%");
        jLabel83.setName("jLabel83"); // NOI18N
        panelisi1.add(jLabel83);
        jLabel83.setBounds(1275, 828, 30, 23);
        ...
        jLabel80.setText("Cetak Dalam Bentuk :");
        jLabel80.setName("jLabel80"); // NOI18N
        jLabel80.setPreferredSize(new java.awt.Dimension(120, 23));
        panelGlass8.add(jLabel80);
        ...
        tbRingkasan.getTableHeader().setReorderingAllowed(false);
        ...
        Scroll5.setViewportView(LoadHTML4);

        panelGlass13.add(Scroll5);
        Scroll5.setBounds(12, 335, 260, 240);

        panelGlass12.add(panelGlass13, java.awt.BorderLayout.EAST);

        internalFrame4.add(panelGlass12, java.awt.BorderLayout.CENTER);
        ...
        jLabel81.setText("Cetak Dalam Bentuk :");
        jLabel81.setName("jLabel81"); // NOI18N
        jLabel81.setPreferredSize(new java.awt.Dimension(120, 23));
        panelGlass9.add(jLabel81);
        ...
        BtnKeluar1.setPreferredSize(new java.awt.Dimension(80, 30));
        ...
        BtnUlangiCopyLab.setMnemonic('U');
        ...
        BtnUlangiCopyRad.setMnemonic('U');
        ...
        DTPCari5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2026" }));
        ...
        DTPCari6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-07-2026" }));
        ...
        internalFrame39.setBackground(new java.awt.Color(235, 255, 235));
        internalFrame39.setName("internalFrame39"); // NOI18N
        internalFrame39.setLayout(new java.awt.BorderLayout(1, 1));
        ...
        internalFrame39.add(panelGlass34, java.awt.BorderLayout.PAGE_END);
        ...
        Scroll33.setBorder(javax.swing.BorderFactory.createTitledBorder(null, ".: Pemeriksaan Patologi Anatomi :.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        Scroll33.setViewportView(tbPA);

        FormInput3.add(Scroll33, java.awt.BorderLayout.CENTER);
        ...
        jLabel78.setText("Key Word :");
        jLabel78.setName("jLabel78"); // NOI18N
        jLabel78.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass33.add(jLabel78);

        TCari6.setForeground(new java.awt.Color(0, 0, 0));
        TCari6.setName("TCari6"); // NOI18N
        TCari6.setPreferredSize(new java.awt.Dimension(190, 23));
        TCari6.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TCari6KeyPressed(evt);
            }
        });
        panelGlass33.add(TCari6);

        jLabel79.setForeground(new java.awt.Color(0, 0, 0));
        jLabel79.setText("Limit Data :");
        jLabel79.setName("jLabel79"); // NOI18N
        jLabel79.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass33.add(jLabel79);
        ...
        Scroll34.setBorder(javax.swing.BorderFactory.createTitledBorder(null, ".: Preview Hasil Pemeriksaan :.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        Scroll34.setViewportView(LoadHTML3);

        panelGlass35.add(Scroll34, java.awt.BorderLayout.CENTER);

        internalFrame39.add(panelGlass35, java.awt.BorderLayout.CENTER);

        TabRingkasan.addTab("Pemeriksaan Lab. (Patologi Anatomi)", internalFrame39);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRW.getText().equals("")) {
            ...
            try {
                if (Sequel.menyimpantf("ringkasan_pulang_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Ringkasan Pulang Pasien Rawat Inap", 30, new String[]{
                    ...
                    cmbKondisiWP.getSelectedItem().toString(), Tsaturasi.getText(), ""
                }) == true) {
                    Sequel.queryu("update reg_periksa set kd_dokter='" + nipDpjpAwal + "' where no_rawat='" + TNoRW.getText() + "'");
                    if (nmgedung.equals("PARU")) {
    ...
    private void BtnGantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGantiActionPerformed
        if (TNoRW.getText().equals("")) {
            ...
            try {
                Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + TNoRW.getText() + "'", "alasan_masuk_dirawat='" + TAlasanDirawat.getText() + "', "
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        ((DlgRingkasanPulangRalan.Painter) gambarQR).setImage("");
        TCari.setText("");
        tampil();
        emptTeks();        
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        if (Sequel.cariInteger("select count(-1) from ringkasan_pulang_ralan where no_rawat='" + TNoRW.getText() + "'") > 0) {
            TabRingkasan.setSelectedIndex(1);
            tampil();
        } else if (Sequel.cariInteger("select count(-1) from ringkasan_pulang_ralan where no_rawat='" + TNoRW.getText() + "'") == 0) {
        ...
        Sequel.cariIsiComboDB("select nm_dokumen from master_nomor_dokumen_erm where "
                + "status='aktif' and unit_pengguna='Poliklinik & Instalasi' and ttd_keluarga_pasien='Ya' order by kode_erm", cmbRekmed);
    ...
    private void TabRingkasanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabRingkasanMouseClicked
        ...
        } else if (TabRingkasan.getSelectedIndex() == 6) {
            TCari6.setText("");
    ...
    private void BtnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterActionPerformed
        pilihan = 1;
        akses.setform("DlgRingkasanPulangRalan");
        dokter.isCek();
...
//        Valid.pindah(evt, TKdPrw, cmbJam);
    ...
    private void TgcsKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TgcsKeyPressed
        Valid.pindah(evt, TFrekuensiNafas, Tsaturasi);
    ...
    private void MnDiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDiagnosaActionPerformed
        if (TNoRW.getText().trim().equals("")) {
            ...
            resep.isCek();
            resep.setNoRm(TNoRW.getText(), Valid.SetTgl2(Sequel.cariIsi("select date(now())")), "Ralan");
        ...
        if (tbRingkasan.getSelectedRow() > -1) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                if (tbRingkasan.getValueAt(tbRingkasan.getSelectedRow(), 35).toString().equals(akses.getkode())
                    ...
                    simpanHistory();
                    if (Sequel.queryu2tf("delete from ringkasan_pulang_ralan where no_rawat=?", 1, new String[]{
        ...
        if (tbRingkasan.getSelectedRow() > -1) {
            ...
            try {
                psdiag = koneksi.prepareStatement("SELECT dp.kd_penyakit icd_sekunder, py.ciri_ciri diag_sekunder FROM diagnosa_pasien dp "
                        ...
                        + "WHERE dp.no_rawat like '%" + TNoRW.getText() + "%' AND dp.prioritas <> 1 AND dp.STATUS = 'ralan'");
                try {
            ...
            try {
                pspros = koneksi.prepareStatement("SELECT pp.kode, i.deskripsi_panjang FROM prosedur_pasien pp INNER JOIN icd9 i ON i.kode = pp.kode "
                        + "WHERE pp.no_rawat like '%" + TNoRW.getText() + "%' AND pp.STATUS = 'ralan'");
                try {
            ...
            param.put("rgrawat", TnmPoli.getText());
            ...
            param.put("kesadaran", TKesadaran.getText() + ", GCS : " + Tgcs.getText() + ", Saturasi : " + satur);
            ...
            if (chkTglKontrol.isSelected() == false) {
                ...
                param.put("tglkontrolpoli", Valid.SetTglINDONESIA(Sequel.cariIsi("select tgl_kontrol_poliklinik from ringkasan_pulang_ralan where no_rawat='" + TNoRW.getText() + "'")));
            }

            param.put("tglRingkasan", "Martapura, " + Valid.SetTglINDONESIA(Sequel.cariIsi("select tgl_registrasi from reg_periksa where no_rawat='" + TNoRW.getText() + "' and status_lanjut ='Ralan'")));
            param.put("jamRingkasan", "Jam          : " + Sequel.cariIsi("select concat(time_format(now(),'%H:%i'),' WITA')"));

            if (TabRingkasan.getSelectedIndex() == 0) {
                if (cmbPilihCetak.getSelectedIndex() == 0) {
                    ...
                    if (Tdpjp.getText().equals("") || Tdpjp.getText().equals("-") || Tdpjp.getText().equals("--")) {
                        ...
                        tgl = Sequel.cariIsi("select date_format(tgl_registrasi,'%d/%m/%Y') from reg_periksa where no_rawat='" + TNoRW.getText() + "' and status_lanjut ='Ralan'");
                        jam = Sequel.cariIsi("select jam_reg from reg_periksa where no_rawat='" + TNoRW.getText() + "' and status_lanjut ='Ralan'");

                        isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                                + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='001'"),
                                        "Resume Medis/Ringkasan Pulang Pasien", Tdpjp.getText(), tgl, jam) + "') from kalimat_tte where kode='001'");
                        ...
                        Valid.MyReport("rptRingkasanPulangRalanQr.jasper", "report", "::[ Lembar Ringkasan Pulang Pasien Rawat Jalan ]::",
                                "select date(now())", param);
                        Sequel.hapusIisiFolder(Sequel.cariFolderTte() + File.separator);
                    }
                } else {
                    Valid.MyReport("rptRingkasanPulangRalan.jasper", "report", "::[ Lembar Ringkasan Pulang Pasien Rawat Jalan ]::",
                            "select date(now())", param);
                }
            } else if (TabRingkasan.getSelectedIndex() == 1) {
        ...
        if (tbRingkasan.getSelectedRow() > -1) {
            if (Sequel.cariInteger("select count(-1) from rme_file_upload where no_rawat = '" + TNoRW.getText() + "' and jenis_pemeriksaan = 'RSM1' and stts_data = '1'") > 0) {
                ...
                if (tbRingkasan.getValueAt(tbRingkasan.getSelectedRow(), 35).toString().equals(akses.getkode())) {
                    ...
                    param.put("tglRingkasan", "Martapura, " + Valid.SetTglINDONESIA(Sequel.cariIsi("select tgl_registrasi from reg_periksa where "
                            + "no_rawat='" + TNoRW.getText() + "' and status_lanjut='Ralan' order by tgl_registrasi desc, jam_reg desc")));
                    param.put("jamRingkasan", "Jam          : " + Sequel.cariIsi("select concat(time_format(now(),'%H:%i'),' WITA')"));
...
//                    mengunggahFile(TNoRW.getText().replaceAll("/", "") + ".pdf", encodedString, TNoRW.getText(), "0803202100007062", "RSM1", "Hantek1234.!", Sequel.cariIsi("select status_lanjut from reg_periksa where no_rawat = '" + TNoRW.getText() + "'"), akses.getkode(), TNoRM.getText());
    ...
    private void BtnSimpan7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan7ActionPerformed
        if (kddokter1.getText().equals("")) {
            ...
            Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + TNoRW.getText() + "'", "nip_penyimpan='" + kddokter1.getText() + "'");
    ...
    private void BtnRestorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRestorActionPerformed
        if (tbRiwayat.getSelectedRow() > -1) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                if (Sequel.cariInteger("select count(-1) from ringkasan_pulang_ralan where "
    ...
    private void MnBersihkanStringSampahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBersihkanStringSampahActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            Sequel.queryu("UPDATE ringkasan_pulang_ralan SET pemeriksaan_penunjang = REPLACE(pemeriksaan_penunjang, 'false', ' ') WHERE no_rawat='" + TNoRW.getText() + "' and pemeriksaan_penunjang LIKE '%false%'");
            Sequel.queryu("UPDATE ringkasan_pulang_ralan SET pemeriksaan_penunjang = REPLACE(pemeriksaan_penunjang, '\\\\''', ' ') WHERE no_rawat='" + TNoRW.getText() + "' and pemeriksaan_penunjang LIKE '%\\\\''%'");
            Sequel.queryu("UPDATE ringkasan_pulang_ralan_histori SET pemeriksaan_penunjang = REPLACE(pemeriksaan_penunjang, 'false', ' ') WHERE no_rawat='" + TNoRW.getText() + "' and pemeriksaan_penunjang LIKE '%false%'");
            Sequel.queryu("UPDATE ringkasan_pulang_ralan_histori SET pemeriksaan_penunjang = REPLACE(pemeriksaan_penunjang, '\\\\''', ' ') WHERE no_rawat='" + TNoRW.getText() + "' and pemeriksaan_penunjang LIKE '%\\\\''%'");
    ...
    private void TCari6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCari6KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            BtnCari9ActionPerformed(null);
        }
    }//GEN-LAST:event_TCari6KeyPressed
    ...
    private void TsaturasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TsaturasiKeyPressed
        Valid.pindah(evt, Tgcs, cmbLanjutan);
    ...
    private void MnHapusTtdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusTtdActionPerformed
        if (tbRingkasan.getSelectedRow() > -1) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin tanda tangan pasien/keluarga/png. jawab mau dihapus..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                String ipGambar = "";
                try {
                    //cek atau ping ip addres
                    ...
                    if (inet.isReachable(100)) {
                        if (idFileTtd.equals("")) {
                            JOptionPane.showMessageDialog(null, "Pasien/keluarga/png. jawab ini belum melakukan tanda tangan...!!!!");
                        } else {
                            if (Sequel.hapusFileTTD(idFileTtd) == true) {
                                Sequel.mengedit("ringkasan_pulang_ralan", "no_rawat='" + tbRingkasan.getValueAt(tbRingkasan.getSelectedRow(), 0).toString() + "'",
                                        "id_file_penanggung_jwb_pasien=''");
                                tampil();
                                emptTeks();
                            }
    ...
    private void MnBikinQrCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBikinQrCodeActionPerformed
        if (tbRingkasan.getSelectedRow() > -1) {
            ((DlgRingkasanPulangRalan.Painter) gambarQR).setImage("");
            if (Sequel.cariInteger("select count(-1) from master_nomor_dokumen_erm where nm_dokumen like '%RINGKASAN PULANG RAWAT JALAN%'") > 0) {
                bikinQR();
            } else {
        ...
        if (cmbRekmed.getSelectedIndex() != 0) {
            ...
            try {
                ...
                for (int I = 0; hasil.next(); I++) {
                    ...
                    ((DlgRingkasanPulangRalan.Painter) gambarQR).setImageIcon(new javax.swing.ImageIcon(
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRingkasanPulangRalan dialog = new DlgRingkasanPulangRalan(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT rr.*, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') tgl_lhr, IF(p.jk='L','Laki-laki','Perempuan') jk, "
                    + "pl.nm_poli, DATE_FORMAT(rp.tgl_registrasi,'%d-%m-%Y') tgl_msk, IF(rr.nm_dokter_pengirim='','-',rr.nm_dokter_pengirim) dr_pengirim, pj.png_jawab, "
                    + "ifnull(d.nm_dokter,'-') dpjp, ifnull(rr.hasil_pemeriksaan,'') hasil_pemeriksaan, pg.nama disimpan_oleh "
                    + "FROM ringkasan_pulang_ralan rr INNER JOIN reg_periksa rp on rp.no_rawat=rr.no_rawat "
                    + "inner join poliklinik pl on pl.kd_poli=rp.kd_poli INNER JOIN penjab pj on pj.kd_pj=rp.kd_pj "
                    + "INNER JOIN pasien p on p.no_rkm_medis=rp.no_rkm_medis INNER JOIN pegawai pg on pg.nik=rr.nip_penyimpan left JOIN dokter d on d.kd_dokter=rp.kd_dokter where "
                    + "rp.status_lanjut='Ralan' and rr.no_rawat like ? or "
                    + "rp.status_lanjut='Ralan' and p.no_rkm_medis like ? or "
                    + "rp.status_lanjut='Ralan' and p.nm_pasien like ? or "
                    + "rp.status_lanjut='Ralan' and IF (p.jk = 'L','Laki-laki','Perempuan') like ? or "
                    + "rp.status_lanjut='Ralan' and pl.nm_poli like ? or "
                    + "rp.status_lanjut='Ralan' and IF (rr.nm_dokter_pengirim = '','-',rr.nm_dokter_pengirim) like ? or "
                    + "rp.status_lanjut='Ralan' and pj.png_jawab like ? or "
                    + "rp.status_lanjut='Ralan' and rr.alasan_masuk_dirawat like ? or "
                    + "rp.status_lanjut='Ralan' and rr.ringkasan_riwayat_penyakit like ? or "
                    + "rp.status_lanjut='Ralan' and rr.pemeriksaan_fisik like ? or "
                    + "rp.status_lanjut='Ralan' and rr.pemeriksaan_penunjang like ? or "
                    + "rp.status_lanjut='Ralan' and rr.terapi_pengobatan like ? or "
                    + "rp.status_lanjut='Ralan' and rr.diagnosa_utama like ? or "
                    + "rp.status_lanjut='Ralan' and rr.diagnosa_sekunder like ? or "
                    + "rp.status_lanjut='Ralan' and rr.tindakan_prosedur like ? or "                    
                    + "rp.status_lanjut='Ralan' and rr.keadaan_umum like ? or "
                    + "rp.status_lanjut='Ralan' and rr.kesadaran like ? or "
                    + "rp.status_lanjut='Ralan' and rr.gcs like ? or "
                    + "rp.status_lanjut='Ralan' and rr.tekanan_darah like ? or "
                    + "rp.status_lanjut='Ralan' and rr.suhu like ? or "
                    + "rp.status_lanjut='Ralan' and rr.nadi like ? or "
                    + "rp.status_lanjut='Ralan' and rr.frekuensi_nafas like ? or "
                    + "rp.status_lanjut='Ralan' and rr.catatan_penting like ? or "
                    + "rp.status_lanjut='Ralan' and rr.terapi_pulang like ? or "
                    + "rp.status_lanjut='Ralan' and rr.pengobatan_dilanjutkan like ? or "
                    + "rp.status_lanjut='Ralan' and rr.dokter_luar_lanjutan like ? or "
                    + "rp.status_lanjut='Ralan' and rr.tgl_kontrol_poliklinik like ? or "
                    + "rp.status_lanjut='Ralan' and rr.stts_pulang like ? or "
                    + "rp.status_lanjut='Ralan' and ifnull(d.nm_dokter,'-') like ? or "
                    + "rp.status_lanjut='Ralan' and rr.penanggung_jwb_pasien like ? ORDER BY rp.tgl_registrasi desc, rp.jam_reg desc, rr.no_rawat desc LIMIT 100");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("dokter_luar_lanjutan"),
                        rs.getString("tgl_kontrol_poliklinik"),
                        rs.getString("dpjp"),
                        ...
                        rs.getString("id_file_penanggung_jwb_pasien")
                    });                    
                }
            } catch (Exception e) {
                System.out.println("simrskhanza.DlgRingkasanPulangRalan.tampil() : " + e);
            } finally {
                if (rs != null) {
                    rs.close();
                }
    ...
    private void getData() {
        ...
        if (tbRingkasan.getSelectedRow() != -1) {
            ...
            TnmPoli.setText(tbRingkasan.getValueAt(tbRingkasan.getSelectedRow(), 7).toString());
            ...
            nipDpjpAwal = Sequel.cariIsi("select kd_dokter from reg_periksa where no_rawat='" + TNoRW.getText() + "'");
            ...
            Tsaturasi.setText(tbRingkasan.getValueAt(tbRingkasan.getSelectedRow(), 38).toString());
            nmgedung = TnmPoli.getText();
    ...
    public void cekPasien() {
        ...
        try {
            psPasien = koneksi.prepareStatement("SELECT p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') tgl_lhr, "
                    + "IF(p.jk='L','Laki-laki','Perempuan') jk, DATE_FORMAT(rp.tgl_registrasi,'%d-%m-%Y') tgl_msk, pl.nm_poli, pj.png_jawab, ifnull(d.nm_dokter,'-') dpjp, "
                    + "rp.kd_dokter from reg_periksa rp inner join pasien p on p.no_rkm_medis=rp.no_rkm_medis inner join poliklinik pl on pl.kd_poli=rp.kd_poli "
                    + "inner join penjab pj ON pj.kd_pj = rp.kd_pj INNER JOIN dokter d on d.kd_dokter=rp.kd_dokter where "
                    + "rp.no_rawat like '%" + TNoRW.getText() + "%' order by rp.tgl_registrasi desc, rp.jam_reg desc limit 1");
            try {
                ...
                while (rsPasien.next()) {
                    ...
                    TTglPulang.setText(rsPasien.getString("tgl_msk").replaceAll("00-00-0000", "-"));
                    TnmPoli.setText(rsPasien.getString("nm_poli"));
                    TCaraBayar.setText(rsPasien.getString("png_jawab"));
                    cmbKondisiWP.setSelectedItem("-");
                    nipDpjpAwal = rsPasien.getString("kd_dokter");
                    Tdpjp.setText(rsPasien.getString("dpjp"));
                    nmgedung = rsPasien.getString("nm_poli");
                    TNmDokter.setText(rsPasien.getString("dpjp"));
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
            } finally {
...
//                            }
    ...
    private void simpanHistory() {
        ...
        try {
            if (Sequel.menyimpantf("ringkasan_pulang_ralan_histori", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Ringkasan Pulang Pasien Rawat Inap", 32, new String[]{
                TNoRW.getText(), TAlasanDirawat.getText(), TRingkasanRiwayat.getText(), Valid.mysql_real_escape_stringERM(TPemeriksaanFisik.getText()),
                Valid.mysql_real_escape_stringERM(TPemeriksaanPenunjang.getText()), TTerapiPengobatan.getText(), TDiagUtama.getText(),
                TDiagSekunder.getText(), TKeadaanumum.getText(), TKesadaran.getText(), TTensi.getText(), TSuhu.getText(), TNadi.getText(), TFrekuensiNafas.getText(),
                TCatatan.getText(), TTerapiPulang.getText(), cmbLanjutan.getSelectedItem().toString(), kontrolPoli, TNmDokter.getText(), Tgcs.getText(),
                TTindakan.getText(), TDokterLuar.getText(), cekTgl, Tedukasi.getText().replaceAll("'", ""), TKlgPasien.getText(), nipPenyimpan, THasil.getText(),
                cmbKondisiWP.getSelectedItem().toString(), Tsaturasi.getText(), nipExecutor, Sequel.cariIsi("select now()"), ""
            }) == true) {
                if (nmgedung.equals("PARU")) {
                    if (noreg.getText().length() == 16) {
                        Sequel.simpanReplaceInto("nomor_reg_tb", "'" + TNoRM.getText() + "','" + noreg.getText() + "'", "No. Registrasi Pasien TB");
    ...
    private void tampilRiwayat() {
        ...
        try {
            ps6 = koneksi.prepareStatement("SELECT IF(pg.nama='-','Admin Utama',pg.nama) pelaku, a.no_rawat, p.no_rkm_medis, p.nm_pasien, "
                    + "date_format(a.waktu_eksekusi,'%d-%m-%Y') tglHapus, a.waktu_eksekusi FROM ringkasan_pulang_ralan_histori a "
    ...
    private void kembalikanData() {
        try {
            ps7 = koneksi.prepareStatement("select * from ringkasan_pulang_ralan_histori where "
                    + "waktu_eksekusi='" + tbRiwayat.getValueAt(tbRiwayat.getSelectedRow(), 5).toString() + "'");
            try {
                rs7 = ps7.executeQuery();
                while (rs7.next()) {
                    try {
                        if (Sequel.menyimpantf("ringkasan_pulang_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 30, new String[]{
                            ...
                            rs7.getString("saturasi"),
                            rs7.getString("id_file_penanggung_jwb_pasien")
                        }) == true) {
    ...
    private void tampilPeriksaPA() {
        ...
        try {
            ps10 = koneksi.prepareStatement("SELECT hpa.*, p.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-laki','Perempuan') jenkel, date_format(p.tgl_lahir,'%d-%m-%Y') tglLahir, "
            ...
            try {
                ps10.setString(1, "%" + TNoRM.getText() + "%");
                ps10.setString(2, "%" + TCari6.getText().trim() + "%");
                ps10.setString(3, "%" + TNoRM.getText() + "%");
                ps10.setString(4, "%" + TCari6.getText().trim() + "%");
                ps10.setString(5, "%" + TNoRM.getText() + "%");
                ps10.setString(6, "%" + TCari6.getText().trim() + "%");
                ps10.setString(7, "%" + TNoRM.getText() + "%");
                ps10.setString(8, "%" + TCari6.getText().trim() + "%");
                ps10.setString(9, "%" + TNoRM.getText() + "%");
                ps10.setString(10, "%" + TCari6.getText().trim() + "%");
                ps10.setString(11, "%" + TNoRM.getText() + "%");
                ps10.setString(12, "%" + TCari6.getText().trim() + "%");
                ps10.setString(13, "%" + TNoRM.getText() + "%");
                ps10.setString(14, "%" + TCari6.getText().trim() + "%");
                ps10.setString(15, "%" + TNoRM.getText() + "%");
                ps10.setString(16, "%" + TCari6.getText().trim() + "%");
                ps10.setString(17, "%" + TNoRM.getText() + "%");
                ps10.setString(18, "%" + TCari6.getText().trim() + "%");
                rs10 = ps10.executeQuery();
                while (rs10.next()) {
                    tabMode3.addRow(new String[]{
                        rs10.getString("no_rawat"),
                        rs10.getString("no_pa"),
                        rs10.getString("no_rkm_medis"),
                        rs10.getString("nm_pasien"),
                        rs10.getString("jenkel"),
                        rs10.getString("tglLahir"),                        
                        rs10.getString("drPengirim"),                        
                        rs10.getString("nm_unit"),                        
                        rs10.getString("tglPeriksa"),                        
                        rs10.getString("tglHasil"),                        
                        rs10.getString("lokasi_organ"),
                        rs10.getString("makroskopik"),
                        rs10.getString("mikroskopik"),
                        rs10.getString("kesimpulan"),
                        rs10.getString("anjuran"),
                        rs10.getString("kd_gambar"),
                        rs10.getString("nip_perujuk"),
    ...
    private void tampilPreviewPA(String wktsimpan) {
        ...
        try {
            StringBuilder htmlContent = new StringBuilder();
            try {
                rs11 = koneksi.prepareStatement("SELECT hpa.*, p.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-laki','Perempuan') jenkel, date_format(p.tgl_lahir,'%d-%m-%Y') tglLahir, "
                ...
                if (rs11.next()) {
                    ...
                    while (rs11.next()) {
                        ...
                        htmlContent.append(
                                ...
                                + "<td valign='top' colspan='7' align='left'>: " + rs11.getString("lokasi_organ")
                        ...
                        try {
                            ...
                            //ping sukses timeout 100 ms (0.1 detik)
                            if (inet.isReachable(100)) {
                                if (rs11.getString("kd_gambar").equals("")) {
                                    gambar = "http://192.168.0.230:7183/img-rme/gambar_tidak_ditemukan.jpg";
                                } else {
                                    gambar = "http://192.168.0.230:7183/rme/download.php?id=" + rs11.getString("kd_gambar");
                                }
                            //ping gagal
                            } else {
                        ...
                        isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                                + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='006'"),
                                        "Hasil Pemeriksaan Lab. (Patologi Anatomi)", rs11.getString("drPatologi"),
                                        rs11.getString("tgl"), rs11.getString("jam")) + "') from kalimat_tte where kode='006'");
                        Valid.cetakQrTte(isi, Sequel.cariFolderTte(), "QRTte.jpg", "select logo from setting");
                        ...
                        htmlContent.append(
                                ...
                                + rs11.getString("drPatologi") + "</b><br>SIP : "
                                + Sequel.cariIsi("select no_ijn_praktek from dokter where kd_dokter='" + rs11.getString("nip_dokter_pa") + "'") + "</td>"
                                + "</tr>");
                    }
                    htmlContent.append(
                            "</tbody>"
    ...
    private void bikinQR() {  
        ...
        Valid.cetakQrTte(URL, Sequel.cariFolderTte(), "QRTte.jpg", "select logo from setting");
        Sequel.menyimpanQrTte("parameter_ttd_rme", "'" + idParameterTtd + "','" + usernya + "','" + pwdnya + "','" + TNoRW.getText() + "','" + TNoRM.getText() + "','"
                + Sequel.cariIsi("select kode_erm from master_nomor_dokumen_erm where nm_dokumen like '%RINGKASAN PULANG RAWAT JALAN%'") + "',"
                + "'" + Sequel.cariIsi("select now()") + "'", "file QRCode URL Ttd", Sequel.cariFolderPrintTte());
    ...
    private void tampilTTD() {
        try {
            ...
            htmlContent.append(
                    ...
                    + "<thead>"
                    + "<tr class='isi'>"
                    + "<td align='center' bgcolor='#f8fdf3'><b>Pasien/Keluarga</b></td>"
                    + "</tr>"
                    + "</thead>"
                    + "<tbody>"
            );
            ...
            htmlContent.append(
                    "<tr class='isi'>"
                    + "<td valign='middle' align='center'><img src='" + gambar + "' width='160' height='160' alt='TTD Pasien/Keluarga'><br>(" + TKlgPasien.getText() + ")<br></td>"
                    + "</tr>"
            );
