...
public final class DlgRujuk extends javax.swing.JDialog {
    ...
    private String tgl = "", sql = "", kode_rujukanya = "", URL = "", utc = "", user = "", requestJson, tte = "", isi = "";
    ...
    private void initComponents() {
        ...
        MnSuratRujukan1 = new javax.swing.JMenu();
        MnTTD = new javax.swing.JMenuItem();
        MnTTE = new javax.swing.JMenuItem();
        jPopupMenu2 = new javax.swing.JPopupMenu();
        MnSuratRujukanBpjs = new javax.swing.JMenuItem();
        ...
        MnSuratRujukan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSuratRujukan1.setText("Surat Rujukan");
        MnSuratRujukan1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSuratRujukan1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnSuratRujukan1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnSuratRujukan1.setIconTextGap(5);
        MnSuratRujukan1.setName("MnSuratRujukan1"); // NOI18N
        MnSuratRujukan1.setOpaque(true);
        MnSuratRujukan1.setPreferredSize(new java.awt.Dimension(120, 28));
        ...
        MnTTE.setPreferredSize(new java.awt.Dimension(120, 28));
        MnTTE.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTEActionPerformed(evt);
            }
        });
        MnSuratRujukan1.add(MnTTE);

        jPopupMenu1.add(MnSuratRujukan1);

        jPopupMenu2.setName("jPopupMenu2"); // NOI18N

        MnSuratRujukanBpjs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSuratRujukanBpjs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSuratRujukanBpjs.setText("Surat Rujukan");
        MnSuratRujukanBpjs.setName("MnSuratRujukanBpjs"); // NOI18N
        MnSuratRujukanBpjs.setPreferredSize(new java.awt.Dimension(120, 28));
        MnSuratRujukanBpjs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSuratRujukanBpjsActionPerformed(evt);
            }
        });
        jPopupMenu2.add(MnSuratRujukanBpjs);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Data Rujukan Keluar ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        TTmpRujuk.setBounds(205, 66, 440, 23);
        ...
        FormInput.add(TNoRw);
        TNoRw.setBounds(113, 10, 141, 23);

        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Diagnosa :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 150, 110, 23);
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(256, 10, 120, 23);

        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Dokter :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(0, 178, 110, 23);
        ...
        btnDokter.setBounds(650, 178, 28, 23);
        ...
        jLabel14.setBounds(290, 122, 80, 23);

        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("Keterangan :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(720, 10, 80, 23);

        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("Jam :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(475, 38, 40, 23);
        ...
        CmbMenit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                CmbMenitMouseReleased(evt);
            }
        });
        FormInput.add(CmbMenit);
        CmbMenit.setBounds(570, 38, 45, 23);
        ...
        ambulance.setBounds(378, 122, 170, 23);
        ...
        CmbDetik.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                CmbDetikMouseReleased(evt);
            }
        });
        FormInput.add(CmbDetik);
        CmbDetik.setBounds(622, 38, 45, 23);
        ...
        ktrujuk.setBounds(113, 122, 170, 23);
        ...
        kdfaskes.setBounds(113, 66, 90, 23);
        ...
        btnFaskes.setBounds(650, 66, 28, 23);
        ...
        ket.setPreferredSize(new java.awt.Dimension(170, 2500));
        Scroll21.setViewportView(ket);

        FormInput.add(Scroll21);
        Scroll21.setBounds(804, 10, 560, 190);

        jLabel16.setForeground(new java.awt.Color(0, 0, 0));
        jLabel16.setText("Bagian/Spesialis :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(0, 94, 110, 23);
        ...
        FormInput.add(TBagian);
        TBagian.setBounds(113, 94, 532, 23);
        ...
        kodeDok.setBounds(113, 178, 90, 23);
        ...
        FormInput.add(nmDok);
        nmDok.setBounds(205, 178, 440, 23);

        diagnosanya.setForeground(new java.awt.Color(0, 0, 0));
        diagnosanya.setHighlighter(null);
        diagnosanya.setName("diagnosanya"); // NOI18N
        diagnosanya.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                diagnosanyaKeyPressed(evt);
            }
        });
        FormInput.add(diagnosanya);
        diagnosanya.setBounds(113, 150, 532, 23);

        jLabel17.setForeground(new java.awt.Color(0, 0, 0));
        jLabel17.setText("Klinis  ");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(720, 26, 80, 23);
        ...
        tbRujukanNon.getTableHeader().setReorderingAllowed(false);
        ...
        tbRujukanBPJS.setComponentPopupMenu(jPopupMenu2);
        tbRujukanBPJS.setName("tbRujukanBPJS"); // NOI18N
        tbRujukanBPJS.getTableHeader().setReorderingAllowed(false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (TBagian.getText().trim().equals("")) {
            Valid.textKosong(TBagian, "nama poliklinik tujuan");
            TBagian.requestFocus();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRj.getText().trim().equals("")) {
            ...
            Valid.editTable(tabMode, "rujuk", "no_rujuk", TNoRj, "no_rawat='" + TNoRw.getText()
                    ...
                    + "',poliklinik_tujuan='" + TBagian.getText() + "'");
...
private void btnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDokterActionPerformed
    dokter.isCek();
    dokter.setSize(1063, internalFrame1.getHeight() - 40);
    ...
    private void TBagianKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBagianKeyPressed
        Valid.pindah(evt, btnFaskes, ktrujuk);
    }//GEN-LAST:event_TBagianKeyPressed

    private void diagnosanyaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_diagnosanyaKeyPressed
        Valid.pindah(evt, ambulance, btnDokter);
    }//GEN-LAST:event_diagnosanyaKeyPressed

    private void CmbJamMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CmbJamMouseReleased
        AutoCompleteDecorator.decorate(CmbJam);
    }//GEN-LAST:event_CmbJamMouseReleased

    private void CmbMenitMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CmbMenitMouseReleased
        AutoCompleteDecorator.decorate(CmbMenit);
    }//GEN-LAST:event_CmbMenitMouseReleased

    private void CmbDetikMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CmbDetikMouseReleased
        AutoCompleteDecorator.decorate(CmbDetik);
    }//GEN-LAST:event_CmbDetikMouseReleased

    private void MnSuratRujukanBpjsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratRujukanBpjsActionPerformed
    ...
    }//GEN-LAST:event_MnSuratRujukanBpjsActionPerformed
    ...
    private javax.swing.JMenu MnSuratRujukan1;
    private javax.swing.JMenuItem MnSuratRujukanBpjs;
    ...
    public void tampilLain() {
        ...
        try {
            ...
            sql = "SELECT r.no_rujuk,r.no_rawat,rp.no_rkm_medis,p.nm_pasien, "
                    + "CONCAT(r.rujuk_ke,' (Bag./Spesialis : ',IFNULL(r.poliklinik_tujuan,'-'),')') rujuk_ke,DATE_FORMAT(r.tgl_rujuk,'%d-%m-%Y') tglrujuk, "
    ...
    private void getData() {
        ...
        if (tbRujukanNon.getSelectedRow() != -1) {
            ...
            TBagian.setText(tbRujukanNon.getValueAt(tbRujukanNon.getSelectedRow(), 15).toString());
    ...
    private void getDataBPJS() {
        ...
        if (tbRujukanBPJS.getSelectedRow() != -1) {
            ...
            kdfaskes.setText(Sequel.cariIsi("select kode_faskes_bpjs from master_nama_rujukan where kd_rujukan='" + kode_rujukanya + "'"));
            TTmpRujuk.setText(Sequel.cariIsi("SELECT IFNULL(nama_rujukan,'-') FROM master_nama_rujukan WHERE kode_faskes_bpjs='" + kdfaskes.getText() + "'"));
            TBagian.setText(tbRujukanBPJS.getValueAt(tbRujukanBPJS.getSelectedRow(), 15).toString());
    ...
    private void cetakRujukan() {
        ...
        if (tte.equals("tidak")) {
            Valid.MyReport("rptSuratRujukan.jasper", "report", "::[ Surat Rujukan Keluar RS ]::",
                    "SELECT CONCAT(r.rujuk_ke,'\n(Bagian/Spesialis : ',IFNULL(r.poliklinik_tujuan,'-'),')') rujukKe,r.no_rujuk,rp.no_rawat, "
                    ...
                    + "DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') tglLhr, p.nm_pasien, p.pekerjaan,"
            ...
            if (kodeDok.getText().equals("") || kodeDok.getText().equals("-") || kodeDok.getText().equals("--")) {
                JOptionPane.showMessageDialog(rootPane, "Nama dokter harus diisi dulu,..");
            } else {
                isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                        + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='001'"),
                                "Surat Rujukan Keluar", nmDok.getText(),
                ...
                Valid.MyReport("rptSuratRujukanQr.jasper", "report", "::[ Surat Rujukan Keluar RS ]::",
                        "SELECT CONCAT(r.rujuk_ke,'\n(Bagian/Spesialis : ',IFNULL(r.poliklinik_tujuan,'-'),')') rujukKe,r.no_rujuk,rp.no_rawat, "
                        + "CONCAT(p.alamat,', Kel. ',kl.nm_kel,', Kec. ',nm_kec,', ',nm_kab) alamat, d.nm_dokter, "
                        + "rp.no_rkm_medis, IF(p.jk='L','Laki-laki','Perempuan') jk,p.keluarga,p.namakeluarga, "
                        + "DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') tglLhr, p.nm_pasien, p.pekerjaan,"
