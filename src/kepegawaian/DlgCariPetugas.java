...
public final class DlgCariPetugas extends javax.swing.JDialog {
    ...
    public DlgCariPetugas(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"NIP", "Nama Petugas", "J.K.", "Tmp.Lahir", "Tgl.Lahir", "G.D.", "Agama", "Stts.Nikah", "Alamat", "Jabatan", "No.Telp", "User Id"};
    ...
    public void tampil() {  
        ...
        try {
            ps = koneksi.prepareStatement("select nip,nama,jk,tmp_lahir,tgl_lahir, "
                    + "gol_darah,agama,stts_nikah,alamat,nm_jbtn,no_telp,user_id "
                    ...
                    + "petugas.status='1' and nm_jbtn like ? or "
                    + "petugas.status='1' and user_id like ? order by nip");
            try {
