...
public final class RMAsesmenMedikDewasaRanap extends javax.swing.JDialog {
    ...
    private String rujukan = "", dtg_sendiri = "", diantar = "", hipertensi1 = "", dm1 = "", pjk = "",
            ...
            jantung = "", asma2 = "", lain2 = "", nyeri = "", resus = "", reguler = "", ireguler = "", kdItemrad = "",
            itemDipilih = "", tglRad = "", jamRad = "";
    ...
    public RMAsesmenMedikDewasaRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "perencanaan_pemulangan", "catatan_penting", "tgl_dpjp", "nip_dpjp", "nmdokter_memeriksa", "nm_super"
        }) {
        ...
        Tdiameter_kanan.setDocument(new batasInput((byte) 3).getOnlyAngka(Tdiameter_kanan));
        Tdiameter_kiri.setDocument(new batasInput((byte) 3).getOnlyAngka(Tdiameter_kiri));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Assesmen Medik Dewasa Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 2078));
        ...
        TglAsesmen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023 22:20:25" }));
        ...
        TglAnamnesa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023 22:20:32" }));
        ...
        label56.setBounds(200, 1053, 80, 23);
        ...
        label77.setBounds(0, 1478, 210, 23);
        ...
        scrollPane15.setBounds(24, 1499, 830, 80);
        ...
        label78.setBounds(0, 1585, 100, 23);
        ...
        Tdiagnosa1.setBounds(49, 1605, 805, 23);
        ...
        label79.setBounds(0, 1605, 47, 23);
        ...
        label80.setBounds(0, 1635, 47, 23);
        ...
        Tdiagnosa2.setBounds(49, 1635, 805, 23);
        ...
        label81.setBounds(0, 1665, 47, 23);
        ...
        Tdiagnosa3.setBounds(49, 1665, 805, 23);
        ...
        label82.setBounds(0, 1695, 47, 23);
        ...
        Tdiagnosa4.setBounds(49, 1695, 805, 23);
        ...
        label83.setBounds(0, 1725, 190, 23);
        ...
        Trencana_kerja.setPreferredSize(new java.awt.Dimension(162, 200));
        ...
        scrollPane16.setBounds(24, 1745, 830, 80);
        ...
        label84.setBounds(0, 1830, 230, 23);
        ...
        Trencana_pulang.setPreferredSize(new java.awt.Dimension(162, 200));
        ...
        scrollPane17.setBounds(24, 1850, 830, 80);
        ...
        label85.setBounds(0, 1938, 132, 23);
        ...
        Tcatatan.setPreferredSize(new java.awt.Dimension(162, 200));
        ...
        scrollPane18.setBounds(24, 1958, 830, 80);
        ...
        label86.setBounds(625, 2045, 100, 23);

        TglDpjp.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-08-2023 22:20:39" }));
        TglDpjp.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        TglDpjp.setName("TglDpjp"); // NOI18N
        TglDpjp.setOpaque(false);
        FormInput.add(TglDpjp);
        TglDpjp.setBounds(725, 2045, 130, 23);
        ...
        jLabel47.setBounds(220, 1478, 380, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbPenilaian.getSelectedRow() > -1) {
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (kddpjp.getText().equals(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(), 109).toString())) {
                    hapus();
                } else {
...
//            
    ...
    private void Tdiagnosa4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Tdiagnosa4KeyPressed
        Valid.pindah(evt, Tdiagnosa3, Trencana_kerja);
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (cekHasilRad >= 1) {
                ...
                form.setData(TNoRw.getText(), kdItemrad, itemDipilih, "OK", TNoRM.getText(), TPasien.getText(), tglRad, jamRad,
                        Sequel.cariIsi("select diagnosa_awal from kamar_inap where no_rawat='" + TNoRw.getText() + "' order by tgl_masuk, jam_masuk limit 1"),
                        TRuangan.getText(),
    ...
    */
    ...
    private void ganti() {
        ...
        if (Sequel.mengedittf("asesmen_medik_dewasa_ranap", "no_rawat=?", "no_rawat=?, kd_kamar=?, tgl_asesmen=?, rujukan=?, ket_rs=?, ket_puskes=?, ket_praktek=?, ket_lainya=?, diagnosa_rujukan=?, "
                ...
                + "hasil_pemeriksaan=?, diagnosis1=?, diagnosis2=?, diagnosis3=?, diagnosis4=?, rencana_kerja=?, perencanaan_pemulangan=?, catatan_penting=?, tgl_dpjp=?, nip_dpjp=?", 104, new String[]{
