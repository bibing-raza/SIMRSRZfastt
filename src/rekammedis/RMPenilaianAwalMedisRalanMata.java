...
public final class RMPenilaianAwalMedisRalanMata extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Jalan Mata ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        MBOkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Visuskanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Visuskiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        CCkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        CCkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Palkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Palkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Conkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Conkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Corneakanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Corneakiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        COAkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        COAkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Pupilkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Pupilkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lensakanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lensakiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Funduskanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Funduskiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Papilkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Papilkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Retinakanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Retinakiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Makulakanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Makulakiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TIOkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TIOkiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MBOkanan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Radiologi.setPreferredSize(new java.awt.Dimension(102, 300));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-04-2023" }));
        ...
        TglAsuhan.setBounds(436, 40, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ralan_mata", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 56, new String[]{
                TNoRw.getText(), Valid.SetTgl(TglAsuhan.getSelectedItem() + ""), KdDokter.getText(), Anamnesis.getSelectedItem().toString(), Hubungan.getText(),
                ...
                Visuskanan.getText(), Visuskiri.getText(), CCkanan.getText(), CCkiri.getText(), Palkanan.getText(), Palkiri.getText(), Conkanan.getText(), Conkiri.getText(), Corneakanan.getText(), Corneakiri.getText(), 
                COAkanan.getText(), COAkiri.getText(), Pupilkanan.getText(), Pupilkiri.getText(), Lensakanan.getText(), Lensakiri.getText(), Funduskanan.getText(), Funduskiri.getText(), Papilkanan.getText(), Papilkiri.getText(), 
                Retinakanan.getText(), Retinakiri.getText(), Makulakanan.getText(), Makulakiri.getText(), TIOkanan.getText(), TIOkiri.getText(), MBOkanan.getText(), MBOkiri.getText(), Laborat.getText(), Radiologi.getText(), 
                Penunjang.getText(), TesPenglihatan.getText(), PemeriksaanLain.getText(), Diagnosis.getText(), DiagnosisBdg.getText(), Permasalahan.getText(), Terapi.getText(), Tindakan.getText(), Edukasi.getText()
            }) == true) {                
                emptTeks();
                tampil();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbAsesmen.getSelectedRow() > -1) {
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (KdDokter.getText().equals(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 5).toString())) {
                    hapus();
                } else {
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                if (TCari.getText().trim().equals("")) {
                    ps = koneksi.prepareStatement("select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_mata.tanggal,"
                                ...
                                "<table width='5000px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    "<tr class='isi2'>"+
                                        "<td valign='top' align='center'>"+
                                            ...
                                            "<font size='2' face='Tahoma'>DATA PENILAIAN AWAL MEDIS RAWAT JALAN POLIKLINIK MATA<br><br></font>"+        
                                        "</td>"+
                                   "</tr>"+
                                "</table>")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        ...
        } else if (Sequel.cariInteger("select count(-1) from penilaian_medis_ralan_mata where no_rawat='" + TNoRw.getText() + "'") == 0) {
            JOptionPane.showMessageDialog(null, "Data penilaian awal medis rawat jalan poliklinik mata masih belum tersimpan...!!!!");
        } else {
            if (tbAsesmen.getSelectedRow() > -1) {
                ...
                param.put("lokalis", Sequel.cariGambar("select lokalismata from gambar"));
                param.put("lokalis2", Sequel.cariGambar("select lokalismata from gambar"));
                Valid.MyReport("rptCetakPenilaianAwalMedisRalanMata.jasper", "report", "::[ Laporan Penilaian Awal Medis Rawat Jalan Mata ]::",
                        ...
                        + "penilaian_medis_ralan_mata.kd_dokter,penilaian_medis_ralan_mata.anamnesis,penilaian_medis_ralan_mata.hubungan,penilaian_medis_ralan_mata.keluhan_utama,penilaian_medis_ralan_mata.rps,penilaian_medis_ralan_mata.rpd,penilaian_medis_ralan_mata.rpo,penilaian_medis_ralan_mata.alergi,"
                        + "penilaian_medis_ralan_mata.status,penilaian_medis_ralan_mata.td,penilaian_medis_ralan_mata.nadi,penilaian_medis_ralan_mata.rr,penilaian_medis_ralan_mata.suhu,penilaian_medis_ralan_mata.nyeri,penilaian_medis_ralan_mata.bb,concat(date_format(reg_periksa.tgl_registrasi,'%d/%m/%Y'),' ',reg_periksa.jam_reg) tgljamreg,"
                        + "penilaian_medis_ralan_mata.visuskanan,penilaian_medis_ralan_mata.visuskiri,penilaian_medis_ralan_mata.cckanan,penilaian_medis_ralan_mata.cckiri,penilaian_medis_ralan_mata.palkanan,penilaian_medis_ralan_mata.palkiri,penilaian_medis_ralan_mata.conkanan,penilaian_medis_ralan_mata.conkiri,"
                        + "penilaian_medis_ralan_mata.corneakanan,penilaian_medis_ralan_mata.corneakiri,penilaian_medis_ralan_mata.coakanan,penilaian_medis_ralan_mata.coakiri,penilaian_medis_ralan_mata.pupilkanan,penilaian_medis_ralan_mata.pupilkiri,penilaian_medis_ralan_mata.lensakanan,penilaian_medis_ralan_mata.lensakiri,"
                        + "penilaian_medis_ralan_mata.funduskanan,penilaian_medis_ralan_mata.funduskiri,penilaian_medis_ralan_mata.papilkanan,penilaian_medis_ralan_mata.papilkiri,penilaian_medis_ralan_mata.retinakanan,penilaian_medis_ralan_mata.retinakiri,penilaian_medis_ralan_mata.makulakanan,penilaian_medis_ralan_mata.makulakiri,"
                        + "penilaian_medis_ralan_mata.tiokanan,penilaian_medis_ralan_mata.tiokiri,penilaian_medis_ralan_mata.mbokanan,penilaian_medis_ralan_mata.mbokiri,penilaian_medis_ralan_mata.lab,penilaian_medis_ralan_mata.rad,penilaian_medis_ralan_mata.penunjang,penilaian_medis_ralan_mata.tes,penilaian_medis_ralan_mata.pemeriksaan,"
                        ...
                        + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join penilaian_medis_ralan_mata on reg_periksa.no_rawat=penilaian_medis_ralan_mata.no_rawat "
                        + "inner join dokter on penilaian_medis_ralan_mata.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_mata.no_rawat='" + tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 0).toString() + "'", param);
            }
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        tampil();
        if (Sequel.cariInteger("select count(-1) from penilaian_medis_ralan_mata where no_rawat='" + TNoRw.getText() + "'") == 0) {
            TabRawat.setSelectedIndex(0);
        } else if (Sequel.cariInteger("select count(-1) from penilaian_medis_ralan_mata where no_rawat='" + TNoRw.getText() + "'") > 0) {
            TabRawat.setSelectedIndex(1);
        }
    ...
    */
    ...
    public void tampil() {
        ...
        try{
            if (TCari.getText().trim().equals("")) {
                ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,pm.tanggal, "
                        + "pm.kd_dokter,pm.anamnesis,pm.hubungan,pm.keluhan_utama,pm.rps,pm.rpd,pm.rpo,pm.alergi, "
                        + "pm.status,pm.td,pm.nadi,pm.rr,pm.suhu,pm.nyeri,pm.bb, "
                        + "pm.visuskanan,pm.visuskiri,pm.cckanan,pm.cckiri,pm.palkanan,pm.palkiri,pm.conkanan,pm.conkiri, "
                        + "pm.corneakanan,pm.corneakiri,pm.coakanan,pm.coakiri,pm.pupilkanan,pm.pupilkiri,pm.lensakanan,pm.lensakiri, "
                        + "pm.funduskanan,pm.funduskiri,pm.papilkanan,pm.papilkiri,pm.retinakanan,pm.retinakiri,pm.makulakanan,pm.makulakiri, "
                        + "pm.tiokanan,pm.tiokiri,pm.mbokanan,pm.mbokiri,pm.lab,pm.rad,pm.penunjang,pm.tes,pm.pemeriksaan, "
                        + "pm.diagnosis,pm.diagnosisbdg,pm.permasalahan,pm.terapi,pm.tindakan,pm.edukasi,d.nm_dokter "
                        + "FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                        + "INNER JOIN penilaian_medis_ralan_mata pm ON rp.no_rawat = pm.no_rawat "
                        + "INNER JOIN dokter d ON pm.kd_dokter = d.kd_dokter WHERE pm.tanggal BETWEEN ? AND ? ORDER BY pm.tanggal");
            } else {
                ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,pm.tanggal, "
                        + "pm.kd_dokter,pm.anamnesis,pm.hubungan,pm.keluhan_utama,pm.rps,pm.rpd,pm.rpo,pm.alergi, "
                        + "pm.status,pm.td,pm.nadi,pm.rr,pm.suhu,pm.nyeri,pm.bb, "
                        ...
                        + "pm.diagnosis,pm.diagnosisbdg,pm.permasalahan,pm.terapi,pm.tindakan,pm.edukasi,d.nm_dokter "
                        + "FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                        + "INNER JOIN penilaian_medis_ralan_mata pm ON rp.no_rawat = pm.no_rawat INNER JOIN dokter d ON pm.kd_dokter = d.kd_dokter "
                        + "WHERE pm.tanggal BETWEEN ? AND ? AND (rp.no_rawat LIKE ? OR p.no_rkm_medis LIKE ? OR "
                        + "p.nm_pasien LIKE ? OR pm.kd_dokter LIKE ? OR d.nm_dokter LIKE ?) ORDER BY pm.tanggal");
            }
    ...
    private void getData() {
        if (tbAsesmen.getSelectedRow() != -1) {
            ...
            Jk.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 4).toString());
            Anamnesis.setSelectedItem(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 8).toString());
            Hubungan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 9).toString());
            KeluhanUtama.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 10).toString());
            RPS.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 11).toString());
            RPD.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 12).toString());
            RPO.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 13).toString());
            Alergi.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 14).toString());
            StatusNutrisi.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 15).toString());
            TD.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 16).toString());
            Nadi.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 17).toString());
            RR.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 18).toString());
            Suhu.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 19).toString());
            Nyeri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 20).toString());
            BB.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 21).toString());
            Visuskanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 22).toString());
            Visuskiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 23).toString());
            CCkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 24).toString());
            CCkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 25).toString());
            Palkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 26).toString());
            Palkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 27).toString());
            Conkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 28).toString());
            Conkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 29).toString());
            Corneakanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 30).toString());
            Corneakiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 31).toString());
            COAkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 32).toString());
            COAkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 33).toString());
            Pupilkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 34).toString());
            Pupilkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 35).toString());
            Lensakanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 36).toString());
            Lensakiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 37).toString());
            Funduskanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 38).toString());
            Funduskiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 39).toString());
            Papilkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 40).toString());
            Papilkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 41).toString());
            Retinakanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 42).toString());
            Retinakiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 43).toString());
            Makulakanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 44).toString());
            Makulakiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 45).toString());
            TIOkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 46).toString());
            TIOkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 47).toString());
            MBOkanan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 48).toString());
            MBOkiri.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 49).toString());
            Laborat.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 50).toString());
            Radiologi.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 51).toString());
            Penunjang.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 52).toString());
            TesPenglihatan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 53).toString());
            PemeriksaanLain.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 54).toString());
            Diagnosis.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 55).toString());
            DiagnosisBdg.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 56).toString());
            Permasalahan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 57).toString());
            Terapi.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 58).toString());
            Tindakan.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 59).toString());
            Edukasi.setText(tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 60).toString());
            Valid.SetTgl(TglAsuhan, tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 7).toString());
        }
    }

    private void isRawat() {
        try {
            ps = koneksi.prepareStatement("SELECT rp.no_rkm_medis, p.nm_pasien, IF (p.jk = 'L','Laki-Laki','Perempuan') jk, p.tgl_lahir, rp.tgl_registrasi, "
                    + "ifnull(pr.tensi,'') td, ifnull(pr.berat,'') bb, ifnull(pr.suhu_tubuh,'') suhu, ifnull(pr.nadi,'') nadi, ifnull(pr.respirasi,'') rr, "
                    + "ifnull(prd.keluhan,'') keluhan, ifnull(prd.diagnosa,'') riw_py_skr, ifnull(prd.alergi,'') alergi FROM reg_periksa rp "
                    + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis LEFT JOIN pemeriksaan_ralan_petugas pr on pr.no_rawat=rp.no_rawat "
                    + "LEFT JOIN pemeriksaan_ralan prd on prd.no_rawat=rp.no_rawat WHERE rp.no_rawat =?");
            try {
                ...
                if (rs.next()) {
                    ...
                    RPS.setText(rs.getString("riw_py_skr"));
                    ...
                    TglAsuhan.setDate(rs.getDate("tgl_registrasi"));
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private void isRadiologi() {
        try {
            ps1 = koneksi.prepareStatement("SELECT concat('Pemeriksaan : ',ifnull(jpr.nm_perawatan,'-'),', Hasil Pemeriksaan : ',ifnull(hr.hasil, '-')) hasil "
                    + "FROM periksa_radiologi pr INNER JOIN jns_perawatan_radiologi jpr on jpr.kd_jenis_prw=pr.kd_jenis_prw "
                    ...
                    + "WHERE pr.no_rawat = ? ORDER BY pr.tgl_periksa, pr.jam");
            try {
                ps1.setString(1, TNoRw.getText());
                rs1 = ps1.executeQuery();
                if (rs1.next()) {
                    Radiologi.setText(rs1.getString("hasil"));                    
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_mata", "no_rawat=?", "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,status=?,td=?,nadi=?,rr=?,suhu=?,"
                + "nyeri=?,bb=?,visuskanan=?,visuskiri=?,cckanan=?,cckiri=?,palkanan=?,palkiri=?,conkanan=?,conkiri=?,corneakanan=?,corneakiri=?,coakanan=?,coakiri=?,pupilkanan=?,pupilkiri=?,lensakanan=?,lensakiri=?,"
                + "funduskanan=?,funduskiri=?,papilkanan=?,papilkiri=?,retinakanan=?,retinakiri=?,makulakanan=?,makulakiri=?,tiokanan=?,tiokiri=?,mbokanan=?,mbokiri=?,lab=?,rad=?,penunjang=?,tes=?,pemeriksaan=?,"
                + "diagnosis=?,diagnosisbdg=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?", 57, new String[]{
                    TNoRw.getText(), Valid.SetTgl(TglAsuhan.getSelectedItem() + ""), KdDokter.getText(), Anamnesis.getSelectedItem().toString(),
                    Hubungan.getText(), KeluhanUtama.getText(), RPS.getText(), RPD.getText(), RPO.getText(), Alergi.getText(), StatusNutrisi.getText(), TD.getText(), Nadi.getText(), RR.getText(), Suhu.getText(),
                    Nyeri.getText(), BB.getText(), Visuskanan.getText(), Visuskiri.getText(), CCkanan.getText(), CCkiri.getText(), Palkanan.getText(), Palkiri.getText(), Conkanan.getText(), Conkiri.getText(),
                    Corneakanan.getText(), Corneakiri.getText(), COAkanan.getText(), COAkiri.getText(), Pupilkanan.getText(), Pupilkiri.getText(), Lensakanan.getText(), Lensakiri.getText(), Funduskanan.getText(),
                    Funduskiri.getText(), Papilkanan.getText(), Papilkiri.getText(), Retinakanan.getText(), Retinakiri.getText(), Makulakanan.getText(), Makulakiri.getText(), TIOkanan.getText(), TIOkiri.getText(),
                    MBOkanan.getText(), MBOkiri.getText(), Laborat.getText(), Radiologi.getText(), Penunjang.getText(), TesPenglihatan.getText(), PemeriksaanLain.getText(), Diagnosis.getText(), DiagnosisBdg.getText(),
                    Permasalahan.getText(), Terapi.getText(), Tindakan.getText(), Edukasi.getText(), tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 0).toString()
                }) == true) {
