...
//        RPD.setDocument(new batasInput((int)100).getKata(RPD));
        ...
        KetLapor.setDocument(new batasInput((int) 200).getKata(KetLapor));
        ...
        Durasi.setDocument(new batasInput((int) 200).getKata(Durasi));
        KetNyeri.setDocument(new batasInput((int) 200).getKata(KetNyeri));
        KetDokter.setDocument(new batasInput((int) 200).getKata(KetDokter));
...
//        KetLapor.setDocument(new batasInput((int) 8).getKata(KetLapor));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Penilaian Awal Keperawatan (Assesmen) Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_awal_keperawatan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 58, new String[]{
                ...
                Sequel.SimpanHistoriRekamMedis(TNoRw.getText(), "Assesmen Keperawatan Rawat Jalan", "Simpan");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.mengedittf("penilaian_awal_keperawatan_ralan", "no_rawat=?", "no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,bmi=?,keluhan_utama=?,rpd=?,rpk=?,rpo=?,"
                ...
                Sequel.SimpanHistoriRekamMedis(TNoRw.getText(), "Assesmen Keperawatan Rawat Jalan", "Ganti");
                getMasalah();
                tampil();
                BtnBatalActionPerformed(null);
                TabRawat.setSelectedIndex(1);
...
//        Valid.pindah(evt,RPD,Alergi);
    ...
    */
    ...
    private void tampilTemplate() {
        ...
        try {
            ps4 = koneksi.prepareStatement("SELECT p.no_rkm_medis, p.nm_pasien, pa.* from penilaian_awal_keperawatan_ralan pa "
