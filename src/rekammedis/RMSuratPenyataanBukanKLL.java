 ...
 * @author dosen
 */
public class RMSuratPenyataanBukanKLL extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMSuratPenyataanBukanKLL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            ...
            "nm_berttd", "no_ktp", "alamat", "kd_kel", "kd_kec", "kd_kab", "pernyataan", "tanggal", "id_file_nm_berttd", "nip_petugas", "waktu_simpan"
        }) {
            @Override
        ...
        kel.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("RMSuratPenyataanBukanKLL")) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Surat Pernyataan Bukan Kasus KLL (Kecelakaan Lalu Lintas) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jLabel14.setBounds(0, 38, 110, 23);
        ...
        TnoKtp.setBounds(114, 38, 180, 23);

        jLabel16.setForeground(new java.awt.Color(0, 0, 0));
        jLabel16.setText("Nama Pasien : ");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(0, 278, 110, 23);

        Tpasien.setEditable(false);
        Tpasien.setForeground(new java.awt.Color(0, 0, 0));
        Tpasien.setName("Tpasien"); // NOI18N
        FormInput.add(Tpasien);
        Tpasien.setBounds(204, 278, 360, 23);

        jLabel18.setForeground(new java.awt.Color(0, 0, 0));
        jLabel18.setText("No. Kartu JKN/BPJS : ");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(0, 306, 130, 23);
        ...
        TnokaBPJS.setBounds(132, 306, 170, 23);
        ...
        FormInput.add(Ttgl);
        Ttgl.setBounds(550, 334, 90, 23);

        jLabel21.setForeground(new java.awt.Color(0, 0, 0));
        jLabel21.setText("Nama Petugas : ");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(0, 362, 110, 23);
        ...
        TnmPetugas.setBounds(114, 362, 400, 23);
        ...
        BtnPetugas.setBounds(517, 362, 28, 23);

        TNoRM.setEditable(false);
        TNoRM.setForeground(new java.awt.Color(0, 0, 0));
        TNoRM.setName("TNoRM"); // NOI18N
        FormInput.add(TNoRM);
        TNoRM.setBounds(114, 278, 85, 23);

        jLabel22.setForeground(new java.awt.Color(0, 0, 0));
        jLabel22.setText("Ruang Rawat : ");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(0, 334, 110, 23);

        TrgRawat.setEditable(false);
        TrgRawat.setForeground(new java.awt.Color(0, 0, 0));
        TrgRawat.setName("TrgRawat"); // NOI18N
        FormInput.add(TrgRawat);
        TrgRawat.setBounds(114, 334, 370, 23);

        jLabel23.setForeground(new java.awt.Color(0, 0, 0));
        jLabel23.setText("Tgl. Daftar/Reg. : ");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(302, 306, 110, 23);
        ...
        TtglReg.setBounds(415, 306, 150, 23);

        jLabel13.setForeground(new java.awt.Color(0, 0, 0));
        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Menyatakan Bahwa Ini Bukan Kasus KLL Yaitu : ");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(114, 178, 270, 23);

        scrollPane2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        scrollPane2.setName("scrollPane2"); // NOI18N

        Tpernyataan.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Tpernyataan.setColumns(20);
        Tpernyataan.setRows(5);
        Tpernyataan.setName("Tpernyataan"); // NOI18N
        Tpernyataan.setPreferredSize(new java.awt.Dimension(162, 2000));
        Tpernyataan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TpernyataanKeyPressed(evt);
            }
        });
        scrollPane2.setViewportView(Tpernyataan);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (norawat.equals("")) {
            ...
            if (Sequel.menyimpantf("surat_pernyataan_bukan_kll", "?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 12, new String[]{
                norawat, Tnm.getText(), TnoKtp.getText(), Talamat.getText(), kdkel, kdkec, kdkab, Tpernyataan.getText(),
                Valid.SetTgl(Ttgl.getSelectedItem() + ""), "", nipPtgs, Sequel.cariIsi("select now()")
            }) == true) {

                Sequel.SimpanHistoriRekamMedis(norawat, "Surat Pernyataan Bukan Kasus KLL", "Simpan");
    ...
    private void BtnKelurahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKelurahanActionPerformed
        akses.setform("RMSuratPenyataanBukanKLL");
        kel.setSize(703, 384);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tbSurat.getSelectedRow() > -1) {
            ...
            if (TnoKtp.getText().equals("")) {
                ...
                param.put("noKTP", TnoKtp.getText());
            }
            
            if (TnokaBPJS.getText().equals("")) {
                param.put("nokaPas", "..........................");
            } else {
                param.put("nokaPas", "(" + TnokaBPJS.getText() + ") " + Tpasien.getText());
            }
            
            param.put("alamat", Talamat.getText() + ", Kel. " + TnmKel.getText() + ", Kec. " + TnmKec.getText() + ", Kab. " + TnmKab.getText());            

            if (Tpernyataan.getText().equals("")) {
                param.put("pernyataan", "..........................");
            } else {
    ...
    private void TpernyataanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TpernyataanKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSuratPenyataanBukanKLL dialog = new RMSuratPenyataanBukanKLL(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Tpernyataan;
    ...
    public void tampil() {     
        ...
        try {
            ps = koneksi.prepareStatement("select sp.*, p.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-laki','Perempuan') jenkel, date_format(p.tgl_lahir,'%d-%m-%Y') tglLahir, "
                    ...
                    + "pg.nama nmPtgs from surat_pernyataan_bukan_kll sp inner join reg_periksa rp on rp.no_rawat=sp.no_rawat "
    ...
    private void getData() {
        ...
        if (tbSurat.getSelectedRow() != -1) {
            ...
            TnoKtp.setText(tbSurat.getValueAt(tbSurat.getSelectedRow(), 11).toString());
            ...
            Tpernyataan.setText(tbSurat.getValueAt(tbSurat.getSelectedRow(), 16).toString());
            isPasien();
    ...
    private void isPasien() {
        try {
            ps2 = koneksi.prepareStatement("select p.*, rp.tgl_registrasi from pasien p "
                    + "inner join kelurahan kl on kl.kd_kel=p.kd_kel "
                    + "inner join kecamatan kc on kc.kd_kec=p.kd_kec "
