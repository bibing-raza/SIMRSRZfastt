...
import widget.PanelSiteMarkingOdontogram;

/**
 *
 * @author dosen
 */
public class RMFormulirSiteMarkingOdontogram extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMFormulirSiteMarkingOdontogram(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        PanelSiteMarkingOdontogram panelGambar = new PanelSiteMarkingOdontogram();
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("RMFormulirSiteMarkingOdontogram")) {
    ...
    private void initComponents() {
        ...
        panelSiteMarkingOdontogram = new widget.PanelSiteMarkingOdontogram();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Formulir Site Marking Odontogram ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 872));
        ...
        jLabel70.setText("Saya menyatakan bahwa lokasi yang telah ditetapkan pada diagram adalah benar.");
        jLabel70.setName("jLabel70"); // NOI18N
        FormInput.add(jLabel70);
        jLabel70.setBounds(0, 775, 460, 23);
        ...
        TnmDokter.setBounds(145, 831, 410, 23);
        ...
        BtnDokter.setBounds(560, 831, 28, 23);

        TtglProsedur.setEditable(false);
        TtglProsedur.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-09-2026" }));
        ...
        jLabel71.setBounds(0, 831, 140, 23);

        jLabel65.setForeground(new java.awt.Color(0, 0, 0));
        jLabel65.setText("Nama Keluarga Pasien :");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(0, 803, 140, 23);
        ...
        TnmKeluarga.setBounds(145, 803, 410, 23);
        ...
        panelSiteMarkingOdontogram.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        panelSiteMarkingOdontogram.setName("panelSiteMarkingOdontogram"); // NOI18N
        FormInput.add(panelSiteMarkingOdontogram);
        panelSiteMarkingOdontogram.setBounds(70, 130, 830, 640);

        Scroll1.setViewportView(FormInput);

        panelGlass9.add(Scroll1);

        PanelInput1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "[ Data Formulir Site Marking Odontogram ]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().equals("")) {
            ...
            if (Sequel.menyimpantf("formulir_site_marking_operasi_odontogram", "?,?,?,?,?,?,?,?,?", "No. Rawat", 9, new String[]{
                TNoRw.getText(), TrgRawat.getText(), Tprosedur.getText(), Valid.SetTgl(TtglProsedur.getSelectedItem() + ""),
                panelSiteMarkingOdontogram.getJsonCoretan(), TnmKeluarga.getText(), nipDokter, Sequel.cariIsi("select now()"), ""
            }) == true) {

                Sequel.SimpanHistoriRekamMedis(TNoRw.getText(), "Formulir Site Marking Odontogram", "Simpan");
    ...
    private void BtnGantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGantiActionPerformed
        if (TNoRw.getText().equals("")) {
            ...
            if (tbFormulir.getSelectedRow() > -1) {
                if (Sequel.mengedittf("formulir_site_marking_operasi_odontogram", "waktu_simpan=?", "prosedur=?, tgl_prosedur=?, data_koordinat=?, "
                        + "nm_keluarga_pasien=?, nip_dokter=?", 6, new String[]{
                            Tprosedur.getText(), Valid.SetTgl(TtglProsedur.getSelectedItem() + ""), panelSiteMarkingOdontogram.getJsonCoretan(),
                            TnmKeluarga.getText(), nipDokter,
                            tbFormulir.getValueAt(tbFormulir.getSelectedRow(), 11).toString()
                        }) == true) {

                    Sequel.SimpanHistoriRekamMedis(TNoRw.getText(), "Formulir Site Marking Odontogram", "Ganti");
                    TCari.setText(TNoRw.getText());
                    tampil();
                    emptTeks();
                }
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ((RMFormulirSiteMarkingOdontogram.Painter) gambarQR).setImage("");
        tampil();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbFormulir.getSelectedRow() > -1) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                if (Sequel.queryu2tf("delete from formulir_site_marking_operasi_odontogram where waktu_simpan=?", 1, new String[]{
                    tbFormulir.getValueAt(tbFormulir.getSelectedRow(), 11).toString()
                }) == true) {
                    if (!idFileTtd.equals("")) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tbFormulir.getSelectedRow() > -1) {
            ...
            BufferedImage imgSiteMarking = panelSiteMarkingOdontogram.getBufferedImage();
            ...
            if (cmbPilihCetak.getSelectedIndex() == 0) {
                ...
                if (nipDokter.equals("") || nipDokter.equals("-") || nipDokter.equals("--")) {
                    ...
                    isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                            + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='001'"),
                                    "Formulir Site Marking Odontogram", TnmDokter.getText(),
                                    Sequel.cariIsi("select date_format(waktu_simpan,'%d/%m/%Y') from formulir_site_marking_operasi_odontogram where "
                                            + "waktu_simpan='" + tbFormulir.getValueAt(tbFormulir.getSelectedRow(), 11).toString() + "'"),
                                    Sequel.cariIsi("select time(waktu_simpan) from formulir_site_marking_operasi_odontogram where "
                    ...
                    Valid.MyReport("rptFormulirSiteMarkingOdontogramQr.jasper", "report", "::[ Formulir Site Marking Odontogram ]::",
                ...
                Valid.MyReport("rptFormulirSiteMarkingOdontogram.jasper", "report", "::[ Formulir Site Marking Odontogram ]::",
                        "SELECT now() tanggal", param);
    ...
    private void BtnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterActionPerformed
        akses.setform("RMFormulirSiteMarkingOdontogram");
        dokter.isCek();
    ...
    private void BtnHapusCoretanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusCoretanActionPerformed
        panelSiteMarkingOdontogram.hapusCoretan();
                    ...
                    if (inet.isReachable(100)) {
                        if (idFileTtd.equals("")) {
                            ...
                            if (Sequel.hapusFileTTD(idFileTtd) == true) {
                                Sequel.mengedit("formulir_site_marking_operasi_odontogram", "waktu_simpan='" + tbFormulir.getValueAt(tbFormulir.getSelectedRow(), 11).toString() + "'",
    ...
    private void MnBikinQrCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBikinQrCodeActionPerformed
        if (tbFormulir.getSelectedRow() > -1) {
            ((RMFormulirSiteMarkingOdontogram.Painter) gambarQR).setImage("");
            if (Sequel.cariInteger("select count(-1) from master_nomor_dokumen_erm where nm_dokumen like '%FORMULIR SITE MARKING ODONTOGRAM%'") > 0) {
                bikinQR();
            } else {
        ...
        if (cmbRM.getSelectedIndex() != 0) {
            ...
            try {
                ...
                for (int I = 0; hasil.next(); I++) {
                    ...
                    ((RMFormulirSiteMarkingOdontogram.Painter) gambarQR).setImageIcon(new javax.swing.ImageIcon(
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMFormulirSiteMarkingOdontogram dialog = new RMFormulirSiteMarkingOdontogram(new javax.swing.JFrame(), true);
    ...
    private widget.PanelSiteMarkingOdontogram panelSiteMarkingOdontogram;
    ...
    public void tampil() {  
        ...
        try {
            ps = koneksi.prepareStatement("select fs.*, p.no_rkm_medis, p.nm_pasien, date_format(p.tgl_lahir,'%d-%m-%Y') tgllahir, pg.nama nmdokter "
                    + "from formulir_site_marking_operasi_odontogram fs inner join reg_periksa rp on rp.no_rawat=fs.no_rawat "
    ...
    private void getData() {
        ...
        if (tbFormulir.getSelectedRow() != -1) {
            ...
            panelSiteMarkingOdontogram.setJsonCoretan(tbFormulir.getValueAt(tbFormulir.getSelectedRow(), 9).toString());
    ...
    private void bikinQR() {
        ...
        Valid.cetakQrTte(URL, Sequel.cariFolderTte(), "QRTte.jpg", "select logo from setting");
        Sequel.menyimpanQrTte("parameter_ttd_rme", "'" + idParameterTtd + "','" + usernya + "','" + pwdnya + "','" + TNoRw.getText() + "','" + TNoRM.getText() + "','"
                + Sequel.cariIsi("select kode_erm from master_nomor_dokumen_erm where nm_dokumen like '%FORMULIR SITE MARKING ODONTOGRAM%'") + "',"
                + "'" + Sequel.cariIsi("select now()") + "'", "file QRCode URL Ttd", Sequel.cariFolderPrintTte());
