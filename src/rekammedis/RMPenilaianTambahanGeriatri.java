...
public final class RMPenilaianTambahanGeriatri extends javax.swing.JDialog {
    ...
    public RMPenilaianTambahanGeriatri(java.awt.Frame parent, boolean modal) {
        ...
        tbGeriatri.setModel(tabMode);
        tbGeriatri.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbGeriatri.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 35; i++) {
            TableColumn column = tbGeriatri.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbGeriatri.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("RMPenilaianTambahanGeriatri")) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Tambahan Pasien Geriatri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2022 13:54:15" }));
        ...
        DiagnosaMedis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KondisiMasuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganKondisiMasuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AsalMasuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        InfeksiTelinga.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Sinus.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Pneumonia.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Abses.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Sariawan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MemerlukanAntibitotika.setForeground(new java.awt.Color(0, 0, 0));
        ...
        InfeksiDalam.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Immunodefisiensi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JenisKanker.setForeground(new java.awt.Color(0, 0, 0));
        ...
        InfeksiOportunistik.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Mobilitas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PerawatanDiri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AktivitasSeharihari.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NyeriTidakNyaman.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IstirahatTidur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganIstirahat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganPenggunaanObatTidur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PenggunaanObatTidur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Olahraga.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganOlahraga.setForeground(new java.awt.Color(0, 0, 0));
        ...
        tbGeriatri.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbGeriatri.setComponentPopupMenu(jPopupMenu1);
        tbGeriatri.setName("tbGeriatri"); // NOI18N
        tbGeriatri.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbGeriatriMouseClicked(evt);
            }
        });
        tbGeriatri.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbGeriatriKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbGeriatri);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbGeriatri.getSelectedRow() > -1) {
            if (akses.getkode().equals("Admin Utama")) {
                hapus();
            } else {
                if (KdPetugas.getText().equals(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 5).toString())) {
                    hapus();
                } else {
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                if (TCari.getText().trim().equals("")) {
                    ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,ptg.tanggal, "
                            + "ptg.nik,pg.nama,ptg.asal_masuk,ptg.kondisi_masuk,ptg.keterangan_kondisi_masuk, "
                            + "ptg.anamnesis,ptg.diagnosa_medis,ptg.riwayat_immuno_telinga,ptg.riwayat_immuno_sinus, "
                            + "ptg.riwayat_immuno_antibiotik,ptg.riwayat_immuno_pneumonia,ptg.riwayat_immuno_abses, "
                            + "ptg.riwayat_immuno_sariawan,ptg.riwayat_immuno_memerlukan_antibiotik,ptg.riwayat_immuno_infeksi_dalam, "
                            + "ptg.riwayat_immuno_immunodefisiensi_primer,ptg.riwayat_immuno_jenis_kangker,ptg.riwayat_immuno_infeksi_oportunistik, "
                            + "ptg.pola_aktifitas_tidur,ptg.keterangan_pola_aktifitas_tidur,ptg.pola_aktifitas_obat_tidur, "
                            + "ptg.keterangan_pola_aktifitas_obat_tidur,ptg.pola_aktifitas_olahraga,ptg.keterangan_pola_aktifitas_olahraga, "
                            + "ptg.kualitas_hidup_mobilitas,ptg.kualitas_hidup_perawatan_diri,ptg.kualitas_hidup_aktifitas_seharihari, "
                            + "ptg.kualitas_hidup_rasa_nyeri,ptg.skala_nyeri FROM reg_periksa INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                            + "INNER JOIN penilaian_tambahan_geriatri ptg ON rp.no_rawat = ptg.no_rawat INNER JOIN pegawai pg ON ptg.nik = pg.nik "
                            + "WHERE ptg.tanggal BETWEEN ? AND ? ORDER BY ptg.tanggal");
                } else {
                    ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,ptg.tanggal, "
                            + "ptg.nik,pg.nama,ptg.asal_masuk,ptg.kondisi_masuk,ptg.keterangan_kondisi_masuk, "
                            + "ptg.anamnesis,ptg.diagnosa_medis,ptg.riwayat_immuno_telinga,ptg.riwayat_immuno_sinus, "
                            ...
                            + "ptg.keterangan_pola_aktifitas_obat_tidur,ptg.pola_aktifitas_olahraga,ptg.keterangan_pola_aktifitas_olahraga, "
                            + "ptg.kualitas_hidup_mobilitas,ptg.kualitas_hidup_perawatan_diri,ptg.kualitas_hidup_aktifitas_seharihari, "
                            + "ptg.kualitas_hidup_rasa_nyeri,ptg.skala_nyeri FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                            + "INNER JOIN penilaian_tambahan_geriatri ptg ON rp.no_rawat = ptg.no_rawat INNER JOIN pegawai pg ON ptg.nik = pg.nik "
                            + "WHERE ptg.tanggal BETWEEN ? AND ? AND (rp.no_rawat LIKE ? OR p.no_rkm_medis LIKE ? OR p.nm_pasien LIKE ? OR ptg.nik LIKE ? OR pg.nama LIKE ?) "
                            + "ORDER BY ptg.tanggal");
                }
    ...
    private void tbGeriatriMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGeriatriMouseClicked
        if (tabMode.getRowCount() != 0) {
            try {
                getData();
            } catch (java.lang.NullPointerException e) {
            }
            if ((evt.getClickCount() == 2) && (tbGeriatri.getSelectedColumn() == 0)) {
                TabRawat.setSelectedIndex(0);
            }
        }
}//GEN-LAST:event_tbGeriatriMouseClicked

    private void tbGeriatriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbGeriatriKeyPressed
        if (tabMode.getRowCount() != 0) {
...
}//GEN-LAST:event_tbGeriatriKeyPressed

    private void BtnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPetugasActionPerformed
        akses.setform("RMPenilaianTambahanGeriatri");
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbGeriatri.getSelectedRow() > -1) {
            ...
            Valid.MyReport("rptCetakPenilaianTambahanGeriatri.jasper", "report", "::[ Laporan Penilaian Tambahan Geriatri ]::",
                    ...
                    + "where penilaian_tambahan_geriatri.no_rawat='" + tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 0).toString() + "'", param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    */
    ...
    private widget.Table tbGeriatri;
    ...
    public void tampil() {
        ...
        try {
            if (TCari.getText().trim().equals("")) {
                ps = koneksi.prepareStatement("select rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF (p.jk = 'L','Laki-Laki','Perempuan') jk, "
                        + "date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir, ptg.tanggal, ptg.nik, pg.nama, ptg.asal_masuk, ptg.kondisi_masuk, "
                        + "ptg.keterangan_kondisi_masuk, ptg.anamnesis, ptg.diagnosa_medis, ptg.riwayat_immuno_telinga, ptg.riwayat_immuno_sinus, "
                        + "ptg.riwayat_immuno_antibiotik, ptg.riwayat_immuno_pneumonia, ptg.riwayat_immuno_abses, "
                        + "ptg.riwayat_immuno_sariawan, ptg.riwayat_immuno_memerlukan_antibiotik, ptg.riwayat_immuno_infeksi_dalam, "
                        + "ptg.riwayat_immuno_immunodefisiensi_primer, ptg.riwayat_immuno_jenis_kangker, ptg.riwayat_immuno_infeksi_oportunistik, "
                        + "ptg.pola_aktifitas_tidur, ptg.keterangan_pola_aktifitas_tidur, ptg.pola_aktifitas_obat_tidur, "
                        + "ptg.keterangan_pola_aktifitas_obat_tidur, ptg.pola_aktifitas_olahraga, ptg.keterangan_pola_aktifitas_olahraga, "
                        + "ptg.kualitas_hidup_mobilitas, ptg.kualitas_hidup_perawatan_diri, ptg.kualitas_hidup_aktifitas_seharihari, "
                        + "ptg.kualitas_hidup_rasa_nyeri, ptg.skala_nyeri FROM reg_periksa rp "
                        + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis INNER JOIN penilaian_tambahan_geriatri ptg ON rp.no_rawat = ptg.no_rawat "
                        + "INNER JOIN pegawai pg ON ptg.nik = pg.nik WHERE ptg.tanggal BETWEEN ? AND ? ORDER BY ptg.tanggal");
            } else {
                ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk, "
                        + "date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir,ptg.tanggal, ptg.nik,pg.nama,ptg.asal_masuk,ptg.kondisi_masuk,"
                        + "ptg.keterangan_kondisi_masuk, ptg.anamnesis,ptg.diagnosa_medis,ptg.riwayat_immuno_telinga,ptg.riwayat_immuno_sinus, "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kondisi_masuk"), 
                        rs.getString("keterangan_kondisi_masuk"), 
                        rs.getString("anamnesis"), 
                        rs.getString("diagnosa_medis"), 
                        rs.getString("asal_masuk"), 
                        rs.getString("riwayat_immuno_telinga"),
                        rs.getString("riwayat_immuno_sinus"), 
                        rs.getString("riwayat_immuno_antibiotik"), 
                        rs.getString("riwayat_immuno_pneumonia"), 
                        rs.getString("riwayat_immuno_abses"), 
                        rs.getString("riwayat_immuno_sariawan"),
                        ...
                        rs.getString("kualitas_hidup_perawatan_diri"), 
                        rs.getString("kualitas_hidup_mobilitas"), 
                        rs.getString("kualitas_hidup_aktifitas_seharihari"),
                        rs.getString("kualitas_hidup_rasa_nyeri"), 
                        rs.getString("skala_nyeri"), 
                        rs.getString("pola_aktifitas_tidur"), 
                        rs.getString("keterangan_pola_aktifitas_tidur"), 
    ...
    private void getData() {
        if (tbGeriatri.getSelectedRow() != -1) {
            TNoRw.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 0).toString());
            TNoRM.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 1).toString());
            TPasien.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 2).toString());
            TglLahir.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 3).toString());
            Jk.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 4).toString());
            KdPetugas.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 5).toString());
            NmPetugas.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 6).toString());
            KondisiMasuk.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 8).toString());
            KeteranganKondisiMasuk.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 9).toString());
            Anamnesis.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 10).toString());
            DiagnosaMedis.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 11).toString());
            AsalMasuk.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 12).toString());
            InfeksiTelinga.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 13).toString());
            Sinus.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 14).toString());
            Antibiotik.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 15).toString());
            Pneumonia.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 16).toString());
            Abses.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 17).toString());
            Sariawan.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 18).toString());
            MemerlukanAntibitotika.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 19).toString());
            InfeksiDalam.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 20).toString());
            Immunodefisiensi.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 21).toString());
            JenisKanker.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 22).toString());
            InfeksiOportunistik.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 23).toString());
            PerawatanDiri.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 24).toString());
            Mobilitas.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 25).toString());
            AktivitasSeharihari.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 26).toString());
            NyeriTidakNyaman.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 27).toString());
            SkalaNyeri.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 28).toString());
            IstirahatTidur.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 29).toString());
            KeteranganIstirahat.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 30).toString());
            PenggunaanObatTidur.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 31).toString());
            KeteranganPenggunaanObatTidur.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 32).toString());
            Olahraga.setSelectedItem(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 33).toString());
            KeteranganOlahraga.setText(tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 34).toString());
            Valid.SetTgl2(TglAsuhan, tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 7).toString());
        }
    }
    ...
    private void isRawat() {
        try {
            ps = koneksi.prepareStatement("select rp.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-Laki','Perempuan') jk, "
                    + "date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir, rp.tgl_registrasi from reg_periksa rp "
                    + "inner join pasien p on rp.no_rkm_medis=p.no_rkm_medis where rp.no_rawat=?");
            try {
    ...
    public void setNoRm(String norwt, Date tgl2, String kdptgs, String nmdok) {
        TNoRw.setText(norwt);
        TCari.setText(norwt);
        DTPCari2.setDate(tgl2);
        KdPetugas.setText(kdptgs);
        NmPetugas.setText(nmdok);
        isRawat();
    }
    
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_pasien_geriatri());
        BtnHapus.setEnabled(akses.getpenilaian_pasien_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_pasien_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_pasien_geriatri());
        if (akses.getjml2() >= 1) {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_tambahan_geriatri where no_rawat=? and tanggal=?", 2, new String[]{
            tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 0).toString(), tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 7).toString()
        }) == true) {
            tampil();
            TabRawat.setSelectedIndex(1);
        } else {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_tambahan_geriatri", "no_rawat=?", "no_rawat=?,tanggal=?,nik=?,asal_masuk=?,kondisi_masuk=?,keterangan_kondisi_masuk=?,anamnesis=?,diagnosa_medis=?,"
                ...
                + "skala_nyeri=?", 31, new String[]{
                    ...
                    Olahraga.getSelectedItem().toString(), KeteranganOlahraga.getText(), Mobilitas.getSelectedItem().toString(), PerawatanDiri.getSelectedItem().toString(),
                    AktivitasSeharihari.getSelectedItem().toString(), NyeriTidakNyaman.getSelectedItem().toString(), SkalaNyeri.getSelectedItem().toString(),
                    tbGeriatri.getValueAt(tbGeriatri.getSelectedRow(), 0).toString()
                }) == true) {
            tampil();
            emptTeks();
            TabRawat.setSelectedIndex(1);
