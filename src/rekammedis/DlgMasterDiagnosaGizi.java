 ...
 * @author dosen
 */
public class DlgMasterDiagnosaGizi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMasterDiagnosaGizi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{
            "Kode Diagnosa", "Nama Diagnosa Gizi"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Master Diagnosa Gizi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        kdDiagnosa.setBounds(103, 10, 90, 23);

        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Nama Diagnosa : ");
        ...
        TDiagnosa.setBounds(103, 38, 630, 23);
        ...
        tbDiagnosa.setToolTipText("Silahkan klik untuk memilih data yang diperbaiki");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdDiagnosa.getText().trim().equals("")) {
            Valid.textKosong(kdDiagnosa, "kode diagnosa");
            kdDiagnosa.requestFocus();
        } else if (TDiagnosa.getText().trim().equals("")) {
            Valid.textKosong(TDiagnosa, "nama diagnosa gizi");
            TDiagnosa.requestFocus();
        } else {
            Sequel.menyimpan("katalog_diagnosa_gizi", "'" + kdDiagnosa.getText() + "','" + TDiagnosa.getText() + "'", "Diagnosa Gizi");
            emptTeks();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,kdDiagnosa,BtnBatal);
        }
    ...
    private void BtnGantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGantiActionPerformed
        if (kdDiagnosa.getText().trim().equals("")) {
            ...
            Sequel.mengedit("katalog_diagnosa_gizi", "kd_diagnosa_gizi='" + kode + "'",
                    "kd_diagnosa_gizi='" + kdDiagnosa.getText() + "',deskripsi_diagnosa='" + TDiagnosa.getText() + "'");
            emptTeks();
            BtnCariActionPerformed(null);
        }
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnCari, kdDiagnosa);
        }
    ...
    private void kdDiagnosaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdDiagnosaKeyPressed
        Valid.pindah(evt, kdDiagnosa, TDiagnosa);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMasterDiagnosaGizi dialog = new DlgMasterDiagnosaGizi(new javax.swing.JFrame(), true);
    ...
    public void tampil() {     
        ...
        try {
            ps = koneksi.prepareStatement("SELECT * FROM katalog_diagnosa_gizi WHERE kd_diagnosa_gizi LIKE ? or "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{                        
                        rs.getString("kd_diagnosa_gizi"),
                        rs.getString("deskripsi_diagnosa")
                    });
                }
                this.setCursor(Cursor.getDefaultCursor());
            } catch (Exception e) {
                System.out.println("rekammedis.DlgMasterDiagnosaGizi.tampil() : " + e);
            } finally {
                if (rs != null) {
                    rs.close();
                }
    ...
    private void getData() {
        ...
        if (tbDiagnosa.getSelectedRow() != -1) {
            kdDiagnosa.setText(tbDiagnosa.getValueAt(tbDiagnosa.getSelectedRow(), 0).toString());
            TDiagnosa.setText(tbDiagnosa.getValueAt(tbDiagnosa.getSelectedRow(), 1).toString());
            kode = kdDiagnosa.getText();
        }
    }
