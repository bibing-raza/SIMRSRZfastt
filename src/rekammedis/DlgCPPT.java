...
public class DlgCPPT extends javax.swing.JDialog {
    ...
    private String status = "", cekjam = "", statusOK = "", nipppa = "", kdItemrad = "", itemDipilih = "",
            tglRad = "", jamRad = "", jamkeluar = "", serahterima = "", jamserahterima = "", nipkonsul1 = "", nipkonsul2 = "";
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgCPPT")) {
                    if (pilihan == 1) {
                        ...
                        if (dokter.getTable().getSelectedRow() != -1) {
                            nipkonsul1 = dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 0).toString();
                            nmKonsulen1.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 1).toString());
                            BtnKonsulen1.requestFocus();
                        }
                    } else if (pilihan == 3) {
                        if (dokter.getTable().getSelectedRow() != -1) {
                            nipkonsul2 = dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 0).toString();
                            nmKonsulen2.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 1).toString());
                            BtnKonsulen2.requestFocus();
                        }
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        ChkSerahTerima = new widget.CekBox();
        tglserah = new widget.Tanggal();
        ChkJamSerah = new widget.CekBox();
        cmbJam1 = new widget.ComboBox();
        cmbMnt1 = new widget.ComboBox();
        cmbDtk1 = new widget.ComboBox();
        jLabel18 = new widget.Label();
        nmKonsulen1 = new widget.TextBox();
        BtnKonsulen1 = new widget.Button();
        jLabel20 = new widget.Label();
        nmKonsulen2 = new widget.TextBox();
        ...
        BtnBaca.setBounds(97, 95, 110, 30);

        tglA.setEditable(false);
        tglA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2023" }));
        ...
        tglB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2023" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2023" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2023" }));
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(44, 500));
        ...
        jLabel14.setBounds(635, 409, 70, 23);
        ...
        cmbVerifikasi.setBounds(710, 409, 65, 23);
        ...
        tglCppt.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2023" }));
        ...
        jLabel4.setBounds(0, 381, 180, 23);
        ...
        BtnPPA.setBounds(784, 381, 28, 23);
        ...
        ChkSerahTerima.setForeground(new java.awt.Color(0, 0, 0));
        ChkSerahTerima.setText("Tgl. Serah Terima CPPT :");
        ChkSerahTerima.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ChkSerahTerima.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkSerahTerima.setName("ChkSerahTerima"); // NOI18N
        ChkSerahTerima.setOpaque(false);
        ChkSerahTerima.setPreferredSize(new java.awt.Dimension(175, 23));
        ChkSerahTerima.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkSerahTerimaActionPerformed(evt);
            }
        });
        panelGlass7.add(ChkSerahTerima);
        ChkSerahTerima.setBounds(0, 409, 180, 23);

        tglserah.setEditable(false);
        tglserah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2023" }));
        tglserah.setDisplayFormat("dd-MM-yyyy");
        tglserah.setName("tglserah"); // NOI18N
        tglserah.setOpaque(false);
        tglserah.setPreferredSize(new java.awt.Dimension(90, 23));
        panelGlass7.add(tglserah);
        tglserah.setBounds(185, 409, 90, 23);

        ChkJamSerah.setBackground(new java.awt.Color(255, 255, 250));
        ChkJamSerah.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 250)));
        ChkJamSerah.setForeground(new java.awt.Color(0, 0, 0));
        ChkJamSerah.setText("Jam Serah Terima :");
        ChkJamSerah.setBorderPainted(true);
        ChkJamSerah.setBorderPaintedFlat(true);
        ChkJamSerah.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ChkJamSerah.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkJamSerah.setName("ChkJamSerah"); // NOI18N
        ChkJamSerah.setOpaque(false);
        ChkJamSerah.setPreferredSize(new java.awt.Dimension(175, 23));
        ChkJamSerah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkJamSerahActionPerformed(evt);
            }
        });
        panelGlass7.add(ChkJamSerah);
        ChkJamSerah.setBounds(275, 409, 120, 23);
        ...
        cmbJam1.setBounds(401, 409, 45, 23);
        ...
        cmbMnt1.setBounds(452, 409, 45, 23);
        ...
        cmbDtk1.setBounds(504, 409, 45, 23);
        ...
        panelGlass7.add(BtnKonsulen1);
        BtnKonsulen1.setBounds(784, 325, 28, 23);
        ...
        panelGlass7.add(BtnKonsulen2);
        BtnKonsulen2.setBounds(784, 353, 28, 23);

        jLabel22.setForeground(new java.awt.Color(0, 0, 0));
        jLabel22.setText("Petugas Yang Menyerahkan :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass7.add(jLabel22);
        jLabel22.setBounds(0, 437, 180, 23);
        ...
        nipSerah.setBounds(186, 437, 130, 23);
        ...
        nmSerah.setBounds(320, 437, 460, 23);
        ...
        nipTerima.setBounds(186, 465, 130, 23);
        ...
        nmTerima.setBounds(320, 465, 460, 23);
        ...
        BtnTerima.setBounds(784, 465, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (ChkSerahTerima.isSelected() == true) {
                serahterima = "ya";
            } else {
                serahterima = "tidak";
            }
            
            if (ChkJamSerah.isSelected() == true) {
                jamserahterima = "ya";
            } else {
                jamserahterima = "tidak";
            }
    ...
    private void ChkSerahTerimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkSerahTerimaActionPerformed
        if (ChkSerahTerima.isSelected() == true) {
            tglserah.setDate(new Date());
            ChkJamSerah.setSelected(false);
            cmbJam1.setSelectedIndex(0);
            cmbMnt1.setSelectedIndex(0);
            cmbDtk1.setSelectedIndex(0);
            
            tglserah.setEnabled(true);
            ChkJamSerah.setEnabled(true);
            ...
            cmbMnt1.setSelectedIndex(0);
            cmbDtk1.setSelectedIndex(0);
            tglserah.setEnabled(false);
            ChkJamSerah.setEnabled(false);
            cmbJam1.setEnabled(false);
            cmbMnt1.setEnabled(false);
            cmbDtk1.setEnabled(false);
            BtnSerah.setEnabled(false);
    ...
    }//GEN-LAST:event_ChkSerahTerimaActionPerformed

    private void ChkJamSerahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJamSerahActionPerformed
        if (ChkJamSerah.isSelected() == true) {
            cmbJam1.setSelectedIndex(0);
            cmbMnt1.setSelectedIndex(0);
            cmbDtk1.setSelectedIndex(0);
    ...
    }//GEN-LAST:event_ChkJamSerahActionPerformed
    ...
    */
    ...
    public widget.CekBox ChkJamSerah;
    public widget.CekBox ChkSamaPPA;
    public widget.CekBox ChkSerahTerima;
    ...
    private widget.TextBox nmKonsulen1;
    private widget.TextBox nmKonsulen2;
    ...
    private widget.Tanggal tglserah;
        ...
        try {
            if (cmbRawat.getSelectedIndex() == 0) {
                ps = koneksi.prepareStatement("SELECT c.no_rawat, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') tgllhr, "
                        ...
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and c.no_rawat like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and p.no_rkm_medis like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and p.nm_pasien like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and c.hasil_pemeriksaan like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and c.instruksi_nakes like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and c.verifikasi like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and c.jenis_bagian like ? or "
                        + "c.tgl_cppt between ? and ? and c.cppt_shift like '%" + cmbSiftCppt.getSelectedItem() + "%' and pg.nama like ? order by c.waktu_simpan desc");
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("cek_serah_terima"),
                        rs.getString("tgl_serah_terima"),
                        rs.getString("cek_jam_serah_terima"),
                        rs.getString("jam_serah_terima"),
                        rs.getString("nmkonsulen1"),
                        rs.getString("nmkonsulen2"),
    ...
    private void emptTeks() {
        ...
        nipppa = "-";
        cmbBagian.setSelectedIndex(0);
        ChkSerahTerima.setSelected(false);
    ...
    private void dataCek() {
        ...
        if (serahterima.equals("ya")) {
            ChkSerahTerima.setSelected(true);
            tglserah.setEnabled(true);
            ChkJamSerah.setEnabled(true);
            ChkJamSerah.setSelected(true);
            cmbJam1.setEnabled(true);
            cmbMnt1.setEnabled(true);
            cmbDtk1.setEnabled(true);
            BtnSerah.setEnabled(true);
    ...
    private void cetakCPPTranap() {
        ...
        if (cmbTanggal.getSelectedIndex() == 0) {
            if (cmbSiftPetugas.getSelectedIndex() == 0) {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI (Rawat Inap), Shift : -");
            } else {
            ...
            Valid.MyReport("rptCPPT.jasper", "report", "::[ Laporan CPPT Rawat Inap ]::",
                    ...
                    + "AND c.STATUS='Ranap' and cppt_shift like '%" + cmbSiftPetugas.getSelectedItem().toString() + "%' ORDER BY c.waktu_simpan", param);
        
        //periode    
        } else if (cmbTanggal.getSelectedIndex() == 1) {
            if (cmbSiftPetugas.getSelectedIndex() == 0) {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI (Rawat Inap) Tgl. " + tglA.getSelectedItem() + " S.D Tgl. " + tglB.getSelectedItem() + ", Shift : -");
            } else {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI (Rawat Inap) Tgl. " + tglA.getSelectedItem() + " S.D Tgl. " + tglB.getSelectedItem() + ", Shift : " + cmbSiftPetugas.getSelectedItem().toString());
            }
            Valid.MyReport("rptCPPT.jasper", "report", "::[ Laporan CPPT Periode Rawat Inap ]::",
                    ...
                    + "FROM cppt c INNER JOIN reg_periksa rp ON rp.no_rawat = c.no_rawat INNER JOIN pasien p ON p.no_rkm_medis = rp.no_rkm_medis "
                    + "INNER JOIN pegawai pg ON pg.nik = c.nip_dpjp WHERE c.no_rawat = '" + TNoRw.getText() + "' "
                    + "AND c.STATUS='Ranap' and tgl_cppt between '" + Valid.SetTgl(tglA.getSelectedItem() + "") + "' and '" + Valid.SetTgl(tglB.getSelectedItem() + "") + "' "
                    + "and cppt_shift like '%" + cmbSiftPetugas.getSelectedItem().toString() + "%' ORDER BY c.waktu_simpan", param);
        
        //pertanggal
        } else if (cmbTanggal.getSelectedIndex() == 2) {
            if (cmbSiftPetugas.getSelectedIndex() == 0) {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI (Rawat Inap) Tgl. " + tglA.getSelectedItem() + ", Shift : -");
            } else {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI (Rawat Inap) Tgl. " + tglA.getSelectedItem() + ", Shift : " + cmbSiftPetugas.getSelectedItem().toString());
            }
            Valid.MyReport("rptCPPT.jasper", "report", "::[ Laporan CPPT PerTanggal Rawat Inap ]::",
                    ...
                    + "FROM cppt c INNER JOIN reg_periksa rp ON rp.no_rawat = c.no_rawat INNER JOIN pasien p ON p.no_rkm_medis = rp.no_rkm_medis "
                    + "INNER JOIN pegawai pg ON pg.nik = c.nip_dpjp WHERE c.no_rawat = '" + TNoRw.getText() + "' "
                    + "AND c.STATUS='Ranap' and tgl_cppt='" + Valid.SetTgl(tglA.getSelectedItem() + "") + "' "
                    + "and cppt_shift like '%" + cmbSiftPetugas.getSelectedItem().toString() + "%' ORDER BY c.waktu_simpan", param);
        }
    ...
    private void cetakCPPTsemua() {
        ...
        if (cmbTanggal.getSelectedIndex() == 0) {
            if (cmbSiftPetugas.getSelectedIndex() == 0) {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI Shift : -");
            } else {
        ...
        //periode
            ...
            if (cmbSiftPetugas.getSelectedIndex() == 0) {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI Tgl. " + tglA.getSelectedItem() + " S.D Tgl. " + tglB.getSelectedItem() + ", Shift : -");
            } else {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI Tgl. " + tglA.getSelectedItem() + " S.D Tgl. " + tglB.getSelectedItem() + ", Shift : " + cmbSiftPetugas.getSelectedItem().toString());
            }
            Valid.MyReport("rptCPPT.jasper", "report", "::[ Laporan CPPT Pasien ]::",
                    "SELECT p.no_rkm_medis, p.nm_pasien, date_format(p.tgl_lahir, '%d-%m-%Y') tgllhr, "
                    + "if(c.cek_jam='ya',concat(date_format(c.tgl_cppt, '%d-%m-%Y'),', ',date_format(c.jam_cppt, '%H:%i')),date_format(c.tgl_cppt, '%d-%m-%Y')) tglcppt, "
        ...
        //pertanggal
            ...
            if (cmbSiftPetugas.getSelectedIndex() == 0) {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI Tgl. " + tglA.getSelectedItem() + ", Shift : -");
            } else {
                param.put("judul", "CATATAN PERKEMBANGAN PASIEN TERINTEGRASI Tgl. " + tglA.getSelectedItem() + ", Shift : " + cmbSiftPetugas.getSelectedItem().toString());
            }
            Valid.MyReport("rptCPPT.jasper", "report", "::[ Laporan CPPT Pasien ]::",
                    "SELECT p.no_rkm_medis, p.nm_pasien, date_format(p.tgl_lahir, '%d-%m-%Y') tgllhr, "
                    + "if(c.cek_jam='ya',concat(date_format(c.tgl_cppt, '%d-%m-%Y'),', ',date_format(c.jam_cppt, '%H:%i')),date_format(c.tgl_cppt, '%d-%m-%Y')) tglcppt, "
                    ...
                    + "FROM cppt c INNER JOIN reg_periksa rp ON rp.no_rawat = c.no_rawat INNER JOIN pasien p ON p.no_rkm_medis = rp.no_rkm_medis "
                    + "INNER JOIN pegawai pg ON pg.nik = c.nip_dpjp WHERE c.no_rawat = '" + TNoRw.getText() + "' "
                    + "and tgl_cppt='" + Valid.SetTgl(tglA.getSelectedItem() + "") + "' "
                    + "and cppt_shift like '%" + cmbSiftPetugas.getSelectedItem().toString() + "%' ORDER BY c.waktu_simpan", param);
        }
