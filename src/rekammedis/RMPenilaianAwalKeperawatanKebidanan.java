...
public final class RMPenilaianAwalKeperawatanKebidanan extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanKebidanan(java.awt.Frame parent, boolean modal) {
        ...
        DlgRiwayatPersalinan.setSize(673, 204);
        ...
        tabModeRiwayatKehamilan=new DefaultTableModel(null,new Object[]{
                "No", "Tgl/Thn", "Tempat Persalinan", "Usia Hamil", "Jenis Persalinan", "Penolong", "Penyulit", "J.K.", "BB/PB", "Keadaan", "waktu_simpan"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tbRiwayatKehamilan.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tbRiwayatKehamilan.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        tbRiwayatKehamilan.getColumnModel().getColumn(7).setCellRenderer(centerRenderer);
        ...
        //ini posisi kolom yang datanya ingin rata tengah
        tbRiwayatKehamilan1.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tbRiwayatKehamilan1.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        tbRiwayatKehamilan1.getColumnModel().getColumn(7).setCellRenderer(centerRenderer);
        ...
        TanggalPersalinan.setDocument(new batasInput((byte) 12).getKata(TanggalPersalinan));
    ...
    private void initComponents() {
        ...
        TanggalPersalinan = new widget.TextBox();
        ...
        internalFrame4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Riwayat Persalinan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        BtnKeluarKehamilan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        UsiaHamil.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnSimpanRiwayatKehamilan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TempatPersalinan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JenisPersalinan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Penolong.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Penyulit.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TanggalPersalinan.setForeground(new java.awt.Color(0, 0, 0));
        TanggalPersalinan.setHighlighter(null);
        TanggalPersalinan.setName("TanggalPersalinan"); // NOI18N
        TanggalPersalinan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TanggalPersalinanKeyPressed(evt);
            }
        });
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Penilaian Awal Keperawatan Rawat Jalan Kebidanan & Kandungan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 1763));

        FormInput.setBackground(new java.awt.Color(255, 255, 255));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1852));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-10-2025 08:13:22" }));
        ...
        LILA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Presentasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Penurunan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Kekuatan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lamanya.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BJJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganBJJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Portio.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LabelServiks.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PembukaanServiks.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Hodge.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganInspekulo.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Inspekulo.setForeground(new java.awt.Color(0, 0, 0));
        ...
        CTG.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganCTG.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Laboratorium.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganLaboratorium.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusKawin1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganUSG.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Lakmus.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganLakmus.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PemeriksaanPanggul.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeluhanUtama.setPreferredSize(new java.awt.Dimension(162, 1000));
        ...
        scrollPane1.setBounds(129, 390, 725, 40);
        ...
        Lama.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Banyaknya.setForeground(new java.awt.Color(0, 0, 0));
        ...
        HaidTerakhir.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Siklus.setForeground(new java.awt.Color(0, 0, 0));
        ...
        USG.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetSiklus.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusMenikah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        UsiaKawin1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetSiklus2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        UsiaKawin3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusKawin3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        UsiaKawin2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusKawin2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KaliMenikah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        HPHT.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-10-2025" }));
        ...
        TP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-10-2025" }));
        ...
        RiwayatImunisasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JumlahImunisasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Hidup.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Scroll6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "[ Riwayat Persalinan ]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        BtnTambahMasalah.setBounds(865, 690, 190, 23);

        BtnHapusRiwayatPersalinan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnHapusRiwayatPersalinan.setText("Hapus Riw. Persalinan");
        ...
        BtnHapusRiwayatPersalinan.setBounds(865, 720, 180, 23);

        jLabel113.setForeground(new java.awt.Color(0, 0, 0));
        jLabel113.setText("Riwayat Ginekologi :");
        jLabel113.setName("jLabel113"); // NOI18N
        FormInput.add(jLabel113);
        jLabel113.setBounds(561, 884, 144, 23);

        RiwayatGenekologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        RiwayatGenekologi.setBounds(709, 884, 145, 23);

        jLabel114.setForeground(new java.awt.Color(0, 0, 0));
        jLabel114.setText("Riwayat KB :");
        jLabel114.setName("jLabel114"); // NOI18N
        FormInput.add(jLabel114);
        jLabel114.setBounds(0, 854, 105, 23);

        RiwayatKB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        RiwayatKB.setBounds(109, 854, 117, 23);

        jLabel115.setForeground(new java.awt.Color(0, 0, 0));
        jLabel115.setText("Lamanya :");
        jLabel115.setName("jLabel115"); // NOI18N
        FormInput.add(jLabel115);
        jLabel115.setBounds(235, 854, 60, 23);

        LamanyaKB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LamanyaKB.setBounds(299, 854, 60, 23);

        KomplikasiKB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KomplikasiKB.setBounds(441, 854, 100, 23);

        jLabel116.setForeground(new java.awt.Color(0, 0, 0));
        jLabel116.setText("Komplikasi :");
        jLabel116.setName("jLabel116"); // NOI18N
        FormInput.add(jLabel116);
        jLabel116.setBounds(370, 854, 67, 23);

        KeteranganKomplikasiKB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganKomplikasiKB.setBounds(545, 854, 309, 23);

        jLabel117.setForeground(new java.awt.Color(0, 0, 0));
        jLabel117.setText("Kapan Berhenti KB :");
        jLabel117.setName("jLabel117"); // NOI18N
        FormInput.add(jLabel117);
        jLabel117.setBounds(60, 884, 110, 23);

        BerhentiKB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BerhentiKB.setBounds(174, 884, 60, 23);

        jLabel118.setForeground(new java.awt.Color(0, 0, 0));
        jLabel118.setText("Alasan :");
        jLabel118.setName("jLabel118"); // NOI18N
        FormInput.add(jLabel118);
        jLabel118.setBounds(235, 884, 60, 23);

        AlasanBerhentiKB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KebiasaanObat.setBounds(174, 934, 185, 23);

        KebiasaanObatDiminum.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KebiasaanObatDiminum.setBounds(363, 934, 491, 23);
        ...
        jLabel121.setBounds(321, 964, 70, 23);

        KebiasaanMerokok.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KebiasaanMerokok.setBounds(174, 964, 80, 23);

        KebiasaanJumlahRokok.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KebiasaanJumlahRokok.setBounds(258, 964, 60, 23);

        jLabel122.setForeground(new java.awt.Color(0, 0, 0));
        jLabel122.setText("Merokok :");
        jLabel122.setName("jLabel122"); // NOI18N
        FormInput.add(jLabel122);
        jLabel122.setBounds(0, 964, 170, 23);
        ...
        jLabel123.setBounds(596, 964, 70, 23);

        KebiasaanAlkohol.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KebiasaanAlkohol.setBounds(449, 964, 80, 23);

        KebiasaanJumlahAlkohol.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KebiasaanJumlahAlkohol.setBounds(533, 964, 60, 23);

        jLabel124.setForeground(new java.awt.Color(0, 0, 0));
        jLabel124.setText("Alkohol :");
        jLabel124.setName("jLabel124"); // NOI18N
        FormInput.add(jLabel124);
        jLabel124.setBounds(380, 964, 65, 23);

        KebiasaanNarkoba.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jSeparator4.setBounds(0, 994, 880, 1);
        ...
        AlatBantu.setBounds(124, 1014, 90, 23);
        ...
        KetBantu.setBounds(218, 1014, 220, 23);
        ...
        Prothesa.setBounds(540, 1014, 90, 23);
        ...
        CacatFisik.setBounds(124, 1044, 314, 23);
        ...
        jSeparator5.setBounds(0, 1074, 880, 1);
        ...
        jLabel131.setBounds(10, 1074, 380, 23);
        ...
        StatusPsiko.setBounds(134, 1094, 110, 23);
        ...
        HubunganKeluarga.setBounds(289, 1144, 100, 23);
        ...
        TinggalDengan.setBounds(497, 1144, 110, 23);
        ...
        jLabel138.setBounds(0, 1174, 366, 23);
        ...
        StatusBudaya.setBounds(370, 1174, 110, 23);
        ...
        Edukasi.setBounds(370, 1204, 110, 23);
        ...
        FormInput.add(Agama);
        Agama.setBounds(86, 1204, 110, 23);
        ...
        jSeparator6.setBounds(0, 1234, 880, 1);
        ...
        jLabel144.setBounds(370, 1274, 400, 23);

        RJa2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel145.setBounds(0, 1304, 571, 23);

        RJb.setForeground(new java.awt.Color(0, 0, 0));
        ...
        FormInput.add(Lapor);
        Lapor.setBounds(575, 1334, 80, 23);
        ...
        jSeparator7.setBounds(0, 1364, 880, 1);
        ...
        jLabel149.setBounds(10, 1364, 380, 23);
        ...
        Nilai1.setBounds(774, 1384, 80, 23);
        ...
        jLabel152.setBounds(40, 1414, 460, 23);
        ...
        TotalHasil.setBounds(774, 1444, 80, 23);
        ...
        jLabel155.setBounds(10, 1474, 380, 23);
        ...
        jSeparator8.setBounds(0, 1474, 880, 1);
        ...
        PanelWall.setBounds(40, 1494, 320, 130);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(375, 1494, 130, 23);
        ...
        Provokes.setBounds(574, 1494, 130, 23);
        ...
        jSeparator9.setBounds(365, 1489, 1, 140);
        ...
        Quality.setBounds(429, 1524, 140, 23);
        ...
        Menyebar.setBounds(773, 1574, 80, 23);
        ...
        jLabel161.setBounds(815, 1604, 35, 23);
        ...
        jLabel162.setBounds(428, 1604, 60, 23);
        ...
        SkalaNyeri.setBounds(491, 1604, 70, 23);
        ...
        jLabel166.setBounds(480, 1634, 150, 23);
        ...
        NyeriHilang.setBounds(134, 1634, 130, 23);
        ...
        PadaDokter.setBounds(634, 1634, 80, 23);
        ...
        KetDokter.setBounds(774, 1634, 80, 23);
        ...
        jSeparator10.setBounds(0, 1664, 880, 1);
        ...
        jLabel168.setBounds(10, 1674, 120, 23);
        ...
        Tindakan.setPreferredSize(new java.awt.Dimension(162, 2000));
        ...
        scrollPane5.setBounds(453, 1694, 400, 143);
        ...
        jLabel169.setBounds(453, 1674, 120, 23);
        ...
        Masalah.setPreferredSize(new java.awt.Dimension(162, 2000));
        ...
        scrollPane8.setBounds(10, 1694, 400, 143);

        UsiaKehamilan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        scrollPane9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)), "Riwayat Persalinan :", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 11))); // NOI18N
        ...
        scrollPane7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)), "Masalah Kebidanan :", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 11))); // NOI18N
        ...
        scrollPane6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 254)), "Tindakan :", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 11))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            String caridata = "";
            caridata = "rp.no_rawat LIKE '%" + TCari.getText().trim() + "%' OR "
                    + "p.no_rkm_medis LIKE '%" + TCari.getText().trim() + "%' OR "
                    + "p.nm_pasien LIKE '%" + TCari.getText().trim() + "%' OR "
                    + "pk.nip LIKE '%" + TCari.getText().trim() + "%' OR "
                    + "pt.nama LIKE '%" + TCari.getText().trim() + "%'";
            try {
                ps = koneksi.prepareStatement("SELECT rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF(p.jk='L','Laki-Laki','Perempuan') AS jk, DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') AS tgl_lahir, "
                        + "p.agama, bp.nama_bahasa, pk.cacat_fisik, pk.tanggal, pk.informasi, pk.td, pk.nadi, pk.rr, pk.suhu, pk.gcs, pk.bb, pk.tb, pk.bmi, pk.lila, "
                        + "pk.tfu, pk.tbj, pk.letak, pk.presentasi, pk.penurunan, pk.his, pk.kekuatan, pk.lamanya, pk.bjj, pk.ket_bjj, pk.portio, pk.serviks, pk.ketuban, "
                        + "pk.hodge, pk.inspekulo, pk.ket_inspekulo, pk.ctg, pk.ket_ctg, pk.usg, pk.ket_usg, pk.lab, pk.ket_lab, pk.lakmus, pk.ket_lakmus, pk.panggul, "
                        + "pk.keluhan_utama, pk.umur, pk.lama, pk.banyaknya, pk.haid, pk.siklus, pk.ket_siklus, pk.ket_siklus1, pk.status, pk.kali, pk.usia1, pk.ket1, "
                        + "pk.usia2, pk.ket2, pk.usia3, pk.ket3, pk.hpht, pk.usia_kehamilan, pk.tp, pk.imunisasi, pk.ket_imunisasi, pk.g, pk.p, pk.a, pk.hidup, pk.ginekologi, "
                        + "pk.kebiasaan, pk.ket_kebiasaan, pk.kebiasaan1, pk.ket_kebiasaan1, pk.kebiasaan2, pk.ket_kebiasaan2, pk.kebiasaan3, pk.kb, pk.ket_kb, pk.komplikasi, "
                        + "pk.ket_komplikasi, pk.berhenti, pk.alasan, pk.alat_bantu, pk.ket_bantu, pk.prothesa, pk.ket_pro, pk.adl, pk.status_psiko, pk.ket_psiko, pk.hub_keluarga, "
                        + "pk.tinggal_dengan, pk.ket_tinggal, pk.ekonomi, pk.budaya, pk.ket_budaya, pk.edukasi, pk.ket_edukasi, pk.berjalan_a, pk.berjalan_b, pk.berjalan_c, "
                        + "pk.hasil, pk.lapor, pk.ket_lapor, pk.sg1, pk.nilai1, pk.sg2, pk.nilai2, pk.total_hasil, pk.nyeri, pk.provokes, pk.ket_provokes, pk.quality, "
                        + "pk.ket_quality, pk.lokasi, pk.menyebar, pk.skala_nyeri, pk.durasi, pk.nyeri_hilang, pk.ket_nyeri, pk.pada_dokter, pk.ket_dokter, pk.masalah, "
                        + "pk.tindakan, pk.nip, pt.nama, pk.cacat_fisik nama_cacat FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                        + "INNER JOIN penilaian_awal_keperawatan_kebidanan pk ON rp.no_rawat = pk.no_rawat INNER JOIN petugas pt ON pk.nip = pt.nip "
                        + "INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien WHERE DATE(pk.tanggal) between ? AND ? and (" + caridata + ") ORDER BY pk.tanggal");
                try {
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptCetakPenilaianAwalKebidananRalan.jasper", "report", "::[ Laporan Penilaian Awal Ralan Kebidanan & Kandungan ]::",
                    "SELECT rp.no_rawat,p.no_rkm_medis,p.nm_pasien,IF(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,p.agama,bp.nama_bahasa,pk.cacat_fisik nama_cacat,pk.tanggal,"
                    ...
                    + "INNER JOIN petugas pt ON pk.nip = pt.nip INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien "
                    + "WHERE rp.no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString() + "'", param);
            
            Valid.MyReport("rptCetakPenilaianAwalKebidananRalan2.jasper", "report", "::[ Laporan Penilaian Awal Ralan Kebidanan & Kandungan ]::",
                    "SELECT rp.no_rawat,p.no_rkm_medis,p.nm_pasien,IF(p.jk='L','Laki-Laki','Perempuan') AS jk,p.tgl_lahir,p.agama,bp.nama_bahasa,pk.cacat_fisik nama_cacat,pk.tanggal,"
                    + "pk.informasi,pk.td,pk.nadi,pk.rr,pk.suhu,pk.bb, pk.tb,pk.nadi,pk.rr,pk.suhu,pk.gcs,pk.bb,"
                    + "pk.tb,pk.bmi,pk.lila,pk.tfu,pk.tbj,pk.letak, pk.presentasi,pk.penurunan,pk.his,pk.kekuatan,pk.lamanya,pk.bjj,"
                    + "pk.ket_bjj,pk.portio,pk.serviks,pk.ketuban,pk.hodge,pk.inspekulo, pk.ket_inspekulo,pk.ctg,pk.ket_ctg,pk.usg,pk.ket_usg,pk.lab,"
                    + "pk.ket_lab,pk.lakmus,pk.ket_lakmus,pk.panggul,pk.keluhan_utama,pk.umur, pk.lama,pk.banyaknya,pk.haid,pk.siklus,pk.ket_siklus,pk.ket_siklus1,"
    ...
    private void BtnTambahMasalahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahMasalahActionPerformed
        if (TNoRM.getText().equals("")) {
            ...
            DlgRiwayatPersalinan.toFront();
            DlgRiwayatPersalinan.requestFocus();
        }
    ...
    private void BtnSimpanRiwayatKehamilanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanRiwayatKehamilanActionPerformed
        if (TempatPersalinan.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("riwayat_persalinan_pasien", "?,?,?,?,?,?,?,?,?,?,?", "Riwayat Persalinan", 11, new String[]{
                TNoRM.getText(), TanggalPersalinan.getText(), TempatPersalinan.getText(), UsiaHamil.getText(), JenisPersalinan.getText(),
                Penolong.getText(), Penyulit.getText(), JK.getSelectedItem().toString().substring(0, 1), BBPB.getText(), Keadaan.getText(),
    ...
    private void BtnHapusRiwayatPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusRiwayatPersalinanActionPerformed
        if (tbRiwayatKehamilan.getSelectedRow() > -1) {
            Sequel.meghapus2("riwayat_persalinan_pasien", "waktu_simpan", tbRiwayatKehamilan.getValueAt(tbRiwayatKehamilan.getSelectedRow(), 10).toString());
            tampilPersalinan();
        } else {
            JOptionPane.showMessageDialog(rootPane, "Silahkan anda pilih data terlebih dahulu..!!");
        }
    ...
    private void KeadaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeadaanKeyPressed
        Valid.pindah(evt,Penyulit,TanggalPersalinan);
    ...
    private void TanggalPersalinanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalPersalinanKeyPressed
        Valid.pindah(evt,Keadaan,UsiaHamil);
    ...
    */
    ...
    private widget.TextBox TanggalPersalinan;
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF(p.jk='L','Laki-Laki','Perempuan') AS jk, DATE_FORMAT(p.tgl_lahir,'%d-%m-%Y') AS tgl_lahir, "
                    ...
                    + "pk.hasil, pk.lapor, pk.ket_lapor, pk.sg1, pk.nilai1, pk.sg2, pk.nilai2, pk.total_hasil, pk.nyeri, pk.provokes, pk.ket_provokes, pk.quality, "
                    + "pk.ket_quality, pk.lokasi, pk.menyebar, pk.skala_nyeri, pk.durasi, pk.nyeri_hilang, pk.ket_nyeri, pk.pada_dokter, pk.ket_dokter, pk.masalah, "
                    + "pk.tindakan, pk.nip, pt.nama FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                    + "INNER JOIN penilaian_awal_keperawatan_kebidanan pk ON rp.no_rawat = pk.no_rawat INNER JOIN petugas pt ON pk.nip = pt.nip "
                    + "INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien WHERE DATE(pk.tanggal) between ? AND ? and (" + caridata + ") ORDER BY pk.tanggal");
            try {
                ps.setString(1, Valid.SetTgl(DTPCari1.getSelectedItem() + ""));
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Valid.SetTgl(HPHT, tbObat.getValueAt(tbObat.getSelectedRow(), 60).toString());
            Valid.SetTgl(TP, tbObat.getValueAt(tbObat.getSelectedRow(), 62).toString());
        }
    }
    ...
    private void isRawat() {
        try {
            ps = koneksi.prepareStatement("SELECT rp.no_rkm_medis,p.nm_pasien, IF(p.jk='L','Laki-Laki','Perempuan') jk, "
                    + "date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir,p.agama,bp.nama_bahasa,rp.tgl_registrasi, ifnull(pr.tensi,'') td, ifnull(pr.berat,'') bb, "
                    + "ifnull(pr.nadi,'') nadi, ifnull(pr.tinggi,'') tb, ifnull(pr.respirasi,'') rr, ifnull(pr.suhu_tubuh,'') suhu, ifnull(pr.gcs,'') gcs, "
                    + "ifnull(pr.keluhan,'') keluhan FROM reg_periksa rp "
    ...
    public void isCek() {
        ...
        if (akses.getjml2() >= 1) {
            ...
            NmPetugas.setText(Sequel.cariIsi("select nama from pegawai where nik='" + KdPetugas.getText() + "'"));
            ...
            try {
                ...
                while (rs.next()) {
                    tabModeRiwayatKehamilan.addRow(new String[]{
                        i + "", 
                        rs.getString("tgl_thn"), 
                        rs.getString("tempat_persalinan"), 
                        rs.getString("usia_hamil"), 
                        rs.getString("jenis_persalinan"),
                        rs.getString("penolong"), 
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_awal_keperawatan_kebidanan", "no_rawat=?", "no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,lila=?,bmi=?,tfu=?,tbj=?,letak=?,presentasi=?,penurunan=?,his=?,kekuatan=?,lamanya=?,bjj=?,ket_bjj=?,portio=?,serviks=?,ketuban=?,hodge=?,inspekulo=?,ket_inspekulo=?,ctg=?,ket_ctg=?,usg=?,ket_usg=?,lab=?,ket_lab=?,"
                ...
                + "total_hasil=?,nyeri=?,provokes=?,ket_provokes=?,quality=?,ket_quality=?,lokasi=?,menyebar=?,skala_nyeri=?,durasi=?,nyeri_hilang=?,ket_nyeri=?,pada_dokter=?,ket_dokter=?,masalah=?,tindakan=?,nip=?,cacat_fisik=?", 120, new String[]{
                    ...
                    RJb.getSelectedItem().toString(), Hasil.getSelectedItem().toString(), Lapor.getSelectedItem().toString(), KetLapor.getText(), SG1.getSelectedItem().toString(), Nilai1.getSelectedItem().toString(), SG2.getSelectedItem().toString(), Nilai2.getSelectedItem().toString(), TotalHasil.getText(), Nyeri.getSelectedItem().toString(), Provokes.getSelectedItem().toString(),
                    KetProvokes.getText(), Quality.getSelectedItem().toString(), KetQuality.getText(), Lokasi.getText(), Menyebar.getSelectedItem().toString(), SkalaNyeri.getSelectedItem().toString(), Durasi.getText(), NyeriHilang.getSelectedItem().toString(), KetNyeri.getText(), PadaDokter.getSelectedItem().toString(), KetDokter.getText(), Masalah.getText(),
                    Tindakan.getText(), KdPetugas.getText(), CacatFisik.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
            getMasalah();
            tampil();
            emptTeks();
