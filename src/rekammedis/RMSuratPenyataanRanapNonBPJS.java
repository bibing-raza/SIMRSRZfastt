 ...
 * @author dosen
 */
public class RMSuratPenyataanRanapNonBPJS extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMSuratPenyataanRanapNonBPJS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Surat Pernyataan Rawat Inap Pasien Jaminan Umum / Pribadi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        Ttgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-02-2026" }));
        ...
        jLabel23.setBounds(460, 234, 105, 23);
        ...
        TtglReg.setBounds(568, 234, 150, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (norawat.equals("")) {
            ...
            if (Sequel.menyimpantf("surat_pernyataan_ranap_non_bpjs", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 15, new String[]{
                ...
                Sequel.SimpanHistoriRekamMedis(norawat, "Surat Pernyataan Rawat Inap Pasien Jaminan Umum", "Simpan");
    ...
    private void BtnGantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGantiActionPerformed
        if (tbSurat.getSelectedRow() > -1) {
            if (Sequel.cariInteger("select count(-1) from ttd_erm_keluarga_pasien where id_file='" + idFileNmBerttd + "'") > 0
                ...
                if (Sequel.mengedittf("surat_pernyataan_ranap_non_bpjs", "no_rawat=?", "nm_berttd=?, umur=?, alamat=?, kd_kel=?, kd_kec=?, kd_kab=?, no_tlp=?, "
                    ...
                    Sequel.SimpanHistoriRekamMedis(tbSurat.getValueAt(tbSurat.getSelectedRow(), 0).toString(), "Surat Pernyataan Rawat Inap Pasien Jaminan Umum", "Ganti");
        ...
        if (tbSurat.getSelectedRow() > -1) {
            if (akses.getadmin() == true || nipPtgs.equals(akses.getkode())) {
                ...
                if (x == JOptionPane.YES_OPTION) {
                    if (Sequel.queryu2tf("delete from surat_pernyataan_ranap_non_bpjs where no_rawat=?", 1, new String[]{
                        tbSurat.getValueAt(tbSurat.getSelectedRow(), 0).toString()
                    }) == true) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Maaf, data rekam medis surat pernyataan rawat inap pasien jaminan umum/pribadi     \n"
                        + "hanya bisa dihapus oleh " + TnmPetugas.getText() + " ...!!");
                tampil();
                emptTeks();
            }
        } else {
                ...
                if (nipPtgs.equals("") || nipPtgs.equals("-") || nipPtgs.equals("--")) {
                    ...
                    isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                            + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='001'"),
                                    "Surat Pernyataan Rawat Inap Pasien Jaminan Umum", TnmPetugas.getText(),
                    ...
                    Sequel.menyimpanQr("setting_qr", "'QRTte'", "file QRCode TTE Surat Pernyataan Ranap Umum", Sequel.cariFolderPrintTte());
                    param.put("lokasiQr", Sequel.cariGambar("select gambar from setting_qr where judul = 'QRTte'"));
                    param.put("kalimatTte", Sequel.cariIsi("select replace(kalimat_footer,'##jns_dokumen##',jenis_dokumen) from kalimat_tte where kode='001'"));

                    Valid.MyReport("rptSuratPernyataanRanapNonBpjsQr.jasper", "report", "::[ Surat Pernyataan Rawat Inap Pasien Jaminan Umum/Pribadi ]::",
                            "SELECT date(now()) tgl", param);
                    Sequel.hapusIisiFolder(Sequel.cariFolderTte() + File.separator);
                }
            } else {
                Valid.MyReport("rptSuratPernyataanRanapNonBpjs.jasper", "report", "::[ Surat Pernyataan Rawat Inap Pasien Jaminan Umum/Pribadi ]::",
                        "SELECT date(now()) tgl", param);
            }
                        ...
                        if (inet.isReachable(100)) {
                            if (idFileNmBerttd.equals("")) {
                                ...
                                if (Sequel.hapusFileTTD(idFileNmBerttd) == true) {
                                    Sequel.mengedit("surat_pernyataan_ranap_non_bpjs", "no_rawat='" + norawat + "'", "id_file_nm_berttd=''");
                                    tampil();
                                    emptTeks();
                                }
                            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSuratPenyataanRanapNonBPJS dialog = new RMSuratPenyataanRanapNonBPJS(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select sp.*, p.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-laki','Perempuan') jenkel, date_format(p.tgl_lahir,'%d-%m-%Y') tglLahir, "
                    ...
                    + "pg.nama nmPtgs from surat_pernyataan_ranap_non_bpjs sp inner join reg_periksa rp on rp.no_rawat=sp.no_rawat "
        ...
        try {
            ...
            try {
                ...
                while (rs2.next()) {
                    ...
                    Tnik.setText(rs2.getString("no_ktp"));
