 ...
 * @author dosen
 */
public class RMSkorApgarDowneCapBayiLuarRS extends javax.swing.JDialog {
    ...
    private String nip = "", cekpem1 = "", cekpem2 = "", cekpem3 = "";
    private frmUtama formUtama;
    
    /** Creates new form DlgPemberianInfus
     * @param parent
     * @param modal */
    public RMSkorApgarDowneCapBayiLuarRS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            ...
            "cek_pem1", "cek_pem2", "cek_pem3", "tgl_pemeriksaan1", "tgl_pemeriksaan2", "tgl_pemeriksaan3", "jam_pemeriksaan1", "jam_pemeriksaan2", "jam_pemeriksaan3"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        TtglPem1 = new widget.Tanggal();
        jLabel57 = new widget.Label();
        cmbJam1 = new widget.ComboBox();
        cmbMnt1 = new widget.ComboBox();
        cmbDtk1 = new widget.ComboBox();
        chkPem1 = new widget.CekBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Skor Apgar, Skor Downe, Cap Jari Ibu Dan Bayi (Lahir Dari Luar RS) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        TtglPem1.setEditable(false);
        TtglPem1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
        TtglPem1.setDisplayFormat("dd-MM-yyyy");
        TtglPem1.setName("TtglPem1"); // NOI18N
        TtglPem1.setOpaque(false);
        TtglPem1.setPreferredSize(new java.awt.Dimension(90, 23));
        panelBiasa11.add(TtglPem1);
        TtglPem1.setBounds(115, 10, 90, 23);

        jLabel57.setForeground(new java.awt.Color(0, 0, 0));
        jLabel57.setText("Jam :");
        jLabel57.setName("jLabel57"); // NOI18N
        panelBiasa11.add(jLabel57);
        jLabel57.setBounds(206, 10, 50, 23);
        ...
        panelBiasa11.add(cmbJam1);
        cmbJam1.setBounds(263, 10, 45, 23);
        ...
        panelBiasa11.add(cmbMnt1);
        cmbMnt1.setBounds(315, 10, 45, 23);
        ...
        panelBiasa11.add(cmbDtk1);
        cmbDtk1.setBounds(368, 10, 45, 23);

        chkPem1.setBackground(new java.awt.Color(255, 255, 250));
        chkPem1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 250)));
        chkPem1.setForeground(new java.awt.Color(0, 0, 0));
        chkPem1.setText("Tanggal :");
        chkPem1.setBorderPainted(true);
        chkPem1.setBorderPaintedFlat(true);
        chkPem1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        chkPem1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        chkPem1.setName("chkPem1"); // NOI18N
        chkPem1.setOpaque(false);
        chkPem1.setPreferredSize(new java.awt.Dimension(175, 23));
        chkPem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkPem1ActionPerformed(evt);
            }
        });
        panelBiasa11.add(chkPem1);
        chkPem1.setBounds(0, 10, 110, 23);
        ...
        TtglPem2.setEditable(false);
        TtglPem2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
        TtglPem2.setDisplayFormat("dd-MM-yyyy");
        TtglPem2.setName("TtglPem2"); // NOI18N
        TtglPem2.setOpaque(false);
        TtglPem2.setPreferredSize(new java.awt.Dimension(90, 23));
        panelBiasa12.add(TtglPem2);
        TtglPem2.setBounds(115, 10, 90, 23);

        jLabel59.setForeground(new java.awt.Color(0, 0, 0));
        jLabel59.setText("Jam :");
        jLabel59.setName("jLabel59"); // NOI18N
        panelBiasa12.add(jLabel59);
        jLabel59.setBounds(206, 10, 50, 23);
        ...
        panelBiasa12.add(cmbJam2);
        cmbJam2.setBounds(263, 10, 45, 23);
        ...
        panelBiasa12.add(cmbMnt2);
        cmbMnt2.setBounds(315, 10, 45, 23);
        ...
        panelBiasa12.add(cmbDtk2);
        cmbDtk2.setBounds(368, 10, 45, 23);

        chkPem2.setBackground(new java.awt.Color(255, 255, 250));
        chkPem2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 250)));
        chkPem2.setForeground(new java.awt.Color(0, 0, 0));
        chkPem2.setText("Tanggal :");
        chkPem2.setBorderPainted(true);
        chkPem2.setBorderPaintedFlat(true);
        chkPem2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        chkPem2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        chkPem2.setName("chkPem2"); // NOI18N
        chkPem2.setOpaque(false);
        chkPem2.setPreferredSize(new java.awt.Dimension(175, 23));
        chkPem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkPem2ActionPerformed(evt);
            }
        });
        panelBiasa12.add(chkPem2);
        chkPem2.setBounds(0, 10, 110, 23);
        ...
        TtglPem3.setEditable(false);
        TtglPem3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
        TtglPem3.setDisplayFormat("dd-MM-yyyy");
        TtglPem3.setName("TtglPem3"); // NOI18N
        TtglPem3.setOpaque(false);
        TtglPem3.setPreferredSize(new java.awt.Dimension(90, 23));
        panelBiasa13.add(TtglPem3);
        TtglPem3.setBounds(115, 10, 90, 23);

        jLabel61.setForeground(new java.awt.Color(0, 0, 0));
        jLabel61.setText("Jam :");
        jLabel61.setName("jLabel61"); // NOI18N
        panelBiasa13.add(jLabel61);
        jLabel61.setBounds(206, 10, 50, 23);
        ...
        panelBiasa13.add(cmbJam3);
        cmbJam3.setBounds(263, 10, 45, 23);
        ...
        panelBiasa13.add(cmbMnt3);
        cmbMnt3.setBounds(315, 10, 45, 23);
        ...
        panelBiasa13.add(cmbDtk3);
        cmbDtk3.setBounds(368, 10, 45, 23);

        chkPem3.setBackground(new java.awt.Color(255, 255, 250));
        chkPem3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 250)));
        chkPem3.setForeground(new java.awt.Color(0, 0, 0));
        chkPem3.setText("Tanggal :");
        chkPem3.setBorderPainted(true);
        chkPem3.setBorderPaintedFlat(true);
        chkPem3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        chkPem3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        chkPem3.setName("chkPem3"); // NOI18N
        chkPem3.setOpaque(false);
        chkPem3.setPreferredSize(new java.awt.Dimension(175, 23));
        chkPem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkPem3ActionPerformed(evt);
            }
        });
        panelBiasa13.add(chkPem3);
        chkPem3.setBounds(0, 10, 110, 23);
        ...
        Ttgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            cekData();
            if (Sequel.cariInteger("select count(-1) from skor_apgar_downe_cap_jari_perinatologi where no_rawat='" + TNoRw.getText() + "' and bayi_lahir='di luar rs'") > 0) {
                JOptionPane.showMessageDialog(null, "Data skor apgar & skor downe sudah ada tersimpan...");
            } else if (Sequel.cariInteger("select count(-1) from skor_apgar_downe_cap_jari_perinatologi where no_rawat='" + TNoRw.getText() + "' and bayi_lahir='di rs raza'") > 0) {
                JOptionPane.showMessageDialog(null, "Data skor apgar & skor downe sudah ada tersimpan pada rekam medis (bayi lahir di RS)...");
            } else {
                if (Sequel.menyimpantf("skor_apgar_downe_cap_jari_perinatologi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 50, new String[]{
                    ...
                    "", "", "", cmbFrekNafasA.getSelectedItem().toString(), cmbRetraksiA.getSelectedItem().toString(), cmbSianosisA.getSelectedItem().toString(),
                    cmbAirA.getSelectedItem().toString(), cmbMerintihA.getSelectedItem().toString(), cmbFrekNafasB.getSelectedItem().toString(), cmbRetraksiB.getSelectedItem().toString(),
                    cmbSianosisB.getSelectedItem().toString(), cmbAirB.getSelectedItem().toString(), cmbMerintihB.getSelectedItem().toString(), cmbFrekNafasC.getSelectedItem().toString(),
                    cmbRetraksiC.getSelectedItem().toString(), cmbSianosisC.getSelectedItem().toString(), cmbAirC.getSelectedItem().toString(), cmbMerintihC.getSelectedItem().toString(),
                    cmbEvaluasi.getSelectedItem().toString(), Valid.SetTgl(Ttgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
                    nip, Sequel.cariIsi("select now()"), "di luar rs", cekpem1, cekpem2, cekpem3, Valid.SetTgl(TtglPem1.getSelectedItem() + ""), Valid.SetTgl(TtglPem2.getSelectedItem() + ""),
                    Valid.SetTgl(TtglPem3.getSelectedItem() + ""), cmbJam1.getSelectedItem() + ":" + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.getSelectedItem(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tbSkor.getSelectedRow() > -1) {
            ...
            //waktu ke
            if (chkPem1.isSelected() == true) {
                param.put("tglPem1", TtglPem1.getSelectedItem().toString().replaceAll("-", "/"));
                param.put("jamPem1", cmbJam1.getSelectedItem().toString() + ":" + cmbMnt1.getSelectedItem().toString());
            } else {
                param.put("tglPem1", "");
                param.put("jamPem1", "");
            }
            
            if (chkPem2.isSelected() == true) {
                param.put("tglPem2", TtglPem2.getSelectedItem().toString().replaceAll("-", "/"));
                param.put("jamPem2", cmbJam2.getSelectedItem().toString() + ":" + cmbMnt2.getSelectedItem().toString());
            } else {
                param.put("tglPem2", "");
                param.put("jamPem2", "");
            }
            
            if (chkPem3.isSelected() == true) {
                param.put("tglPem3", TtglPem3.getSelectedItem().toString().replaceAll("-", "/"));
                param.put("jamPem3", cmbJam3.getSelectedItem().toString() + ":" + cmbMnt3.getSelectedItem().toString());
            } else {
                param.put("tglPem3", "");
                param.put("jamPem3", "");
            }
            ...
            if (cmbPilihCetak.getSelectedIndex() == 0) {
                ...
                if (TnmPerawat.getText().equals("") || TnmPerawat.getText().equals("-") || TnmPerawat.getText().equals("--")) {
                    ...
                    Valid.MyReport("rptSkorApgarDowneCapJariLuarQr.jasper", "report", "::[ Skor Apgar, Downe, Cap Jari Ibu & Bayi ]::",
                            "SELECT now() tanggal", param);
                    Sequel.hapusIisiFolder(Sequel.cariFolderTte() + File.separator);
                }                
            } else {
                Valid.MyReport("rptSkorApgarDowneCapJariLuar.jasper", "report", "::[ Skor Apgar, Downe, Cap Jari Ibu & Bayi ]::",
                        "SELECT now() tanggal", param);
            }
    ...
    private void chkPem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkPem1ActionPerformed
        TtglPem1.setDate(new Date());        
        if (chkPem1.isSelected() == true) {
            ...
            TtglPem1.setEnabled(false);
            cmbJam1.setEnabled(false);
            cmbMnt1.setEnabled(false);
            cmbDtk1.setEnabled(false);
        }
    }//GEN-LAST:event_chkPem1ActionPerformed

    private void chkPem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkPem2ActionPerformed
        TtglPem2.setDate(new Date());        
        if (chkPem2.isSelected() == true) {
            ...
            TtglPem2.setEnabled(false);
            cmbJam2.setEnabled(false);
            cmbMnt2.setEnabled(false);
            cmbDtk2.setEnabled(false);
        }
    }//GEN-LAST:event_chkPem2ActionPerformed

    private void chkPem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkPem3ActionPerformed
        TtglPem3.setDate(new Date());        
        if (chkPem3.isSelected() == true) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSkorApgarDowneCapBayiLuarRS dialog = new RMSkorApgarDowneCapBayiLuarRS(new javax.swing.JFrame(), true);
    ...
    private widget.Tanggal TtglPem1;
    private widget.Tanggal TtglPem2;
    private widget.Tanggal TtglPem3;
    public widget.CekBox chkPem1;
    public widget.CekBox chkPem2;
    public widget.CekBox chkPem3;
    ...
    public void tampil() {     
        ...
        try {
            ps = koneksi.prepareStatement("SELECT sa.*, p.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-laki','Perempuan') jenkel, date_format(p.tgl_lahir,'%d-%m-%Y') tglLahir, "
                    ...
                    + "sa.tanggal between ? and ? and sa.bayi_lahir='di luar rs' and sa.no_rawat like ? or "
                    + "sa.tanggal between ? and ? and sa.bayi_lahir='di luar rs' and p.no_rkm_medis like ? or "
                    + "sa.tanggal between ? and ? and sa.bayi_lahir='di luar rs' and p.nm_pasien like ? or "
                    + "sa.tanggal between ? and ? and sa.bayi_lahir='di luar rs' and sa.ruang_rawat like ? or "
                    + "sa.tanggal between ? and ? and sa.bayi_lahir='di luar rs' and pg.nama like ? order by sa.waktu_simpan desc");            
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("cek_pem1"),
                        rs.getString("cek_pem2"),
                        rs.getString("cek_pem3"),                        
                        rs.getString("tgl_pemeriksaan1"),
                        rs.getString("tgl_pemeriksaan2"),
                        rs.getString("tgl_pemeriksaan3"),
                        rs.getString("jam_pemeriksaan1"),
                        rs.getString("jam_pemeriksaan2"),
                        rs.getString("jam_pemeriksaan3")
                    });
                }                
            } catch (Exception e) {
    ...
    private void getData() {
        ...
        if (tbSkor.getSelectedRow() != -1) {
            ...
            cekpem1 = tbSkor.getValueAt(tbSkor.getSelectedRow(), 49).toString();
            cekpem2 = tbSkor.getValueAt(tbSkor.getSelectedRow(), 50).toString();
            cekpem3 = tbSkor.getValueAt(tbSkor.getSelectedRow(), 51).toString();
            Valid.SetTgl(TtglPem1, tbSkor.getValueAt(tbSkor.getSelectedRow(), 52).toString());
            Valid.SetTgl(TtglPem2, tbSkor.getValueAt(tbSkor.getSelectedRow(), 53).toString());
            Valid.SetTgl(TtglPem3, tbSkor.getValueAt(tbSkor.getSelectedRow(), 54).toString());
            cmbJam1.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 55).toString().substring(0, 2));
            cmbMnt1.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 55).toString().substring(3, 5));
            cmbDtk1.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 55).toString().substring(6, 8));
            cmbJam2.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 56).toString().substring(0, 2));
            cmbMnt2.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 56).toString().substring(3, 5));
            cmbDtk2.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 56).toString().substring(6, 8));
            cmbJam3.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 57).toString().substring(0, 2));
            cmbMnt3.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 57).toString().substring(3, 5));
            cmbDtk3.setSelectedItem(tbSkor.getValueAt(tbSkor.getSelectedRow(), 57).toString().substring(6, 8));
    ...
    private void ganti() {
        ...
        if (Sequel.mengedittf("skor_apgar_downe_cap_jari_perinatologi", "no_rawat=?", "apgar_frekuensi1=?, apgar_usaha1=?, apgar_tonus1=?, apgar_reflex1=?, "
                ...
                + "apgar_reflex10=?, apgar_warna10=?, downe_frekuensi_nilaiA=?, downe_retraksi_nilaiA=?, downe_sianosis_nilaiA=?, downe_air_nilaiA=?, downe_merintih_nilaiA=?, "
                + "downe_frekuensi_nilaiB=?, downe_retraksi_nilaiB=?, downe_sianosis_nilaiB=?, downe_air_nilaiB=?, downe_merintih_nilaiB=?, downe_frekuensi_nilaiC=?, "
                + "downe_retraksi_nilaiC=?, downe_sianosis_nilaiC=?, downe_air_nilaiC=?, downe_merintih_nilaiC=?, evaluasi_downe=?, tanggal=?, jam=?, nip_perawat=?, "
                + "cek_pem1=?, cek_pem2=?, cek_pem3=?, tgl_pemeriksaan1=?, tgl_pemeriksaan2=?, tgl_pemeriksaan3=?, jam_pemeriksaan1=?, jam_pemeriksaan2=?, "
                + "jam_pemeriksaan3=?", 44, new String[]{
                    cmbFrek1.getSelectedItem().toString(), cmbUsaha1.getSelectedItem().toString(), cmbTonus1.getSelectedItem().toString(),
                    cmbReflex1.getSelectedItem().toString(), cmbWarna1.getSelectedItem().toString(), cmbFrek5.getSelectedItem().toString(), cmbUsaha5.getSelectedItem().toString(),
                    cmbTonus5.getSelectedItem().toString(), cmbReflex5.getSelectedItem().toString(), cmbWarna5.getSelectedItem().toString(), cmbFrek10.getSelectedItem().toString(),
                    cmbUsaha10.getSelectedItem().toString(), cmbTonus10.getSelectedItem().toString(), cmbReflex10.getSelectedItem().toString(), cmbWarna10.getSelectedItem().toString(),
                    cmbFrekNafasA.getSelectedItem().toString(), cmbRetraksiA.getSelectedItem().toString(), cmbSianosisA.getSelectedItem().toString(), cmbAirA.getSelectedItem().toString(),
                    cmbMerintihA.getSelectedItem().toString(), cmbFrekNafasB.getSelectedItem().toString(), cmbRetraksiB.getSelectedItem().toString(), cmbSianosisB.getSelectedItem().toString(),
                    cmbAirB.getSelectedItem().toString(), cmbMerintihB.getSelectedItem().toString(), cmbFrekNafasC.getSelectedItem().toString(), cmbRetraksiC.getSelectedItem().toString(),
                    cmbSianosisC.getSelectedItem().toString(), cmbAirC.getSelectedItem().toString(), cmbMerintihC.getSelectedItem().toString(), cmbEvaluasi.getSelectedItem().toString(),
                    Valid.SetTgl(Ttgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(), nip, cekpem1, cekpem2, cekpem3,
                    Valid.SetTgl(TtglPem1.getSelectedItem() + ""), Valid.SetTgl(TtglPem2.getSelectedItem() + ""), Valid.SetTgl(TtglPem3.getSelectedItem() + ""),
    ...
    private void dataCek() {
        if (cekpem1.equals("ya")) {
            chkPem1.setSelected(true);
            TtglPem1.setEnabled(true);
            cmbJam1.setEnabled(true);
            cmbMnt1.setEnabled(true);
            cmbDtk1.setEnabled(true);
        ...
        if (cekpem2.equals("ya")) {
            chkPem2.setSelected(true);
            TtglPem2.setEnabled(true);
            cmbJam2.setEnabled(true);
            cmbMnt2.setEnabled(true);
            cmbDtk2.setEnabled(true);
        ...
        if (cekpem3.equals("ya")) {
            chkPem3.setSelected(true);
            TtglPem3.setEnabled(true);
            cmbJam3.setEnabled(true);
            cmbMnt3.setEnabled(true);
            cmbDtk3.setEnabled(true);
