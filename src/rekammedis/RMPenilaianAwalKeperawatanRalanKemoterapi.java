 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalKeperawatanRalanKemoterapi extends javax.swing.JDialog {
    private final DefaultTableModel tabMode, tabMode1, tabModeMasalah, tabModeDetailMasalah;
    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private validasi Valid = new validasi();
    private PreparedStatement ps, ps2, ps3, ps4;
    private ResultSet rs, rs2, rs3, rs4;
    private int i = 0, jml = 0, index = 0, cek1 = 0, x = 0;
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalKeperawatanRalanKemoterapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Data Template Rencana Keperawatan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Penilaian Awal Keperawatan (Assesmen) Rawat Jalan Kemoterapi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        BtnRencana.setBounds(860, 1130, 100, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_awal_keperawatan_ralan_kemoterapi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 58, new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbPenilaian.getSelectedRow() > -1) {
            if (Sequel.queryu2tf("delete from penilaian_awal_keperawatan_ralan_kemoterapi where no_rawat=?", 1, new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.mengedittf("penilaian_awal_keperawatan_ralan_kemoterapi", "no_rawat=?", "no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,bmi=?,keluhan_utama=?,rpd=?,rpk=?,rpo=?,"
            ...
            try {
                if (TCari.getText().equals("")) {
                    ps = koneksi.prepareStatement(
                            ...
                            + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis INNER JOIN penilaian_awal_keperawatan_ralan_kemoterapi pa ON rp.no_rawat = pa.no_rawat "
                    ...
                    ps = koneksi.prepareStatement(
                            ...
                            + "INNER JOIN penilaian_awal_keperawatan_ralan_kemoterapi pa ON rp.no_rawat = pa.no_rawat "
                            + "INNER JOIN petugas pt ON pa.nip = pt.nip INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien "
                ...
                try {
                    ...
                    bw.write(LoadHTML.getText().replaceAll("<head>", "<head>"
                            ...
                            + "<font size='2' face='Tahoma'>DATA PENILAIAN AWAL KEPERAWATAN RAWAT JALAN KEMOTERAPI<br><br></font>"
                            + "</td>"
                            + "</tr>"
                            + "</table>")
                    );
...
//        Valid.pindah(evt,RPD,Alergi);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if (Sequel.cariInteger("select count(-1) from penilaian_awal_keperawatan_ralan_kemoterapi where no_rawat='" + TNoRw.getText() + "'") == 0) {
            TabRawat.setSelectedIndex(0);            
        } else if (Sequel.cariInteger("select count(-1) from penilaian_awal_keperawatan_ralan_kemoterapi where no_rawat='" + TNoRw.getText() + "'") > 0) {
            TabRawat.setSelectedIndex(1);            
        }
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbPenilaian.getSelectedRow() > -1) {
            ...
            Valid.MyReport("rptCetakPenilaianAwalKeperawatanRalanKemo.jasper", "report", "::[ Laporan Penilaian Awal Keperawatan (Assesmen) Ralan Kemoterapi ]::",
    ...
    private void BtnRencanaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRencanaActionPerformed
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3),
                "::[ Data Template Rencana Keperawatan Kemoterapi ]::",
    ...
    private void BtnCopasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopasActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            if (Rencana.getText().equals("")) {
                Rencana.setText(Ttemplate.getText());
            } else {
                Rencana.setText(Rencana.getText() + "\n\n" + Ttemplate.getText());
            }
            WindowTemplate.dispose();
        } else {
            WindowTemplate.dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanRalanKemoterapi dialog = new RMPenilaianAwalKeperawatanRalanKemoterapi(new javax.swing.JFrame(), true);
    ...
    private void isRawat() {
        try {
            ps = koneksi.prepareStatement(
                    "select p.no_rkm_medis, p.nm_pasien, if(p.jk='L','Laki-Laki','Perempuan') jk, date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir, p.agama, bp.nama_bahasa, "
                    + "ifnull(pr.tensi,'') td, ifnull(pr.nadi,'') nadi, ifnull(pr.respirasi,'') rr, ifnull(pr.suhu_tubuh,'') suhu, ifnull(pr.gcs,'') gcs, "
                    + "ifnull(pr.berat,'') bb, ifnull(pr.tinggi,'') tb, ifnull(pr.keluhan,'') keluhan, ifnull(prd.diagnosa,'') diagnosa, "
                    + "ifnull(prd.alergi,'') alergi from reg_periksa rp "
                    + "inner join pasien p on p.no_rkm_medis=rp.no_rkm_medis "
                    + "inner join bahasa_pasien bp on bp.id=p.bahasa_pasien "
                    + "left join pemeriksaan_ralan_petugas pr on pr.no_rawat=rp.no_rawat "
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    RPD.setText(rs.getString("diagnosa"));
    ...
    private void tampilTemplate() {
        ...
        try {
            ps4 = koneksi.prepareStatement("SELECT p.no_rkm_medis, p.nm_pasien, pa.* from penilaian_awal_keperawatan_ralan_kemoterapi pa "
