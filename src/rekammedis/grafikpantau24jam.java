...
//        String series1 = "Datanya 1";
//        String series2 = "Datanya 2";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                result.addValue(field, "Nadi (x/mnt)",tksbr);
            }
...
//        String series2 = "Datanya 2";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                result.addValue(field, "Suhu (°C)", tksbr);
            }
        } catch (SQLException e) {
            System.out.println("Notifikasi : " + e);
        }
        return result;
         ...
         private static JFreeChart createChart(String symbol) {
             ...
             NumberAxis rangeAxis1 = new NumberAxis("Nadi (x/mnt)");
             ...
             NumberAxis rangeAxis2 = new NumberAxis("Suhu (°C)");
             ...
             CategoryAxis domainAxis = new CategoryAxis("Jam Pemantauan");
