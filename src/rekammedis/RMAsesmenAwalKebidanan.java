 ...
 * @author perpustakaan
 */
public final class RMAsesmenAwalKebidanan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAsesmenAwalKebidanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAsesmenAwalKebidanan dialog = new RMAsesmenAwalKebidanan(new javax.swing.JFrame(), true);
