...
public final class RMPenilaianAwalMedisRalanGeriatri extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanGeriatri(java.awt.Frame parent, boolean modal) {
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("RMPenilaianAwalMedisRalanGeriatri")) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Jalan Geriatri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TglLahir.setBounds(635, 10, 80, 23);
        ...
        jLabel11.setBounds(720, 10, 50, 23);
        ...
        PosturTulang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganKepala.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganThoraks.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganAbdomen.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganEkstremitas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Psikologis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Kognitif.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IntegumentKebersihan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IntegumentWarna.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IntegumentGangguan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IntegumentKelembaban.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Fungsional.setForeground(new java.awt.Color(0, 0, 0));
        ...
        RisikoJatuh.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Nutrisi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                if (TCari.getText().trim().equals("")) {
                    ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,pmg.tanggal, "
                            + "pmg.kd_dokter,d.nm_dokter,pmg.anamnesis,pmg.hubungan,pmg.keluhan_utama,pmg.rps,pmg.rpd,pmg.rpo,pmg.alergi,pmg.tulang_belakang, "
                            + "pmg.td,pmg.nadi,pmg.suhu,pmg.rr,pmg.kondisi_umum,pmg.status_psikologis_gds,pmg.kondisi_sosial,pmg.status_kognitif_mmse, "
                            + "pmg.kepala,pmg.keterangan_kepala,pmg.thoraks,pmg.keterangan_thoraks,pmg.abdomen,pmg.keterangan_abdomen,pmg.ekstremitas, "
                            + "pmg.keterangan_ekstremitas,pmg.Integument_kebersihan,pmg.Integument_warna,pmg.Integument_kelembaban,pmg.Integument_gangguan_kulit, "
                            + "pmg.status_fungsional,pmg.skrining_jatuh,pmg.status_nutrisi,pmg.lainnya,pmg.lab,pmg.rad,pmg.pemeriksaan,pmg.diagnosis, "
                            + "pmg.diagnosis2,pmg.permasalahan,pmg.terapi,pmg.tindakan,pmg.edukasi FROM reg_periksa rp "
                            + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis INNER JOIN penilaian_medis_ralan_geriatri pmg ON rp.no_rawat = pmg.no_rawat "
                            + "INNER JOIN dokter d ON pmg.kd_dokter = d.kd_dokter WHERE pmg.tanggal BETWEEN ? AND ? ORDER BY pmg.tanggal");
                } else {
                    ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk,p.tgl_lahir,pmg.tanggal, "
                            + "pmg.kd_dokter,d.nm_dokter,pmg.anamnesis,pmg.hubungan,pmg.keluhan_utama,pmg.rps,pmg.rpd,pmg.rpo,pmg.alergi,pmg.tulang_belakang, "
                            + "pmg.td,pmg.nadi,pmg.suhu,pmg.rr,pmg.kondisi_umum,pmg.status_psikologis_gds,pmg.kondisi_sosial,pmg.status_kognitif_mmse,pmg.kepala, "
                            + "pmg.keterangan_kepala,pmg.thoraks,pmg.keterangan_thoraks,pmg.abdomen,pmg.keterangan_abdomen,pmg.ekstremitas,pmg.keterangan_ekstremitas, "
                            + "pmg.Integument_kebersihan,pmg.Integument_warna,pmg.Integument_kelembaban,pmg.Integument_gangguan_kulit,pmg.status_fungsional, "
                            + "pmg.skrining_jatuh,pmg.status_nutrisi,pmg.lainnya,pmg.lab,pmg.rad,pmg.pemeriksaan,pmg.diagnosis,pmg.diagnosis2,pmg.permasalahan, "
                            + "pmg.terapi,pmg.tindakan,pmg.edukasi FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                            + "INNER JOIN penilaian_medis_ralan_geriatri pmg ON rp.no_rawat = pmg.no_rawat INNER JOIN dokter d ON pmg.kd_dokter = d.kd_dokter "
                            + "WHERE pmg.tanggal BETWEEN ? AND ? AND (rp.no_rawat LIKE ? OR p.no_rkm_medis LIKE ? OR p.nm_pasien LIKE ? OR pmg.kd_dokter LIKE ? OR d.nm_dokter LIKE ?) "
                            + "ORDER BY pmg.tanggal");
                }
    ...
    private void BtnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterActionPerformed
        akses.setform("RMPenilaianAwalMedisRalanGeriatri");
        dokter.isCek();
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptCetakPenilaianAwalMedisRalanGeriatri.jasper", "report", "::[ Laporan Penilaian Awal Medis Rawat Jalan Geriatri ]::",
    ...
    */
    ...
    public void tampil() {
        ...
        try {
            if (TCari.getText().trim().equals("")) {
                ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk, date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir, "
                        + "pmg.tanggal, pmg.kd_dokter,d.nm_dokter,pmg.anamnesis,pmg.hubungan,pmg.keluhan_utama, pmg.rps,pmg.rpd,pmg.rpo,pmg.alergi,pmg.tulang_belakang, "
                        + "pmg.td,pmg.nadi,pmg.suhu,pmg.rr,pmg.kondisi_umum,pmg.status_psikologis_gds,pmg.kondisi_sosial,pmg.status_kognitif_mmse,pmg.kepala, "
                        + "pmg.keterangan_kepala,pmg.thoraks,pmg.keterangan_thoraks,pmg.abdomen,pmg.keterangan_abdomen,pmg.ekstremitas,pmg.keterangan_ekstremitas, "
                        + "pmg.Integument_kebersihan,pmg.Integument_warna,pmg.Integument_kelembaban,pmg.Integument_gangguan_kulit,pmg.status_fungsional, "
                        + "pmg.skrining_jatuh,pmg.status_nutrisi,pmg.lainnya,pmg.lab,pmg.rad,pmg.pemeriksaan,pmg.diagnosis,pmg.diagnosis2,pmg.permasalahan, "
                        + "pmg.terapi,pmg.tindakan,pmg.edukasi FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                        + "INNER JOIN penilaian_medis_ralan_geriatri pmg ON rp.no_rawat = pmg.no_rawat INNER JOIN dokter d ON pmg.kd_dokter = d.kd_dokter "
                        + "WHERE pmg.tanggal BETWEEN ? AND ? ORDER BY pmg.tanggal");
            } else {
                ps = koneksi.prepareStatement("select rp.no_rawat,p.no_rkm_medis,p.nm_pasien,if(p.jk='L','Laki-Laki','Perempuan') jk, date_format(p.tgl_lahir,'%d-%m-%Y') tgl_lahir, "
                        + "pmg.tanggal, pmg.kd_dokter,d.nm_dokter,pmg.anamnesis,pmg.hubungan,pmg.keluhan_utama,pmg.rps,pmg.rpd,pmg.rpo,pmg.alergi,pmg.tulang_belakang, "
                        + "pmg.td,pmg.nadi,pmg.suhu,pmg.rr,pmg.kondisi_umum,pmg.status_psikologis_gds,pmg.kondisi_sosial,pmg.status_kognitif_mmse,pmg.kepala, "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("rpo"),
                        rs.getString("alergi"),
                        rs.getString("kondisi_umum"),
                        rs.getString("td"),
                        rs.getString("nadi"),
                        rs.getString("suhu"),
                        rs.getString("rr"),
                        rs.getString("tulang_belakang"),
                        rs.getString("kepala"),
                        rs.getString("keterangan_kepala"),
                        rs.getString("thoraks"),
                        rs.getString("keterangan_thoraks"),
                        rs.getString("abdomen"),
                        rs.getString("keterangan_abdomen"),
                        rs.getString("ekstremitas"),
                        rs.getString("keterangan_ekstremitas"),
                        rs.getString("Integument_kebersihan"),
                        rs.getString("Integument_warna"),
                        rs.getString("Integument_kelembaban"),
                        rs.getString("Integument_gangguan_kulit"),
                        rs.getString("lainnya"),
                        rs.getString("kondisi_sosial"),
                        rs.getString("status_psikologis_gds"),
                        rs.getString("status_kognitif_mmse"),
                        rs.getString("status_nutrisi"),
                        rs.getString("skrining_jatuh"),
                        rs.getString("status_fungsional"),
                        rs.getString("lab"),
                        rs.getString("rad"),
    ...
    public void setNoRm(String norwt, Date tgl2, String kddok, String nmdok) {
        TNoRw.setText(norwt);
        TCari.setText(norwt);
