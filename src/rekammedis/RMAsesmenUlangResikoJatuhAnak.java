 ...
 * @author dosen
 */
public class RMAsesmenUlangResikoJatuhAnak extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAsesmenUlangResikoJatuhAnak(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame13.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Data Riwayat Asesmen Ulang Resiko Jatuh Pasien Anak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-05-2024" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-05-2024" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Asesmen Ulang Resiko Jatuh Humpty Dumpty (Pasien Anak) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-05-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-05-2024" }));
        ...
        tglAsesmen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-05-2024" }));
        ...
        Scroll8.setBounds(125, 94, 950, 156);
        ...
        TabPencegahan.addTab("Pencegahan Resiko Tinggi (B)", panelBiasa9);

        FormInput.add(TabPencegahan);
        TabPencegahan.setBounds(25, 305, 405, 138);

        jLabel140.setForeground(new java.awt.Color(0, 0, 0));
        jLabel140.setText("Tindakan Pencegahan :");
        jLabel140.setName("jLabel140"); // NOI18N
        FormInput.add(jLabel140);
        jLabel140.setBounds(450, 340, 130, 23);
        ...
        cmbTindakanCegah.setBounds(587, 340, 40, 23);

        jLabel99.setForeground(new java.awt.Color(0, 0, 0));
        jLabel99.setText("Nama Petugas : ");
        jLabel99.setName("jLabel99"); // NOI18N
        FormInput.add(jLabel99);
        jLabel99.setBounds(450, 383, 130, 23);
        ...
        TnmPetugas.setBounds(587, 383, 440, 23);
        ...
        BtnPetugas.setBounds(1030, 383, 28, 23);
        ...
        jLabel141.setBounds(450, 355, 130, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (x == 0) {
                ...
                if (Sequel.menyimpantf("asesmen_ulang_resiko_jatuh_anak", "?,?,?,?,?,?,?,?,?,?", "No.Rawat", 10, new String[]{
                    ...
                    for (i = 0; i < tbFaktorResiko.getRowCount(); i++) {
                        if (tbFaktorResiko.getValueAt(i, 0).toString().equals("true")) {
                            Sequel.menyimpan2("detail_asesmen_ulang_resiko_jatuh_anak", "?,?,?", 3, new String[]{
        ...
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (tbAsesmen.getSelectedRow() > -1) {
                ...
                if (x == 0) {
                    ...
                    riwayatData = "ganti";
                    SimpanHistori();
                    if (Sequel.mengedittf("asesmen_ulang_resiko_jatuh_anak", "waktu_simpan=?", "tgl_asesmen=?, jam_asesmen=?, kode_ulang_resiko=?, total_skor=?, tindakan_pencegahan=?, "
                        ...
                        Sequel.meghapus("detail_asesmen_ulang_resiko_jatuh_anak", "kode_ulang_resiko",
    ...
    private void BtnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPetugasActionPerformed
        akses.setform("RMAsesmenUlangResikoJatuhAnak");
        petugas.isCek();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbAsesmen.getSelectedRow() > -1) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                riwayatData = "hapus";
                SimpanHistori();
                if (Sequel.queryu2tf("delete from asesmen_ulang_resiko_jatuh_anak where waktu_simpan=?", 1, new String[]{
                    tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 14).toString()
                }) == true) {
                    Sequel.meghapus("detail_asesmen_ulang_resiko_jatuh_anak", "kode_ulang_resiko",
                            tbAsesmen.getValueAt(tbAsesmen.getSelectedRow(), 1).toString());
        ...
        if (tbRiwayat.getSelectedRow() > -1) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                if (tbRiwayat.getValueAt(tbRiwayat.getSelectedRow(), 7).toString().equals("DIHAPUS")) {
                    if (Sequel.cariInteger("select count(-1) from asesmen_ulang_resiko_jatuh_anak where "
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAsesmenUlangResikoJatuhAnak dialog = new RMAsesmenUlangResikoJatuhAnak(new javax.swing.JFrame(), true);
    ...
    public void tampil() {     
        ...
        try {
            ps = koneksi.prepareStatement("SELECT *, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(au.tgl_asesmen,'%d-%m-%Y') tgl, "
                    + "TIME_FORMAT(au.jam_asesmen,'%H:%i') jam, pg.nama ptgs from asesmen_ulang_resiko_jatuh_anak au "
            ...
            try {
                ...
                System.out.println("rekammedis.RMAsesmenUlangResikoJatuhAnak.tampil() : " + e);
            } finally {
                if (rs != null) {
                    rs.close();
                }
    ...
    private void tampilFaktorResiko() {
        ...
        try {
            ps1 = koneksi.prepareStatement("SELECT * FROM master_faktor_resiko_igd where asesmen='Ulang Resiko Jatuh Anak' ORDER BY kode_resiko");
            try {
    ...
    public void setData(String norw, String norm, String nmpasien, String ruangan) {
        ...
        if (Sequel.cariInteger("select count(-1) from asesmen_ulang_resiko_jatuh_anak where no_rawat='" + norw + "'") > 0) {
            Valid.SetTgl(DTPCari1, Sequel.cariIsi("select tgl_asesmen from asesmen_ulang_resiko_jatuh_anak where "
    ...
    public void autoNomorFaktorResiko() {
        Valid.autoNomer7("select ifnull(MAX(CONVERT(LEFT(kode_ulang_resiko,4),signed)),0) from asesmen_ulang_resiko_jatuh_anak where "
    ...
    private void tampilDataFaktorResiko() {
        ...
        try {
            ps2 = koneksi.prepareStatement("SELECT DISTINCT a.kode_resiko, a.faktor_resiko, a.skala, a.skor, IF(ifnull(b.kode_resiko,'-')='-','-','dipilih') cekkode "
                    + "FROM master_faktor_resiko_igd a LEFT JOIN detail_asesmen_ulang_resiko_jatuh_anak b ON a.kode_resiko = b.kode_resiko "
                    + "AND b.kode_ulang_resiko = '" + TkdFaktor.getText() + "' left join asesmen_ulang_resiko_jatuh_anak c on c.kode_ulang_resiko = b.kode_ulang_resiko "
                    ...
                    + "WHERE a.asesmen = 'Ulang Resiko Jatuh Anak' ORDER BY a.kode_resiko");
            try {
    ...
    private void SimpanHistori() {
        ...
        if (Sequel.menyimpantf("asesmen_ulang_resiko_jatuh_anak_histori", "?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 13, new String[]{
            TNoRw.getText(), Valid.SetTgl(tglAsesmen.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
            TkdFaktor.getText(), TtotSkor.getText(), cmbTindakanCegah.getSelectedItem().toString(), nip, Tkategori.getText(),
            ...
            for (i = 0; i < tbFaktorResiko.getRowCount(); i++) {
                if (tbFaktorResiko.getValueAt(i, 0).toString().equals("true")) {
                    Sequel.menyimpan2("detail_asesmen_ulang_resiko_jatuh_anak_histori", "?,?,?,?", 4, new String[]{
    ...
    private void tampilRiwayat() {
        ...
        try {
            psrestor = koneksi.prepareStatement("SELECT IF(pg.nama='-','Admin Utama',pg.nama) pelaku, a.no_rawat, p.no_rkm_medis, "
                    ...
                    + "a.kode_ulang_resiko FROM asesmen_ulang_resiko_jatuh_anak_histori a inner join reg_periksa rp on rp.no_rawat=a.no_rawat "
    ...
    private void kembalikanData() {
        try {
            ps3 = koneksi.prepareStatement("select * from asesmen_ulang_resiko_jatuh_anak_histori where "
                ...
                while (rs3.next()) {
                    try {
                        if (Sequel.menyimpantf("asesmen_ulang_resiko_jatuh_anak", "?,?,?,?,?,?,?,?,?,?", "No.Rawat", 10, new String[]{
                            ...
                            //simpan faktor resiko
                            try {
                                ps4 = koneksi.prepareStatement("select * from detail_asesmen_ulang_resiko_jatuh_anak_histori where "
