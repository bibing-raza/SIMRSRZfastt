...
public final class BPJSCekRujukanKartuPCare extends javax.swing.JDialog {
    ...
    public BPJSCekRujukanKartuPCare(java.awt.Frame parent, boolean modal) {
        ...
        pasien.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("BPJSCekRujukanKartuPCare")){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Rujukan PCare Berdasarkan Nomor Kartu ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void btnPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPasienActionPerformed
        akses.setform("BPJSCekRujukanKartuPCare");
        pasien.emptTeks();
        pasien.isCek();
        pasien.TutupJendela();
