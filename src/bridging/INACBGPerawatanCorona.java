...
public class INACBGPerawatanCorona extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnNIK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MnKartu.setForeground(new java.awt.Color(0, 0, 0));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kebutuhan Perawatan Pasien Corona Untuk Penagihan INACBG ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-04-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-04-2020" }));
        ...
        PemulasaranJenazah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KantongJenazah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PetiJenazah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PlastikErat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DesinfektanJenazah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MobilJenazah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DesinFektanMobilJenazah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusCovid.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NoJaminan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Episodes1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Episodes2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Episodes3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Episodes4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Episodes5.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Episodes6.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Comorbid.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPerawatanCorona.jasper", "report", "::[ Kebutuhan Perawatan Pasien Corona Untuk Penagihan INACBG ]::",
  ...
  isForm();                
    ...
    */
    ...
    public void tampil() {     
        ...
        try {
            ps = koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,reg_periksa.tgl_registrasi,perawatan_corona.pemulasaraan_jenazah,"
                    + "perawatan_corona.kantong_jenazah,perawatan_corona.peti_jenazah,perawatan_corona.plastik_erat,perawatan_corona.desinfektan_jenazah,"
                    + "perawatan_corona.mobil_jenazah,perawatan_corona.desinfektan_mobil_jenazah,perawatan_corona.covid19_status_cd,perawatan_corona.nomor_kartu_t,"
                    + "perawatan_corona.episodes1,perawatan_corona.episodes2,perawatan_corona.episodes3,perawatan_corona.episodes4,perawatan_corona.episodes5,"
                    + "perawatan_corona.episodes6,perawatan_corona.covid19_cc_ind from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
