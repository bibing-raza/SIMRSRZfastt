...
public final class SisruteRujukanKeluar extends javax.swing.JDialog {
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pegawai.getTable().getSelectedRow()!= -1){  
                    if(pilihan==1){
                        KdDokter.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),23).toString());
                        DokterPerujuk.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),1).toString());
                        KdDokter.requestFocus();
                    }else if(pilihan==2){
                        KdPetugas.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),23).toString());
                        PetugasEntry.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),1).toString());
    ...
    private void initComponents() {
        ...
        ppRiwayat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Rujukan Keluar Sisrute ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-03-2020 08:58:16" }));
        ...
        jLabel10.setBounds(12, 408, 100, 23);
        ...
        KdAlasan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NmAlasan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TmpLahir.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AlasanLainnya.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JenisRujukan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JenisRujukan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JenisRujukanMouseClicked(evt);
            }
        });
        ...
        KdDiagnosa.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DokterPerujuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PetugasEntry.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel28.setBounds(12, 128, 100, 23);
        ...
        JenisKesadaran.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JenisKesadaran.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JenisKesadaranMouseClicked(evt);
            }
        });
        ...
        TekananDarah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        FrekuensiNadi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SuhuBadan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Respirasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TingkatNyeri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TingkatNyeri.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TingkatNyeriMouseClicked(evt);
            }
        });
        ...
        KeadaanUmum.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel45.setBounds(12, 268, 100, 23);
        ...
        Laborat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Radiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TerapiTindakan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TabRujukan.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
            ...
            try {
                ...
                if (root.path("status").asText().equals("200")) {
                    if (Sequel.menyimpantf("sisrute_rujukan_keluar", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Nomor Rujuk", 36, new String[]{
                        ...
                        Sequel.menyimpan2("rujuk_keluar_sisrute", "'" + root.path("data").path("RUJUKAN").path("NOMOR").asText() + "','"
            ...
            if(tbObat.getSelectedRow()!= -1){
                try {
                    ...
                    if(root.path("status").asText().equals("200")){                    
                        ...
                        Sequel.meghapus3("rujuk_keluar_sisrute","no_rawat",TNoRw.getText());
                        emptTeks();
                        tampil();
                    }
                } catch (Exception ex) {
    ...
    private void BtnAlasanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAlasanActionPerformed
        ...
        alasanrujuk.tcari.requestFocus();
    ...
    private void JenisRujukanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JenisRujukanMouseClicked
        JenisRujukan.setEditable(false);
    }//GEN-LAST:event_JenisRujukanMouseClicked

    private void JenisKesadaranMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JenisKesadaranMouseClicked
        JenisKesadaran.setEditable(false);
    }//GEN-LAST:event_JenisKesadaranMouseClicked

    private void TingkatNyeriMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TingkatNyeriMouseClicked
        TingkatNyeri.setEditable(false);
    }//GEN-LAST:event_TingkatNyeriMouseClicked
    ...
    */
    ...
    public widget.ComboBox JenisRujukan;
    ...
    public void setPasien(String NoRawat){
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT rp.no_rawat, p.nm_pasien, concat(p.alamat,', ',kl.nm_kel,', ',kc.nm_kec,', ',kb.nm_kab) asal, "
                    + "p.no_rkm_medis, p.no_ktp, p.no_peserta, p.jk, p.tmp_lahir, p.tgl_lahir, p.no_tlp, pg.nama, pg.no_ktp AS ktpdokter "
                    + "FROM pasien p INNER JOIN reg_periksa rp ON rp.no_rkm_medis=p.no_rkm_medis "
                    ...
                    + "INNER JOIN pegawai pg on pg.nik=rp.kd_dokter where rp.no_rawat=?");
            try {            
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "alergi, imun_ke, rencana_follow_up from pemeriksaan_ralan where no_rawat=? order by tgl_perawatan desc limit 1");
                    try {
                        ps2.setString(1,NoRawat);
                        rs2=ps2.executeQuery();
                        while(rs2.next()){                            
    ...
    public void setPasien2(String NoRawat){
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT rp.no_rawat, nm_pasien, concat(p.alamat,', ',kl.nm_kel,', ',kc.nm_kec,', ',kb.nm_kab) asal, "
                    + "p.no_rkm_medis, p.no_ktp, p.no_peserta, p.jk, p.tmp_lahir, p.tgl_lahir, p.no_tlp, pg.nama, pg.no_ktp AS ktpdokter "
                    + "FROM pasien p INNER JOIN reg_periksa rp on rp.no_rkm_medis=p.no_rkm_medis "
                    + "INNER JOIN kelurahan kl on kl.kd_kel=p.kd_kel "
                    + "INNER JOIN kecamatan kc on kc.kd_kec=p.kd_kec "
