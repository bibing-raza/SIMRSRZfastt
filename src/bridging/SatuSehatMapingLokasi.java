...
public final class SatuSehatMapingLokasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Lokasi Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        Altitude.setForeground(new java.awt.Color(0, 0, 0));
        ...
        tbLokasi.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbLokasi.setName("tbLokasi"); // NOI18N
        tbLokasi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbLokasiMouseClicked(evt);
            }
        });
        tbLokasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbLokasiKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbLokasi);
        ...
        AltitudeKamar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodeDepartemenRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaDepartemenRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnDepartemenRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IDOrganisasiRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LongitudeRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LatitudeRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AltitudeRuangOK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodeDepartemenRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaDepartemenRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnDepartemenRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IDOrganisasiRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LongitudeRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LatitudeRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AltitudeRuangLabPK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodeDepartemenRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaDepartemenRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnDepartemenRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IDOrganisasiRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LongitudeRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LatitudeRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AltitudeRuangLabPA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodeDepartemenRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaDepartemenRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnDepartemenRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IDOrganisasiRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LongitudeRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LatitudeRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AltitudeRuangLabMB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodeDepartemenRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaDepartemenRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnDepartemenRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        IDOrganisasiRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LongitudeRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LatitudeRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AltitudeRuangRadiologi.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void btnDepartemenRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepartemenRSActionPerformed
        pilih = 1;
        organisasi.setSize(863, internalFrame1.getHeight() - 40);
    ...
    private void tbLokasiKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLokasiKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    */
    ...
    private void getData() {
       if(tbLokasi.getSelectedRow()!= -1){
           KodePoli.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),0).toString());
           NamaPoli.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),1).toString());
           Longitude.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),3).toString());
           Latitude.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),4).toString());
           Altitude.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),5).toString());
           KodeDepartemen.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),6).toString());
           NamaDepartemen.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),7).toString());
           IDOrganisasi.setText(tbLokasi.getValueAt(tbLokasi.getSelectedRow(),8).toString());
        }
    }
