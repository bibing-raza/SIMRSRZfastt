...
public final class SatuSehatKirimMedicationRequest extends javax.swing.JDialog {
    ...
    public SatuSehatKirimMedicationRequest(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            "P", "KFA Code", "KFA System", "Kode Barang", "KFA Display", "Form Code", "Form System",
            "Form Display", "Status", "ID Medication Satu Sehat"
            }){
    ...
    private void initComponents() {
        ...
        ppPilihIdMedicationKosong = new javax.swing.JMenuItem();
        ...
        ppPilihIdMedicationKosong.setBackground(new java.awt.Color(255, 255, 254));
        ppPilihIdMedicationKosong.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppPilihIdMedicationKosong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppPilihIdMedicationKosong.setText("Pilih Id Medication Kosong");
        ppPilihIdMedicationKosong.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppPilihIdMedicationKosong.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppPilihIdMedicationKosong.setName("ppPilihIdMedicationKosong"); // NOI18N
        ppPilihIdMedicationKosong.setPreferredSize(new java.awt.Dimension(170, 26));
        ppPilihIdMedicationKosong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppPilihIdMedicationKosongActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppPilihIdMedicationKosong);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Medication Request Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        for (i = 0; i < tbMedication.getRowCount(); i++) {
            if (tbMedication.getValueAt(i, 0).toString().equals("true") 
                    && (!tbMedication.getValueAt(i, 9).toString().equals(""))) {
                try {
                    try {
                        ...
                        json = "{" +
                                    ...
                                    "\"identifier\": [" +
                                        "{" +
                                            ...
                                            "\"use\": \"official\"," +
                                            "\"value\" : \""+tbMedication.getValueAt(i,3).toString()+"\"" +
                                        "}" +
                                    "]," +
                                    "\"code\": {" +
                                        "\"coding\": [" +
                                            "{" +
                                                "\"system\": \""+tbMedication.getValueAt(i,2).toString()+"\"," +
                                                "\"code\": \""+tbMedication.getValueAt(i,1).toString()+"\"," +
                                                "\"display\": \""+tbMedication.getValueAt(i,4).toString()+"\"" +
                                            "}" +
                                        "]" +
                                    "}," +
                                    "\"status\": \""+tbMedication.getValueAt(i,8).toString()+"\"," +
                                    "\"form\": {" +
                                        "\"coding\": [" +
                                            "{" +
                                                "\"system\": \""+tbMedication.getValueAt(i,6).toString()+"\"," +
                                                "\"code\": \""+tbMedication.getValueAt(i,5).toString()+"\"," +
                                                "\"display\": \""+tbMedication.getValueAt(i,7).toString()+"\"" +
                                            "}" +
                                        "]" +
                                    "}," +
                                    "\"extension\": [" +
                        ...
                        if (!response.asText().equals("")) {
                            if (Sequel.menyimpantf2("satu_sehat_medication", "?,?", "Obat/Alkes", 2, new String[]{
                                tbMedication.getValueAt(i, 3).toString(), response.asText()
                            }) == true) {
                                tbMedication.setValueAt(response.asText(), i, 9);
                            }
                        }
                    } catch (Exception e) {
            ...
            if (tbMedication.getValueAt(i, 0).toString().equals("true") 
                ...
                try {
                    try {
                        ...
                        json = "{" +
                                    "\"resourceType\": \"Medication\"," +
                                    "\"id\": \""+tbMedication.getValueAt(i,9).toString()+"\"," +
                                    "\"meta\": {" +
                                        "\"profile\": [" +
                                            "\"https://fhir.kemkes.go.id/r4/StructureDefinition/Medication\"" +
                                        "]" +
                                    ...
                                    "]" +
                                "}";
                        System.out.println("URL : " + link + "/Medication/" + tbMedication.getValueAt(i, 9).toString());
                        System.out.println("Request JSON : " + json);
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(link + "/Medication/" + tbMedication.getValueAt(i, 9).toString(), HttpMethod.PUT, requestEntity, String.class).getBody();
                        System.out.println("Result JSON : " + json);
                    } catch (Exception e) {
                        System.out.println("Notifikasi Bridging : " + e);
                    }
    ...
    private void ppPilihIdMedicationKosongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPilihIdMedicationKosongActionPerformed
        for (i = 0; i < tbMedication.getRowCount(); i++) {
            if (tbMedication.getValueAt(i, 9).equals("")) {
                tbMedication.setValueAt(true, i, 0);
            }
        }
    }//GEN-LAST:event_ppPilihIdMedicationKosongActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppPilihIdMedicationKosong;
    ...
    private void tampil() {
        ...
        try {
            if (cmbData.getSelectedIndex() == 0) {
                ps = koneksi.prepareStatement("SELECT sm.obat_code, sm.obat_system, db.STATUS, sm.kode_brng, sm.obat_display, sm.form_code, "
                        + "sm.form_system, sm.form_display, ifnull(smm.id_medication,'') id_medication FROM satu_sehat_mapping_obat sm "
                        + "INNER JOIN databarang db ON sm.kode_brng = db.kode_brng LEFT JOIN satu_sehat_medication smm ON smm.kode_brng = sm.kode_brng "
                        + (TCari.getText().equals("") ? "" : "where (sm.obat_code like ? or sm.kode_brng like ? or "
                        + "sm.obat_display like ? or sm.form_code like ? or sm.form_display like ?) ")
                        + "order by sm.obat_display");
            } else if (cmbData.getSelectedIndex() == 1) {
                ps = koneksi.prepareStatement("SELECT sm.obat_code, sm.obat_system, db.STATUS, sm.kode_brng, sm.obat_display, sm.form_code, "
                        + "sm.form_system, sm.form_display, ifnull(smm.id_medication,'') id_medication FROM satu_sehat_mapping_obat sm "
                        + "INNER JOIN databarang db ON sm.kode_brng = db.kode_brng LEFT JOIN satu_sehat_medication smm ON smm.kode_brng = sm.kode_brng "
                        + (TCari.getText().equals("") ? "" : "where (smm.id_medication is null or smm.id_medication='') and "
                        + "(sm.obat_code like ? or sm.kode_brng like ? or sm.obat_display like ? or sm.form_code like ? or sm.form_display like ?) ")
                        + "order by sm.obat_display");
            } else if (cmbData.getSelectedIndex() == 2) {
                ps = koneksi.prepareStatement("SELECT sm.obat_code, sm.obat_system, db.STATUS, sm.kode_brng, sm.obat_display, sm.form_code, "
                        + "sm.form_system, sm.form_display, ifnull(smm.id_medication,'') id_medication FROM satu_sehat_mapping_obat sm "
                        + "INNER JOIN databarang db ON sm.kode_brng = db.kode_brng LEFT JOIN satu_sehat_medication smm ON smm.kode_brng = sm.kode_brng "
                        + (TCari.getText().equals("") ? "" : "where smm.id_medication<>'' and  (sm.obat_code like ? or sm.kode_brng like ? or "
                        + "sm.obat_display like ? or sm.form_code like ? or sm.form_display like ?) ")
                        + "order by sm.obat_display");
            }
