...
public final class BPJSDataSEP extends javax.swing.JDialog {
    private DefaultTableModel tabMode, tabMode1, tabMode2, tabMode3, tabMode4, tabMode5, tabMode6, tabMode7, tabMode8, tabModeFarmasi;
    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private validasi Valid = new validasi();
    private PreparedStatement ps, ps1, ps2, ps3, ps4, ps5, ps6, ps7, ps8, ps9, psFar;
    private ResultSet rs, rs1, rs2, rs3, rs4, rs5, rs6, rs7, rs8, rs9, rsFar;
    private int i = 0, pilihan = 0, x, tglpulangnya = 0, cekPulang = 0, cekDataPlg = 0, cekRujukan = 0, cekSEP = 0, jml = 0, s = 0, index = 0;
    ...
    private String no_peserta = "", requestJson, URL = "", jkel = "", duplikat = "", user = "", tglkkl = "", tglkkl_ok = "", jnsrawat = "", dialog_simpan = "",
            ...
            tglPulangInap = "", cekLaka = "", SEPkontrol = "", antrianKhusus = "", kasus = "";
    private boolean[] pilih;
    private String[] nmObat, satuan;
...
//                column.setPreferredWidth(165);
        ...
        tbRekapKunjungan.setModel(tabMode8);
...
//        });
    ...
    private void initComponents() {
        ...
        MnRekapPasienRanapBlmPulang = new javax.swing.JMenuItem();
        MnRekapSEPRanapPasienMati = new javax.swing.JMenuItem();
        MnRekapSEPRalanPasienMati = new javax.swing.JMenuItem();
        MnRekapSEPRalanKunjunganBanyak = new javax.swing.JMenu();
        MnRujukInternal = new javax.swing.JMenuItem();
        MnKonsul = new javax.swing.JMenuItem();
        MnRekapSemuaSEPKunjunganBanyak = new javax.swing.JMenu();
        MnRujukInternal1 = new javax.swing.JMenuItem();
        MnKonsul1 = new javax.swing.JMenuItem();
        ...
        MnRekapSEPRalanUPD = new javax.swing.JMenuItem();
        ...
        WindowCariObat = new javax.swing.JDialog();
        ...
        BtnRekapObat = new widget.Button();
        TobatCari = new widget.TextBox();
        ...
        BtnRekapTindakan = new widget.Button();
        TtindakanCari = new widget.TextBox();
        ...
        tbRekapKunjungan = new widget.Table();
        ...
        btnBatalNaikKls = new widget.Button();
        ...
        ppSEP.setText("Print SEP / Bukti Registrasi");
        ...
        ppDetailSEPvclaim.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        ppSEPinternal.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        ppUpdateSEPdariVclaim.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        ppRencanaKontrollagi.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        ppDataRujukanKeluar.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        ppMembuatRujukan.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        MnRekapPasienRanapBlmPulang.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapPasienRanapBlmPulang.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapPasienRanapBlmPulang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRekapPasienRanapBlmPulang.setText("Rekap Pasien Ranap Belum Pulang");
        MnRekapPasienRanapBlmPulang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapPasienRanapBlmPulang.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapPasienRanapBlmPulang.setIconTextGap(8);
        MnRekapPasienRanapBlmPulang.setName("MnRekapPasienRanapBlmPulang"); // NOI18N
        MnRekapPasienRanapBlmPulang.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapPasienRanapBlmPulang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapPasienRanapBlmPulangBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(MnRekapPasienRanapBlmPulang);
        ...
        MnRekapSEPRalanPasienMati.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapSEPRalanPasienMati.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapSEPRalanPasienMati.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRekapSEPRalanPasienMati.setText("Rekap No. SEP Ralan Pasien Meninggal");
        MnRekapSEPRalanPasienMati.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapSEPRalanPasienMati.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapSEPRalanPasienMati.setIconTextGap(8);
        MnRekapSEPRalanPasienMati.setName("MnRekapSEPRalanPasienMati"); // NOI18N
        MnRekapSEPRalanPasienMati.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapSEPRalanPasienMati.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapSEPRalanPasienMatiBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(MnRekapSEPRalanPasienMati);

        MnRekapSEPRalanKunjunganBanyak.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapSEPRalanKunjunganBanyak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRekapSEPRalanKunjunganBanyak.setText("Rekap SEP R. Jalan Kunj. Banyak PerNoRM PerTgl.");
        MnRekapSEPRalanKunjunganBanyak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapSEPRalanKunjunganBanyak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapSEPRalanKunjunganBanyak.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapSEPRalanKunjunganBanyak.setIconTextGap(5);
        MnRekapSEPRalanKunjunganBanyak.setName("MnRekapSEPRalanKunjunganBanyak"); // NOI18N
        MnRekapSEPRalanKunjunganBanyak.setOpaque(true);
        MnRekapSEPRalanKunjunganBanyak.setPreferredSize(new java.awt.Dimension(300, 25));

        MnRujukInternal.setBackground(new java.awt.Color(242, 242, 242));
        MnRujukInternal.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRujukInternal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRujukInternal.setText("Kasus Rujuk Internal");
        ...
        MnRujukInternal.setPreferredSize(new java.awt.Dimension(150, 25));
        MnRujukInternal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRujukInternalActionPerformed(evt);
            }
        });
        MnRekapSEPRalanKunjunganBanyak.add(MnRujukInternal);

        MnKonsul.setBackground(new java.awt.Color(242, 242, 242));
        MnKonsul.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnKonsul.setText("Kasus Konsul");
        ...
        MnKonsul.setIconTextGap(5);
        MnKonsul.setName("MnKonsul"); // NOI18N
        MnKonsul.setPreferredSize(new java.awt.Dimension(150, 25));
        MnKonsul.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKonsulActionPerformed(evt);
            }
        });
        MnRekapSEPRalanKunjunganBanyak.add(MnKonsul);

        Popup.add(MnRekapSEPRalanKunjunganBanyak);

        MnRekapSemuaSEPKunjunganBanyak.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapSemuaSEPKunjunganBanyak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRekapSemuaSEPKunjunganBanyak.setText("Rekap Semua SEP Kunj. Banyak PerNoRM PerTgl.");
        MnRekapSemuaSEPKunjunganBanyak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapSemuaSEPKunjunganBanyak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapSemuaSEPKunjunganBanyak.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapSemuaSEPKunjunganBanyak.setIconTextGap(5);
        MnRekapSemuaSEPKunjunganBanyak.setName("MnRekapSemuaSEPKunjunganBanyak"); // NOI18N
        MnRekapSemuaSEPKunjunganBanyak.setOpaque(true);
        MnRekapSemuaSEPKunjunganBanyak.setPreferredSize(new java.awt.Dimension(300, 25));

        MnRujukInternal1.setBackground(new java.awt.Color(242, 242, 242));
        MnRujukInternal1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRujukInternal1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRujukInternal1.setText("Kasus Rujuk Internal");
        MnRujukInternal1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRujukInternal1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRujukInternal1.setIconTextGap(5);
        MnRujukInternal1.setName("MnRujukInternal1"); // NOI18N
        MnRujukInternal1.setPreferredSize(new java.awt.Dimension(150, 25));
        MnRujukInternal1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRujukInternal1ActionPerformed(evt);
            }
        });
        MnRekapSemuaSEPKunjunganBanyak.add(MnRujukInternal1);

        MnKonsul1.setBackground(new java.awt.Color(242, 242, 242));
        MnKonsul1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKonsul1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnKonsul1.setText("Kasus Konsul");
        MnKonsul1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKonsul1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnKonsul1.setIconTextGap(5);
        MnKonsul1.setName("MnKonsul1"); // NOI18N
        MnKonsul1.setPreferredSize(new java.awt.Dimension(150, 25));
        MnKonsul1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKonsul1ActionPerformed(evt);
            }
        });
        MnRekapSemuaSEPKunjunganBanyak.add(MnKonsul1);

        Popup.add(MnRekapSemuaSEPKunjunganBanyak);
        ...
        MnRekapSEPRanap.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        MnRekapSEPRalan.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        MnRekapSEPRalanRM.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapSEPRalanRM.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapSEPRalanRM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRekapSEPRalanRM.setText("Rekap No. SEP R. JALAN Rehab Medik");
        MnRekapSEPRalanRM.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapSEPRalanRM.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapSEPRalanRM.setIconTextGap(8);
        MnRekapSEPRalanRM.setName("MnRekapSEPRalanRM"); // NOI18N
        MnRekapSEPRalanRM.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapSEPRalanRM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapSEPRalanRMBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(MnRekapSEPRalanRM);

        MnRekapSEPRalanUPD.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapSEPRalanUPD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapSEPRalanUPD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRekapSEPRalanUPD.setText("Rekap No. SEP R. JALAN UPD");
        MnRekapSEPRalanUPD.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapSEPRalanUPD.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapSEPRalanUPD.setIconTextGap(8);
        MnRekapSEPRalanUPD.setName("MnRekapSEPRalanUPD"); // NOI18N
        MnRekapSEPRalanUPD.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapSEPRalanUPD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapSEPRalanUPDBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(MnRekapSEPRalanUPD);
        ...
        MnRekapObatDicari.setName("MnRekapObatDicari"); // NOI18N
        MnRekapObatDicari.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapObatDicari.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapObatDicariBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(MnRekapObatDicari);
        ...
        MnRekapTindakan.setName("MnRekapTindakan"); // NOI18N
        MnRekapTindakan.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapTindakan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapTindakanBtnPrintActionPerformed(evt);
            }
        });
        ...
        MnRekapPeriksaLab.setPreferredSize(new java.awt.Dimension(300, 25));
        ...
        MnRekapSEPRalanAproval.setBackground(new java.awt.Color(242, 242, 242));
        MnRekapSEPRalanAproval.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRekapSEPRalanAproval.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/export-excel.png"))); // NOI18N
        MnRekapSEPRalanAproval.setText("Rekap SEP R. Jalan Aproval");
        MnRekapSEPRalanAproval.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRekapSEPRalanAproval.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRekapSEPRalanAproval.setIconTextGap(8);
        MnRekapSEPRalanAproval.setName("MnRekapSEPRalanAproval"); // NOI18N
        MnRekapSEPRalanAproval.setPreferredSize(new java.awt.Dimension(300, 25));
        MnRekapSEPRalanAproval.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRekapSEPRalanAprovalBtnPrintActionPerformed(evt);
            }
        });
        ...
        tglMati.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        noLP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        tglRencanaKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        WindowCariObat.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowCariObat.setName("WindowCariObat"); // NOI18N
        ...
        internalFrame15.add(Scroll33, java.awt.BorderLayout.CENTER);
        ...
        BtnCloseIn9.setBounds(680, 34, 100, 30);
        ...
        BtnRekapObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRekapObatActionPerformed(evt);
            }
        });
        internalFrame19.add(BtnRekapObat);
        BtnRekapObat.setBounds(500, 34, 165, 30);

        TobatCari.setForeground(new java.awt.Color(0, 0, 0));
        TobatCari.setName("TobatCari"); // NOI18N
        TobatCari.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TobatCariKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TobatCariKeyTyped(evt);
            }
        });
        internalFrame19.add(TobatCari);
        TobatCari.setBounds(83, 10, 270, 23);

        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Cari Obat : ");
        jLabel3.setName("jLabel3"); // NOI18N
        internalFrame19.add(jLabel3);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        DTPCari3.setDisplayFormat("dd-MM-yyyy");
        DTPCari3.setName("DTPCari3"); // NOI18N
        DTPCari3.setOpaque(false);
        DTPCari3.setPreferredSize(new java.awt.Dimension(95, 23));
        internalFrame19.add(DTPCari3);
        DTPCari3.setBounds(83, 38, 95, 23);
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        DTPCari4.setDisplayFormat("dd-MM-yyyy");
        DTPCari4.setName("DTPCari4"); // NOI18N
        DTPCari4.setOpaque(false);
        DTPCari4.setPreferredSize(new java.awt.Dimension(95, 23));
        internalFrame19.add(DTPCari4);
        DTPCari4.setBounds(215, 38, 95, 23);

        jLabel59.setForeground(new java.awt.Color(0, 0, 0));
        jLabel59.setText("Dari SEP : ");
        jLabel59.setName("jLabel59"); // NOI18N
        internalFrame19.add(jLabel59);
        jLabel59.setBounds(310, 38, 70, 23);
        ...
        internalFrame19.add(cmbRawat);
        cmbRawat.setBounds(382, 38, 95, 23);
        ...
        BtnCari2.setPreferredSize(new java.awt.Dimension(65, 30));
        BtnCari2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCari2ActionPerformed(evt);
            }
        });
        internalFrame19.add(BtnCari2);
        BtnCari2.setBounds(360, 10, 70, 23);

        internalFrame15.add(internalFrame19, java.awt.BorderLayout.PAGE_END);
        ...
        WindowCariTindakan.setName("WindowCariTindakan"); // NOI18N
        ...
        BtnRekapTindakan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRekapTindakanActionPerformed(evt);
            }
        });
        ...
        TtindakanCari.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TtindakanCariKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TtindakanCariKeyTyped(evt);
            }
        });
        internalFrame16.add(TtindakanCari);
        TtindakanCari.setBounds(202, 53, 260, 23);

        jLabel55.setForeground(new java.awt.Color(0, 0, 0));
        jLabel55.setText("Tindakan : ");
        jLabel55.setName("jLabel55"); // NOI18N
        internalFrame16.add(jLabel55);
        jLabel55.setBounds(2, 53, 80, 23);

        jLabel57.setForeground(new java.awt.Color(0, 0, 0));
        jLabel57.setText("Tgl. SEP : ");
        jLabel57.setName("jLabel57"); // NOI18N
        internalFrame16.add(jLabel57);
        jLabel57.setBounds(2, 25, 80, 23);

        DTPCari5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        internalFrame16.add(DTPCari5);
        DTPCari5.setBounds(86, 25, 95, 23);

        jLabel58.setForeground(new java.awt.Color(0, 0, 0));
        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel58.setText("s.d");
        jLabel58.setName("jLabel58"); // NOI18N
        jLabel58.setPreferredSize(new java.awt.Dimension(23, 23));
        internalFrame16.add(jLabel58);
        jLabel58.setBounds(185, 25, 23, 23);

        DTPCari6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        cmbRawat1.setBounds(86, 81, 95, 23);

        cmbTindakan.setForeground(new java.awt.Color(0, 0, 0));
        cmbTindakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua Tindakan", "Pertindakan" }));
        ...
        internalFrame16.add(cmbTindakan);
        cmbTindakan.setBounds(86, 53, 110, 23);
        ...
        DTPCari7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        DTPCari8.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        DTPCari9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        DTPCari10.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        scrollInput4.setPreferredSize(new java.awt.Dimension(102, 1200));

        tbRekapKunjungan.setName("tbRekapKunjungan"); // NOI18N
        scrollInput4.setViewportView(tbRekapKunjungan);
        ...
        TPasien.setBounds(319, 12, 400, 23);
        ...
        NoKartu.setBounds(113, 68, 120, 23);
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        TanggalSEP.setBounds(288, 96, 90, 23);
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        TanggalRujuk.setBounds(113, 96, 90, 23);
        ...
        jLabel23.setBounds(420, 68, 100, 23);
        ...
        NoRujukan.setBounds(523, 68, 195, 23);
        ...
        label_surat.setBounds(420, 96, 100, 23);
        ...
        btnPPKRujukan.setBounds(562, 152, 28, 23);

        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("PPK Rujukan :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput1.add(jLabel10);
        jLabel10.setBounds(0, 152, 110, 23);
        ...
        KdPpkRujukan.setBounds(113, 152, 75, 23);
        ...
        NmPpkRujukan.setBounds(190, 152, 370, 23);

        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("Diagnosa Awal :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput1.add(jLabel11);
        jLabel11.setBounds(0, 180, 110, 23);
        ...
        NmPenyakit.setBounds(190, 180, 370, 23);
        ...
        btnDiagnosa.setBounds(562, 180, 28, 23);
        ...
        btnPoli.setBounds(562, 208, 28, 23);
        ...
        NmPoli.setBounds(190, 208, 370, 23);
        ...
        KdPoli.setBounds(113, 208, 75, 23);
        ...
        JenisPelayanan.setBounds(690, 152, 80, 23);
        ...
        hakKelas.setBounds(690, 208, 80, 23);
        ...
        LabTglkll.setBounds(343, 403, 93, 23);
        ...
        LakaLantas.setBounds(113, 403, 230, 23);
        ...
        LabNoSup.setBounds(185, 543, 93, 23);
        ...
        jLabel24.setBounds(233, 40, 50, 23);
        ...
        JenisPeserta.setBounds(288, 40, 250, 23);
        ...
        jLabel25.setBounds(233, 68, 50, 23);
        ...
        Status.setBounds(288, 68, 100, 23);
        ...
        rujukanSEP.setBounds(223, 124, 250, 23);
        ...
        AsalRujukan.setBounds(113, 124, 106, 23);

        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("Eksekutif :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput1.add(jLabel15);
        jLabel15.setBounds(600, 180, 85, 23);
        ...
        Eksekutif.setBounds(690, 180, 80, 23);
        ...
        LabelKelas1.setBounds(770, 152, 90, 23);
        ...
        LabKetkll.setBounds(0, 431, 110, 23);
        ...
        TanggalKejadian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        TanggalKejadian.setBounds(443, 403, 90, 23);
        ...
        KdProv.setBounds(113, 459, 60, 23);
        ...
        NmProv.setBounds(176, 459, 500, 23);
        ...
        NmKab.setBounds(176, 487, 500, 23);
        ...
        NmKec.setBounds(176, 515, 500, 23);
        ...
        btnProv.setBounds(680, 459, 28, 23);
        ...
        btnKab.setBounds(680, 487, 28, 23);
        ...
        NoSEPSuplesi.setBounds(284, 543, 392, 23);
        ...
        LabelPoli.setBounds(0, 208, 110, 23);
        ...
        KasusKatarak.setBounds(865, 180, 75, 23);

        jLabel42.setForeground(new java.awt.Color(0, 0, 0));
        jLabel42.setText("DPJP :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput1.add(jLabel42);
        jLabel42.setBounds(480, 124, 40, 23);
        ...
        noSurat.setBounds(523, 96, 195, 23);
        ...
        NmDPJP.setBounds(593, 124, 315, 23);
        ...
        btnDPJP.setBounds(910, 124, 28, 23);
        ...
        btnNoSurat.setBounds(720, 96, 28, 23);
        ...
        tujuanKun.setBounds(113, 264, 110, 23);
        ...
        flagPro.setBounds(113, 292, 210, 23);
        ...
        kdPenunjang.setBounds(424, 292, 150, 23);
        ...
        btnDPJPlayan.setBounds(562, 236, 28, 23);
        ...
        nmdpjpLayan.setBounds(190, 236, 370, 23);

        JK.setEditable(false);
        JK.setForeground(new java.awt.Color(0, 0, 0));
        JK.setName("JK"); // NOI18N
        FormInput1.add(JK);
        JK.setBounds(628, 40, 90, 23);
        ...
        btnNoRujukanInap.setBounds(753, 68, 32, 23);
        ...
        kdNaikKls.setBounds(690, 236, 33, 23);
        ...
        nmKlsNaik.setBounds(728, 236, 80, 23);
        ...
        btnNaikKls.setBounds(810, 236, 28, 23);
        ...
        Kddpjp.setBounds(523, 124, 67, 23);
        ...
        KdPenyakit.setBounds(113, 180, 75, 23);
        ...
        KddpjpLayan.setBounds(113, 236, 75, 23);
        ...
        btnBatalNaikKls.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBatalNaikKlsActionPerformed(evt);
            }
        });
        FormInput1.add(btnBatalNaikKls);
        btnBatalNaikKls.setBounds(845, 236, 170, 23);
        ...
        tbSEP.getTableHeader().setReorderingAllowed(false);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-02-2026" }));
        ...
        TabRawat.addTab("25 Riwayat Kunjungan Terakhir", internalFrame13);
            ...
            if (JenisPelayanan.getSelectedIndex() == 0) {
                ...
                if (Sequel.cariIsi("select kd_poli from reg_periksa where no_rawat='" + tbSEP.getValueAt(tbSEP.getSelectedRow(), 2).toString() + "'").equals("HIV")) {
                    ...
                    Valid.MyReport("rptBuktiRegistrasiRZvct.jasper", "report", "::[ Bukti Registrasi Rawat Jalan Poliklinik VCT ]::",
                            "SELECT bs.no_sep, bs.no_kartu, concat(p.no_rkm_medis,' (No. Reg. : ',rp.no_reg,')') no_rkm_medis, p.nm_pasien, "
...
//                            + "and jnspelayanan='2'", param);
                    ...
                    if (Sequel.cariIsi("select kd_poli from reg_periksa where no_rawat='" + tbSEP.getValueAt(tbSEP.getSelectedRow(), 2).toString() + "'").equals("IGDK")) {
...
//            }
            ...
            if (cekSEP > 0) {
                Sequel.menyimpantf("bridging_sep", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                    ...
                    Sequel.cariIsi("select ifnull(MAX(urutan_sep)+1,1) from bridging_sep where no_sep='" + NoSEP.getText() + "'"), 
                    nmKlsNaik.getText(), Status.getText(), "tidak"
                });
            } else {
                Sequel.menyimpantf("bridging_sep", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                    NoSEP.getText(), TNoRw.getText(), Valid.SetTgl(TanggalSEP.getSelectedItem() + ""), Valid.SetTgl(TanggalRujuk.getSelectedItem() + ""),
                    ...
                    nmdpjpLayan.getText(), "1", nmKlsNaik.getText(), Status.getText(), "tidak"
                });
            }
...
//sampai sini -------------
    ...
    private void MnRekapSEPRalanRMBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapSEPRalanRMBtnPrintActionPerformed
        if (tbSEP.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa diexport menjadi file excel...!!!!");
            BtnBatal.requestFocus();
        } else if (tbSEP.getRowCount() != 0) {
            ExportSEPRalanFisioterapi();
        }
    ...
    private void MnRekapObatDicariBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapObatDicariBtnPrintActionPerformed
        WindowCariObat.setSize(821, internalFrame1.getHeight() - 40);
    ...
    private void BtnRekapObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRekapObatActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        x = 0;
        for (i = 0; i < tbObat.getRowCount(); i++) {
        ...
        if (x == 0) {
            JOptionPane.showMessageDialog(null, "Silahkan conteng dulu obat yang dipilih..!!!!");
            tbObat.requestFocus();
        } else {
            String obat = "";
            try {
                for (i = 0; i < tbObat.getRowCount(); i++) {
                    if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                        if (obat.equals("")) {
                            obat = "'" + tbObat.getValueAt(i, 1).toString() + "'";
                        } else {
                            obat = obat + ",'" + tbObat.getValueAt(i, 1).toString() + "'";
                        }
                    }
                }
                ...
                if (cmbRawat.getSelectedIndex() == 0) {
                    ...
                    Valid.MyReportToExcel("SELECT b.no_sep 'No. SEP', date_format(b.tglsep,'%d/%m/%Y') 'Tgl. SEP', p.no_rkm_medis 'No. RM', "
                            ...
                            + "and rp.status_lanjut='ralan' and db.nama_brng in (" + obat + ") order by b.tglsep, rp.kd_poli", dialog_simpan);

                    JOptionPane.showMessageDialog(null, "Rekap obat yang dipilih sesuai SEP Rawat Jalan berhasil diexport menjadi file excel,..!!!");
                } else {
                    dialog_simpan = Valid.openDialog();
                    Valid.MyReportToExcel("SELECT b.no_sep 'No. SEP', date_format( b.tglsep, '%d/%m/%Y' ) 'Tgl. SEP', p.no_rkm_medis 'No. RM', "
                            ...
                            + "b.tglsep BETWEEN '" + Valid.SetTgl(DTPCari3.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari4.getSelectedItem() + "") + "' "
                            + "and rp.status_lanjut='ranap' and db.nama_brng in (" + obat + ") order by b.tglsep, bs.nm_bangsal", dialog_simpan);

                    JOptionPane.showMessageDialog(null, "Rekap obat yang dipilih sesuai SEP Rawat Inap berhasil diexport menjadi file excel,..!!!");
                }
                WindowCariObat.dispose();
            } catch (Exception e) {
    ...
    private void TobatCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TobatCariKeyTyped
        evt.setKeyChar(Character.toUpperCase(evt.getKeyChar()));
    }//GEN-LAST:event_TobatCariKeyTyped
    ...
    private void MnRekapTindakanBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapTindakanBtnPrintActionPerformed
        WindowCariTindakan.setSize(495, 165);
        ...
        TtindakanCari.setEnabled(false);
    ...
    private void BtnRekapTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRekapTindakanActionPerformed
        if (cmbTindakan.getSelectedIndex() == 1 && TtindakanCari.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Isi dulu nama tindakan medis yang dicari...!");
            TtindakanCari.requestFocus();
        } else if (cmbTindakan.getSelectedIndex() == 1
                && (Sequel.cariInteger("select count(-1) from jns_perawatan where nm_perawatan like '%" + TtindakanCari.getText() + "%'") == 0
                && Sequel.cariInteger("select count(-1) from jns_perawatan_radiologi where nm_perawatan like '%" + TtindakanCari.getText() + "%'") == 0)) {
            JOptionPane.showMessageDialog(null, "Cek lagi penulisan nama tindakannya...!");
            TtindakanCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            if (cmbRawat1.getSelectedIndex() == 0) {
                ...
                if (cmbTindakan.getSelectedIndex() == 0) {
                    Valid.MyReportToExcel("SELECT bs.no_sep 'No. SEP', DATE_FORMAT(bs.tglsep,'%d/%m/%Y') 'Tgl. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', "
                            ...
                            + "bs.tglsep BETWEEN '" + Valid.SetTgl(DTPCari5.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari6.getSelectedItem() + "") + "' and rp.status_lanjut='Ralan' "
                            + "union all "
                            ...
                            + "and rp.status_lanjut='Ralan'", dialog_simpan);
                } else {
                    Valid.MyReportToExcel("SELECT bs.no_sep 'No. SEP', DATE_FORMAT(bs.tglsep,'%d/%m/%Y') 'Tgl. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', "
                            + "DATE_FORMAT(rj.tgl_perawatan,'%d/%m/%Y') 'Tgl. Pemeriksaan', pl.nm_poli 'Poliklinik', d.nm_dokter 'Nama Dokter', "
                            + "jp.nm_perawatan 'Nama Pemeriksaan' from bridging_sep bs inner join reg_periksa rp on rp.no_rawat=bs.no_rawat "
                ...
                if (cmbTindakan.getSelectedIndex() == 0) {
                    Valid.MyReportToExcel("SELECT bs.no_sep 'No. SEP', DATE_FORMAT(bs.tglsep,'%d/%m/%Y') 'Tgl. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', "
                            ...
                            + "bs.tglsep BETWEEN '" + Valid.SetTgl(DTPCari5.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari6.getSelectedItem() + "") + "' and rp.status_lanjut='Ranap' "
                            + "union all "
                            + "SELECT bs.no_sep 'No. SEP', DATE_FORMAT(bs.tglsep,'%d/%m/%Y') 'Tgl. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', "
                            + "DATE_FORMAT(ri.tgl_perawatan,'%d/%m/%Y') 'Tgl. Pemeriksaan', b.nm_bangsal 'Ruang Perawatan', pg.nama 'Nama Dokter', "
                            + "jp.nm_perawatan 'Nama Pemeriksaan' FROM bridging_sep bs INNER JOIN reg_periksa rp ON rp.no_rawat = bs.no_rawat "
                            ...
                            + "bs.tglsep BETWEEN '" + Valid.SetTgl(DTPCari5.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari6.getSelectedItem() + "") + "' and rp.status_lanjut='Ranap'", dialog_simpan);
                } else {
                    Valid.MyReportToExcel("SELECT bs.no_sep 'No. SEP', DATE_FORMAT(bs.tglsep,'%d/%m/%Y') 'Tgl. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', "
                            + "DATE_FORMAT(ri.tgl_perawatan,'%d/%m/%Y') 'Tgl. Pemeriksaan', b.nm_bangsal 'Ruang Perawatan', pg.nama 'Nama Dokter', "
                            + "jp.nm_perawatan 'Nama Pemeriksaan' FROM bridging_sep bs INNER JOIN reg_periksa rp ON rp.no_rawat = bs.no_rawat "
    ...
    private void TtindakanCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TtindakanCariKeyTyped
        evt.setKeyChar(Character.toUpperCase(evt.getKeyChar()));
    ...
    private void MnRekapSEPRalanPasienMatiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapSEPRalanPasienMatiBtnPrintActionPerformed
        if (tbSEP.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa diexport menjadi file excel...!!!!");
            BtnBatal.requestFocus();
        } else if (tbSEP.getRowCount() != 0) {            
            ExportSEPRalanMeninggal();
        }
    }//GEN-LAST:event_MnRekapSEPRalanPasienMatiBtnPrintActionPerformed

    private void MnRekapSEPRalanAprovalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapSEPRalanAprovalBtnPrintActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        dialog_simpan = Valid.openDialog();
        Valid.MyReportToExcel("SELECT bs.no_sep 'No. SEP', bs.no_kartu 'No. Kartu', bs.nomr 'No. RM', bs.nama_pasien 'Nama Pasien', "
                + "DATE_FORMAT(bs.tglsep,'%d/%m/%Y') 'Tgl. SEP', DATE_FORMAT(bsp.tgl_pengajuan,'%d/%m/%Y') 'Tgl. Pengajuan', "
                + "if(bsp.jns_pelayanan='1','R. Inap','R. Jalan') 'Jns. Pelayanan', bsp.des_jns_pengajuan 'Jns. Pengajuan', bsp.keterangan 'Keterangan Pengajuan', "
                + "DATE_FORMAT(bsa.tgl_aproval,'%d/%m/%Y') 'Tgl. Aproval', bsa.keterangan 'Keterangan Aproval' FROM bridging_sep bs "
                + "inner join bridging_sep_pengajuan bsp on bsp.no_rawat=bs.no_rawat "
                + "inner join bridging_sep_aproval_pengajuan bsa on bsa.no_rawat=bs.no_rawat WHERE "
                + "bsp.tgl_pengajuan between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                + "order by bsp.tgl_pengajuan", dialog_simpan);

        JOptionPane.showMessageDialog(null, "Data SEP Rawat Jalan Aproval berhasil diexport menjadi file excel,..!!!");
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnRekapSEPRalanAprovalBtnPrintActionPerformed

    private void btnBatalNaikKlsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBatalNaikKlsActionPerformed
        kdNaikKls.setText("");
        nmKlsNaik.setText("");
    ...
    private void MnRujukInternalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukInternalActionPerformed
        if (tbSEP.getRowCount() == 0) {
            ...
            cekSEP = 1;
            kasus = "rujukan";
            tampilJumlahKunjungan();
            ExportSEPKunjunganBanyak();
        }
    ...
    private void MnRujukInternal1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukInternal1ActionPerformed
        if (tbSEP.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa diexport menjadi file excel...!!!!");
            BtnBatal.requestFocus();
        } else if (tbSEP.getRowCount() != 0) {
    ...
    }//GEN-LAST:event_MnRujukInternal1ActionPerformed

    private void MnKonsul1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKonsul1ActionPerformed
        if (tbSEP.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa diexport menjadi file excel...!!!!");
            BtnBatal.requestFocus();
        } else if (tbSEP.getRowCount() != 0) {
    ...
    }//GEN-LAST:event_MnKonsul1ActionPerformed

    private void MnRekapSEPRalanUPDBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapSEPRalanUPDBtnPrintActionPerformed
        if (tbSEP.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa diexport menjadi file excel...!!!!");
            BtnBatal.requestFocus();
        } else if (tbSEP.getRowCount() != 0) {
    ...
    }//GEN-LAST:event_MnRekapSEPRalanUPDBtnPrintActionPerformed

    private void MnRekapPasienRanapBlmPulangBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapPasienRanapBlmPulangBtnPrintActionPerformed
        dialog_simpan = Valid.openDialog();
        if (Valid.MyReportToExcelBoolean("select bs.no_sep 'No. SEP',p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', date_format(rp.tgl_registrasi,'%d-%m-%Y') 'Tgl. MRS', b.nm_bangsal 'Ruang Rawat', "
                + "if(dr.no_rawat is null,'-',pg.nama) 'DPJP', "
                + "concat(if(to_days(NOW()) - to_days(concat(ki.tgl_masuk,' ',ki.jam_masuk)) = 0, "
                + "if(time_to_sec(NOW()) - time_to_sec(concat(ki.tgl_masuk,' ',ki.jam_masuk)) > (3600*1),1,0),to_days(NOW()) - to_days(concat(ki.tgl_masuk,' ',ki.jam_masuk))),' hari') 'Lama Rawat', "
                + "ki.diagnosa_awal 'Diagnosa Awal' from kamar_inap ki inner join kamar k on k.kd_kamar=ki.kd_kamar "
                + "inner join bangsal b on b.kd_bangsal=k.kd_bangsal inner join reg_periksa rp on rp.no_rawat=ki.no_rawat "
                + "inner join pasien p on p.no_rkm_medis=rp.no_rkm_medis inner join bridging_sep bs on bs.no_rawat=ki.no_rawat "
                + "left join dpjp_ranap dr on dr.no_rawat=ki.no_rawat left join pegawai pg on pg.nik=dr.kd_dokter where "
                + "ki.stts_pulang ='-' and bs.jnspelayanan='1' order by b.nm_gedung", dialog_simpan) == true) {
            JOptionPane.showMessageDialog(null, "Data pasien rawat inap yang masih dirawat berhasil diexport menjadi file excel,..!!!");
        } else {
            JOptionPane.showMessageDialog(null, "Data pasien rawat inap yang masih dirawat gagal diexport menjadi file excel,..!!!");
        }
    }//GEN-LAST:event_MnRekapPasienRanapBlmPulangBtnPrintActionPerformed
    ...
    private widget.Button btnBatalNaikKls;
    ...
    public widget.Table tbRekapKunjungan;
    ...
    public void isCek() {
        ...
        BtnHapus.setEnabled(akses.getHapusSEP());
    }
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (cekSEP > 0) {
                    if (Sequel.menyimpantf("bridging_sep", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                        ...
                        KdKec.getText(), NmKec.getText(), noSurat.getText(), Kddpjp.getText(), NmDPJP.getText(), "", hakKelas.getSelectedItem().toString().substring(0, 1),
                        kdNaikKls.getText(), pembi, pngJwb.getText(), tujuanKun.getSelectedItem().toString(), flag, kdpnjg, asesmen, KddpjpLayan.getText(), nmdpjpLayan.getText(),
                        Sequel.cariIsi("select ifnull(MAX(urutan_sep)+1,1) from bridging_sep where no_sep='" + response.asText() + "'"), 
                        nmKlsNaik.getText(), Status.getText(), "tidak"
                    }) == true) {
                    ...
                    if (Sequel.menyimpantf("bridging_sep_backup", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                        ...
                        Sequel.menyimpantf("bridging_sep_backup", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                            ...
                            KdKec.getText(), NmKec.getText(), noSurat.getText(), Kddpjp.getText(), NmDPJP.getText(), "", hakKelas.getSelectedItem().toString().substring(0, 1),
                            kdNaikKls.getText(), pembi, pngJwb.getText(), tujuanKun.getSelectedItem().toString(), flag, kdpnjg, asesmen, KddpjpLayan.getText(), 
                            nmdpjpLayan.getText(), api.Decrypt(root.path("response").asText(), utc), "tidak"
                        });
                    }
                    emptTeks();
                    tampil();
                    ...
                    if (Sequel.menyimpantf("bridging_sep", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                        ...
                        KddpjpLayan.getText(), nmdpjpLayan.getText(), "1", nmKlsNaik.getText(), Status.getText(), "tidak"
                    }) == true) {
                        Sequel.menyimpan("rujuk_masuk", "?,?,?,?,?,?,?,?,?,?,?", 11, new String[]{
                            TNoRw.getText(), NmPpkRujukan.getText(), "-", NoRujukan.getText(), "0", NmPpkRujukan.getText(), KdPenyakit.getText(), "-",
                            "-", NoBalasan.getText(), kode_rujukanya.getText()
...
//                     }
                ...
                if (Sequel.menyimpantf("bridging_sep_backup", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                    ...
                    NoSEPSuplesi.getText(), KdProv.getText(), NmProv.getText(), KdKab.getText(), NmKab.getText(),
                    KdKec.getText(), NmKec.getText(), noSurat.getText(), Kddpjp.getText(), NmDPJP.getText(), "", hakKelas.getSelectedItem().toString().substring(0, 1),
                    kdNaikKls.getText(), pembi, pngJwb.getText(), tujuanKun.getSelectedItem().toString(), flag, kdpnjg, 
                    asesmen, KddpjpLayan.getText(), nmdpjpLayan.getText(), respons, "tidak"
                }) == false) {
                    Sequel.menyimpantf("bridging_sep_backup", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                        "-", TNoRw.getText(), Valid.SetTgl(TanggalSEP.getSelectedItem() + "") + " " + Sequel.cariIsi("select time(now())"), Valid.SetTgl(TanggalRujuk.getSelectedItem() + ""),
                        NoRujukan.getText(), KdPpkRujukan.getText(), rujukanSEP.getText(), KdPPK.getText(), NmPPK.getText(),
...
//                NmPpkRujukan.setText(NmPPK.getText());
    ...
    private void ExportSEPKunjunganBanyak() {
        ...
        for (int r = 0; r < row; r++) {
            Sequel.menyimpan("temporary", "'0','"
                    ...
                    + tabMode8.getValueAt(r, 2).toString().replaceAll("'", "") + "','"
    ...
    private void ExportSEPRalanMeninggal() {
        ...
        try {
            sb.append("select bs.*, ifnull(concat('474.3/',pm.no_surat),'-') noSurat, ");
            sb.append("DATE_FORMAT(bs.tglsep,'%d/%m/%Y') tglSep, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(pm.tanggal,'%d/%m/%Y') tglMati, ");
            sb.append("time_format(pm.jam,'%H:%i:%s') jamMati from pasien_mati pm ");
            sb.append("inner join pasien p on p.no_rkm_medis=pm.no_rkm_medis inner join bridging_sep bs on bs.nomr=pm.no_rkm_medis WHERE ");
            sb.append("bs.tglsep BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' ");
            sb.append("and bs.jnspelayanan='2' order by pm.tanggal, pm.jam");
    ...
    private void ExportSEPRanapMeninggal() {
        ...
        try {
            ...
            sb.append("inner join pasien p on p.no_rkm_medis=pm.no_rkm_medis inner join bridging_sep bs on bs.nomr=pm.no_rkm_medis WHERE ");
            sb.append("bs.tglsep BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' ");
            sb.append("and bs.jnspelayanan='1' order by pm.tanggal, pm.jam");
            ps7 = koneksi.prepareStatement(sb.toString());
    ...
    private void ExportSEPRanap() {
        ...
        Valid.MyReportToExcel("SELECT p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', bs.no_sep 'No. SEP', d.nm_dokter 'DPJP', b.nm_bangsal 'Ruang Perawatan', "
                ...
                + "IF(ri.no_rawat IS NOT NULL, DATE_FORMAT(ri.tgl_perawatan,'%d/%m/%Y'),'-') 'Tgl. Permintaan Knt. Darah', "
                + "IF(jp.kd_jenis_prw IS NOT NULL, jp.nm_perawatan,'-') 'Jenis Darah', IF(hp.jml_pa IS NOT NULL, 'Ada', '-') 'Hasil Lab. PA', "
                + "IF(hp.jml_pa IS NOT NULL, concat(hp.jml_pa,' X'), '-') 'Jml Pmrksaan. Lab. PA' FROM bridging_sep bs "
                + "INNER JOIN reg_periksa rp ON rp.no_rawat = bs.no_rawat "
                + "INNER JOIN pasien p ON p.no_rkm_medis = rp.no_rkm_medis "
                + "INNER JOIN dpjp_ranap dr ON dr.no_rawat = bs.no_rawat "
                + "INNER JOIN dokter d ON d.kd_dokter = dr.kd_dokter "
                + "INNER JOIN kamar_inap ki ON ki.no_rawat = bs.no_rawat "
                + "INNER JOIN kamar k ON k.kd_kamar = ki.kd_kamar "
                + "INNER JOIN bangsal b ON b.kd_bangsal = k.kd_bangsal "
                + "LEFT JOIN rawat_inap_pr ri ON ri.no_rawat = bs.no_rawat AND ri.kd_jenis_prw IN ("
                + "'2024RI1P017','2024RI1P009','2024RI1P003','2024RI1P004',"
                + "'2024RI1P018','2024RI1P001','2024RI1P005','2024RI1P006',"
                + "'2024RI1P007','2024RI1P013','2024RI1P016','2024RI1P002',"
                + "'2024RI1P011','2024RI1P010','2024RI1P008','2024RI1P014',"
                + "'2024RI1P015','2024RI1P012') "
                + "LEFT JOIN jns_perawatan_inap jp ON jp.kd_jenis_prw = ri.kd_jenis_prw "
                + "LEFT JOIN (SELECT no_rawat, COUNT(*) jml_pa FROM hasil_patologi_anatomi GROUP BY no_rawat) hp ON hp.no_rawat = bs.no_rawat WHERE "
                ...
                + "AND ki.stts_pulang NOT IN ('-','Pindah Kamar') ORDER BY bs.no_sep, ri.tgl_perawatan", dialog_simpan);
    ...
    private void ExportSEPRalan() {
        ...
        Valid.MyReportToExcel("SELECT p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', DATE_FORMAT(bs.tglsep,'%d-%m-%Y') 'Tgl. SEP', bs.no_sep 'No. SEP', "
                ...
                + "CAST(UPPER(bs.sep_resep_obat_kronis) AS CHAR) 'SEP Resep Obat Kronis', CAST(concat(COUNT(DISTINCT rp.no_rawat),' X') AS CHAR) 'Jml. Kunjungan', "
                + "IF(hp.jml_pa IS NOT NULL, 'Ada', '-') 'Hasil Lab. PA', IF(hp.jml_pa IS NOT NULL, concat(hp.jml_pa,' X'), '-') 'Jml Pmrksaan. Lab. PA', "
                + "if(it.no_sep is not null,'YA','-') 'SEP Kunjungan Iter' FROM bridging_sep bs INNER JOIN reg_periksa rp ON rp.no_rawat = bs.no_rawat "
                + "INNER JOIN pasien p ON p.no_rkm_medis = rp.no_rkm_medis "
                + "INNER JOIN dokter d ON d.kd_dokter = rp.kd_dokter "
                + "INNER JOIN poliklinik pl ON pl.kd_poli = rp.kd_poli "
                + "LEFT JOIN (SELECT bs2.no_sep, COUNT(pa.no_rawat) jml_pa FROM bridging_sep bs2 JOIN hasil_patologi_anatomi pa ON pa.no_rawat = bs2.no_rawat GROUP BY bs2.no_sep) hp ON hp.no_sep = bs.no_sep "
                + "LEFT JOIN (select bs3.no_sep from bridging_sep bs3 join iter_obat_bpjs i on i.no_sep=bs3.no_sep group by bs3.no_sep) it on it.no_sep=bs.no_sep "
    ...
    private void ExportSEPRalanUPD() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        dialog_simpan = Valid.openDialog();
        Valid.MyReportToExcel("select bs.no_sep 'No. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', "
                + "date_format(r.tgl_perawatan,'%d-%m-%Y') 'Tgl. Permintaan Knt. Darah', jp.nm_perawatan 'Jenis Darah', pl.nm_poli 'Poliklinik/Inst.', "
                + "pg.nama 'Nama Dokter' from rawat_jl_drpr r "
                + "inner join jns_perawatan jp on jp.kd_jenis_prw=r.kd_jenis_prw "
                + "inner join reg_periksa rp on rp.no_rawat=r.no_rawat "
                + "inner join pasien p on p.no_rkm_medis=rp.no_rkm_medis "
                + "inner join poliklinik pl on pl.kd_poli=rp.kd_poli "
                + "inner join pegawai pg on pg.nik=rp.kd_dokter "
                + "inner join bridging_sep bs on bs.no_rawat=r.no_rawat where "
                + "rp.tgl_registrasi BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                + "and jp.kd_jenis_prw in ('2024RJ1P018','2024RJ1P017','2024RJ1P016','2024RJ1P015','2024RJ1P014','2024RJ1P013',"
                + "'2024RJ1P012','2024RJ1P011','2024RJ1P010','2024RJ1P009','2024RJ1P008','2024RJ1P007',"
                + "'2024RJ1P006','2024RJ1P005','2024RJ1P004','2024RJ1P003','2024RJ1P002','2024RJ1P001') "
                + "order by r.tgl_perawatan", dialog_simpan);

        JOptionPane.showMessageDialog(null, "Data SEP Rawat Jalan UPD berhasil diexport menjadi file excel,..!!!");
        this.setCursor(Cursor.getDefaultCursor());
    }

    private void ExportSEPRalanFisioterapi() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        dialog_simpan = Valid.openDialog();

        Valid.MyReportToExcel("SELECT bs.no_sep 'No. SEP', p.no_rkm_medis 'No. RM', p.nm_pasien 'Nama Pasien', date_format(rp.tgl_registrasi,'%d-%m-%Y') 'Tgl. Kunjungan', "
                + "dr.jns_rehabmedik 'Jns. Rehab Medik', ifnull(pg.nama,'-') 'Petugas Rehab Medik' from bridging_sep bs "
                + "inner join reg_periksa rp on rp.no_rawat=bs.no_rawat inner join pasien p on p.no_rkm_medis=rp.no_rkm_medis "
                + "inner join data_rehab_medik dr on dr.no_rawat=bs.no_rawat left join pemeriksaan_ralan_petugas pr on pr.no_rawat = rp.no_rawat "
                + "left join pegawai pg on pg.nik = pr.nip WHERE "
                + "bs.tglsep between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                + "and bs.jnspelayanan='2' and rp.tgl_registrasi>='" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' "
                + "and rp.tgl_registrasi<='" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' order by rp.tgl_registrasi, dr.jns_rehabmedik", dialog_simpan);

        JOptionPane.showMessageDialog(null, "Data SEP Rawat Jalan rehab medik berhasil diexport menjadi file excel,..!!!");
        this.setCursor(Cursor.getDefaultCursor());
    }
...
//                JsonNode response = root.path("response");
    ...
    private void simpanBackupSEPAwal() {
        ...
        if (Sequel.menyimpantf("bridging_sep_backup", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
            ...
            KdKec.getText(), NmKec.getText(), noSurat.getText(), Kddpjp.getText(), NmDPJP.getText(), "", hakKelas.getSelectedItem().toString().substring(0, 1),
            kdNaikKls.getText(), pembi, pngJwb.getText(), tujuanKun.getSelectedItem().toString(), flag, kdpnjg, 
            asesmen, KddpjpLayan.getText(), nmdpjpLayan.getText(), requestJson, "tidak"
        }) == false) {
            Sequel.menyimpantf("bridging_sep_backup", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "SEP", 60, new String[]{
                "-", TNoRw.getText(), Valid.SetTgl(TanggalSEP.getSelectedItem() + "") + " " + Sequel.cariIsi("select time(now())"), Valid.SetTgl(TanggalRujuk.getSelectedItem() + ""),
                NoRujukan.getText(), KdPpkRujukan.getText(), rujukanSEP.getText(), KdPPK.getText(), NmPPK.getText(),
    ...
    private void tampilJumlahKunjungan() {
        ...
        //cekSEP = 2 adalah data semua sep kasus rawat jalan & rawat inap
        try {
            if (cekSEP == 1) {
                if (kasus.equals("rujukan")) {
                    ps4 = koneksi.prepareStatement("select distinct a.tgl_registrasi, a.no_rkm_medis, a.jml FROM ((select rp.tgl_registrasi, rp.no_rkm_medis, count(rp.no_rkm_medis) jml "
                            + "from reg_periksa rp inner join rujukan_internal_poli ri on ri.no_rawat=rp.no_rawat "
                            + "WHERE rp.tgl_registrasi BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                            + "and rp.status_lanjut='Ralan' and rp.kd_pj='B01' GROUP BY rp.no_rkm_medis, rp.tgl_registrasi order by rp.tgl_registrasi) as a) where a.jml > 1");
                } else if (kasus.equals("konsul")) {
                    ps4 = koneksi.prepareStatement("select distinct a.tgl_registrasi, a.no_rkm_medis, a.jml FROM ((select rp.tgl_registrasi, rp.no_rkm_medis, count(rp.no_rkm_medis) jml "
                            + "from reg_periksa rp inner join surat_konsul_unit_ralan sk on sk.no_rawat=rp.no_rawat "
                            + "WHERE rp.tgl_registrasi BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                            + "and rp.status_lanjut='Ralan' and rp.kd_pj='B01' GROUP BY rp.no_rkm_medis, rp.tgl_registrasi order by rp.tgl_registrasi) as a) where a.jml > 1");
                }
            } else if (cekSEP == 2) {
                if (kasus.equals("rujukan")) {
                    ps4 = koneksi.prepareStatement("select distinct a.tgl_registrasi, a.no_rkm_medis, a.jml FROM ((select rp.tgl_registrasi, rp.no_rkm_medis, count(rp.no_rkm_medis) jml "
                            + "from reg_periksa rp inner join rujukan_internal_poli ri on ri.no_rawat=rp.no_rawat "
                            + "WHERE rp.tgl_registrasi BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                            + "and rp.kd_pj='B01' GROUP BY rp.no_rkm_medis, rp.tgl_registrasi order by rp.tgl_registrasi) as a) where a.jml > 1");
                } else if (kasus.equals("konsul")) {
                    ps4 = koneksi.prepareStatement("select distinct a.tgl_registrasi, a.no_rkm_medis, a.jml FROM ((select rp.tgl_registrasi, rp.no_rkm_medis, count(rp.no_rkm_medis) jml "
                            + "from reg_periksa rp inner join surat_konsul_unit_ralan sk on sk.no_rawat=rp.no_rawat "
                            + "WHERE rp.tgl_registrasi BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                        ...
                        try {
                            ...
                            while (rs5.next()) {
                                try {
                                    if (cekSEP == 1) {
                                        if (kasus.equals("rujukan")) {
                                            ps6 = koneksi.prepareStatement("select distinct bs.no_sep, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(bs.tglsep,'%d/%m/%Y') tgl "
                                                    + "from bridging_sep bs inner join pasien p on p.no_rkm_medis=bs.nomr "
                                                    + "inner join rujukan_internal_poli ri on ri.no_rawat=bs.no_rawat where "
                                                    + "bs.nomr = '" + rs5.getString("no_rkm_medis") + "' and bs.tglsep = '" + rs5.getString("tgl_registrasi") + "' "
                                                    + "and bs.jnspelayanan = '2' order by bs.tglsep, bs.nomr");
                                        } else if (kasus.equals("konsul")) {
                                            ps6 = koneksi.prepareStatement("select distinct bs.no_sep, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(bs.tglsep,'%d/%m/%Y') tgl "
                                                    + "from bridging_sep bs inner join pasien p on p.no_rkm_medis=bs.nomr "
                                                    + "inner join surat_konsul_unit_ralan sk on sk.no_rawat=bs.no_rawat where "
                                                    + "bs.nomr = '" + rs5.getString("no_rkm_medis") + "' and bs.tglsep = '" + rs5.getString("tgl_registrasi") + "' "
                                                    + "and bs.jnspelayanan = '2' order by bs.tglsep, bs.nomr");
                                        }
                                    } else if (cekSEP == 2) {
    ...
    private void sepTerakhirPasienMatiRalan(String tglA, String tglB, String nokartu) {
        try {
            ps8 = koneksi.prepareStatement("select bs.*, ifnull(concat('474.3/',pm.no_surat),'-') noSurat, "
                    ...
                    + "inner join bridging_sep bs on bs.nomr=pm.no_rkm_medis WHERE "
                    + "bs.tglsep BETWEEN '" + tglA + "' and '" + tglB + "' and bs.no_kartu='" + nokartu + "' and bs.jnspelayanan='2' order by bs.tglsep desc limit 1");
            try {
    ...
    private void sepTerakhirPasienMatiRanap(String tglA, String tglB, String nokartu) {
        try {
            ps8 = koneksi.prepareStatement("select bs.*, ifnull(concat('474.3/',pm.no_surat),'-') noSurat, "
                    + "DATE_FORMAT(bs.tglsep,'%d/%m/%Y') tglSep, p.no_rkm_medis, p.nm_pasien, DATE_FORMAT(pm.tanggal,'%d/%m/%Y') tglMati, "
                    + "time_format(pm.jam,'%H:%i:%s') jamMati from pasien_mati pm inner join pasien p on p.no_rkm_medis=pm.no_rkm_medis "
            ...
            try {
                ...
                while (rs9.next()) {
                    if (rs9.getString("jumlah").equals("banyak")) {
                        sepTerakhirPasienMatiRalan(Valid.SetTgl(DTPCari1.getSelectedItem() + ""),
    ...
    private void cekNoKartuSEPMatiRanap() {
        ...
        try {
            ...
            try {
                ...
                while (rs9.next()) {
                    if (rs9.getString("jumlah").equals("banyak")) {
                        sepTerakhirPasienMatiRanap(Valid.SetTgl(DTPCari1.getSelectedItem() + ""),
                                Valid.SetTgl(DTPCari2.getSelectedItem() + ""),
                                rs9.getString("no_kartu"));
                    }
                }
    ...
    private void tampilFarmasi() {        
        try {
            jml = 0;
            for (s = 0; s < tbObat.getRowCount(); s++) {
                if (tbObat.getValueAt(s, 0).toString().equals("true")) {
                    jml++;
                }
            }
            ...
            for (s = 0; s < tbObat.getRowCount(); s++) {
                if (tbObat.getValueAt(s, 0).toString().equals("true")) {
                    pilih[index] = true;
                    nmObat[index] = tbObat.getValueAt(s, 1).toString();
                    satuan[index] = tbObat.getValueAt(s, 2).toString();
                    index++;
                }
            }
            ...
            for (s = 0; s < jml; s++) {
                tabModeFarmasi.addRow(new Object[]{pilih[s], nmObat[s], satuan[s]});
            }
            
            psFar = koneksi.prepareStatement("SELECT DISTINCT db.nama_brng, db.kode_sat FROM gudangbarang gd "
                    + "INNER JOIN databarang db on db.kode_brng=gd.kode_brng where "
                    + "gd.kd_bangsal in ('APT01','APT02') and db.nama_brng like ? and db.nama_brng not like '(FR)%' and db.nama_brng<>'-' "
                    + "order by db.nama_brng");
            try {
                psFar.setString(1, "%" + TobatCari.getText().trim() + "%");
