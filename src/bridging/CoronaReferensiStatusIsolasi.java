...
public final class CoronaReferensiStatusIsolasi extends javax.swing.JDialog {
    ...
    public CoronaReferensiStatusIsolasi(java.awt.Frame parent, boolean modal) {
        ...
        tbStatusIsolasi.setModel(tabMode);

        //tbKamar.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbKamar.getBackground()));
        tbStatusIsolasi.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbStatusIsolasi.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 2; i++) {
            TableColumn column = tbStatusIsolasi.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbStatusIsolasi.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbStatusIsolasi = new widget.Table();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Referensi Status Isolasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbStatusIsolasi.setAutoCreateRowSorter(true);
        tbStatusIsolasi.setName("tbStatusIsolasi"); // NOI18N
        tbStatusIsolasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbStatusIsolasiKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbStatusIsolasi);
    ...
    private void tbStatusIsolasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbStatusIsolasiKeyPressed
        if(tabMode.getRowCount()!=0){
            if(evt.getKeyCode()==KeyEvent.VK_SPACE){
                dispose();
            }
        }
    }//GEN-LAST:event_tbStatusIsolasiKeyPressed
    ...
    */
    ...
    private widget.Table tbStatusIsolasi;
