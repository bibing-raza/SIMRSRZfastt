...
public final class BPJSCekReferensiDokterHFIS extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiDokterHFIS(java.awt.Frame parent, boolean modal) {
        ...
        tbDokterHFIS.setModel(tabMode);

        //tbKamar.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbKamar.getBackground()));
        tbDokterHFIS.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbDokterHFIS.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 3; i++) {
            TableColumn column = tbDokterHFIS.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbDokterHFIS.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Dokter HFIS BPJS VClaim ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbDokterHFIS.setAutoCreateRowSorter(true);
        tbDokterHFIS.setName("tbDokterHFIS"); // NOI18N
        Scroll.setViewportView(tbDokterHFIS);
    ...
    */
    ...
    private widget.Table tbDokterHFIS;
