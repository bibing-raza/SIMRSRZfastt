...
public class CoronaPasien extends javax.swing.JDialog {
    ...
    private String link = "", idrs = "", body = "", jenis_rawat = "";
    ...
    public CoronaPasien(java.awt.Frame parent, boolean modal) {
        ...
        tbPasienCovid.setModel(tabMode);

        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbPasienCovid.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbPasienCovid.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 33; i++) {
            TableColumn column = tbPasienCovid.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbPasienCovid.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbPasienCovid = new widget.Table();
        ...
        ppDiagnosaPasien.setForeground(new java.awt.Color(0, 0, 0));
        ...
        tbPasienCovid.setAutoCreateRowSorter(true);
        tbPasienCovid.setComponentPopupMenu(Popup);
        tbPasienCovid.setName("tbPasienCovid"); // NOI18N
        tbPasienCovid.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbPasienCovidMouseClicked(evt);
            }
        });
        tbPasienCovid.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbPasienCovidKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbPasienCovid);
        ...
        KodeJK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaJK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-04-2020" }));
        ...
        KodeKewarganegaraan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaKewarganegaraan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnKewarganegaraan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodePenularan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaPenularan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnSumberPenularan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnKecamatan.setBounds(793, 70, 28, 23);
        ...
        TglKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-04-2020" }));
        ...
        KodeStatusKeluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaStatusKeluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnStatusKeluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglLapor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-04-2020 11:41:35" }));
        ...
        KodeStatusRawat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaStatusRawat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnStatusRawat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodeStatusIsolasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaStatusIsolasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnStatusIsolasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnPropinsi.setBounds(793, 10, 28, 23);
        ...
        KodeJenisPasien.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaJenisPasien.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnJenisPasien.setForeground(new java.awt.Color(0, 0, 0));
                    ...
                    for (JsonNode list : response) {
                        if (list.path("status").asText().equals("200")) {
                            if (Sequel.menyimpantf("pasien_corona", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Pasien", 33, new String[]{
                                ...
                                Sequel.mengedit("pasien", "no_rkm_medis='" + NoRM.getText() + "'", "no_ktp='" + NoKTP.getText() + "', no_tlp='" + NoTelp.getText() + "'");                                
                                tampil();
                                emptTeks();
                            }
                        } else {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbPasienCovid.getSelectedRow() > -1) {
            try {
                headers = new HttpHeaders();
                headers.add("X-rs-id", idrs);
                headers.add("X-Timestamp", String.valueOf(api.GetUTCdatetimeAsString()));
                headers.add("X-pass", api.getHmac());
                headers.add("nomr", tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(), 1).toString());
                    ...
                    for (JsonNode list : response) {
                        if (list.path("status").asText().equals("200")) {
                            if (Sequel.queryu2tf("delete from pasien_corona where no_rkm_medis=?", 1, new String[]{
                                tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(), 1).toString()
                            }) == true) {
                                tampil();
                            }
                        } else {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPasienCorona.jasper", "report", "::[ Data Bridging Pasien Corona Kemenkes RI ]::",
    ...
    private void tbPasienCovidMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPasienCovidMouseClicked
        if(tabMode.getRowCount()!=0){
            try {
                getData();
...
}//GEN-LAST:event_tbPasienCovidMouseClicked

    private void tbPasienCovidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPasienCovidKeyPressed
        if(tabMode.getRowCount()!=0){
...
}//GEN-LAST:event_tbPasienCovidKeyPressed
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnStatusIsolasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStatusIsolasiActionPerformed
        statusisolasi.setSize(653, 491);
        statusisolasi.setLocationRelativeTo(internalFrame1);
        statusisolasi.setVisible(true);
        statusisolasi.TCari.requestFocus();
        statusisolasi.tampil();
    ...
    private void BtnPropinsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPropinsiActionPerformed
        propinsi.setSize(654, 342);
        propinsi.setLocationRelativeTo(internalFrame1);
        propinsi.setVisible(true);
        propinsi.TCari.requestFocus();
        propinsi.TCari.setText("Kalimantan");
        propinsi.tampil();
    ...
    */
    ...
    private widget.Table tbPasienCovid;
    // End of variables declaration//GEN-END:variables

    private void tampil() {     
        Valid.tabelKosong(tabMode);
        try {
            ps = koneksi.prepareStatement("select no_pengenal,no_rkm_medis,inisial,nama_lengkap,tgl_masuk,kode_jk,nama_jk,tgl_lahir,kode_kewarganegaraan,"
                    + "nama_kewarganegaraan,kode_penularan,sumber_penularan,kd_kelurahan,nm_kelurahan,kd_kecamatan,nm_kecamatan,kd_kabupaten,"
                    + "nm_kabupaten,kd_propinsi,nm_propinsi,tgl_keluar,kode_statuskeluar,nama_statuskeluar,tgl_lapor,kode_statusrawat,"
                    ...
                    + "nama_statuskeluar like ? or nama_statusrawat like ? or nama_statusisolasi like ? or sebab_kematian like ? or nama_jenis_pasien like ? or "
                    + "inisial like ? or nama_lengkap like ?) ")
                    + "order by tgl_masuk");
            try {
    ...
    public void emptTeks() {
        ...
        Email.setText("-");
        NoTelp.setText("");
        KodeKewarganegaraan.setText("1");
        NamaKewarganegaraan.setText("Indonesia");
    ...
    private void getData() {
        if(tbPasienCovid.getSelectedRow()!= -1){      
            NoKTP.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),0).toString());
            NoRM.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),1).toString());
            NamaPasien.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),2).toString());
            Inisial.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),3).toString());
            KodeJK.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),4).toString());
            NamaJK.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),5).toString());
            Email.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),7).toString());
            NoTelp.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),8).toString());
            KodeKewarganegaraan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),12).toString());
            NamaKewarganegaraan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),13).toString());
            KodePenularan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),14).toString());
            NamaPenularan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),15).toString());
            KodeKelurahan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),16).toString());
            NamaKelurahan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),17).toString());
            KodeKecamatan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),18).toString());
            NamaKecamatan.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),19).toString());
            KodeKabupaten.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),20).toString());
            NamaKabupaten.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),21).toString());
            KodePropinsi.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),22).toString());
            NamaPropinsi.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),23).toString());
            KodeStatusKeluar.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),24).toString());
            NamaStatusKeluar.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),25).toString());
            KodeStatusRawat.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),26).toString());
            NamaStatusRawat.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),27).toString());
            KodeStatusIsolasi.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),28).toString());
            NamaStatusIsolasi.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),29).toString());
            SebabKematian.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),30).toString());
            KodeJenisPasien.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),31).toString());
            NamaJenisPasien.setText(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),32).toString());
            TglLahir.setText(Valid.SetTgl3(tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),6).toString()));
            Valid.SetTgl2(TglLapor,tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),9).toString());
            Valid.SetTgl(TglMasuk,tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),10).toString());
            Valid.SetTgl(TglKeluar,tbPasienCovid.getValueAt(tbPasienCovid.getSelectedRow(),11).toString());
        }
    }
    ...
    public void setPasien(String nomr, String tgl_masuk, String rawatnya){
        ChkInput.setSelected(true);
        jenis_rawat = rawatnya;
        isForm();
        
        try {
            ps = koneksi.prepareStatement("select pasien.no_rkm_medis,pasien.nm_pasien,pasien.kd_kel,kelurahan.nm_kel,ifnull(pasien.no_ktp,'0') no_ktp,pasien.jk, "
                    + "date_format(pasien.tgl_lahir,'%d-%m-%Y') as tgl_lahir,'-' email,ifnull(pasien.no_tlp,'0') no_tlp,kecamatan.nm_kec,kecamatan.kd_kec,kabupaten.nm_kab,kabupaten.kd_kab "
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (jenis_rawat.equals("Poliklinik")) {
                        Valid.SetTgl(TglMasuk, tgl_masuk);
                        Valid.SetTgl(TglKeluar, tgl_masuk);
                        KodeJenisPasien.setText("1");
                        NamaJenisPasien.setText("Rawat Jalan");
                    } else if (jenis_rawat.equals("IGD")) {
                        Valid.SetTgl(TglMasuk, tgl_masuk);
                        Valid.SetTgl(TglKeluar, tgl_masuk);
                        KodeJenisPasien.setText("2");
                        NamaJenisPasien.setText("IGD");
                    } else if (jenis_rawat.equals("NGINAP")) {
                        Valid.SetTgl(TglMasuk, tgl_masuk);
                        TglKeluar.setDate(new Date());
                        KodeJenisPasien.setText("3");
                        NamaJenisPasien.setText("Rawat Inap");
                    }
                }
            } catch (Exception ex) {
