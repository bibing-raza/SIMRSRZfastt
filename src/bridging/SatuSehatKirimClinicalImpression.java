                ...
                try {
                    ...
                    try {
                        ...
                        json = "{" +
                                    ...
                                    "},"+
                                    "\"effectiveDateTime\": \""+tbImpresion.getValueAt(i,14).toString()+"T"+tbImpresion.getValueAt(i,15).toString()+"+07:00\"," +
                                    "\"date\": \""+tbImpresion.getValueAt(i,14).toString()+"T"+tbImpresion.getValueAt(i,15).toString()+"+07:00\"," +
                                    "\"assessor\" : {"+
