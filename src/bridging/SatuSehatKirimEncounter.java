...
public final class SatuSehatKirimEncounter extends javax.swing.JDialog {
                        ...
                        json = "{" +
                                    ...
                                    "\"statusHistory\": [" +
                                        "{" +
                                            ...
                                            "\"period\": {" +
                                                "\"start\": \""+tbEncounter.getValueAt(i,1).toString()+"\"," +
                                                "\"end\": \""+tbEncounter.getValueAt(i,14).toString()+"\"" +
                                            "}" +
                                        "}" +
                                    "]," +
                                    "\"serviceProvider\": {" +
    ...
    */
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "pg.no_ktp ktpdokter, rp.kd_poli, pl.nm_poli, ss.id_lokasi_satusehat, rp.stts, rp.status_lanjut, concat(nj.tanggal,'T',nj.jam,'+07:00') pulang, "
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "LEFT JOIN satu_sehat_encounter se ON se.no_rawat = rp.no_rawat where ni.tanggal between ? and ? "
                    + (TCari.getText().equals("") ? "" : "and (rp.no_rawat like ? or rp.no_rkm_medis like ? or "
                    + "p.nm_pasien like ? or p.no_ktp like ? or pg.nama like ? or pl.nm_poli like ? or "
                    + "rp.stts like ? or rp.status_lanjut like ?)") + " order by rp.tgl_registrasi,rp.jam_reg");
            try {
    ...
    public void isCek(){
        ...
        BtnUpdate.setEnabled(akses.getsatu_sehat());
