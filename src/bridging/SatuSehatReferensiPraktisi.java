...
public final class SatuSehatReferensiPraktisi extends javax.swing.JDialog {
    ...
    public SatuSehatReferensiPraktisi(java.awt.Frame parent, boolean modal) {
        ...
        tbPraktisi.setModel(tabMode);

        //tbKamar.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbKamar.getBackground()));
        tbPraktisi.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbPraktisi.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 2; i++) {
            TableColumn column = tbPraktisi.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbPraktisi.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Praktisi Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        tbPraktisi.setName("tbPraktisi"); // NOI18N
        Scroll.setViewportView(tbPraktisi);
    ...
    */
    ...
    private widget.Table tbPraktisi;
