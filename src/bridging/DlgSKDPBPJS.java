...
public class DlgSKDPBPJS extends javax.swing.JDialog {
    ...
    private String URUTNOREG="",status="";
    ...
    public DlgSKDPBPJS(java.awt.Frame parent, boolean modal) {
        ...
        tbSKDP.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Surat Keterangan Dalam Perawatan (SKDP BPJS) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbSKDP.setAutoCreateRowSorter(true);
        tbSKDP.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbSKDP.setComponentPopupMenu(jPopupMenu1);
        tbSKDP.setName("tbSKDP"); // NOI18N
        tbSKDP.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbSKDPMouseClicked(evt);
            }
        });
        tbSKDP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbSKDPKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbSKDP);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-02-2020" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-02-2020" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-02-2020" }));
        ...
        Alasan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Alasan2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Rtl1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Rtl2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-02-2020" }));
        ...
        TanggalPeriksa.setBounds(96, 160, 90, 23);
        ...
        Terapi.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            Sequel.menyimpan("skdp_bpjs", "'" + TanggalPeriksa.getSelectedItem().toString().substring(6, 10) + "','" + TNoRM.getText() + "',"
                    + "'" + Diagnosa.getText() + "','" + Terapi.getText() + "','" + Alasan1.getText() + "','" + Alasan2.getText() + "',"
                    + "'" + Rtl1.getText() + "','" + Rtl2.getText() + "','" + Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + "',"
                    + "'" + Valid.SetTgl(TanggalSurat.getSelectedItem() + "") + "','" + NoSurat.getText() + "','" + KdDokter.getText() + "',"
                    + "'" + Status.getSelectedItem().toString() + "','" + KdPoli.getText() + "' ", "Tahun dan nomor surat");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbSKDP.getSelectedRow() != -1) {
                Sequel.queryu("delete from skdp_bpjs where tahun='" + tbSKDP.getValueAt(tbSKDP.getSelectedRow(), 0).toString() + "' "
                        + "and no_antrian='" + tbSKDP.getValueAt(tbSKDP.getSelectedRow(), 11).toString() + "'");
                tampil();
                emptTeks();
            } else {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Untuk rekap laporan data SKDP sementara belum dibikin, belum tau format laporanya gaes...!!!!");
...
//            Valid.MyReport("rptSKDPBPJS.jasper", "report", "::[ Laporan Daftar SKDP BPJS ]::",
...
//            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void tbSKDPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSKDPMouseClicked
        if(tabMode.getRowCount()!=0){
            try {
                getData();
...
}//GEN-LAST:event_tbSKDPMouseClicked

    private void tbSKDPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSKDPKeyPressed
        if(tabMode.getRowCount()!=0){
...
}//GEN-LAST:event_tbSKDPKeyPressed
  ...
  isForm();                
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (tbSKDP.getSelectedRow() != -1) {
                Sequel.mengedit("skdp_bpjs", "tahun='" + tbSKDP.getValueAt(tbSKDP.getSelectedRow(), 0).toString() + "' and no_antrian='" + tbSKDP.getValueAt(tbSKDP.getSelectedRow(), 11).toString() + "'",
                        ...
                        + "alasan1='" + Alasan1.getText() + "',"
                        + "alasan2='" + Alasan2.getText() + "',"
                        + "rtl1='" + Rtl1.getText() + "',"
                        + "rtl2='" + Rtl2.getText() + "',"
                        + "tanggal_rujukan='" + Valid.SetTgl(TanggalSurat.getSelectedItem() + "") + "',"
                        + "no_antrian='" + NoSurat.getText() + "',"
                ...
                JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih terlebih dulu data yang mau anda ganti... Klik data pada tabel untuk memilih data...!!!!");
            }
        }
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbSKDP.getSelectedRow() != -1) {
                ...
                param.put("logo", Sequel.cariGambar("select logo from setting"));
                Valid.MyReport("rptSuratSKDPBPJS.jasper", "report", "::[ Surat SKDP ]::",
                        "select sb.tahun,sb.no_rkm_medis,p.nm_pasien, sb.diagnosa,sb.terapi,sb.alasan1,sb.alasan2, "
                        ...
                        + "where tahun='" + tbSKDP.getValueAt(tbSKDP.getSelectedRow(), 0).toString() + "' and "
                        + "no_antrian='" + tbSKDP.getValueAt(tbSKDP.getSelectedRow(), 11).toString() + "' order by sb.tanggal_rujukan,sb.no_antrian", param);
                this.setCursor(Cursor.getDefaultCursor());
            } else {
                JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih terlebih dulu data yang mau anda hapus...  Klik data pada tabel untuk memilih data...!!!!");
            }
    ...
    */
    ...
    private widget.Table tbSKDP;
    // End of variables declaration//GEN-END:variables

    private void tampil() {     
        if(R1.isSelected()==true){
            status=" sb.status='Menunggu' ";
        }else if(R2.isSelected()==true){
            status=" sb.tanggal_rujukan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
        }else if(R3.isSelected()==true){
            status=" sb.status<>'Menunggu' and sb.tanggal_rujukan between '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari4.getSelectedItem()+"")+"' ";           
        }
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    + "from skdp_bpjs sb inner join pasien p on p.no_rkm_medis=sb.no_rkm_medis "
                    + "inner join dokter d on d.kd_dokter=sb.kd_dokter inner join poliklinik pl on pl.kd_poli=sb.kd_poli "
                    + "where " + status + " and sb.no_rkm_medis like ? or "
                    + status + " and p.nm_pasien like ? or "
                    + status + " and sb.diagnosa like ? or "
                    + status + " and sb.terapi like ? or "
                    + status + " and sb.no_antrian like ? or "
                    + status + " and pl.nm_poli like ? or "
                    + status + " and d.nm_dokter like ? order by sb.tanggal_rujukan,sb.no_antrian");
            try {
    ...
    private void getData() {
        if(tbSKDP.getSelectedRow()!= -1){
            TNoRM.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),1).toString()); 
            TPasien.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),2).toString());
            Diagnosa.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),3).toString());
            Terapi.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),4).toString());
            Alasan1.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),5).toString());
            Alasan2.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),6).toString());
            Rtl1.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),7).toString());
            Rtl2.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),8).toString());
            Valid.SetTgl(TanggalPeriksa,tbSKDP.getValueAt(tbSKDP.getSelectedRow(),9).toString());
            Valid.SetTgl(TanggalSurat,tbSKDP.getValueAt(tbSKDP.getSelectedRow(),10).toString());
            NoSurat.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),11).toString());
            KdDokter.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),12).toString());
            NmDokter.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),13).toString());
            KdPoli.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),14).toString());
            NmPoli.setText(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),15).toString());
            Status.setSelectedItem(tbSKDP.getValueAt(tbSKDP.getSelectedRow(),16).toString());
        }
    }
    ...
    public void DokterPoli(String kddokter, String kdpoli) {
