 ...
 * @author dosen
 */
public final class BPJSListSpesialistikRujukan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSListSpesialistikRujukan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row = {"No.","Kode","Nama Spesialistik","Kapasitas","Jumlah Rujukan","Persentase"
        };
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        
        tbSpesialistik.setModel(tabMode);
        tbSpesialistik.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbSpesialistik.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 6; i++) {
            TableColumn column = tbSpesialistik.getColumnModel().getColumn(i);
            if (i == 0) {
        ...
        tbSpesialistik.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbSpesialistik = new widget.Table();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data/List Spesialistik Rujukan BPJS VClaim ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbSpesialistik.setAutoCreateRowSorter(true);
        tbSpesialistik.setToolTipText("");
        tbSpesialistik.setName("tbSpesialistik"); // NOI18N
        Scroll.setViewportView(tbSpesialistik);
        ...
        jLabel18.setText("Kode/Nama Spesialistik : ");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSListSpesialistikRujukan dialog = new BPJSListSpesialistikRujukan(new javax.swing.JFrame(), true);
    ...
    private widget.Table tbSpesialistik;
    public widget.Tanggal tglRujukan;
                ...
                if (respon_lagi.path("list").isArray()) {
                    ...
                    for (JsonNode list : respon_lagi.path("list")) {
                        if (list.path("kodeSpesialis").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                                || list.path("namaSpesialis").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{
                                x + ".",
                                list.path("kodeSpesialis").asText(),
                                list.path("namaSpesialis").asText(),
                                list.path("kapasitas").asText(),
                                list.path("jumlahRujukan").asText(),
    ...
    private void cekData() {
        ...
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            URL = prop.getProperty("URLAPIBPJS") + "/Rujukan/ListSpesialistik/PPKRujukan/" + kdRujukan.getText() + "/TglRujukan/" + Valid.SetTgl(tglRujukan.getSelectedItem() + "");
