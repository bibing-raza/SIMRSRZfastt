...
public final class SatuSehatMapingVaksin extends javax.swing.JDialog {
    ...
    public SatuSehatMapingVaksin(java.awt.Frame parent, boolean modal) {
        ...
        tbVaksin.setModel(tabMode);

        tbVaksin.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbVaksin.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 11; i++) {
            TableColumn column = tbVaksin.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbVaksin.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Vaksin Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        tbVaksin.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbVaksin.setName("tbVaksin"); // NOI18N
        tbVaksin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbVaksinMouseClicked(evt);
            }
        });
        tbVaksin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbVaksinKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbVaksin);
        ...
        RouteCode.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DoseCode.setForeground(new java.awt.Color(0, 0, 0));
        ...
        VaksinCode.setForeground(new java.awt.Color(0, 0, 0));
        ...
        VaksinDisplay.setForeground(new java.awt.Color(0, 0, 0));
        ...
        RouteSystem.setForeground(new java.awt.Color(0, 0, 0));
        ...
        RouteDisplay.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DoseSystem.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DoseUnit.setForeground(new java.awt.Color(0, 0, 0));
        ...
        VaksinSystem.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void btnBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarangActionPerformed
        barang.isCek();
        barang.setSize(1039, internalFrame1.getHeight() - 40);
            ...
            if (tbVaksin.getSelectedRow() > -1) {
                if (Sequel.mengedittf("satu_sehat_mapping_vaksin", "kode_brng=?", "kode_brng=?,vaksin_code=?,vaksin_system=?,vaksin_display=?,"
                        + "route_code=?,route_system=?,route_display=?,dose_quantity_code=?,dose_quantity_system=?,dose_quantity_unit=?", 11, new String[]{
                            KodeBarang.getText(), VaksinCode.getText(), VaksinSystem.getText(), VaksinDisplay.getText(), RouteCode.getText(),
                            RouteSystem.getText(), RouteDisplay.getText(), DoseCode.getText(), DoseSystem.getText(), DoseUnit.getText(),
                            tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 2).toString()
                        }) == true) {
                    emptTeks();
                    tampil();
                }
    ...
    private void tbVaksinKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbVaksinKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbVaksinKeyReleased
    ...
    */
    ...
    private void getData() {
        if (tbVaksin.getSelectedRow() != -1) {
            VaksinCode.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 0).toString());
            VaksinSystem.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 1).toString());
            KodeBarang.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 2).toString());
            VaksinDisplay.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 4).toString());
            RouteCode.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 5).toString());
            RouteSystem.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 6).toString());
            RouteDisplay.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 7).toString());
            DoseCode.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 8).toString());
            DoseSystem.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 9).toString());
            DoseUnit.setText(tbVaksin.getValueAt(tbVaksin.getSelectedRow(), 10).toString());
        }
    }
