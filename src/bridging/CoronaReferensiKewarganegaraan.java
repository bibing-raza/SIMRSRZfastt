...
public final class CoronaReferensiKewarganegaraan extends javax.swing.JDialog {
    ...
    public CoronaReferensiKewarganegaraan(java.awt.Frame parent, boolean modal) {
        ...
        tbNegara.setModel(tabMode);

        //tbKamar.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbKamar.getBackground()));
        tbNegara.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbNegara.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 2; i++) {
            TableColumn column = tbNegara.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbNegara.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Referensi Kewarganegaraan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbNegara.setAutoCreateRowSorter(true);
        tbNegara.setName("tbNegara"); // NOI18N
        tbNegara.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbNegaraKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbNegara);
    ...
    private void tbNegaraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbNegaraKeyPressed
        if(tabMode.getRowCount()!=0){
            if(evt.getKeyCode()==KeyEvent.VK_SPACE){
                dispose();
            }
        }
    }//GEN-LAST:event_tbNegaraKeyPressed
