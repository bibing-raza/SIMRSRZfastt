...
public final class BPJSCekSuplesiJasaRaharja extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTanggal.setEditable(false);
        DTPTanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-11-2021" }));
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int r=0;r<row;r++){  
                Sequel.menyimpan("temporary","'0','"+
                                ...
                                tabMode.getValueAt(r,6).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Rekap Harian Pengadaan Ipsrs"); 
            }
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            i + "",
                            list.path("noRegister").asText(),
                            list.path("noSep").asText(),
                            list.path("noSepAwal").asText(),
                            list.path("noSuratJaminan").asText(),
