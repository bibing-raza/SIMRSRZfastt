...
public final class BPJSHistoriPelayanan extends javax.swing.JDialog {
    ...
    public BPJSHistoriPelayanan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Diagnosa", "Jns. Pelayanan", "Kelas Rawat", "Nama Peserta", "No. Kartu", "No. SEP",
            "No. Rujukan", "Poliklinik", "PPK Pelayanan", "Tgl. Plg. SEP", "Tgl. SEP"
        };
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Histori Pelayanan Peserta BPJS VClaim ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jLabel19.setText("Periode Tgl. :");
        jLabel19.setName("jLabel19"); // NOI18N
        jLabel19.setPreferredSize(new java.awt.Dimension(80, 23));
        panelGlass6.add(jLabel19);

        DTPCari1.setEditable(false);
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-12-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-12-2021" }));
                ...
                if(response.isArray()){
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            i + ".", 
                            list.path("diagnosa").asText(), 
                            list.path("jnsPelayanan").asText().replaceAll("1", "R. Inap").replaceAll("2", "R. Jalan"),
                            list.path("kelasRawat").asText(), 
                            list.path("namaPeserta").asText(), 
                            list.path("noKartu").asText(), 
                            list.path("noSep").asText(),
                            list.path("noRujukan").asText(), 
                            list.path("poli").asText(), 
                            list.path("ppkPelayanan").asText(), 
                            list.path("tglPlgSep").asText().replaceAll("null", ""),
