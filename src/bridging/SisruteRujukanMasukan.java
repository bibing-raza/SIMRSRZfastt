...
public final class SisruteRujukanMasukan extends javax.swing.JDialog {
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pegawai.getTable().getSelectedRow()!= -1){                   
                    NoKTP.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),23).toString());
    ...
    private void initComponents() {
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Balas Rujukan Masuk Sisrute ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        AlasanBalasan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        CmbTerima.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnJawab.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            for(int r=0;r<row;r++){  
                ...
                tabMode.getValueAt(r,34).toString().replaceAll("'","`")+"','',''","Rujukan masuk SISRUTE"); 
            }
