...
public class INACBGDaftarKlaim extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, ps1, ps2, ps4, ps5, ps6, ps7, ps8;
    private ResultSet rs, rs1, rs2, rs4, rs5, rs6, rs7, rs8;
    private Date tgl = new Date();
    private String cekSEP = "", jnsKlaim = "", nik = "", noka = "", tglKunj = "", jnsrwt = "", norm = "", dialog_simpan = "", jnsTgl = "",
            nmpas = "", tgllahir = "", jk = "", tglSep = "", nilaiRWT = "", kd_payor = "", nmibu = "", cekData = "", jnsRawat = "";
    private JsonNode root;
    private int cekKlaim = 0, x = 0, i = 0, n = 0, prosesData = 0;
    ...
    public INACBGDaftarKlaim(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Cek", "No. Rawat", "Jns. Jaminan", "No. SEP/No.Klaim", "No. RM", "Nama Pasien", "Jns. Rawat", "Nama Unit",
...
//                column.setPreferredWidth(120);
        ...
        tabMode4 = new DefaultTableModel(null, new Object[]{
            "No. Rawat", "No. Kartu", "No. SEP", "Tgl. SEP", "No. RM", "Nama Pasien", "Jns. Rawat"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tbSEPgagal.setModel(tabMode4);
        tbSEPgagal.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbSEPgagal.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 7; i++) {
            TableColumn column = tbSEPgagal.getColumnModel().getColumn(i);
            if (i == 0) {
        ...
        tbSEPgagal.setDefaultRenderer(Object.class, new WarnaTable());
...
//        }
    ...
    private void initComponents() {
        ...
        ppCekSEPGagal = new javax.swing.JMenuItem();
        ppContengSemua = new javax.swing.JMenuItem();
        ...
        ppRestorIcd10 = new javax.swing.JMenu();
        MnRalan10 = new javax.swing.JMenuItem();
        MnRanap10 = new javax.swing.JMenuItem();
        ppRestorIcd9 = new javax.swing.JMenu();
        MnRalan9 = new javax.swing.JMenuItem();
        MnRanap9 = new javax.swing.JMenuItem();
        ...
        WindowGagalSEP = new javax.swing.JDialog();
        internalFrame8 = new widget.InternalFrame();
        jPanel6 = new javax.swing.JPanel();
        panelGlass16 = new widget.panelisi();
        jLabel30 = new widget.Label();
        tgl7 = new widget.Tanggal();
        jLabel31 = new widget.Label();
        tgl8 = new widget.Tanggal();
        jLabel32 = new widget.Label();
        LCount5 = new widget.Label();
        jLabel33 = new widget.Label();
        cmbLimit4 = new widget.ComboBox();
        BtnAll6 = new widget.Button();
        ...
        tbSEPgagal = new widget.Table();
        WindowKirimKolektif = new javax.swing.JDialog();
        internalFrame9 = new widget.InternalFrame();
        BtnCloseIn4 = new widget.Button();
        BtnKirim = new widget.Button();
        jLabel35 = new widget.Label();
        cmbJnsRawatKirim = new widget.ComboBox();
        jLabel36 = new widget.Label();
        cmbJnsTanggal = new widget.ComboBox();
        jLabel37 = new widget.Label();
        TtglA = new widget.Tanggal();
        jLabel38 = new widget.Label();
        TtglB = new widget.Tanggal();
        ...
        Popup1.setPreferredSize(new java.awt.Dimension(242, 250));
        ...
        ppPengajuanKlaim.setPreferredSize(new java.awt.Dimension(240, 27));
        ...
        ppExportKlaimFinal.setPreferredSize(new java.awt.Dimension(240, 27));
        ...
        ppCekSEPGagal.setBackground(new java.awt.Color(242, 242, 242));
        ppCekSEPGagal.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCekSEPGagal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCekSEPGagal.setText("Cek Proses Gagal SEP BPJS");
        ppCekSEPGagal.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCekSEPGagal.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCekSEPGagal.setIconTextGap(8);
        ppCekSEPGagal.setName("ppCekSEPGagal"); // NOI18N
        ppCekSEPGagal.setPreferredSize(new java.awt.Dimension(240, 27));
        ppCekSEPGagal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCekSEPGagalBtnPrintActionPerformed(evt);
            }
        });
        Popup1.add(ppCekSEPGagal);

        ppContengSemua.setBackground(new java.awt.Color(242, 242, 242));
        ppContengSemua.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppContengSemua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppContengSemua.setText("Conteng Semua Belum Terkirim");
        ppContengSemua.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppContengSemua.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppContengSemua.setIconTextGap(8);
        ppContengSemua.setName("ppContengSemua"); // NOI18N
        ppContengSemua.setPreferredSize(new java.awt.Dimension(240, 27));
        ppContengSemua.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppContengSemuaBtnPrintActionPerformed(evt);
            }
        });
        Popup1.add(ppContengSemua);

        ppHapusConteng.setBackground(new java.awt.Color(242, 242, 242));
        ...
        ppHapusConteng.setText("Hapus Conteng Semua Data");
        ...
        ppHapusConteng.setPreferredSize(new java.awt.Dimension(240, 27));
        ppHapusConteng.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppHapusContengBtnPrintActionPerformed(evt);
            }
        });
        ...
        ppAmbilDataKlaim.setPreferredSize(new java.awt.Dimension(240, 27));
        ...
        ppKirimOnlineKolektif.setBackground(new java.awt.Color(242, 242, 242));
        ppKirimOnlineKolektif.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppKirimOnlineKolektif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/34.png"))); // NOI18N
        ppKirimOnlineKolektif.setText("Kirim Klaim Online Kolektif");
        ppKirimOnlineKolektif.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppKirimOnlineKolektif.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppKirimOnlineKolektif.setIconTextGap(8);
        ppKirimOnlineKolektif.setName("ppKirimOnlineKolektif"); // NOI18N
        ppKirimOnlineKolektif.setPreferredSize(new java.awt.Dimension(240, 27));
        ppKirimOnlineKolektif.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppKirimOnlineKolektifBtnPrintActionPerformed(evt);
            }
        });
        Popup1.add(ppKirimOnlineKolektif);

        ppRestorIcd10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/42a.png"))); // NOI18N
        ppRestorIcd10.setText("Restore Diagnosa ICD 10");
        ppRestorIcd10.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppRestorIcd10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppRestorIcd10.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppRestorIcd10.setIconTextGap(8);
        ppRestorIcd10.setName("ppRestorIcd10"); // NOI18N
        ppRestorIcd10.setOpaque(true);
        ppRestorIcd10.setPreferredSize(new java.awt.Dimension(240, 27));

        MnRalan10.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRalan10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRalan10.setText("Rawat Jalan");
        MnRalan10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRalan10.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRalan10.setIconTextGap(8);
        MnRalan10.setName("MnRalan10"); // NOI18N
        MnRalan10.setPreferredSize(new java.awt.Dimension(110, 27));
        MnRalan10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRalan10ActionPerformed(evt);
            }
        });
        ppRestorIcd10.add(MnRalan10);

        MnRanap10.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRanap10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRanap10.setText("Rawat Inap");
        MnRanap10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRanap10.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRanap10.setIconTextGap(8);
        MnRanap10.setName("MnRanap10"); // NOI18N
        MnRanap10.setPreferredSize(new java.awt.Dimension(110, 27));
        MnRanap10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRanap10ActionPerformed(evt);
            }
        });
        ppRestorIcd10.add(MnRanap10);

        Popup1.add(ppRestorIcd10);

        ppRestorIcd9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/42a.png"))); // NOI18N
        ppRestorIcd9.setText("Restore Prosedur ICD 9");
        ppRestorIcd9.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppRestorIcd9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppRestorIcd9.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppRestorIcd9.setIconTextGap(8);
        ppRestorIcd9.setName("ppRestorIcd9"); // NOI18N
        ppRestorIcd9.setOpaque(true);
        ppRestorIcd9.setPreferredSize(new java.awt.Dimension(240, 27));

        MnRalan9.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRalan9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRalan9.setText("Rawat Jalan");
        MnRalan9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRalan9.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRalan9.setIconTextGap(8);
        MnRalan9.setName("MnRalan9"); // NOI18N
        MnRalan9.setPreferredSize(new java.awt.Dimension(110, 27));
        MnRalan9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRalan9ActionPerformed(evt);
            }
        });
        ppRestorIcd9.add(MnRalan9);

        MnRanap9.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRanap9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRanap9.setText("Rawat Inap");
        MnRanap9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRanap9.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRanap9.setIconTextGap(8);
        MnRanap9.setName("MnRanap9"); // NOI18N
        MnRanap9.setPreferredSize(new java.awt.Dimension(110, 27));
        MnRanap9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRanap9ActionPerformed(evt);
            }
        });
        ppRestorIcd9.add(MnRanap9);

        Popup1.add(ppRestorIcd9);
        ...
        panelGlass8.setPreferredSize(new java.awt.Dimension(44, 45));
        ...
        tgl1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        tgl2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        internalFrame5.add(jPanel3, java.awt.BorderLayout.CENTER);

        Scroll1.setToolTipText("Silahkan pilih salah satu data pasien ibu bersalin");
        Scroll1.setName("Scroll1"); // NOI18N
        Scroll1.setOpaque(true);
        Scroll1.setPreferredSize(new java.awt.Dimension(452, 465));
        ...
        internalFrame5.add(Scroll1, java.awt.BorderLayout.PAGE_END);
        ...
        tgl3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        tgl4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        tgl5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        tgl6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        WindowGagalSEP.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowGagalSEP.setName("WindowGagalSEP"); // NOI18N
        WindowGagalSEP.setUndecorated(true);
        WindowGagalSEP.setResizable(false);

        internalFrame8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Daftar SEP BPJS Pasien Untuk Proses Verifikasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        tgl8.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        tgl8.setDisplayFormat("dd-MM-yyyy");
        tgl8.setName("tgl8"); // NOI18N
        tgl8.setOpaque(false);
        tgl8.setPreferredSize(new java.awt.Dimension(95, 23));
        panelGlass16.add(tgl8);

        jLabel32.setForeground(new java.awt.Color(0, 0, 0));
        jLabel32.setText("Record :");
        jLabel32.setName("jLabel32"); // NOI18N
        jLabel32.setPreferredSize(new java.awt.Dimension(55, 30));
        panelGlass16.add(jLabel32);
        ...
        LCount5.setPreferredSize(new java.awt.Dimension(75, 30));
        panelGlass16.add(LCount5);

        jLabel33.setForeground(new java.awt.Color(0, 0, 0));
        jLabel33.setText("Limit Data : ");
        jLabel33.setName("jLabel33"); // NOI18N
        jLabel33.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass16.add(jLabel33);

        cmbLimit4.setForeground(new java.awt.Color(0, 0, 0));
        cmbLimit4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25", "50", "200", "1000", "Semuanya" }));
        cmbLimit4.setName("cmbLimit4"); // NOI18N
        panelGlass16.add(cmbLimit4);
        ...
        BtnAll6.setPreferredSize(new java.awt.Dimension(100, 23));
        BtnAll6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAll6ActionPerformed(evt);
            }
        });
        panelGlass16.add(BtnAll6);

        jPanel6.add(panelGlass16, java.awt.BorderLayout.PAGE_START);
        ...
        jLabel34.setText("Key Word : ");
        jLabel34.setName("jLabel34"); // NOI18N
        jLabel34.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass17.add(jLabel34);
        ...
        BtnCari5.setPreferredSize(new java.awt.Dimension(130, 30));
        ...
        BtnAll5.setPreferredSize(new java.awt.Dimension(120, 23));
        ...
        panelGlass17.add(BtnKeluar5);

        jPanel6.add(panelGlass17, java.awt.BorderLayout.PAGE_END);

        internalFrame8.add(jPanel6, java.awt.BorderLayout.PAGE_END);

        Scroll4.setToolTipText("Silahkan pilih salah satu data pasien ibu bersalin");
        Scroll4.setName("Scroll4"); // NOI18N
        Scroll4.setOpaque(true);

        tbSEPgagal.setToolTipText("");
        tbSEPgagal.setName("tbSEPgagal"); // NOI18N
        tbSEPgagal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbSEPgagalMouseClicked(evt);
            }
        });
        tbSEPgagal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbSEPgagalKeyPressed(evt);
            }
        });
        Scroll4.setViewportView(tbSEPgagal);

        internalFrame8.add(Scroll4, java.awt.BorderLayout.CENTER);

        WindowGagalSEP.getContentPane().add(internalFrame8, java.awt.BorderLayout.CENTER);

        WindowKirimKolektif.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowKirimKolektif.setName("WindowKirimKolektif"); // NOI18N
        WindowKirimKolektif.setUndecorated(true);
        WindowKirimKolektif.setResizable(false);

        internalFrame9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Kirim Klaim INACBG Secara Kolektif ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        BtnCloseIn4.setBounds(260, 90, 100, 30);
        ...
        internalFrame9.add(BtnKirim);
        BtnKirim.setBounds(107, 90, 110, 30);

        jLabel35.setForeground(new java.awt.Color(0, 0, 0));
        jLabel35.setText("Jenis Rawat :");
        jLabel35.setName("jLabel35"); // NOI18N
        internalFrame9.add(jLabel35);
        jLabel35.setBounds(0, 28, 100, 23);

        cmbJnsRawatKirim.setForeground(new java.awt.Color(0, 0, 0));
        cmbJnsRawatKirim.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "INAP", "JALAN", "Semua" }));
        cmbJnsRawatKirim.setSelectedIndex(2);
        cmbJnsRawatKirim.setName("cmbJnsRawatKirim"); // NOI18N
        cmbJnsRawatKirim.setPreferredSize(new java.awt.Dimension(70, 23));
        internalFrame9.add(cmbJnsRawatKirim);
        cmbJnsRawatKirim.setBounds(107, 28, 70, 23);

        jLabel36.setForeground(new java.awt.Color(0, 0, 0));
        jLabel36.setText("Berdasarkan Tgl. :");
        jLabel36.setName("jLabel36"); // NOI18N
        internalFrame9.add(jLabel36);
        jLabel36.setBounds(180, 28, 110, 23);

        cmbJnsTanggal.setForeground(new java.awt.Color(0, 0, 0));
        cmbJnsTanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pulang", "Grouping" }));
        cmbJnsTanggal.setName("cmbJnsTanggal"); // NOI18N
        cmbJnsTanggal.setPreferredSize(new java.awt.Dimension(70, 23));
        internalFrame9.add(cmbJnsTanggal);
        cmbJnsTanggal.setBounds(297, 28, 75, 23);

        jLabel37.setForeground(new java.awt.Color(0, 0, 0));
        jLabel37.setText("Dari Tgl. :");
        jLabel37.setName("jLabel37"); // NOI18N
        internalFrame9.add(jLabel37);
        jLabel37.setBounds(0, 56, 100, 23);

        TtglA.setEditable(false);
        TtglA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        TtglA.setDisplayFormat("dd-MM-yyyy");
        TtglA.setName("TtglA"); // NOI18N
        TtglA.setOpaque(false);
        TtglA.setPreferredSize(new java.awt.Dimension(95, 23));
        internalFrame9.add(TtglA);
        TtglA.setBounds(107, 56, 90, 23);
        ...
        TtglB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        TtglB.setDisplayFormat("dd-MM-yyyy");
        TtglB.setName("TtglB"); // NOI18N
        TtglB.setOpaque(false);
        TtglB.setPreferredSize(new java.awt.Dimension(95, 23));
        internalFrame9.add(TtglB);
        TtglB.setBounds(235, 56, 90, 23);

        WindowKirimKolektif.getContentPane().add(internalFrame9, java.awt.BorderLayout.CENTER);
        ...
        tglA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
        ...
        tglB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2026" }));
...
//            tampilPersalinan();
    ...
    private void ppCekSEPGagalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCekSEPGagalBtnPrintActionPerformed
        tgl7.setDate(new Date());
        Calendar kalender = Calendar.getInstance();
        kalender.add(Calendar.DATE, -30);
        tgl7.setDate(kalender.getTime());
        tgl8.setDate(new Date());
        cmbLimit4.setSelectedIndex(0);
        cekSEP = "";
        TCari3.setText("");
        TCari3.requestFocus();
        tampilSEPgagal();
        WindowGagalSEP.setSize(760, internalFrame1.getHeight() - 40);
        WindowGagalSEP.setLocationRelativeTo(internalFrame1);
        WindowGagalSEP.setVisible(true);
    }//GEN-LAST:event_ppCekSEPGagalBtnPrintActionPerformed
    ...
    private void BtnCari5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari5KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, TCari3, BtnCari5);
        }
...
//            tampilPersalinan();
            ...
            Valid.pindah(evt, TCari3, BtnKeluar5);
        }
    ...
    private void tbSEPgagalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSEPgagalMouseClicked
        if (tabMode4.getRowCount() != 0) {
            try {
                cekSEP = "";
                cekSEP = tbSEPgagal.getValueAt(tbSEPgagal.getSelectedRow(), 2).toString();
            } catch (java.lang.NullPointerException e) {
            }
        }
    }//GEN-LAST:event_tbSEPgagalMouseClicked

    private void tbSEPgagalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSEPgagalKeyPressed
        if (tabMode4.getRowCount() != 0) {
            if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_UP) || (evt.getKeyCode() == KeyEvent.VK_DOWN)) {
                try {
                    cekSEP = "";
    ...
    }//GEN-LAST:event_tbSEPgagalKeyPressed

    private void BtnAll6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAll6ActionPerformed
        if (cekSEP.equals("")) {
            JOptionPane.showMessageDialog(null, "Silahkan pilih dulu salah satu no. sep nya pada tabel..!!!!");
            tbSEPgagal.requestFocus();
        } else {
            x = JOptionPane.showConfirmDialog(rootPane, "Yakin No. SEP yang dipilih akan diverifikasi..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                if (Sequel.queryu2tf("delete from eklaim_new_claim where patient_id='-' and klaim_final='Belum' and no_sep=?", 1, new String[]{cekSEP
                }) == true) {
                    tampilSEPgagal();
                    JOptionPane.showMessageDialog(null, "Proses verifikasi SEP berhasil dilakukan...!!!!");
                    WindowGagalSEP.dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Gagal verifikasi, cek kembali datanya..!!");
                }
            }
        }
    }//GEN-LAST:event_BtnAll6ActionPerformed

    private void ppContengSemuaBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppContengSemuaBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
    ...
    private void ppHapusContengBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusContengBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data klaim masih kosong...!!!!");
            tbINACBG.requestFocus();
        } else {
            BtnCari1ActionPerformed(null);
            for (i = 0; i < tbINACBG.getRowCount(); i++) {
                tbINACBG.setValueAt(Boolean.FALSE, i, 0);
            }
        }
    }//GEN-LAST:event_ppHapusContengBtnPrintActionPerformed

    private void ppKirimOnlineKolektifBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppKirimOnlineKolektifBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data klaim masih kosong...!!!!");
            tbINACBG.requestFocus();
        } else {
    ...
    private void BtnCloseIn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCloseIn4ActionPerformed
        WindowKirimKolektif.dispose();
        BtnCari1ActionPerformed(null);
        cmbJnsRawatKirim.setSelectedIndex(0);
        cmbJnsTanggal.setSelectedIndex(0);
        TtglA.setDate(new Date());
        TtglB.setDate(new Date());
    }//GEN-LAST:event_BtnCloseIn4ActionPerformed

    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        x = JOptionPane.showConfirmDialog(rootPane, "Yakin data klaim INACBG akan dikirim secara kolektif..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
        if (x == JOptionPane.YES_OPTION) {
            if (cmbJnsRawatKirim.getSelectedIndex() == 0) {
                jnsrwt = "1";
            } else if (cmbJnsRawatKirim.getSelectedIndex() == 1) {
                jnsrwt = "2";
            } else if (cmbJnsRawatKirim.getSelectedIndex() == 2) {
                jnsrwt = "3";
            }
            
            if (cmbJnsTanggal.getSelectedIndex() == 0) {
                jnsTgl = "1";
            } else if (cmbJnsTanggal.getSelectedIndex() == 1) {
                jnsTgl = "2";
            }
    ...
    private void MnRalan10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRalan10ActionPerformed
        x = JOptionPane.showConfirmDialog(rootPane, "Apakah proses restore data akan dilakukan..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
        if (x == JOptionPane.YES_OPTION) {
            try {
                if (Chktgl.isSelected() == true) {
                    ps8 = koneksi.prepareStatement("select distinct rp.*, if(dpi.no_rawat is not null,'ada','tidak ada') cekDiagIdrg, "
                            + "if(dp.no_rawat is not null,'ada','tidak ada') cekDiagStat, if(ei.no_sep is null,'-',ei.kode_icd) kodeicd, "
                            + "if(ei.no_sep is null,'1',ei.nomor) nomOR from bridging_sep bs "
                            + "inner join reg_periksa rp on rp.no_rawat=bs.no_rawat "
                            + "inner join eklaim_set_claim esc on esc.no_sep=bs.no_sep "
                            + "left join eklaim_idrg_inacbg_icd10 ei on ei.no_sep=bs.no_sep "
                            + "left join diagnosa_pasien_inadrg dpi on dpi.no_rawat=rp.no_rawat "
                            + "left join diagnosa_pasien dp on dp.no_rawat=rp.no_rawat where "
                            + "date(esc.tgl_input) between '" + Valid.SetTgl(tglA.getSelectedItem() + "") + "' and '" + Valid.SetTgl(tglB.getSelectedItem() + "") + "' "
                    ...
                    ps8 = koneksi.prepareStatement("select distinct rp.*, if(dpi.no_rawat is not null,'ada','tidak ada') cekDiagIdrg, "
                            ...
                            + "left join diagnosa_pasien_inadrg dpi on dpi.no_rawat=rp.no_rawat "
                            + "left join diagnosa_pasien dp on dp.no_rawat=rp.no_rawat where "
                            + "bs.tglsep between '" + Valid.SetTgl(tglA.getSelectedItem() + "") + "' and '" + Valid.SetTgl(tglB.getSelectedItem() + "") + "' "
                            + "and rp.status_lanjut ='Ralan'");
                }
                ...
                try {
                    ...
                    prosesData = 0;
                    while (rs8.next()) {
                        if (rs8.getString("cekDiagIdrg").equals("tidak ada")) {
                            Sequel.menyimpanPesanGagalnyaDiTerminal("diagnosa_pasien_inadrg", "?,?,?,?,?", "Penyakit", 5, new String[]{
                                rs8.getString("no_rawat"),
                                rs8.getString("kodeicd"),
                                rs8.getString("status_lanjut"),
                                rs8.getString("nomOR"),
                                akses.getkode()
                            });
                        } else if (rs8.getString("cekDiagStat").equals("tidak ada")) {
                    ...
                    if (prosesData > 0) {
                        JOptionPane.showMessageDialog(null, "Proses restore data diagnosa ICD 10 rawat jalan sudah selesai ...!");
                    } else {
                        JOptionPane.showMessageDialog(null, "Tidak ada data diagnosa ICD 10 yang bisa direstore ...!");
                    }
                } catch (Exception e) {
                    System.out.println("Notifikasi : " + e);
                } finally {
            ...
            Sequel.queryu("delete from diagnosa_pasien_inadrg where kd_penyakit='-'");
            Sequel.queryu("delete from diagnosa_pasien where kd_penyakit='-'");
        }
    }//GEN-LAST:event_MnRalan10ActionPerformed

    private void MnRanap10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRanap10ActionPerformed
        x = JOptionPane.showConfirmDialog(rootPane, "Apakah proses restore data akan dilakukan..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
        if (x == JOptionPane.YES_OPTION) {
            try {
                if (Chktgl.isSelected() == true) {
                ...
                try {
                    ...
                    if (prosesData > 0) {
                        JOptionPane.showMessageDialog(null, "Proses restore data diagnosa ICD 10 rawat inap sudah selesai ...!");
                    } else {
                        JOptionPane.showMessageDialog(null, "Tidak ada data diagnosa ICD 10 yang bisa direstore ...!");
                    }
                } catch (Exception e) {
    ...
    }//GEN-LAST:event_MnRanap10ActionPerformed

    private void MnRalan9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRalan9ActionPerformed
        if (tbINACBG.getSelectedRow() != -1) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah proses restore data akan dilakukan..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                try {
                    ps8 = koneksi.prepareStatement("select distinct rp.*, if(ppi.no_rawat is not null,'ada','tidak ada') cekProsIdrg, "
                            + "if(pp.no_rawat is not null,'ada','tidak ada') cekProsStat, if(ei.no_sep is null,'-',ei.kode_icd) kodeicd, "
                            + "if(ei.no_sep is null,'1',ei.nomor) nomOR from bridging_sep bs "
                            + "inner join reg_periksa rp on rp.no_rawat=bs.no_rawat "
                            + "inner join eklaim_set_claim esc on esc.no_sep=bs.no_sep "
                            + "left join eklaim_idrg_inacbg_icd9 ei on ei.no_sep=bs.no_sep "
                            + "left join prosedur_pasien_inadrg ppi on ppi.no_rawat=rp.no_rawat "
                            + "left join prosedur_pasien pp on pp.no_rawat=rp.no_rawat where "
                            + "bs.no_sep='" + nosep_klaim.getText() + "' and rp.status_lanjut ='Ralan'");
                    try {
                        rs8 = ps8.executeQuery();
                        prosesData = 0;
                        while (rs8.next()) {
                            if (rs8.getString("cekProsIdrg").equals("tidak ada")) {
                            ...
                            } else if (rs8.getString("cekProsStat").equals("tidak ada")) {
                        ...
                        if (prosesData > 0) {
                            JOptionPane.showMessageDialog(null, "Proses restore data prosedur/tindakan ICD 9 rawat jalan sudah selesai ...!");
                        } else {
                            JOptionPane.showMessageDialog(null, "Tidak ada data prosedur/tindakan ICD 9 yang bisa direstore ...!");
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally {
                ...
                Sequel.queryu("delete from prosedur_pasien_inadrg where kode='-'");
                Sequel.queryu("delete from prosedur_pasien where kode='-'");
            }
        } else {
            JOptionPane.showMessageDialog(null, "Silahkan klik dulu salah satu datanya pada tabel sesuai no. sep yang dipilih ...!");
            tbINACBG.requestFocus();
        }
    }//GEN-LAST:event_MnRalan9ActionPerformed

    private void MnRanap9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRanap9ActionPerformed
        if (tbINACBG.getSelectedRow() != -1) {
            x = JOptionPane.showConfirmDialog(rootPane, "Apakah proses restore data akan dilakukan..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                try {
                    ps8 = koneksi.prepareStatement("select distinct rp.*, if(ppi.no_rawat is not null,'ada','tidak ada') cekProsIdrg, "
                            ...
                            + "left join prosedur_pasien_inadrg ppi on ppi.no_rawat=rp.no_rawat "
                            + "left join prosedur_pasien pp on pp.no_rawat=rp.no_rawat where "
                            + "bs.no_sep='" + nosep_klaim.getText() + "' and rp.status_lanjut ='Ranap'");
                    try {
                        rs8 = ps8.executeQuery();
                        prosesData = 0;
                        while (rs8.next()) {
                        ...
                        if (prosesData > 0) {
                            JOptionPane.showMessageDialog(null, "Proses restore data prosedur/tindakan ICD 9 rawat inap sudah selesai ...!");
                        } else {
                            JOptionPane.showMessageDialog(null, "Tidak ada data prosedur/tindakan ICD 9 yang bisa direstore ...!");
                        }
                    } catch (Exception e) {
    ...
    private javax.swing.JMenuItem MnRalan10;
    private javax.swing.JMenuItem MnRalan9;
    private javax.swing.JMenuItem MnRanap10;
    private javax.swing.JMenuItem MnRanap9;
    ...
    public widget.ComboBox cmbJnsRawatKirim;
    public widget.ComboBox cmbJnsTanggal;
    ...
    public widget.ComboBox cmbLimit4;
    ...
    private javax.swing.JMenuItem ppCekSEPGagal;
    private javax.swing.JMenuItem ppContengSemua;
    ...
    private widget.Tanggal tgl7;
    private widget.Tanggal tgl8;
    ...
    private void tampilSEP() {
        ...
        try {
            if (!cmbLimit.getSelectedItem().equals("Semuanya")) {
                ...
                sb1.append("IF(enc.jnspelayanan='2',CONCAT('Inst./Poli ',pl.nm_poli),CONCAT('Rg. ',b.nm_bangsal)) unit, ");
                ...
                sb2.append("IF(enc.jnspelayanan='2',CONCAT('Inst./Poli ',pl.nm_poli),CONCAT('Rg. ',b.nm_bangsal)) unit, ");
...
//        tglA.setDate(tgl);
    ...
    private void tampilKLAIM() {
        ...
        try {
            if (!cmbLimit.getSelectedItem().equals("Semuanya")) {
                ...
                sb1.append("LEFT JOIN reg_periksa rp on rp.no_rawat=enc.no_rawat LEFT JOIN poliklinik pl ON pl.kd_poli=rp.kd_poli ");
                sb1.append("left join kamar_inap ki on ki.no_rawat = rp.no_rawat left JOIN kamar k ON k.kd_kamar=ki.kd_kamar left JOIN bangsal b ON b.kd_bangsal=k.kd_bangsal WHERE ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.no_rawat like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and esc.payor_cd like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.no_sep like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.nm_pasien like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.klaim_final like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and p.nama like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.no_rm like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and if(eos.kemkes_dc_status='sent','Sudah Terkirim ke Kemenkes','Belum Terkirim') like ? or ");
                sb1.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and IF(rp.status_lanjut='Ralan',CONCAT('Inst./Poli ',pl.nm_poli),CONCAT('Rg. ',b.nm_bangsal)) like ? ");
                ...
                sb2.append("LEFT JOIN reg_periksa rp on rp.no_rawat=enc.no_rawat LEFT JOIN poliklinik pl ON pl.kd_poli=rp.kd_poli ");
                sb2.append("left join kamar_inap ki on ki.no_rawat = rp.no_rawat left JOIN kamar k ON k.kd_kamar=ki.kd_kamar left JOIN bangsal b ON b.kd_bangsal=k.kd_bangsal WHERE ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.no_rawat like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and esc.payor_cd like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.no_sep like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.nm_pasien like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.klaim_final like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and p.nama like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and enc.no_rm like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and if(eos.kemkes_dc_status='sent','Sudah Terkirim ke Kemenkes','Belum Terkirim') like ? or ");
                sb2.append("rp.status_lanjut like '" + nilaiRWT + "' and DATE(esc.tgl_input) BETWEEN ? AND ? and IF(rp.status_lanjut='Ralan',CONCAT('Inst./Poli ',pl.nm_poli),CONCAT('Rg. ',b.nm_bangsal)) like ? ");
    ...
    private void getData() {
        ...
        nmibu = "";
        if (tbINACBG.getSelectedRow() != -1) {
            kd_payor = tbINACBG.getValueAt(tbINACBG.getSelectedRow(), 24).toString();
            if (kd_payor.equals("3")) {
            ...
            noRawat.setText(tbINACBG.getValueAt(tbINACBG.getSelectedRow(), 1).toString());
            nosep_klaim.setText(tbINACBG.getValueAt(tbINACBG.getSelectedRow(), 3).toString());
            tglSep = tbINACBG.getValueAt(tbINACBG.getSelectedRow(), 23).toString();
            jnsKlaim = tbINACBG.getValueAt(tbINACBG.getSelectedRow(), 2).toString();
...
//        PengajuanKlaimINACBGrz ajukan = new PengajuanKlaimINACBGrz(null, false);
    ...
    private void tampilSEPgagal() {
        Valid.tabelKosong(tabMode4);
        try {
            if (cmbLimit4.getSelectedItem().equals("Semuanya")) {
                ps7 = koneksi.prepareStatement("SELECT bs.no_rawat, bs.no_kartu, bs.no_sep, DATE_FORMAT(bs.tglsep, '%d-%m-%Y' ) tgl_SEP, "
                        + "bs.nomr, bs.nama_pasien, IF(bs.jnspelayanan = '1', 'R. Inap', 'R. Jalan') jns_rwt FROM eklaim_new_claim en "
                        + "inner join bridging_sep bs on bs.no_rawat=en.no_rawat WHERE "
                        + "bs.tglsep BETWEEN ? AND ? and bs.no_rawat like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and bs.no_kartu like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and bs.no_sep like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and bs.nomr like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and bs.nama_pasien like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and IF(bs.jnspelayanan = '1', 'R. Inap', 'R. Jalan') like ? ORDER BY bs.no_sep DESC");
            } else {
                ps7 = koneksi.prepareStatement("SELECT bs.no_rawat, bs.no_kartu, bs.no_sep, DATE_FORMAT(bs.tglsep, '%d-%m-%Y' ) tgl_SEP, "
                        + "bs.nomr, bs.nama_pasien, IF(bs.jnspelayanan = '1', 'R. Inap', 'R. Jalan') jns_rwt FROM eklaim_new_claim en "
                        + "inner join bridging_sep bs on bs.no_rawat=en.no_rawat WHERE "
                        ...
                        + "bs.tglsep BETWEEN ? AND ? and bs.nomr like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and bs.nama_pasien like ? or "
                        + "bs.tglsep BETWEEN ? AND ? and IF(bs.jnspelayanan = '1', 'R. Inap', 'R. Jalan') like ? "
                        + "ORDER BY bs.no_sep DESC limit " + cmbLimit4.getSelectedItem().toString() + "");
            }            
            try {
                ps7.setString(1, Valid.SetTgl(tgl7.getSelectedItem() + ""));
                ps7.setString(2, Valid.SetTgl(tgl8.getSelectedItem() + ""));
                ps7.setString(3, "%" + TCari3.getText().trim() + "%");                
                ps7.setString(4, Valid.SetTgl(tgl7.getSelectedItem() + ""));
                ps7.setString(5, Valid.SetTgl(tgl8.getSelectedItem() + ""));
                ps7.setString(6, "%" + TCari3.getText().trim() + "%");                
                ps7.setString(7, Valid.SetTgl(tgl7.getSelectedItem() + ""));
                ps7.setString(8, Valid.SetTgl(tgl8.getSelectedItem() + ""));
                ps7.setString(9, "%" + TCari3.getText().trim() + "%");                
                ps7.setString(10, Valid.SetTgl(tgl7.getSelectedItem() + ""));
                ps7.setString(11, Valid.SetTgl(tgl8.getSelectedItem() + ""));
                ps7.setString(12, "%" + TCari3.getText().trim() + "%");                
                ps7.setString(13, Valid.SetTgl(tgl7.getSelectedItem() + ""));
                ps7.setString(14, Valid.SetTgl(tgl8.getSelectedItem() + ""));
                ps7.setString(15, "%" + TCari3.getText().trim() + "%");                
                ps7.setString(16, Valid.SetTgl(tgl7.getSelectedItem() + ""));
                ps7.setString(17, Valid.SetTgl(tgl8.getSelectedItem() + ""));
                ps7.setString(18, "%" + TCari3.getText().trim() + "%");                
                ...
                while (rs7.next()) {
                    tabMode4.addRow(new Object[]{
                        ...
                        rs7.getString("tgl_SEP"),
                        rs7.getString("nomr"),
                        rs7.getString("nama_pasien"),
                        rs7.getString("jns_rwt")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
        ...
        LCount5.setText("" + tabMode4.getRowCount());
    }
}
