...
import fungsi.TableValidasiData;
...
public final class PengajuanKlaimINACBGrz extends javax.swing.JDialog {
    private final DefaultTableModel tabMode2, tabMode3, tabMode4, tabMode5, tabMode6, tabMode7, tabMode8, tabMode9, 
            tabMode10, tabMode11, tabMode12, tabMode13, tabMode14, tabMode15, tabMode16, tabMode17, tabMode18, tabMode19, tabMode20;
    ...
    private PreparedStatement ps, ps1, ps2, ps3, ps4, ps5, ps6, ps7, ps8, ps9, ps10, ps11, ps12, ps13, ps14, ps15, ps16, ps17, ps18, ps19, ps20, ps21;
    private ResultSet rs, rs1, rs2, rs3, rs4, rs5, rs6, rs7, rs8, rs9, rs10, rs11, rs12, rs13, rs14, rs15, rs16, rs17, rs18, rs19, rs20, rs21;
    ...
    public PengajuanKlaimINACBGrz(java.awt.Frame parent, boolean modal) {
        ...
        tabMode13 = new DefaultTableModel(null, new Object[]{
            "Kode", "Deskripsi Diagnosa ICD-10", "Status Diag.", "Verifikasi"
        }) {
            @Override
        ...
        tbDiagnosaPasien.setModel(tabMode13);
        ...
        tbTindakanPasien.setModel(tabMode15);
        ...
        tabMode18 = new DefaultTableModel(null, new String[]{
            "No.", "Kode ICD 10", "Deskripsi Diagnosa", "Urutan Ke", "Valid Code"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tbDiagInacbg.setModel(tabMode18);
        tbDiagInacbg.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbDiagInacbg.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 5; i++) {
            TableColumn column = tbDiagInacbg.getColumnModel().getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(30);
            } else if (i == 1) {
        ...
        tbDiagInacbg.setDefaultRenderer(Object.class, new TableValidasiData());
        //ini posisi kolom yang datanya ingin rata tengah
        tbDiagInacbg.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tbDiagInacbg.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        
        tabMode19 = new DefaultTableModel(null, new String[]{
            "No.", "Kode ICD 9", "Deskripsi Prosedur/Tindakan", "Urutan Ke", "Valid Code"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tbProsInacbg.setModel(tabMode19);
        tbProsInacbg.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbProsInacbg.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 5; i++) {
            TableColumn column = tbProsInacbg.getColumnModel().getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(30);
            } else if (i == 1) {
                column.setPreferredWidth(75);
        ...
        tbProsInacbg.setDefaultRenderer(Object.class, new TableValidasiData());
        //ini posisi kolom yang datanya ingin rata tengah
        tbProsInacbg.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tbProsInacbg.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        ...
        tabMode20 = new DefaultTableModel(null, new Object[]{"#", "Tipe", "Kode", "Deskripsi", "Tot. Cost Weight"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
        ...
        tbHasil5.setModel(tabMode20);
        tbHasil5.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbHasil5.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 5; i++) {
            TableColumn column = tbHasil5.getColumnModel().getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(30);
            } else if (i == 1) {
                column.setPreferredWidth(125);
        ...
        tbHasil5.setDefaultRenderer(Object.class, new WarnaTable());
...
//                column.setPreferredWidth(350);
        ...
        tbInadrg.setModel(tabMode11);
        tbInadrg.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbInadrg.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void initComponents() {
        ...
        ppLaporanOperasi = new javax.swing.JMenuItem();
        ...
        LtambahanInacbg = new widget.Label();
        BtnGruperStageInacbg = new widget.Button();
        ...
        ScrollHasil7 = new widget.ScrollPane();
        ...
        ScrollHasil9 = new widget.ScrollPane();
        tbHasil5 = new widget.Table();
        BtnGruperStageIdrg = new widget.Button();
        LtambahanIdrg = new widget.Label();
        ...
        ppDiagnosa.setPreferredSize(new java.awt.Dimension(160, 25));
        ...
        ppLaporanOperasi.setBackground(new java.awt.Color(242, 242, 242));
        ppLaporanOperasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLaporanOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLaporanOperasi.setText("Laporan Operasi");
        ppLaporanOperasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLaporanOperasi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLaporanOperasi.setIconTextGap(8);
        ppLaporanOperasi.setName("ppLaporanOperasi"); // NOI18N
        ppLaporanOperasi.setPreferredSize(new java.awt.Dimension(160, 25));
        ppLaporanOperasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLaporanOperasiBtnPrintActionPerformed(evt);
            }
        });
        Popup1.add(ppLaporanOperasi);
        ...
        tglDiagnosa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026" }));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1312));
        ...
        ScrollHasil1.setBounds(45, 940, 570, 150);
        ...
        LtambahanInacbg.setForeground(new java.awt.Color(0, 0, 0));
        LtambahanInacbg.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LtambahanInacbg.setText("tambahan biaya inacbg");
        LtambahanInacbg.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        LtambahanInacbg.setName("LtambahanInacbg"); // NOI18N
        FormInput.add(LtambahanInacbg);
        LtambahanInacbg.setBounds(45, 1263, 600, 23);

        BtnGruperStageInacbg.setForeground(new java.awt.Color(0, 0, 0));
        BtnGruperStageInacbg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/SeratusRibu.png"))); // NOI18N
        BtnGruperStageInacbg.setText("Grouper Stage 2 (INACBG)");
        BtnGruperStageInacbg.setGlassColor(new java.awt.Color(0, 153, 153));
        BtnGruperStageInacbg.setName("BtnGruperStageInacbg"); // NOI18N
        BtnGruperStageInacbg.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnGruperStageInacbg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGruperStageInacbgActionPerformed(evt);
            }
        });
        FormInput.add(BtnGruperStageInacbg);
        BtnGruperStageInacbg.setBounds(45, 1225, 200, 30);
        ...
        ScrollHasil5.setBounds(45, 755, 570, 150);
        ...
        pros_inadrg1.setBounds(850, 680, 450, 23);
        ...
        jLabel65.setBounds(690, 680, 160, 23);
        ...
        tglIntubasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 09:00:02" }));
        ...
        tglEkstubasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 09:00:02" }));
        ...
        wktkelahiran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 09:00:02" }));
        ...
        FormInput.add(internalFrame5);
        internalFrame5.setBounds(45, 540, 630, 160);

        internalFrame9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "[ Prosedur/Tindakan iDRG ]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        FormInput.add(internalFrame9);
        internalFrame9.setBounds(690, 540, 570, 135);

        ScrollHasil7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "[ Diagnosa INACBG ]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ScrollHasil7.setName("ScrollHasil7"); // NOI18N
        ScrollHasil7.setOpaque(true);
        ...
        BtnCetakKlaim.setText("Download PDF Klaim");
        BtnCetakKlaim.setGlassColor(new java.awt.Color(0, 153, 153));
        BtnCetakKlaim.setName("BtnCetakKlaim"); // NOI18N
        BtnCetakKlaim.setPreferredSize(new java.awt.Dimension(120, 30));
        ...
        BtnCetakKlaim.setBounds(860, 1225, 180, 30);
        ...
        gambarFinal.setBackgroundImageType(usu.widget.constan.BackgroundConstan.BACKGROUND_IMAGE_STRECT);
        gambarFinal.setPreferredSize(new java.awt.Dimension(200, 200));
        ...
        ScrollHasil2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "[ Special CMG Option (INACBG) ]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        panelGlass9.add(ScrollHasil2);

        ScrollHasil9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "[ Special CMG Option (iDRG) ]", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ScrollHasil9.setName("ScrollHasil9"); // NOI18N
        ScrollHasil9.setOpaque(true);

        tbHasil5.setName("tbHasil5"); // NOI18N
        tbHasil5.getTableHeader().setReorderingAllowed(false);
        ScrollHasil9.setViewportView(tbHasil5);

        panelGlass9.add(ScrollHasil9);

        FormInput.add(panelGlass9);
        panelGlass9.setBounds(45, 1100, 1210, 120);

        BtnGruperStageIdrg.setForeground(new java.awt.Color(0, 0, 0));
        BtnGruperStageIdrg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/SeratusRibu.png"))); // NOI18N
        BtnGruperStageIdrg.setText("Grouper Stage 2 (iDRG)");
        BtnGruperStageIdrg.setGlassColor(new java.awt.Color(0, 153, 153));
        BtnGruperStageIdrg.setName("BtnGruperStageIdrg"); // NOI18N
        BtnGruperStageIdrg.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnGruperStageIdrg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGruperStageIdrgActionPerformed(evt);
            }
        });
        FormInput.add(BtnGruperStageIdrg);
        BtnGruperStageIdrg.setBounds(1053, 1225, 200, 30);

        LtambahanIdrg.setForeground(new java.awt.Color(0, 0, 0));
        LtambahanIdrg.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        LtambahanIdrg.setText("tambahan biaya idrg");
        LtambahanIdrg.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        LtambahanIdrg.setName("LtambahanIdrg"); // NOI18N
        FormInput.add(LtambahanIdrg);
        LtambahanIdrg.setBounds(655, 1263, 600, 23);
        ...
        tglIntubasi1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 09:00:02" }));
        ...
        tglEkstubasi1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 09:00:02" }));
        ...
        if (kodePayor.equals("3")) {
            if (Sequel.cariInteger("select count(-1) from setting_bridging where kd_bridging='1' and status_aktif='Ya'") == 1) {
                ...
                if ((kankerRanap > 0 && cekKanker < 1) || (kankerRalan > 0 && cekKanker < 1)) {
                    ...
                    LtambahanInacbg.setText("Biaya tambahan yang harus dibayar : Rp. "
                            + Sequel.cariIsi("SELECT format(ifnull(add_payment_amt,'0'),0) tambhn_biaya FROM eklaim_grouping WHERE no_sep='" + noSEP.getText() + "'"));
                    LtambahanIdrg.setText("Biaya tambahan yang harus dibayar : Rp. "
                            + Sequel.cariIsi("SELECT format(ifnull(total_tarif,'0'),0) tambhn_biaya FROM eklaim_response_inagrouper WHERE no_sep='" + noSEP.getText() + "'"));
        ...
        if (kodePayor.equals("3")) {
            ...
            if (akses.getPasteData().equals("sukses")) {
                ...
                if (tabMode20.getRowCount() == 0) {
                    ...
                    BtnGruperStageIdrg.setEnabled(true);
                }
            }
...
//                JOptionPane.showMessageDialog(null, "Hasil grouper belum ada, lakukan proses simpan & grouper klaim dulu,...!!");
//            } else {
            i = JOptionPane.showConfirmDialog(null, "Apakah yakin klaim akan dihapus..??!!", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            if (i == JOptionPane.YES_OPTION) {
...
//            }
    ...
    private void BtnFinalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnFinalActionPerformed
        ...
        if (kodePayor.equals("3")) {
            ...
            if (i == JOptionPane.YES_OPTION) {
                akses.setCopyData("");
                if (mbak_eka.inacbgFinal(noSEP.getText()) == true) {
                    labelhasilG.setText("Hasil Grouper iDRG : " + Sequel.cariIsi("select if(klaim_final='Belum','',klaim_final) from eklaim_new_claim where no_sep='" + noSEP.getText() + "'"));
...
//                    labelhasilG.setText("Hasil Grouper iDRG : " + Sequel.cariIsi("select if(klaim_final='Belum','',klaim_final) from eklaim_new_claim where no_sep='" + noSEP.getText() + "'"));
                    ...
                    if (Sequel.cariIsi("select klaim_final from eklaim_new_claim where no_sep='" + noSEP.getText() + "'").equals("Final")) {
                        gambarFinal.setVisible(true);
                    } else {
    ...
    private void BtnGruperStageInacbgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGruperStageInacbgActionPerformed
        kodeTopUPnya = "";
        tampilDiagnosa();
        tampilProsedur();
        ...
        try {
            ...
            if (j == 0) {
                JOptionPane.showMessageDialog(null, "Belum ada special CMG (INACBG) yang dipilih,.!!!");
                tampilHG2();
            } else {
                for (i = 0; i < tbHasil2.getRowCount(); i++) {
                    if (tbHasil2.getValueAt(i, 0).toString().equals("true")) {
                ...
                akses.setCopyData("");
                mbak_eka.menggrouperKedua(noSEP.getText(), kodeTopUPnya, "inacbg");
                tampilHG1();
                tampilHG2();
    ...
    }//GEN-LAST:event_BtnGruperStageInacbgActionPerformed
...
//        }
    ...
    private void BtnSimpanSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanSetActionPerformed
        if (norawat.equals("") || noSEP.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Pilih dulu salah satu No. SEP...!!!!");
    ...
    private void BtnGroperEditIdrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGroperEditIdrgActionPerformed
        ...
        tampilDiagnosa();
        tampilProsedur();
        mbak_eka.editGrouper(noSEP.getText());
        labelhasilG.setText("Hasil Grouper iDRG : " + Sequel.cariIsi("select if(klaim_final='Belum','',klaim_final) from eklaim_new_claim where no_sep='" + noSEP.getText() + "'"));
        LtambahanInacbg.setText("Biaya tambahan yang harus dibayar : Rp. "
                + Sequel.cariIsi("SELECT format(ifnull(add_payment_amt,'0'),0) tambhn_biaya FROM eklaim_grouping WHERE no_sep='" + noSEP.getText() + "'"));
        LtambahanIdrg.setText("Biaya tambahan yang harus dibayar : Rp. "
...
//            }
    ...
    private void BtnCetakKlaimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakKlaimActionPerformed
        try {
            if (mbak_eka.filePdfPrint(noSEP.getText()) == true) {
                // BASE64 disimpan di variabel data
                String data = akses.getPasteData();
                ...
                fileChooser.setDialogTitle("Pilih lokasi untuk menyimpan File Klaimnya..!");
                fileChooser.setSelectedFile(new File("Klaim SEP (" + noSEP.getText() + ").pdf")); // nama default

                int userSelection = fileChooser.showSaveDialog(null);
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    File fileToSave = fileChooser.getSelectedFile();
                    try {
                        // Simpan sebagai file PDF di lokasi yang dipilih
                        Files.write(fileToSave.toPath(), pdfBytes);
                        // Jika ingin langsung dibuka (preview)
                        i = JOptionPane.showConfirmDialog(null, "Apakah file PDF klaim yang sudah tersimpan mau dibaca..??!!", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                        if (i == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(null, "Penyimpanan file dibatalkan.");
                }

            } else {
                JOptionPane.showMessageDialog(null, "Download file PDF klaim belum bisa, selesaikan dulu semua tahapan prosesnya,...!!");
            }
        } catch (Exception e) {
            System.out.println("Notifikasi : " + e);
        }
    ...
    private void BtnGruperStageIdrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGruperStageIdrgActionPerformed
        kodeTopUPnya = "";
        tampilDiagnosa();
        tampilProsedur();
        ...
        try {
            j = 0;
            for (i = 0; i < tbHasil5.getRowCount(); i++) {
                if (tbHasil5.getValueAt(i, 0).toString().equals("true")) {
                    j++;
                }
            }

            if (j == 0) {
                JOptionPane.showMessageDialog(null, "Belum ada special CMG (iDRG) yang dipilih,.!!!");
                tampilHG3();
            } else {
                for (i = 0; i < tbHasil5.getRowCount(); i++) {
                    if (tbHasil5.getValueAt(i, 0).toString().equals("true")) {
                        kodeTopUPnya = kodeTopUPnya + tbHasil5.getValueAt(i, 2).toString() + "#";
                    }
                }
    ...
    }//GEN-LAST:event_BtnGruperStageIdrgActionPerformed

    private void ppLaporanOperasiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLaporanOperasiBtnPrintActionPerformed
        String unit = "";
        if (labelrwt.getText().equals("INAP")) {
            unit = Sequel.cariIsi("select b.nm_bangsal from kamar_inap ki inner join kamar k on k.kd_kamar=ki.kd_kamar "
        ...
        form.emptTeks();
        form.isCek();
        form.setData(norawat, norm.getText(), nmPasien.getText(), unit);
        form.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        form.setLocationRelativeTo(internalFrame1);
        form.setVisible(true);
    }//GEN-LAST:event_ppLaporanOperasiBtnPrintActionPerformed
    ...
    private widget.Button BtnGruperFinalInacbg;
    private widget.Button BtnGruperStage1;
    private widget.Button BtnGruperStageIdrg;
    private widget.Button BtnGruperStageInacbg;
    ...
    private widget.Label LtambahanIdrg;
    private widget.Label LtambahanInacbg;
    ...
    private widget.ScrollPane ScrollHasil7;
    private widget.ScrollPane ScrollHasil8;
    private widget.ScrollPane ScrollHasil9;
    ...
    private usu.widget.glass.PanelGlass gambarFinal;
    ...
    private javax.swing.JMenuItem ppLaporanOperasi;
    ...
    private widget.Table tbDiagInacbg;
    ...
    private widget.Table tbHasil5;
    private widget.Table tbInadrg;
    private widget.Table tbPersalinan;
    private widget.Table tbProsInacbg;
...
//                        tglREG = Sequel.cariIsi("select tgl_registrasi from reg_periksa where no_rawat='" + norw + "'");
        ...
        if (kodePayor.equals("3")) {
            ...
            labelhasilG2.setText("Hasil Grouper iDRG : " + Sequel.cariIsi("select if(klaim_final='Belum','',klaim_final) from eklaim_new_claim "
                ...
                try {
                    ...
                    while (rs13.next()) {
                        ...
                        if (mbak_eka.ngecekDiagnosaINADRG(rs13.getString("kd_penyakit")) == true) {
                            ...
                            hasilVerifDiag2 = "IM Tidak Berlaku";
                        }
    ...
    public void emptTeksJKN() {
        ...
        labelhasilG.setText("Hasil Grouper iDRG : ");
        LtambahanInacbg.setText("Biaya tambahan yang harus dibayar : Rp. 0");
        LtambahanIdrg.setText("Biaya tambahan yang harus dibayar : Rp. 0");
    ...
    public void emptTeksLAINNYA() {
        ...
        Valid.tabelKosong(tabMode9);
        Valid.tabelKosong(tabMode10);
        labelhasilG2.setText("Hasil Grouper iDRG : ");
        cmbKriteria.setSelectedIndex(1);
        cmbIsolasi.setSelectedIndex(0);
    ...
    public void isCek() {
        ...
        BtnGruperStageInacbg.setEnabled(akses.getpengajuan_klaim_raza());
    ...
    private void tampilHG3() {
        //kalau kode payor 3 adalah JKN
        if (kodePayor.equals("3")) {
            Valid.tabelKosong(tabMode20);
            try {
                StringBuilder sb1 = new StringBuilder();
                sb1.append("SELECT *, TRUNCATE(cost_weight, 2) totCosWeight FROM eklaim_grouping_topup_opt WHERE no_sep='" + noSEP.getText() + "'");
                ps21 = koneksi.prepareStatement(sb1.toString());
                try {
                    rs21 = ps21.executeQuery();
                    while (rs21.next()) {
                        tabMode20.addRow(new Object[]{
                            false,
                            rs21.getString("type"),
                            rs21.getString("code"),
                            rs21.getString("description"),
                            rs21.getString("totCosWeight")
                        });
                    }
                } catch (Exception e) {
                    System.out.println("Notifikasi : " + e);
    ...
    private void dataKlaimBaru() {
        ...
        if (kodePayor.equals("3")) {
            ...
            //jns. pelayanan 2 (rawat jalan)  
                ...
                losIntensif.setEnabled(false);
                ventilator.setEnabled(false);
                wktMasuk.setText(Sequel.cariIsi("select ifnull(concat(date_format(bs.tglsep,'%d %b %Y'),' ',rp.jam_reg),'') FROM reg_periksa rp "
                        + "INNER JOIN bridging_sep bs ON bs.no_rawat=rp.no_rawat WHERE bs.no_sep='" + noSEP.getText() + "' and bs.jnspelayanan='2'"));
//                wktMasuk.setText(Sequel.cariIsi("select ifnull(concat(date_format(tgl_registrasi,'%d %b %Y'),' ',jam_reg),'') from reg_periksa where no_rawat='" + norawat + "'"));
    ...
    private void hasilJLHProsedur() {
        ...
        if (kodePayor.equals("3")) {
            for (i = 0; i < tbTindakanPasien.getRowCount(); i++) {
                if (i == 0) {
                    if (!tbTindakanPasien.getValueAt(i, 2).toString().equals("") && Integer.parseInt(tbTindakanPasien.getValueAt(i, 2).toString()) > 1) {
                        prosedurINADRG1 = tbTindakanPasien.getValueAt(i, 0).toString() + "+" + tbTindakanPasien.getValueAt(i, 2).toString();
                    } else {
                        prosedurINADRG1 = tbTindakanPasien.getValueAt(i, 0).toString();
                    }
                } else {
                    if (!tbTindakanPasien.getValueAt(i, 2).toString().equals("") && Integer.parseInt(tbTindakanPasien.getValueAt(i, 2).toString()) > 1) {
                        prosedurINADRG1 = prosedurINADRG1 + "#" + tbTindakanPasien.getValueAt(i, 0).toString() + "+" + tbTindakanPasien.getValueAt(i, 2).toString();
                    } else {
                        prosedurINADRG1 = prosedurINADRG1 + "#" + tbTindakanPasien.getValueAt(i, 0).toString();
                    }
                }
            }
    ...
    private void simpanKlaim() {
        ...
        for (i = 0; i < tbDiagnosaPasien.getRowCount(); i++) {
            if (tbDiagnosaPasien.getValueAt(i, 3).toString().equals("IM Tidak Berlaku")) {
                diag++;
            }
        }

        if (diag > 0) {
            JOptionPane.showMessageDialog(null, "Masih ada diagnosa iDRG/IM yg. tidak berlaku utk. diklaimkan, Silahkan perbaiki dulu.!!!");
            tbDiagnosaPasien.requestFocus();
        } else {
            if (mbak_eka.simpanSetKlaim(noSEP.getText(), noPeserta.getText(), tglmsk, tglplg, jpel, kls, subakut.getText(), kronik.getText(), icuindikator,
    ...
    private void tampilDiagInacbg() {
        Valid.tabelKosong(tabMode18);
        try {
            ps19 = koneksi.prepareStatement("SELECT e.kode_icd, e.display, e.nomor urutan, if(e.validcode='1','Valid','Tidak Berlaku') validcode "
                    + "FROM eklaim_idrg_inacbg_icd10 e WHERE e.no_sep='" + noSEP.getText() + "' ORDER BY e.nomor");
            try {
                ...
                while (rs19.next()) {
                    tabMode18.addRow(new String[]{
                        x + ".",
                        rs19.getString("kode_icd"),
                        rs19.getString("display"),
                        rs19.getString("urutan"),
                        rs19.getString("validcode")
                    });
                    x++;
                }
            } catch (Exception e) {
    ...
    private void tampilProsInacbg() {
        Valid.tabelKosong(tabMode19);
        try {
            ps20 = koneksi.prepareStatement("SELECT e.kode_icd, e.display, e.nomor urutan, if(e.validcode='1','Valid','Tidak Berlaku') validcode "
                    + "FROM eklaim_idrg_inacbg_icd9 e WHERE e.no_sep='" + noSEP.getText() + "' ORDER BY e.nomor");
            try {
                ...
                while (rs20.next()) {
                    tabMode19.addRow(new String[]{
                        x + ".",
                        rs20.getString("kode_icd"),
                        rs20.getString("display"),
                        rs20.getString("urutan"),
                        rs20.getString("validcode")
                    });
                    x++;
                }
            } catch (Exception e) {
