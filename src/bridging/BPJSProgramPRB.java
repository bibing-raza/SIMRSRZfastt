...
public final class BPJSProgramPRB extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnTampilkanObatPRB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MnTampilkanObatPRB.setIconTextGap(5);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Program PRB di VClaim ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-11-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-11-2021" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(400, 300));
        ...
        btnDokterDPJP.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel4.setBounds(565, 10, 60, 23);
        ...
        Saran.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ObatPRB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-11-2021" }));
            ...
            try{
                ...
                for (i = 0; i < tbObat.getRowCount(); i++) {
                    if (Valid.SetAngka(tbObat.getValueAt(i, 0).toString()) > 0) {
                        obat = obat + "{\"kdObat\":\"" + tbObat.getValueAt(i, 1).toString() + "\","
                                + "\"signa1\":\"" + tbObat.getValueAt(i, 3).toString().trim() + "\","
                                + "\"signa2\":\"" + tbObat.getValueAt(i, 4).toString().trim() + "\","
                                + "\"jmlObat\":\"" + tbObat.getValueAt(i, 0).toString() + "\"},";
                        z++;
                    }
                }
                if (z > 0) {
...
//sampai sini -------------
                    ...
                    if (Sequel.menyimpantf("bridging_srb_bpjs", "?,?,?,?,?,?,?,?,?,?,?,?", "No.SEP SRB", 12, new String[]{
                        NoSEP.getText(), response.asText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""), Alamat.getText(), Email.getText(),
                        KdProgram.getText(), NmProgram.getText(), KdDPJP.getText(), NmDPJP.getText(), KdDPJP.getText(), Keterangan.getText(), Saran.getText()
                    }) == true) {
                        if (z > 0) {
                            for (i = 0; i < tbObat.getRowCount(); i++) {
                                if (Valid.SetAngka(tbObat.getValueAt(i, 0).toString()) > 0) {
                                    Sequel.menyimpan("bridging_srb_bpjs_obat", "?,?,?,?,?,?,?", 7, new String[]{
                                        NoSEP.getText(), response.asText(), tbObat.getValueAt(i, 1).toString(), tbObat.getValueAt(i, 2).toString(), 
                                        tbObat.getValueAt(i, 0).toString(), tbObat.getValueAt(i, 3).toString(), tbObat.getValueAt(i, 4).toString()
                                    });
                                }
                            }
                        }
                ...
                try {
                    ...
                    if (nameNode.path("code").asText().equals("200")) {
                        ...
                        if (Sequel.queryu2tf("update bridging_srb_bpjs set no_sep=?,no_srb=?,tgl_srb=?,alamat=?,email=?,kodeprogram=?,namaprogram=?,kodedpjp=?,nmdpjp=?,user=?,keterangan=?,saran=? where no_sep=? and no_srb=?", 14, new String[]{
                            NoSEP.getText(), response.asText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""), Alamat.getText(), Email.getText(), KdProgram.getText(), 
                            NmProgram.getText(), KdDPJP.getText(), NmDPJP.getText(), KdDPJP.getText(), Keterangan.getText(), Saran.getText(),
                            ...
                            if (z > 0) {
                                Sequel.menghapus("bridging_srb_bpjs_obat","no_sep","no_srb",tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(),6).toString(),
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        if (tbProgramPRB.getSelectedRow() != -1) {
            ...
            param.put("finger", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() 
                    + "Ditandatangani secara elektronik oleh " + tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 10).toString() + "ID " 
            ...
            for (i = 0; i < tbObat.getRowCount(); i++) {
                if (Valid.SetAngka(tbObat.getValueAt(i, 0).toString()) > 0) {
                    obat = obat + z + ". " + tbObat.getValueAt(i, 3).toString().trim() + "x" + tbObat.getValueAt(i, 4).toString().trim() + "  " 
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs2.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "Jumlah", "Kode Barang", "Nama Barang", "Signa 1", "Signa 2", "", "", "", "", "", "", "", "", ""
                                });
                                rs2.beforeFirst();
                                while (rs2.next()) {
                                    tabMode.addRow(new Object[]{
                                        "", 
                                        rs2.getDouble("jumlah"), 
    ...
    */
    ...
    public void setNoRm(String norawat, String nosep, String nokartu, String norm, String namapasien, String alamat, String kodedpjp, String namadpjp) {
    ...
    public void isCek(){
        if (akses.getbpjs_sep() == true || akses.getberi_obat() == true || akses.getkode().equals("Admin Utama")) {
            btnDokterDPJP.setEnabled(true);
            BtnSimpan.setEnabled(true);
            BtnHapus.setEnabled(true);
            BtnEdit.setEnabled(true);
        } else {
            btnDokterDPJP.setEnabled(false);
    ...
    public void bodyWithDeleteRequest() throws Exception {
        ...
        try {
            ...
            requestJson = "{"
                    ...
                    + "\"t_prb\":{"
                    + "\"noSrb\":\"" + tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 7).toString() + "\","
                    + "\"noSep\":\"" + tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 6).toString() + "\","
                    + "\"user\": \"" + tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 9).toString() + "\""
                    + "}"
                    + "}"
                    + "}";
            ...
            if(nameNode.path("code").asText().equals("200")){
                Sequel.menghapus("bridging_srb_bpjs", "no_sep", "no_srb",
                        tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 6).toString(),
                        tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 7).toString());
                Sequel.menghapus("bridging_srb_bpjs_obat", "no_sep", "no_srb",
                        tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 6).toString(),
                        tbProgramPRB.getValueAt(tbProgramPRB.getSelectedRow(), 7).toString());
                tampil();
            }
