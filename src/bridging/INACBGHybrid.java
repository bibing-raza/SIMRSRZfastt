...
public class INACBGHybrid extends javax.swing.JDialog {
                ...
                engine.getLoadWorker().stateProperty().addListener(new ChangeListener<State>() {
                    ...
                    public void changed(ObservableValue ov, State oldState, State newState) {
                        if (newState == State.SUCCEEDED) {
                            try {
                                if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTWEBAPPS()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/","").contains("inacbg/pages")){
                                    setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                    Valid.panggilUrl(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTWEBAPPS()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/",""));
                                    engine.executeScript("history.back()");
                                    setCursor(Cursor.getDefaultCursor());
                                }else if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTWEBAPPS()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/","").contains("Keluar")){
                                    dispose();    
                                }else if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTWEBAPPS()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/","").contains("InputDiagnosa")){
                                    ...
                                    try {
                                        ...
                                        if(rs.next()){
                                            ...
                                            diagnosa.isCek();
                                            diagnosa.setNoRm(rs.getString("no_rawat"), rs.getDate("tgl_registrasi"), rs.getString("status_lanjut"));
                                ...
                                }else if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTWEBAPPS()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/","").contains("InputCorona")){
    ...
    */
    ...
    public void setJudul(String Judul){
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), Judul, javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12), new java.awt.Color(0,0,0))); // NOI18N
    }
}
