...
public final class BPJSCekDataIndukKecelakaan extends javax.swing.JDialog {
    ...
    public BPJSCekDataIndukKecelakaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No", "No. SEP", "Tgl. Kejadian", "PPK Pelayanan", "Kode Prop", "Kode Kab",
            "Kode Kec", "Keterangan Kejadian", "No. SEP Suplesi"
        };
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cek Data Induk Kecelakaan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
                ...
                if(response.isArray()){
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            ...
                            list.path("tglKejadian").asText(),
                            list.path("ppkPelSEP").asText(),
                            list.path("kdProp").asText(),
                            list.path("kdKab").asText(),
                            list.path("kdKec").asText(),
                            list.path("ketKejadian").asText(),
                            list.path("noSEPSuplesi").asText()
                        });
                        i++;
                    }
                }
