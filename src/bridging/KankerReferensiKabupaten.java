 ...
 * @author dosen
 */
public final class KankerReferensiKabupaten extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public KankerReferensiKabupaten(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Referensi Sumber Kabupaten ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TKode.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TKode.setName("TKode"); // NOI18N
        TKode.setPreferredSize(new java.awt.Dimension(50, 23));
        panelGlass6.add(TKode);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KankerReferensiKabupaten dialog = new KankerReferensiKabupaten(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        try {
            if (api.MintaToken().equals("")) {
                ...
                url = koneksiDB.URLAPIKANKER() + "/kab_kota/all";
                ...
                response = root.path("data").path("kab_kota");                

                if (status.equals("true")) {
                    Valid.tabelKosong(tabMode);
                    if (response.isArray()) {
                        for (JsonNode list : response) {
                            if (list.path("propinsi_kode").asText().toLowerCase().contains(TKode.getText().toLowerCase()) && 
                                    (list.path("link_pusdatin").asText().toLowerCase().contains(TCari.getText().toLowerCase()) || list.path("kab_kota").asText().toLowerCase().contains(TCari.getText().toLowerCase()))) {
                                tabMode.addRow(new Object[]{
                                    list.path("link_pusdatin").asText(), list.path("kab_kota").asText()
                                });
                            }
                        }
                    }
