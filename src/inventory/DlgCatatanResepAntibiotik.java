 ...
 * @author perpustakaan
 */
public class DlgCatatanResepAntibiotik extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgCatatanResepAntibiotik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModeResepObat = new DefaultTableModel(null, new Object[]{
            ...
            "Jns. Resep", "Ini Resep", "Keterangan"
        }) {
            @Override
        ...
        tabModeResep2 = new DefaultTableModel(null, new Object[]{
            ...
            "Jns. Resep", "ini_resep", "Keterangan"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{
            ...
            "Tgl. Eksekusi", "Status Data", "noId", "Nama Obat", "Keterangan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-11-2025" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-11-2025" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Pemberian / Catatan Resep Antibiotik Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        DTPCariA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-11-2025" }));
        ...
        DTPCariB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-11-2025" }));
        ...
        TResepObat.setBounds(81, 9, 370, 24);
        ...
        jLabel64.setBounds(5, 10, 100, 23);
        ...
        TCariObat.setBounds(110, 10, 180, 23);
        ...
        BtnCari1.setBounds(295, 10, 70, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().equals("")) {
        ...
        } else if (Tket.getText().equals("") || Tket.getText().length() < 5) {
            Valid.textKosong(Tket, "Keterangan");
            Tket.requestFocus();
            ...
            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                ...
                try {
                    Sequel.menyimpan("catatan_resep_antibiotik", "?,?,?,?,?,?,?,?", "Data", 8, new String[]{
                        noIdObat.getText(), TNoRw.getText(), Sequel.cariIsi("SELECT date(NOW())"), Sequel.cariIsi("SELECT TIME(NOW())"),
                        TResepObat.getText(), "BELUM", akses.getkode(), Tket.getText()
                    });
                ...
                if (Sequel.cariInteger("select count(-1) from kamar_inap where no_rawat='" + TNoRw.getText() + "' and stts_pulang not in ('-','Pindah Kamar')") > 0) {
                    ...
                    Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(noId,6),signed)),0) from catatan_resep_ranap_antibiotik where "
                            ...
                            Sequel.cariIsi("select year(now())"), 6, noIdObat);
                    try {
                        Sequel.menyimpan("catatan_resep_ranap_antibiotik", "?,?,?,?,?,?,?,?,?,?", "Data", 10, new String[]{
                            noIdObat.getText(), TNoRw.getText(), Sequel.cariIsi("SELECT date(NOW())"), Sequel.cariIsi("SELECT TIME(NOW())"),
            ...
            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                if (tbResepObat.getSelectedRow() > -1) {
                    if (tbResepObat.getValueAt(tbResepObat.getSelectedRow(), 5).toString().equals("SUDAH")
                        ...
                        Sequel.mengedit("catatan_resep_antibiotik", "noId='" + TIdObat.getText() + "'",
                ...
                if (tbResepObat.getSelectedRow() > -1) {
                    if (tbResepObat.getValueAt(tbResepObat.getSelectedRow(), 5).toString().equals("SUDAH")
                        ...
                        Sequel.mengedit("catatan_resep_ranap_antibiotik", "noId='" + TIdObat.getText() + "'",
                                "no_rawat='" + TNoRw.getText() + "',tgl_perawatan='" + Sequel.cariIsi("SELECT date(NOW())") + "',"
                                + "jam_perawatan='" + Sequel.cariIsi("SELECT TIME(NOW())") + "',nama_obat = '" + TResepObat.getText() + "',"
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tbResepObat.getRowCount() == 0) {
            ...
            if (x == 0) {
                ...
                if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                    if (Sequel.cariInteger("SELECT COUNT(-1) FROM catatan_resep_antibiotik WHERE no_rawat ='" + TNoRw.getText() + "' AND noId IN (" + resepDipilih + ")") == 0) {
                    ...
                    if (Sequel.cariInteger("SELECT COUNT(-1) FROM catatan_resep_ranap_antibiotik WHERE no_rawat ='" + TNoRw.getText() + "' AND noId IN (" + resepDipilih + ")") == 0) {
    ...
    private void BtnCopyResepTerakhirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResepTerakhirActionPerformed
        ...
        if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
            ...
            if (cekResep == 0) {
                ...
                tglResep = Sequel.cariIsi("SELECT cr.tgl_perawatan FROM catatan_resep_antibiotik cr INNER JOIN reg_periksa rp ON rp.no_rawat=cr.no_rawat "
                        + "WHERE rp.kd_poli='" + kodepoli + "' and rp.no_rkm_medis='" + TNoRM.getText() + "' "
    ...
    private void BtnSetujuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSetujuActionPerformed
        if (tbResepObat.getRowCount() == 0) {
            ...
            if (Sequel.cariInteger("select count(-1) from catatan_resep_ranap_antibiotik where noId in (" + resepDipilih + ") and (status='SUDAH' or status='DILUAR')") > 0) {
                ...
                for (i = 0; i < tbResepObat.getRowCount(); i++) {
                    Sequel.mengedit("catatan_resep_ranap_antibiotik", "noId='" + tbResepObat.getValueAt(i, 7).toString() + "'",
                        ...
                        if (tbItemResep1.getValueAt(i, 0).toString().equals("true")) {
                            if (chkRanap.isSelected() == true) {
                                ...
                                Sequel.menyimpan("catatan_resep_ranap_antibiotik", "'" + noIdObatCopy.getText() + "','" + TNoRw.getText() + "', "
                                        ...
                                        + "'" + tbItemResep1.getValueAt(i, 10).toString() + "'", "Copy Resep Antibiotik Sebelumnya");
            ...
            if (TNoRw.getText().trim().equals("")) {
                ...
                try {
                    for (i = 0; i < tbResepObat.getRowCount(); i++) {
                        if (tbResepObat.getValueAt(i, 0).toString().equals("true")) {
                            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                                Sequel.mengedit("catatan_resep_antibiotik", "noId='" + tbResepObat.getValueAt(i, 7).toString() + "'", "kd_dokter='" + kddokter.getText() + "'");
                            } else if (status.equals("ranap") || status.equals("vk bersalin")) {
                                Sequel.mengedit("catatan_resep_ranap_antibiotik", "noId='" + tbResepObat.getValueAt(i, 7).toString() + "'", "kd_dokter='" + kddokter.getText() + "'");
                            }
                        }
                    }
                    tampilResepObat();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCatatanResepAntibiotik dialog = new DlgCatatanResepAntibiotik(new javax.swing.JFrame(), true);
        ...
        try {
            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                ps1 = koneksi.prepareStatement("select c.no_rawat, c.tgl_perawatan, c.jam_perawatan, c.nama_obat, "
                        + "c.status, d.nm_dokter, c.noID, c.kd_dokter, '-' jenis_resep, '-' resep_untuk, c.keterangan from catatan_resep_antibiotik c "
                ...
                ps1 = koneksi.prepareStatement("select c.no_rawat, c.tgl_perawatan, c.jam_perawatan, c.nama_obat, "
                        + "c.status, d.nm_dokter, c.noID, c.kd_dokter, c.jenis_resep, c.resep_untuk, c.keterangan from catatan_resep_ranap_antibiotik c "
                        + "inner join reg_periksa r on r.no_rawat = c.no_rawat "
                        + "inner join dokter d on d.kd_dokter = c.kd_dokter where "
    ...
    private void tampilItemResepRanap(String tglresep, String norw) {
        ...
        try {
            psR2 = koneksi.prepareStatement("select c.no_rawat, c.tgl_perawatan, c.jam_perawatan, c.nama_obat, c.status, "
                    + "d.nm_dokter, c.noID, c.jenis_resep, c.resep_untuk, c.keterangan FROM catatan_resep_ranap_antibiotik c "
                    + "INNER JOIN reg_periksa r ON r.no_rawat = c.no_rawat "
                    + "INNER JOIN dokter d ON d.kd_dokter = c.kd_dokter	WHERE "
    ...
    private void tampilItemResepRalan(String tglresep, String norm, String kdpoli) {
        ...
        try {
            psR2 = koneksi.prepareStatement("select c.no_rawat, c.tgl_perawatan, c.jam_perawatan, c.nama_obat, c.status, d.nm_dokter, "
                    + "c.noID, '-' jenis_resep, '-' resep_untuk, c.keterangan from catatan_resep_antibiotik c "
                ...
                for (i = 0; i < tbItemResep.getRowCount(); i++) {
                    if (tbItemResep.getValueAt(i, 0).toString().equals("true")) {
                        ...
                        Sequel.menyimpan("catatan_resep_antibiotik", "'" + noIdObat.getText() + "','" + TNoRw.getText() + "', "
                                ...
                                + "'" + tbItemResep.getValueAt(i, 10).toString() + "'", "Copy Resep Antibiotik Sebelumnya");
                    }
                }
        ...
        try {
            for (i = 0; i < tbResepObat.getRowCount(); i++) {
                if (tbResepObat.getValueAt(i, 0).toString().equals("true") && tbResepObat.getValueAt(i, 5).toString().equals("BELUM")) {
                    Sequel.menyimpanPesanGagalnyaDiTerminal("catatan_resep_antibiotik_histori", "?,?,?,?,?,?,?,?,?,?,?", "Data", 11, new String[]{
                        ...
                        tbResepObat.getValueAt(i, 11).toString(),
                        riwayatData,
                        user,
    ...
    private void simpanHistoriResepRanap() {
        ...
        try {
            for (i = 0; i < tbResepObat.getRowCount(); i++) {
                if (tbResepObat.getValueAt(i, 0).toString().equals("true") && tbResepObat.getValueAt(i, 5).toString().equals("BELUM")) {
                    Sequel.menyimpanPesanGagalnyaDiTerminal("catatan_resep_ranap_antibiotik_histori", "?,?,?,?,?,?,?,?,?,?,?,?", "Data", 12, new String[]{
                        tbResepObat.getValueAt(i, 7).toString(),
                        tbResepObat.getValueAt(i, 1).toString(),
                        tbResepObat.getValueAt(i, 2).toString(),
                        tbResepObat.getValueAt(i, 3).toString(),
        ...
        try {
            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                psrestor = koneksi.prepareStatement("SELECT IF(pg.nama = '-', 'Admin Utama', pg.nama ) pelaku, a.no_rawat, p.no_rkm_medis, p.nm_pasien, "
                        + "a.tgl_perawatan, a.jam_perawatan, a.waktu_eksekusi, upper(concat( 'DI', a.status_data )) sttsdata, a.noId, a.nama_obat, a.keterangan "
    ...
    private void kembalikanData() {
        try {
            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                ps3 = koneksi.prepareStatement("select * from catatan_resep_antibiotik_histori where "
                        + "no_rawat='" + tbRiwayat.getValueAt(tbRiwayat.getSelectedRow(), 1).toString() + "'");
            } else if (status.equals("ranap") || status.equals("vk bersalin")) {
                ps3 = koneksi.prepareStatement("select * from catatan_resep_ranap_antibiotik_histori where "
                        + "no_rawat='" + tbRiwayat.getValueAt(tbRiwayat.getSelectedRow(), 1).toString() + "'");
            }
            try {
                    ...
                    if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                        try {
                            Sequel.menyimpanIgnore("catatan_resep_antibiotik",
                                    ...
                                    + "'" + rs3.getString("keterangan") + "'", "Catatan Resep Antibiotik Rawat Jalan");
                        } catch (Exception e) {
                        ...
                        try {
                            Sequel.menyimpanIgnore("catatan_resep_ranap_antibiotik",
                                    ...
                                    + "'" + rs3.getString("keterangan") + "'", "Catatan Resep Rawat Inap");
                        } catch (Exception e) {
                            System.out.println("Simpan : " + e);
                        }
                    }
    ...
    private void tampilItemResepRiwayat(String tglresep, String norawat, String kddokter) {
        ...
        try {
            if (chkRanap.isSelected() == true) {
                psR22 = koneksi.prepareStatement("select *, date_format(tgl_perawatan,'%d-%m-%Y') tgl from catatan_resep_ranap_antibiotik where "
