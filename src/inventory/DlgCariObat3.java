                ...
                for(i=0;i<jml;i++){   
                    ...
                    if(retur>0){
                        ...
                        try {
                            ...
                            if(rsretur.next()){
                                Trackobat.catatRiwayat2(tbObat.getValueAt(i,1).toString(),0,rsretur.getDouble("jml"),"Retur Pasien",akses.getkode(),bangsal,"Hapus");
                        ...
                        try {
                            ...
                            Trackobat.catatRiwayat2(tbObat.getValueAt(i,1).toString(),retur,0,"Retur Pasien",akses.getkode(),bangsal,"Simpan");
                    ...
                    try {
                        if(pagi>0){
                            ...
                            psobatsimpan.setString(13,"Belum");
                            psobatsimpan.setString(14,"-");
        ...
        if(TNoRw.getText().equals("")){
            ...
            try {
                ...
                while(rspasien.next()){
                    ...
                    Valid.MyReport("rptObatPasien.jasper","report","::[ Obat Keluar Masuk ]::",
