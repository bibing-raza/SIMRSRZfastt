...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            Trackobat.catatRiwayat2(rs2.getString("kode_brng"), 0, rs2.getDouble("jml_retur"), "Retur Jual", akses.getkode(), rs.getString("kd_bangsal"), "Hapus");
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select distinct returjual.no_retur_jual,returjual.tgl_retur, "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement("select detreturjual.nota_jual,detreturjual.kode_brng,databarang.nama_brng, "
                            ...
                            + "detreturjual.subtotal from detreturjual "
                            ...
                            + "INNER JOIN returjual on returjual.no_retur_jual = detreturjual.no_retur_jual and returjual.tgl_retur = detreturjual.tgl_retur "
                            + "INNER JOIN petugas on returjual.nip = petugas.nip "
                            + "INNER JOIN pasien on returjual.no_rkm_medis = pasien.no_rkm_medis "
                            + "INNER JOIN bangsal on returjual.kd_bangsal = bangsal.kd_bangsal where"
                            ...
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and pasien.no_rkm_medis like '%" + TCari.getText() + "%' or "
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and pasien.nm_pasien like '%" + TCari.getText() + "%' or "
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and bangsal.nm_bangsal like '%" + TCari.getText() + "%' or "
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and petugas.nip like '%" + TCari.getText() + "%' or "
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and petugas.nama like '%" + TCari.getText() + "%' or "
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and databarang.kode_brng like '%" + TCari.getText() + "%' or "
                            + " detreturjual.no_retur_jual='" + rs.getString(1) + "' and detreturjual.tgl_retur='" + rs.getString(2) + "' " + sat + bar + nonot + " and databarang.nama_brng like '%" + TCari.getText() + "%' or "
