...
public final class DlgGantiAturanPakai extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel3.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 5, 8));
        ...
        if (norawat.getText().equals("")) {
            ...
            if (transaksi.equals("transaksi_rs")) {
                ...
                if (Sequel.cariInteger("select count(-1) from aturan_pakai_jual_bebas where no_nota='" + norawat.getText() + "' and "
                    ...
                    Sequel.mengedit("aturan_pakai_jual_bebas", "no_nota='" + norawat.getText() + "' and "
                            + "tgl_perawatan='" + tglresep.getText() + "' and kode_brng='" + kdobat.getText() + "'",
                            "tgl_perawatan='" + tglresep.getText() + "', jam='" + jamresep.getText() + "', no_nota='" + norawat.getText() + "', "
                            + "kode_brng='" + kdobat.getText() + "', aturan1='" + cmbaturan1.getSelectedItem().toString() + "', "
                            + "aturan2='" + cmbaturan2.getSelectedItem().toString() + "', aturan3='" + cmbaturan3.getSelectedItem().toString() + "', "
                            + "waktu1='" + cmbwaktu1.getSelectedItem().toString() + "', waktu2='" + cmbwaktu2.getSelectedItem().toString() + "', "
                            + "keterangan='" + cmbket.getSelectedItem().toString() + "'");
                } else {
                    Sequel.menyimpan("aturan_pakai_jual_bebas", "'" + tglresep.getText() + "','" + jamresep.getText() + "',"
