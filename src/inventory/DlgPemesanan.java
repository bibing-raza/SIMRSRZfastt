...
public class DlgPemesanan extends javax.swing.JDialog {
    ...
    public DlgPemesanan(java.awt.Frame parent, boolean modal) {
        ...
        NoFaktur.setDocument(new batasInput((byte) 30).getKata(NoFaktur));
    ...
    private void initComponents() {
        ...
        ppBersihkan.setPreferredSize(new java.awt.Dimension(140, 25));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Transaksi Pemesanan Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        chkFree.setBounds(780, 10, 74, 16);
        ...
        if (NoFaktur.getText().trim().equals("")) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                            ...
                            try {
                                if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                                    if (Sequel.menyimpantf2("detailpesan", "?,?,?,?,?,?,?,?,?,?,?", "Transaksi Pemesanan", 11, new String[]{
                                        ...
                                        Trackobat.catatRiwayat2(tbDokter.getValueAt(i, 2).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), 0, "Pemesanan", akses.getkode(), kdgudang.getText(), "Simpan");
                                        Sequel.menyimpan("gudangbarang", "'" + tbDokter.getValueAt(i, 2).toString() + "','" + kdgudang.getText() + "','" + tbDokter.getValueAt(i, 12).toString() + "'",
                                                "stok=stok+'" + tbDokter.getValueAt(i, 0).toString() + "'", "kode_brng='" + tbDokter.getValueAt(i, 2).toString() + "' and kd_bangsal='" + kdgudang.getText() + "'");
                                    }
                                }
                            } catch (Exception e) {
                    ...
                    System.out.println("Notifikasi : " + e);
                    JOptionPane.showMessageDialog(null, "Maaf, gagal menyimpan data. Hubungi Admin");
                }
