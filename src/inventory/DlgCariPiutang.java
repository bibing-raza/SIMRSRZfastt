...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptPiutang.jasper","report","::[ Transaksi Piutang Barang ]::",
     ...
     try {
         ...
         while(rscaripiutang.next()){
             ...
             while(rsdetailpiutang.next()){
                 Trackobat.catatRiwayat2(rsdetailpiutang.getString("kode_brng"),rsdetailpiutang.getDouble("jumlah"),0,"Piutang",akses.getkode(),rscaripiutang.getString("kd_bangsal"),"Hapus");
