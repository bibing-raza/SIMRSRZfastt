...
public class DlgReturBeli extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgReturBeli")) {
                    if (form.barang.getTable().getSelectedRow() != -1) {
                        ...
                        satuanretur.setText(form.barang.getTable().getValueAt(form.barang.getTable().getSelectedRow(), 3).toString());
                        Sequel.cariIsi("select jumlah from detailpesan where no_faktur = '"+ NoFaktur.getText() +"' and kode_brng = '"+ Kdbar.getText() +"'", jmlPesan);
                    }
                    Kdbar.requestFocus();
                }
            }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Transaksi Retur Obat, Alkes & BHP Medis Ke Suplier ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        Hargaretur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnBrg.setBounds(560, 10, 28, 23);

        BtnKnv.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnKnv.setBounds(570, 40, 28, 23);

        satuanretur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        satuanretur.setBounds(510, 40, 65, 23);

        Jmlretur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Jmlretur.setBounds(450, 40, 53, 23);
        ...
        NoBatch.setBounds(290, 40, 100, 23);
        ...
        label22.setBounds(220, 40, 63, 23);

        jmlPesan.setEditable(false);
        jmlPesan.setForeground(new java.awt.Color(0, 0, 0));
        jmlPesan.setName("jmlPesan"); // NOI18N
        jmlPesan.setPreferredSize(new java.awt.Dimension(80, 23));
        panelisi4.add(jmlPesan);
        jmlPesan.setBounds(170, 40, 50, 23);
        ...
        NoRetur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglRetur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnSpl.setForeground(new java.awt.Color(0, 0, 0));
...
*/
                        ...
                        try {
                            ...
                            while (rs.next()) {
                                if (Sequel.menyimpantf("detreturbeli", "'" + NoRetur.getText() + "','" + rs.getString(1) + "','" + rs.getString(2) + "','" + rs.getString(3)
                                    ...
                                    Trackobat.catatRiwayat2(rs.getString(2), 0, rs.getDouble(10), "Retur Beli", akses.getkode(), kdgudang.getText(), "Simpan");
    ...
    private void NoFakturKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoFakturKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                psFaktur = koneksi.prepareStatement("select p.kode_suplier,s.nama_suplier,p.kd_bangsal,b.nm_bangsal "
                        + "from pemesanan p inner join datasuplier s on s.kode_suplier = p.kode_suplier inner join bangsal b on b.kd_bangsal = p.kd_bangsal "
                        + "where p.no_faktur = '"+ NoFaktur.getText() +"'");
                rsFaktur = psFaktur.executeQuery();
                while (rsFaktur.next()){
                    kdsup.setText(rsFaktur.getString("kode_suplier"));
                    nmsup.setText(rsFaktur.getString("nama_suplier"));
                    kdgudang.setText(rsFaktur.getString("kd_bangsal"));
                    nmgudang.setText(rsFaktur.getString("nm_bangsal"));
                }
...
private void BtnBrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBrgActionPerformed
    ...
    form.barang.isCek();
    form.barang.tampil5(NoFaktur.getText());
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    private widget.TextBox jmlPesan;
