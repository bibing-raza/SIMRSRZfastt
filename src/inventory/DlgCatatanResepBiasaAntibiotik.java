...
public class DlgCatatanResepBiasaAntibiotik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnHapusResepAnti = new javax.swing.JMenuItem();
        ...
        MnHapusResepAnti.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHapusResepAnti.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/delete-16x16.png"))); // NOI18N
        MnHapusResepAnti.setText("Hapus Resep Pengecualian");
        MnHapusResepAnti.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnHapusResepAnti.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnHapusResepAnti.setIconTextGap(5);
        MnHapusResepAnti.setName("MnHapusResepAnti"); // NOI18N
        MnHapusResepAnti.setPreferredSize(new java.awt.Dimension(185, 26));
        MnHapusResepAnti.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHapusResepAntiActionPerformed(evt);
            }
        });
        jPopupMenu1Anti.add(MnHapusResepAnti);
            ...
            if (status.equals("IGD (Ralan)") || status.equals("IGD (Ranap)") || status.equals("ralan")) {
                ...
                if (Sequel.cariInteger("select count(-1) from kamar_inap where no_rawat='" + TNoRw.getText() + "' and stts_pulang not in ('-','Pindah Kamar')") > 0) {
                    ...
                    if (Sequel.menyimpantf("catatan_resep_ranap", "?,?,?,?,?,?,?,?,?", "Data", 9, new String[]{
                        ...
                        Sequel.cariIsi("SELECT TIME(NOW())"), TResepObat.getText(), "BELUM", akses.getkode(), jenisResep, cmbIniResep.getSelectedItem().toString()
                    }) == true) {
    ...
    private void BtnCopyResepTerakhir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResepTerakhir1ActionPerformed
        ...
        if (statusAnti.equals("IGD (Ralan)") || statusAnti.equals("IGD (Ranap)") || statusAnti.equals("ralan")) {
            ...
            if (cekResep == 0) {
                ...
                tglResepAnti = Sequel.cariIsi("SELECT tgl_perawatan FROM catatan_resep_ranap_antibiotik where no_rawat='" + TNoRw.getText() + "' ORDER BY tgl_perawatan DESC LIMIT 1");
                ...
                if (x == 0) {
                    ...
                    for (i = 0; i < tbResepObat1.getRowCount(); i++) {
                        if (tbResepObat1.getValueAt(i, 0).toString().equals("true")
                            ...
                            simpanHistoriResepRalanAnti("dokter");
                        }
                    }
                ...
                if (x == 0) {
                    ...
                    for (i = 0; i < tbResepObat1.getRowCount(); i++) {
                        if (tbResepObat1.getValueAt(i, 0).toString().equals("true")
                            ...
                            simpanHistoriResepRanapAnti("dokter");
                        }
                    }
    ...
    private void MnHapusResepAntiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusResepAntiActionPerformed
        //cek conteng
        x = 0;
        for (i = 0; i < tbResepObat1.getRowCount(); i++) {
            if (tbResepObat1.getValueAt(i, 0).toString().equals("true")) {
        ...
        if (x == 0) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                ...
                if (statusAnti.equals("IGD (Ralan)") || statusAnti.equals("IGD (Ranap)") || statusAnti.equals("ralan")) {
                    for (i = 0; i < tbResepObat1.getRowCount(); i++) {
                        if (tbResepObat1.getValueAt(i, 0).toString().equals("true")) {
                            simpanHistoriResepRalanAnti("admin");
                        }
                    }
                    ...
                    for (i = 0; i < tbResepObat1.getRowCount(); i++) {
                        if (tbResepObat1.getValueAt(i, 0).toString().equals("true")) {
                            simpanHistoriResepRanapAnti("admin");
                        }
                    }
                }
    ...
    private javax.swing.JMenuItem MnHapusResepAnti;
    ...
    public void isCek() {
        ...
        MnHapusResepAnti.setEnabled(akses.getadmin());
    }
    ...
    private void tampilItemResepRalan(String tglresep, String norm, String kdpoli) {
        ...
        try {
            psR2 = koneksi.prepareStatement("select c.no_rawat, c.tgl_perawatan, c.jam_perawatan, c.nama_obat, c.status, d.nm_dokter, "
                    + "c.noID, '-' as jenis_resep, '-' as resep_untuk from catatan_resep c "
            ...
            try {
                ...
                while (rs1Anti.next()) {
                    tabModeResepObatAn.addRow(new Object[]{
                        false,
                        rs1Anti.getString("no_rawat"),
                        rs1Anti.getString("tgl_perawatan"),
                        rs1Anti.getString("jam_perawatan"),
                        rs1Anti.getString("nama_obat"),
                        rs1Anti.getString("status"),
                        rs1Anti.getString("nm_dokter"),
                        rs1Anti.getString("noID"),
                        rs1Anti.getString("kd_dokter"),
    ...
    private void simpanHistoriResepRanapAnti(String penghapus) {
        userAnti = "";        
        if (akses.getadmin() == true) {
            userAnti = "-";
        } else {
    ...
    private void simpanHistoriResepRalanAnti(String penghapus) {
        userAnti = "";        
        if (akses.getadmin() == true) {
            userAnti = "-";
        } else {
            ...
            try {
                ...
                while (rsR2Anti.next()) {
                    tabModeResep2An.addRow(new Object[]{
                        false,
                        rsR2Anti.getString("no_rawat"),
                        rsR2Anti.getString("tgl_perawatan"),
                        rsR2Anti.getString("jam_perawatan"),
                        rsR2Anti.getString("nama_obat"),
                        rsR2Anti.getString("status"),
                        rsR2Anti.getString("nm_dokter"),
                        rsR2Anti.getString("noID"),
