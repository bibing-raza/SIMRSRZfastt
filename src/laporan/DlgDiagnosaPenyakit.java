...
public class DlgDiagnosaPenyakit extends javax.swing.JDialog {
    private final DefaultTableModel TabModeDiagnosaPasien, tabModeDiagnosa, tabModeProsedur,
            TabModeTindakanPasien, tabModeDiagnosaSekunder, tabMode1, tabMode2, tabMode3, tabMode4;
    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private validasi Valid = new validasi();
    private DlgPasien pasien = new DlgPasien(null, false);
    private PreparedStatement pspenyakit, psdiagnosapasien, psprosedur, pstindakanpasien, psralan, ps2, ps3, ps4, ps5, ps6, psreg, pskamar, psanak,
    ...
    private ResultSet rs, rs1, rs2, rs3, rs4, rs5, rs6, rsPA, rspasien, rsdiagnosa, rstindakan, rsdokter, rsralan, rsrad, rshslRad, rsreg, rskamar, rscaripoli,
    ...
    private void initComponents() {
        ...
        MnContengSemua1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnContengSemua1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnContengSemua1.setText("Conteng Semua");
        MnContengSemua1.setName("MnContengSemua1"); // NOI18N
        MnContengSemua1.setPreferredSize(new java.awt.Dimension(155, 26));
        MnContengSemua1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnContengSemua1ActionPerformed(evt);
            }
        });
        jPopupMenu3.add(MnContengSemua1);

        MnHapusConteng1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnHapusConteng1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnHapusConteng1.setText("Hapus Conteng Semua");
        MnHapusConteng1.setName("MnHapusConteng1"); // NOI18N
        MnHapusConteng1.setPreferredSize(new java.awt.Dimension(155, 26));
        MnHapusConteng1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnHapusConteng1ActionPerformed(evt);
            }
        });
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-03-2026 13:47:53" }));
        ...
        panelGlass8.add(jLabel65);

        cmbPilihCetak1.setForeground(new java.awt.Color(0, 0, 0));
        cmbPilihCetak1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TTD Basah", "TTE (QR Code)" }));
        ...
        panelGlass9.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 8));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-03-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-03-2026" }));
        ...
        BtnCari.setPreferredSize(new java.awt.Dimension(130, 28));
        ...
        BtnResume.setPreferredSize(new java.awt.Dimension(200, 28));
        BtnResume.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResumeActionPerformed(evt);
            }
        });
        panelGlass9.add(BtnResume);
        ...
        tbProsedur.setComponentPopupMenu(jPopupMenu3);
        ...
        chkTglCppt.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 250)));
        chkTglCppt.setForeground(new java.awt.Color(0, 0, 0));
        chkTglCppt.setSelected(true);
        chkTglCppt.setText("Sesuai Tgl. Rawat Dipilih");
        chkTglCppt.setBorderPainted(true);
        chkTglCppt.setBorderPaintedFlat(true);
        chkTglCppt.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chkTglCppt.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        chkTglCppt.setName("chkTglCppt"); // NOI18N
        chkTglCppt.setOpaque(false);
        chkTglCppt.setPreferredSize(new java.awt.Dimension(155, 23));
        chkTglCppt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkTglCpptActionPerformed(evt);
            }
        });
        ...
        TabPreview.setBackground(new java.awt.Color(254, 255, 254));
        TabPreview.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        TabPreview.setName("TabPreview"); // NOI18N
        TabPreview.setPreferredSize(new java.awt.Dimension(0, 2000));
        TabPreview.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabPreviewMouseClicked(evt);
            }
        });

        Scroll15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        Scroll15.setName("Scroll15"); // NOI18N
        Scroll15.setOpaque(true);
        Scroll15.setPreferredSize(new java.awt.Dimension(452, 200));

        LoadHTML3.setBorder(null);
        LoadHTML3.setForeground(new java.awt.Color(0, 0, 0));
        LoadHTML3.setName("LoadHTML3"); // NOI18N
        Scroll15.setViewportView(LoadHTML3);

        TabPreview.addTab("Semua PPA", Scroll15);

        Scroll17.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        Scroll17.setName("Scroll17"); // NOI18N
        Scroll17.setOpaque(true);
        Scroll17.setPreferredSize(new java.awt.Dimension(452, 200));

        LoadHTML4.setBorder(null);
        LoadHTML4.setForeground(new java.awt.Color(0, 0, 0));
        LoadHTML4.setName("LoadHTML4"); // NOI18N
        Scroll17.setViewportView(LoadHTML4);

        TabPreview.addTab("PPA Dokter", Scroll17);

        Scroll18.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        Scroll18.setName("Scroll18"); // NOI18N
        Scroll18.setOpaque(true);
        Scroll18.setPreferredSize(new java.awt.Dimension(452, 200));

        LoadHTML5.setBorder(null);
        LoadHTML5.setForeground(new java.awt.Color(0, 0, 0));
        LoadHTML5.setName("LoadHTML5"); // NOI18N
        Scroll18.setViewportView(LoadHTML5);

        TabPreview.addTab("PPA Selain Dokter", Scroll18);

        internalFrame26.add(TabPreview, java.awt.BorderLayout.CENTER);

        TabData.addTab("Preview CPPT", internalFrame26);
        ...
        FormInput3.setPreferredSize(new java.awt.Dimension(570, 250));
        ...
        jLabel63.setText("Key Word :");
        jLabel63.setName("jLabel63"); // NOI18N
        jLabel63.setPreferredSize(new java.awt.Dimension(65, 23));
        panelGlass33.add(jLabel63);
        ...
        jLabel64.setText("Limit Data :");
        jLabel64.setName("jLabel64"); // NOI18N
        jLabel64.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass33.add(jLabel64);
        ...
        panelGlass35.add(FormInput3, java.awt.BorderLayout.EAST);
...
//            tampilprosedure();
    ...
    private void TabDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabDataMouseClicked
        ...
        } else if (TabData.getSelectedIndex() == 4) {
        ...
        } else if (TabData.getSelectedIndex() == 5) {
            TCari6.setText("");
    ...
    private void chkTglCpptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkTglCpptActionPerformed
        TabPreviewMouseClicked(null);
    ...
    private void MnContengSemua1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnContengSemua1ActionPerformed
        if (tbProsedur.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Belum ada kode ICD 9 yang dipilih...!!!");
        } else {
            for (i = 0; i < tbProsedur.getRowCount(); i++) {
                tbProsedur.setValueAt(Boolean.TRUE, i, 0);
            }
        }
    }//GEN-LAST:event_MnContengSemua1ActionPerformed

    private void MnHapusConteng1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusConteng1ActionPerformed
        if (tbProsedur.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Belum ada kode ICD 9 yang dipilih...!!!");
        } else {
            for (i = 0; i < tbProsedur.getRowCount(); i++) {
    ...
    public widget.CekBox chkTglCppt;
    ...
    public void setNoRm(String norwt, Date tgl, String status) {
        ...
        if (Status.getSelectedIndex() == 0) {
            ...
            cmbPilihCetak.setEnabled(false);
        } else {
            chkDiagnosa.setEnabled(false);
            BtnResume.setEnabled(true);
            cmbPilihCetak.setEnabled(true);
        }
...
//                        subttl = subttl + rsdetaillab.getDouble("total") + lab;
    ...
    private void cetakRingkasanRanap() {
        try {
            psLaprm = koneksi.prepareStatement("select r.*, p.no_rkm_medis, p.nm_pasien, date_format(p.tgl_lahir,'%d-%m-%Y') tgllahir, if(p.jk='L','Laki-laki','Perempuan') jenkel, "
                    + "date_format(rp.tgl_registrasi,'%d-%m-%Y') tgl_msk, pg.nama nmDpjp from ringkasan_pulang_ranap r "
                    + "inner join reg_periksa rp on rp.no_rawat = r.no_rawat inner join pasien p on p.no_rkm_medis = rp.no_rkm_medis "
                    + "inner join dpjp_ranap dr on dr.no_rawat=r.no_rawat inner join pegawai pg on pg.nik=dr.kd_dokter where r.no_rawat='" + TNoRw.getText() + "'");
            try {
                        ...
                        if (Sequel.cariInteger("select count(-1) from kamar_inap where no_rawat='" + TNoRw.getText() + "' and stts_pulang not in ('-','Pindah Kamar')") > 0) {
                            ...
                            isi = Sequel.cariIsi("select replace(kalimat_qrcode,kalimat_qrcode,"
                                    + "'" + Valid.kalimatQRcode(Sequel.cariIsi("select jenis_dokumen from kalimat_tte where kode='001'"),
                                            "Resume Medis/Ringkasan Pulang Pasien", rsLaprm.getString("nmDpjp"), tgl, jam) + "') from kalimat_tte where kode='001'");
    ...
    private void konfirmasiTerapiPreview(String norw, String tgl, String jam, String sift) {
        konfirmasi_terapi = "";
        try {
            ps5 = koneksi.prepareStatement("SELECT date_format(ck.tgl_lapor,'%d-%m-%Y') tgllapor, time_format(ck.jam_lapor,'%H:%i WITA') jamlapor, "
            ...
            try {
                ...
                while (rs5.next()) {
                    if (konfirmasi_terapi.equals("")) {
                        konfirmasi_terapi
                                = "KONFIRMASI TERAPI VIA TELP. :<br/>Tgl. Lapor : " + rs5.getString("tgllapor") + ", Jam : " + rs5.getString("jamlapor") + "<br/>"
                                + "Tgl. Verif : " + rs5.getString("tglverif") + ", Jam : " + rs5.getString("jamverif") + "<br/>"
                                + "Petugas,<br/><br/><br/><br/>(" + rs5.getString("ptgs") + ")<br/><br/>"
                                + "Dengan DPJP,<br/><br/><br/><br/>(" + rs5.getString("dpjp") + ")";
                    } else {
    ...
    private void tampilPreviewCpptDokter() {
        cekKonfirmasi = 0;
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            StringBuilder htmlContent = new StringBuilder();
    ...
    private void tampilPreviewCpptSelainDokter() {
        cekKonfirmasi = 0;
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            StringBuilder htmlContent = new StringBuilder();
    ...
    private void tampilPeriksaPA() {
        ...
        try {
            ...
            try {
                ps6.setString(1, "%" + TNoRM.getText() + "%");
                ps6.setString(2, "%" + TCari6.getText().trim() + "%");
                ps6.setString(3, "%" + TNoRM.getText() + "%");
                ps6.setString(4, "%" + TCari6.getText().trim() + "%");
                ps6.setString(5, "%" + TNoRM.getText() + "%");
                ps6.setString(6, "%" + TCari6.getText().trim() + "%");
                ps6.setString(7, "%" + TNoRM.getText() + "%");
                ps6.setString(8, "%" + TCari6.getText().trim() + "%");
                ps6.setString(9, "%" + TNoRM.getText() + "%");
                ps6.setString(10, "%" + TCari6.getText().trim() + "%");
                ps6.setString(11, "%" + TNoRM.getText() + "%");
                ps6.setString(12, "%" + TCari6.getText().trim() + "%");
                ps6.setString(13, "%" + TNoRM.getText() + "%");
                ps6.setString(14, "%" + TCari6.getText().trim() + "%");
                ps6.setString(15, "%" + TNoRM.getText() + "%");
                ps6.setString(16, "%" + TCari6.getText().trim() + "%");
                ps6.setString(17, "%" + TNoRM.getText() + "%");
                ps6.setString(18, "%" + TCari6.getText().trim() + "%");
                ...
                if (rsPA.next()) {
                    ...
                    while (rsPA.next()) {
                        ...
                        htmlContent.append(
                                ...
                                + "<td valign='top' colspan='7' align='left'>: " + rsPA.getString("lokasi_organ")
                        ...
                        htmlContent.append(
                                ...
                                + "<td valign='top' colspan='7' align='left'>: " + rsPA.getString("makroskopik")
                                        .replace("\r\n", "<br>").replace("\n", "<br>").replace("\t", "&nbsp;&nbsp;&nbsp;&nbsp;").replace("  ", "&nbsp;&nbsp;")
                                + " <i>" + rsPA.getString("italic_makroskopik") + "</i><br></td>"
                                + "</tr>");
                        
                        htmlContent.append(
                                "<tr class='isi'>"
                                + "<td valign='top' colspan='1' align='left'>Mikroskopik</td>"
                                + "<td valign='top' colspan='7' align='left'>: " + rsPA.getString("mikroskopik")
                                        .replace("\r\n", "<br>").replace("\n", "<br>").replace("\t", "&nbsp;&nbsp;&nbsp;&nbsp;").replace("  ", "&nbsp;&nbsp;")
                                + " <i>" + rsPA.getString("italic_mikroskopik") + "</i><br></td>"
                                + "</tr>");
                        
                        htmlContent.append(
                                "<tr class='isi'>"
                                + "<td valign='top' colspan='1' align='left'>Kesimpulan</td>"
                                + "<td valign='top' colspan='7' align='left'>: " + rsPA.getString("kesimpulan")
                                        .replace("\r\n", "<br>").replace("\n", "<br>").replace("\t", "&nbsp;&nbsp;&nbsp;&nbsp;").replace("  ", "&nbsp;&nbsp;")
                                + " <i>" + rsPA.getString("italic_kesimpulan") + "</i><br></td>"
                                + "</tr>");
                        
                        htmlContent.append(
                                "<tr class='isi'>"
                                + "<td valign='top' colspan='1' align='left'>Anjuran</td>"
                                + "<td valign='top' colspan='7' align='left'>: " + rsPA.getString("anjuran")
                                        .replace("\r\n", "<br>").replace("\n", "<br>").replace("\t", "&nbsp;&nbsp;&nbsp;&nbsp;").replace("  ", "&nbsp;&nbsp;")
                        ...
                        try {
                            ...
                            if (inet.isReachable(100)) {
                                if (rsPA.getString("kd_gambar").equals("")) {
                                    gambar = "http://192.168.0.230:7183/img-rme/gambar_tidak_ditemukan.jpg";
                                } else {
                                    gambar = "http://192.168.0.230:7183/rme/download.php?id=" + rsPA.getString("kd_gambar");
                                }
                            //ping gagal
                            } else {
