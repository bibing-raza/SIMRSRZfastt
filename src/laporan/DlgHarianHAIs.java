...
public class DlgHarianHAIs extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Harian HAIs Rumah Sakit ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            bw.write(LoadHTML.getText().replaceAll("<head>", "<head><link href=\"file2.css\" rel=\"stylesheet\" type=\"text/css\" />"
                    ...
                    + "<br>"
                    + "LAPORAN HARIAN DATA HAIs RUMAH SAKIT<br>"
    ...
    */
    ...
    private void prosesCari() {
        ...
        if (!cekDeku.getSelectedItem().toString().equals("SEMUA")) {
            lihat_deku = " dh.DEKU='" + cekDeku.getSelectedItem() + "' ";
        } else {
            lihat_deku = " dh.DEKU like '%%' ";
        }
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    + "dh.URINE, dh.ANTIBIOTIK, dh.IDO_ILO FROM data_hais dh "
                    + "INNER JOIN reg_periksa rp on rp.no_rawat=dh.no_rawat INNER JOIN pasien p on p.no_rkm_medis=rp.no_rkm_medis where "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and dh.no_rawat like ? or "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and rp.no_rkm_medis like ? or "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and dh.SPUTUM like ? or "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and dh.DARAH like ? or "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and dh.URINE like ? or "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and dh.ANTIBIOTIK like ? or "
                    + "dh.tanggal between ? and ? and " + lihat_deku + " and p.nm_pasien like ? order by dh.tanggal");
            try {
                i=1;
            ...
            System.out.println("laporan.DlgHarianHAIs.prosesCari() 5 : "+e);
        } 
        this.setCursor(Cursor.getDefaultCursor());
