                    ...
                    public void changed(ObservableValue ov, State oldState, State newState) {
                        if (newState == State.SUCCEEDED) {
                            try {
                                ...
                                if(engine.getLocation().replaceAll("http://"+host+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/","").contains("berkasrawat/pages")){
                                    setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                    Valid.panggilUrl(engine.getLocation().replaceAll("http://"+host+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/berkasrawat/pages/upload/","berkasrawat/").replaceAll("http://"+host+"/"+prop.getProperty("HYBRIDWEB")+"/berkasrawat/pages/upload/","berkasrawat/"));
