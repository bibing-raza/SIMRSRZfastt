...
public class DlgBulananHAIs extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Bulanan HAIs Rumah Sakit ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            bw.write(LoadHTML.getText().replaceAll("<head>", "<head><link href=\"file3.css\" rel=\"stylesheet\" type=\"text/css\" />"
                    ...
                    + "<br>"
                    + "LAPORAN BULANAN DATA HAIs RUMAH SAKIT<br>"
                ...
                while(rs.next()){
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+Sequel.cariIsi("select sum(IDO_ILO) from data_hais where tanggal=?",rs.getString("tanggal"))+"</td>"+
