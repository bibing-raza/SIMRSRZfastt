...
public class InformasiKamarInap extends javax.swing.JDialog {
    ...
    public InformasiKamarInap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Rawat","No.RM","Nama Pasien","Umur","Alamat Pasien","Jenis Bayar","Kamar","Tarif Kamar",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Informasi Kamar Inap Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        BtnAll.setPreferredSize(new java.awt.Dimension(115, 23));
        ...
        DTPCari3.setForeground(new java.awt.Color(0, 0, 0));
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-12-2017" }));
        ...
        tbKamIn.setForeground(new java.awt.Color(0, 0, 0));
    ...
    */
    ...
    public void tampil() {
        if(R1.isSelected()==true){
            ...
            kmr=" kamar_inap.tgl_keluar between '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+"' ";           
            if(!BangsalCari.getText().equals("")){
                kmr=" kamar_inap.tgl_keluar between '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari3.getSelectedItem()+"")+"' and bangsal.nm_bangsal='"+BangsalCari.getText()+"' ";
...
//                  cmbJam2.getSelectedItem()+":"+cmbMnt2.getSelectedItem()+":"+cmbDtk2.getSelectedItem()+"' and bangsal.nm_bangsal='"+BangsalCari.getText()+"' ";
        ...
        try{
            rs=koneksi.prepareStatement(
                   "select kamar_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, CONCAT(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur_thn,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab),"+
