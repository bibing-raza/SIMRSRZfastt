 ...
 * @author dosen
 */
public final class InformasiTarifStokDarah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InformasiTarifStokDarah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        String[] row = {"No. Kantong", "Komponen", "G.D", "Rhesus", "Tgl. Aftap", "Tgl. Kadaluarsa",
            "Asal Darah", "status", "Biaya (Rp.)"};
        ...
        tbDarah.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Informasi Tarif & Ketersediaan Stok Darah (UPD) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        Scroll.setViewportView(tbDarah);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InformasiTarifStokDarah dialog = new InformasiTarifStokDarah(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            pstampil = koneksi.prepareStatement("select us.no_kantong, uk.nama darah, us.golongan_darah, us.resus, date_format(us.tanggal_aftap,'%d-%m-%Y') tglaftap, "
