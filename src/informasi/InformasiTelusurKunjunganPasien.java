...
public final class InformasiTelusurKunjunganPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Telusur Kunjungan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        internalFrame1.setName("internalFrame1"); // NOI18N
        internalFrame1.setLayout(new java.awt.BorderLayout(1, 1));

        Scroll.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(241, 246, 236)), "Data Pasien", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        internalFrame2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "Data Kunjungan Pasien", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 0))); // NOI18N
        internalFrame2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        if(!TCari.getText().equals("")){
            ...
            try{     
                ps=koneksi.prepareStatement(
                        "SELECT p.no_rkm_medis, p.nm_pasien, p.no_ktp, p.umur, p.jk, p.tmp_lahir, p.tgl_lahir, p.nm_ibu, "
                        ...
                        + "WHERE concat(p.alamat,', ',kl.nm_kel,', ',kc.nm_kec,', ',kb.nm_kab) LIKE ? "
                        + "OR p.no_rkm_medis LIKE ? OR p.nm_pasien LIKE ? "
                        + "OR p.no_ktp LIKE ? OR p.tmp_lahir LIKE ? OR p.tgl_lahir LIKE ? ORDER BY p.no_rkm_medis DESC LIMIT 500");         
                try {
