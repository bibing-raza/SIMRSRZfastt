...
public class InformasiAnalisaKamin extends javax.swing.JDialog {
    ...
    public InformasiAnalisaKamin(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            ps4=koneksi.prepareStatement("select kd_kamar,trf_kamar from kamar where kamar.statusdata='1' and kd_bangsal=? and status='RUSAK'");
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penggunaan Kamar Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        kdbangsal.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmbangsal.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void prosesCari() {
       ...
       try{   
            ...
            while(rs.next()){               
               ...
               tabMode.addRow(new Object[]{"","Rusak : "+Sequel.cariInteger("select count(kd_bangsal) from kamar where kamar.statusdata='1' and kd_bangsal=? and status='RUSAK' ",rs.getString("kd_bangsal"))});
               
               ps4.setString(1,rs.getString("kd_bangsal"));
               rs3=ps4.executeQuery();
               while(rs3.next()){
                   tabMode.addRow(new Object[]{"",rs3.getString("kd_kamar")+" "+rs3.getString("kelas"),Valid.SetAngka(rs2.getDouble("trf_kamar"))});
               }
