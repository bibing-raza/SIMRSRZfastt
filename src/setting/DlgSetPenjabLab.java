...
public class DlgSetPenjabLab extends javax.swing.JDialog {
    ...
    public DlgSetPenjabLab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P.J.Laboratorium","P.J.Radiologi","P.J.Hemodialisa","P.J.Tranfusi Darah","Aktivasi Bridging LIS"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };

        tbSetPenunjang.setModel(tabMode);
        tbSetPenunjang.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbSetPenunjang.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 5; i++) {
            TableColumn column = tbSetPenunjang.getColumnModel().getColumn(i);
            if (i == 0) {
        ...
        tbSetPenunjang.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbSetPenunjang = new widget.Table();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Penanggung Jawab Unit Penunjang & Aktivasi Bridgingnya ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tbSetPenunjang.setAutoCreateRowSorter(true);
        tbSetPenunjang.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbSetPenunjang.setName("tbSetPenunjang"); // NOI18N
        tbSetPenunjang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbSetPenunjangMouseClicked(evt);
            }
        });
        tbSetPenunjang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbSetPenunjangKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbSetPenunjang);
        ...
        kddokter2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kddokter3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TDokter3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kddokter4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TDokter4.setForeground(new java.awt.Color(0, 0, 0));
        TDokter4.setName("TDokter4"); // NOI18N
        panelGlass7.add(TDokter4);
        TDokter4.setBounds(213, 102, 269, 23);

        BtnDokter4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel17.setText("Aktifkan Bridging LIS :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass7.add(jLabel17);
        jLabel17.setBounds(530, 12, 110, 23);

        cmbLIS.setForeground(new java.awt.Color(0, 0, 0));
        cmbLIS.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TIDAK", "YA" }));
        cmbLIS.setName("cmbLIS"); // NOI18N
        cmbLIS.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbLISKeyPressed(evt);
            }
        });
        panelGlass7.add(cmbLIS);
        cmbLIS.setBounds(645, 12, 70, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TDokter.getText().trim().equals("") || kddokter.getText().trim().equals("")) {
            ...
            if (cmbLIS.getSelectedItem().toString().equals("TIDAK")) {
                cekLIS = "0";
            } else {
                cekLIS = "1";
            }
            ...
            Sequel.menyimpan("set_pjlab", "?,?,?,?,?", "Penanggung Jawab", 5, new String[]{
                kddokter.getText(), kddokter2.getText(), kddokter3.getText(), kddokter4.getText(), cekLIS
            });
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
    ...
    private void tbSetPenunjangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSetPenunjangMouseClicked
        if(tabMode.getRowCount()!=0){
            try {
                getData();
...
}//GEN-LAST:event_tbSetPenunjangMouseClicked

    private void tbSetPenunjangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbSetPenunjangKeyPressed
        if(tabMode.getRowCount()!=0){
...
}//GEN-LAST:event_tbSetPenunjangKeyPressed
    ...
    private void cmbLISKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbLISKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbLISKeyPressed
    ...
    */
    ...
    private widget.ComboBox cmbLIS;
    ...
    private widget.Table tbSetPenunjang;
    // End of variables declaration//GEN-END:variables

    private void tampil() {
        Valid.tabelKosong(tabMode);
        try{
            ResultSet rs=koneksi.prepareStatement("select kd_dokterlab, kd_dokterrad, kd_dokterhemodialisa, kd_dokterutd, "
                    + "if(aktivasi_LIS='0','TIDAK','YA') lis from set_pjlab").executeQuery();
            while(rs.next()){
                tabMode.addRow(new Object[]{
                    Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",rs.getString("kd_dokterlab")),
                    Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",rs.getString("kd_dokterrad")),
                    Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",rs.getString("kd_dokterhemodialisa")),
                    Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",rs.getString("kd_dokterutd")),
                    rs.getString("lis")
                });
            }
    ...
    private void getData() {
        ...
        int row=tbSetPenunjang.getSelectedRow();
        if(row!= -1){
            ...
            cmbLIS.setSelectedItem(tbSetPenunjang.getValueAt(tbSetPenunjang.getSelectedRow(), 4).toString());
