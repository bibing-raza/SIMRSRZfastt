...
public class DlgSetRM extends javax.swing.JDialog {
    ...
    public DlgSetRM(java.awt.Frame parent, boolean modal) {
        ...
        tabMode6=new DefaultTableModel(null,new Object[]{"Batas Umur Maksimal", "Batas Umur Minimal"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };

        tbBatasUmur.setModel(tabMode6);
        tbBatasUmur.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbBatasUmur.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbBatasUmur.getColumnModel().getColumn(i);
            if (i == 0) {
        ...
        tbBatasUmur.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        PanjangAlamatDom.setDocument(new batasInput((byte)3).getOnlyAngka(PanjangAlamatDom));
        PanjangKelurahanDom.setDocument(new batasInput((byte)3).getOnlyAngka(PanjangKelurahanDom));
        PanjangKecamatanDom.setDocument(new batasInput((byte)3).getOnlyAngka(PanjangKecamatanDom));
        PanjangKabupatenDom.setDocument(new batasInput((byte)3).getOnlyAngka(PanjangKabupatenDom));
        
        UmurMax.setDocument(new batasInput((byte)3).getOnlyAngka(UmurMax));
        UmurMin.setDocument(new batasInput((byte)2).getOnlyAngka(UmurMin));
    ...
    private void initComponents() {
        ...
        YesNoAlamatDom = new widget.ComboBox();
        jLabel32 = new widget.Label();
        PanjangAlamatDom = new widget.TextBox();
        jLabel51 = new widget.Label();
        YesNoKelurahanDom = new widget.ComboBox();
        jLabel52 = new widget.Label();
        PanjangKelurahanDom = new widget.TextBox();
        jLabel53 = new widget.Label();
        YesNoKecamatanDom = new widget.ComboBox();
        jLabel54 = new widget.Label();
        PanjangKecamatanDom = new widget.TextBox();
        jLabel55 = new widget.Label();
        YesNoKabupatenDom = new widget.ComboBox();
        jLabel56 = new widget.Label();
        PanjangKabupatenDom = new widget.TextBox();
        ...
        UmurMax = new widget.TextBox();
        jLabel14 = new widget.Label();
        jLabel57 = new widget.Label();
        UmurMin = new widget.TextBox();
        ...
        PanjangKTP.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangTmpLahir.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangNamaIbu.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangAlamat.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangPekerjaan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangTelp.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangUmur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangNamaKeluarga.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangNoPeserta.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangKelurahan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangKecamatan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangKabupaten.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangPekerjaanPJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangAlamatPJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangKelurahanPJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangKecamatanPJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanjangKabupatenPJ.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel50.setText("Alamat Domisili :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(580, 130, 130, 23);
        ...
        YesNoAlamatDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                YesNoAlamatDomKeyPressed(evt);
            }
        });
        FormInput.add(YesNoAlamatDom);
        YesNoAlamatDom.setBounds(718, 130, 55, 23);

        jLabel32.setForeground(new java.awt.Color(0, 0, 0));
        jLabel32.setText("Min. Alamat Domisili :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(580, 160, 130, 23);

        PanjangAlamatDom.setForeground(new java.awt.Color(0, 0, 0));
        PanjangAlamatDom.setText("0");
        PanjangAlamatDom.setName("PanjangAlamatDom"); // NOI18N
        PanjangAlamatDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PanjangAlamatDomKeyPressed(evt);
            }
        });
        FormInput.add(PanjangAlamatDom);
        PanjangAlamatDom.setBounds(718, 160, 55, 23);

        jLabel51.setForeground(new java.awt.Color(0, 0, 0));
        jLabel51.setText("Kelurahan Domisili :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(580, 190, 130, 23);
        ...
        YesNoKelurahanDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                YesNoKelurahanDomKeyPressed(evt);
            }
        });
        FormInput.add(YesNoKelurahanDom);
        YesNoKelurahanDom.setBounds(718, 190, 55, 23);

        jLabel52.setForeground(new java.awt.Color(0, 0, 0));
        jLabel52.setText("Min. Kelurahan Domisili :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(580, 220, 130, 23);

        PanjangKelurahanDom.setForeground(new java.awt.Color(0, 0, 0));
        PanjangKelurahanDom.setText("0");
        PanjangKelurahanDom.setName("PanjangKelurahanDom"); // NOI18N
        PanjangKelurahanDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PanjangKelurahanDomKeyPressed(evt);
            }
        });
        FormInput.add(PanjangKelurahanDom);
        PanjangKelurahanDom.setBounds(718, 220, 55, 23);

        jLabel53.setForeground(new java.awt.Color(0, 0, 0));
        jLabel53.setText("Kecamatan Domisili :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(580, 250, 130, 23);
        ...
        YesNoKecamatanDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                YesNoKecamatanDomKeyPressed(evt);
            }
        });
        FormInput.add(YesNoKecamatanDom);
        YesNoKecamatanDom.setBounds(718, 250, 55, 23);

        jLabel54.setForeground(new java.awt.Color(0, 0, 0));
        jLabel54.setText("Min. Kecamatan Domisili :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(580, 280, 130, 23);

        PanjangKecamatanDom.setForeground(new java.awt.Color(0, 0, 0));
        PanjangKecamatanDom.setText("0");
        PanjangKecamatanDom.setName("PanjangKecamatanDom"); // NOI18N
        PanjangKecamatanDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PanjangKecamatanDomKeyPressed(evt);
            }
        });
        FormInput.add(PanjangKecamatanDom);
        PanjangKecamatanDom.setBounds(718, 280, 55, 23);

        jLabel55.setForeground(new java.awt.Color(0, 0, 0));
        jLabel55.setText("Kabupaten Domisili :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(780, 10, 135, 23);
        ...
        YesNoKabupatenDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                YesNoKabupatenDomKeyPressed(evt);
            }
        });
        FormInput.add(YesNoKabupatenDom);
        YesNoKabupatenDom.setBounds(920, 10, 55, 23);

        jLabel56.setForeground(new java.awt.Color(0, 0, 0));
        jLabel56.setText("Min. Kabupaten Domisili :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(780, 40, 135, 23);

        PanjangKabupatenDom.setForeground(new java.awt.Color(0, 0, 0));
        PanjangKabupatenDom.setText("0");
        PanjangKabupatenDom.setName("PanjangKabupatenDom"); // NOI18N
        PanjangKabupatenDom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PanjangKabupatenDomKeyPressed(evt);
            }
        });
        FormInput.add(PanjangKabupatenDom);
        PanjangKabupatenDom.setBounds(920, 40, 55, 23);
        ...
        tbBatasUmur.setAutoCreateRowSorter(true);
        tbBatasUmur.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbBatasUmur.setName("tbBatasUmur"); // NOI18N
        tbBatasUmur.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbBatasUmurMouseClicked(evt);
            }
        });
        tbBatasUmur.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbBatasUmurKeyPressed(evt);
            }
        });
        Scroll6.setViewportView(tbBatasUmur);
        ...
        jLabel13.setText("Umur Maksimal Registrasi : ");
        jLabel13.setName("jLabel13"); // NOI18N
        jLabel13.setPreferredSize(new java.awt.Dimension(160, 24));
        panelGlass11.add(jLabel13);

        UmurMax.setForeground(new java.awt.Color(0, 0, 0));
        UmurMax.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        UmurMax.setText("0");
        UmurMax.setName("UmurMax"); // NOI18N
        UmurMax.setPreferredSize(new java.awt.Dimension(60, 24));
        panelGlass11.add(UmurMax);

        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel14.setText("Thn / Bln / Hari");
        jLabel14.setName("jLabel14"); // NOI18N
        jLabel14.setPreferredSize(new java.awt.Dimension(80, 24));
        panelGlass11.add(jLabel14);

        jLabel57.setForeground(new java.awt.Color(0, 0, 0));
        jLabel57.setText("Umur Minimal Registrasi : ");
        jLabel57.setName("jLabel57"); // NOI18N
        jLabel57.setPreferredSize(new java.awt.Dimension(160, 24));
        panelGlass11.add(jLabel57);

        UmurMin.setForeground(new java.awt.Color(0, 0, 0));
        UmurMin.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        UmurMin.setText("0");
        UmurMin.setName("UmurMin"); // NOI18N
        UmurMin.setPreferredSize(new java.awt.Dimension(60, 24));
        panelGlass11.add(UmurMin);

        jLabel58.setForeground(new java.awt.Color(0, 0, 0));
        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("Thn / Bln / Hari");
        jLabel58.setName("jLabel58"); // NOI18N
        jLabel58.setPreferredSize(new java.awt.Dimension(80, 24));
        panelGlass11.add(jLabel58);

        internalFrame7.add(panelGlass11, java.awt.BorderLayout.PAGE_START);

        TabRawat.addTab("Pengaturan Batas Umur Pasien", internalFrame7);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            } else if (PanjangAlamatDom.getText().trim().equals("")) {
                Valid.textKosong(PanjangAlamatDom, "Panjang Alamat Domisili");
            } else if (PanjangKelurahanDom.getText().trim().equals("")) {
                Valid.textKosong(PanjangKelurahanDom, "Panjang Kelurahan Domisili");
            } else if (PanjangKecamatanDom.getText().trim().equals("")) {
                Valid.textKosong(PanjangKecamatanDom, "Panjang Kecamatan Domisili");
            } else if (PanjangKabupatenDom.getText().trim().equals("")) {
                Valid.textKosong(PanjangKabupatenDom, "Panjang Kabupaten Domisili");
            } else if (tabMode4.getRowCount() == 0) {
                if (Sequel.menyimpantf("set_kelengkapan_data_pasien", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Set Kelengkapan Data", 42, new String[]{
                    ...
                    YesNoKabupatenPJ.getSelectedItem().toString(), PanjangKabupatenPJ.getText(), YesNoAlamatDom.getSelectedItem().toString(), PanjangAlamatDom.getText(),
                    YesNoKelurahanDom.getSelectedItem().toString(), PanjangKelurahanDom.getText(), YesNoKecamatanDom.getSelectedItem().toString(), PanjangKecamatanDom.getText(),
                    YesNoKabupatenDom.getSelectedItem().toString(), PanjangKabupatenDom.getText()
                }) == true) {
                    tampilkelengkapan();
                    emptTeks2();
                }
            ...
            if (tabMode6.getRowCount() == 0) {
                Sequel.menyimpan("set_batas_umur",
                        "'" + UmurMax.getText() + "','"+UmurMin.getText()+"'", "Pengaturan Batas Umur Pasien"
                );
                tampilbatasumur();
            } else if (tabMode6.getRowCount() > 0) {
                JOptionPane.showMessageDialog(null, "Maaf, Hanya diijinkan satu pengaturan ...!!!!");
                UmurMax.requestFocus();
            }
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            Sequel.queryu("delete from set_batas_umur");
            tampilbatasumur();
        }        
...
private void normKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_normKeyPressed
    ...
    private void YesNoAlamatDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_YesNoAlamatDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_YesNoAlamatDomKeyPressed

    private void PanjangAlamatDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PanjangAlamatDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PanjangAlamatDomKeyPressed

    private void YesNoKelurahanDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_YesNoKelurahanDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_YesNoKelurahanDomKeyPressed

    private void PanjangKelurahanDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PanjangKelurahanDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PanjangKelurahanDomKeyPressed

    private void YesNoKecamatanDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_YesNoKecamatanDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_YesNoKecamatanDomKeyPressed

    private void PanjangKecamatanDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PanjangKecamatanDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PanjangKecamatanDomKeyPressed

    private void YesNoKabupatenDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_YesNoKabupatenDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_YesNoKabupatenDomKeyPressed

    private void PanjangKabupatenDomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PanjangKabupatenDomKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PanjangKabupatenDomKeyPressed

    private void tbBatasUmurMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbBatasUmurMouseClicked
        if(tabMode6.getRowCount()!=0){
            try {
                getDatabatasumur();
            } catch (java.lang.NullPointerException e) {
    ...
    }//GEN-LAST:event_tbBatasUmurMouseClicked

    private void tbBatasUmurKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbBatasUmurKeyPressed
        if(tabMode6.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getDatabatasumur();
    ...
    */
    ...
    private widget.Table tbBatasUmur;
    ...
    public void emptTeks2() {
        ...
        YesNoAlamatDom.setSelectedIndex(0);
        PanjangAlamatDom.setText("0");
        YesNoKelurahanDom.setSelectedIndex(0);
        PanjangKelurahanDom.setText("0");
        YesNoKecamatanDom.setSelectedIndex(0);
        PanjangKecamatanDom.setText("0");
        YesNoKabupatenDom.setSelectedIndex(0);
        PanjangKabupatenDom.setText("0");
        ...
        try{    
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode4.addRow(new Object[]{" Kelengkapan Data Alamat Domisili Pasien",rs.getString(35)});
                    tabMode4.addRow(new Object[]{" Minimal Panjang Alamat Domisili Pasien",rs.getString(36)});
                    tabMode4.addRow(new Object[]{" Kelengkapan Data Kelurahan Domisili Pasien",rs.getString(37)});
                    tabMode4.addRow(new Object[]{" Minimal Panjang Kelurahan Domisili Pasien",rs.getString(38)});
                    tabMode4.addRow(new Object[]{" Kelengkapan Data Kecamatan Domisili Pasien",rs.getString(39)});
                    tabMode4.addRow(new Object[]{" Minimal Panjang Kecamatan Domisili Pasien",rs.getString(40)});
                    tabMode4.addRow(new Object[]{" Kelengkapan Data Kabupaten Domisili Pasien",rs.getString(41)});
                    tabMode4.addRow(new Object[]{" Minimal Panjang Kabupaten Domisili Pasien",rs.getString(42)});
                }
            } catch (Exception e) {
    ...
    private void getDataKelengkapan() {
        ...
        if(row!= -1){
            ...
            YesNoAlamatDom.setSelectedItem(tbKelengkapan.getValueAt(34,1).toString());            
            PanjangAlamatDom.setText(tbKelengkapan.getValueAt(35,1).toString()); 
            YesNoKelurahanDom.setSelectedItem(tbKelengkapan.getValueAt(36,1).toString());            
            PanjangKelurahanDom.setText(tbKelengkapan.getValueAt(37,1).toString()); 
            YesNoKecamatanDom.setSelectedItem(tbKelengkapan.getValueAt(38,1).toString());            
            PanjangKecamatanDom.setText(tbKelengkapan.getValueAt(39,1).toString()); 
            YesNoKabupatenDom.setSelectedItem(tbKelengkapan.getValueAt(40,1).toString());            
            PanjangKabupatenDom.setText(tbKelengkapan.getValueAt(41,1).toString()); 
        }
    }
    ...
    private void tampilbatasumur() {
        Valid.tabelKosong(tabMode6);
        try {
            ps6 = koneksi.prepareStatement("select * from set_batas_umur ");
            try {
                rs = ps6.executeQuery();
                while (rs.next()) {
    ...
    private void getDatabatasumur() {
        int row=tbBatasUmur.getSelectedRow();
        if(row!= -1){
