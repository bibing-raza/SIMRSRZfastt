    ...
    */
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if ("[[N]PIC IGD".toLowerCase().contains(TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{false, "[N]PIC IGD", rs.getBoolean("pic_igd")});
                    }
    ...
    private void Simpan() {
        for (i = 0; i < tbUser.getRowCount(); i++) { 
            ...
            if("[N]PIC IGD".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","pic_igd='"+tbUser.getValueAt(i,2).toString()+"'");
            }
