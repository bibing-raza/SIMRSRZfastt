...
public class DlgSetNota extends javax.swing.JDialog {
    ...
    public DlgSetNota(java.awt.Frame parent, boolean modal) {
        ...
        lembarSEP.setDocument(new batasInput((byte) 2).getOnlyAngka(lembarSEP));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup Billing ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        NotaRalan.setForeground(new java.awt.Color(0, 0, 0));
        NotaRalan.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        cmbYesRalan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KwitansiRalan.setForeground(new java.awt.Color(0, 0, 0));
        KwitansiRalan.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        Nota1Ranap.setForeground(new java.awt.Color(0, 0, 0));
        Nota1Ranap.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        Nota2Ranap.setForeground(new java.awt.Color(0, 0, 0));
        Nota2Ranap.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        KwitansiRanap.setForeground(new java.awt.Color(0, 0, 0));
        KwitansiRanap.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        NotaApotek.setForeground(new java.awt.Color(0, 0, 0));
        NotaApotek.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        NotaLab.setForeground(new java.awt.Color(0, 0, 0));
        NotaLab.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        cmbYesRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesRincianRalan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesRincianRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesCentangDokterRalan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesCentangDokterRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesAdministrasiRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesRincianOperasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesPPNRalan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesPPNRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesTombolNotaRalan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesTombolNotaRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesTombolPenjualan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesTombolPenyerahanDarah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesCetakPenjualan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesTombolNotaPenjualan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbYesCentangObatRalan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel43.setText(" Lembar SEP BPJS : ");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(655, 12, 180, 23);

        lembarSEP.setForeground(new java.awt.Color(0, 0, 0));
        lembarSEP.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        lembarSEP.setHighlighter(null);
        lembarSEP.setName("lembarSEP"); // NOI18N
        lembarSEP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                lembarSEPKeyPressed(evt);
            }
        });
        FormInput.add(lembarSEP);
        lembarSEP.setBounds(835, 12, 50, 23);

        PanelInput.add(FormInput, java.awt.BorderLayout.CENTER);

        internalFrame2.add(PanelInput, java.awt.BorderLayout.PAGE_START);

        TabSetting.addTab("Nota, Kwitansi, SEP BPJS & Verifikasi Penjualan", internalFrame2);
        ...
        ChkInput2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaService.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BesarBiaya.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRanapDokter.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRanapParamedis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRalanDokter.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRalanParamedis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkKamar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRegistrasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkHarian.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkResepPulang.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRetur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ChkInput3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaService1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BesarBiaya1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkLaborat1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRadiologi1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkOperasi1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkObat1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRanapDokter1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRanapParamedis1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRalanDokter1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRalanParamedis1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkTambahan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkKamar1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRegistrasi1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkHarian1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkResepPulang1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkRetur1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkPotongan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        if (TabSetting.getSelectedIndex() == 0) {
            if (NotaRalan.getText().trim().equals("") || KwitansiRalan.getText().trim().equals("") || Nota1Ranap.getText().trim().equals("") || Nota2Ranap.getText().trim().equals("")
                ...
                if (Sequel.menyimpantf("set_nota", "'" + NotaRalan.getText() + "','" + KwitansiRalan.getText() + "','" + Nota1Ranap.getText() + "',"
                        ...
                        + "'" + cmbYesCentangObatRalan.getSelectedItem() + "','" + lembarSEP.getText() + "'", "Set Nota") == true) {
                    tampil();
                    emptTeks();
                }
            } else if (tabMode.getRowCount() > 0) {
                JOptionPane.showMessageDialog(null, "Maaf, Hanya diijinkan satu Set Nota, Kwitansi, Verifikasi Penjualan, SEP BPJS & Printer Gelang...!!!!");
...
private void NotaRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NotaRalanKeyPressed
        ...
        if (TabSetting.getSelectedIndex() == 0) {
            if (NotaRalan.getText().trim().equals("") || KwitansiRalan.getText().trim().equals("") || Nota1Ranap.getText().trim().equals("") || Nota2Ranap.getText().trim().equals("")
                ...
                if (Sequel.menyimpantf("set_nota", "'" + NotaRalan.getText() + "','" + KwitansiRalan.getText() + "','" + Nota1Ranap.getText() + "',"
                        ...
                        + "'" + cmbYesTombolNotaRalan.getSelectedItem() + "','" + cmbYesTombolNotaRanap.getSelectedItem() + "','" + cmbYesTombolPenjualan.getSelectedItem() + "',"
                        + "'" + cmbYesTombolPenyerahanDarah.getSelectedItem() + "','" + cmbYesCetakPenjualan.getSelectedItem() + "','" + cmbYesTombolNotaPenjualan.getSelectedItem() + "',"
                        + "'" + cmbYesCentangObatRalan.getSelectedItem() + "','" + lembarSEP.getText() + "'", "Setting") == true) {
                    tampil();
                    emptTeks();
                }
            }
    ...
    private void lembarSEPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lembarSEPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_lembarSEPKeyPressed
    ...
    */
    ...
    private widget.TextBox lembarSEP;
        ...
        try{    
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{" Jumlah Lembar Kertas SEP BPJS",rs.getString(25)});
                }
            } catch (Exception e) {
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            lembarSEP.setText(tbAdmin.getValueAt(24,1).toString());
        }
    }
