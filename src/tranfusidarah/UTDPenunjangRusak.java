...
public class UTDPenunjangRusak extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ BHP Non Medis Rusak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        TabSetting.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        nmpetugas.setBounds(195, 10, 300, 23);
        ...
        btnPetugas.setBounds(498, 10, 28, 23);
        ...
        label32.setBounds(530, 10, 70, 23);
        ...
        Tanggal.setBounds(603, 10, 140, 23);
        ...
        Keterangan.setBounds(103, 40, 392, 23);
        ...
        label40.setBounds(530, 40, 70, 23);
        ...
        LTotal.setBounds(603, 40, 140, 23);

        internalFrame2.add(panelisi3, java.awt.BorderLayout.PAGE_START);

        panelisi1.setName("panelisi1"); // NOI18N
        panelisi1.setPreferredSize(new java.awt.Dimension(734, 48));
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(816, 95));
        ...
        jLabel19.setText("Tgl. Kerusakan :");
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (nmpetugas.getText().trim().equals("") || nip.getText().trim().equals("")) {
            ...
            i = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data yang mau disimpan..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select ib.kode_brng, ib.nama_brng,us.hargaterakhir,ib.kode_sat, us.stok "
    ...
    public void tampil2() {
        ...
        try {
            ps2 = koneksi.prepareStatement("select up.kode_brng,ib.nama_brng,up.jml,up.harga,up.total,up.nip,pg.nama,up.tanggal, "
                    + "up.keterangan,ib.kode_sat from utd_penunjang_rusak up inner join ipsrsbarang ib on ib.kode_brng=up.kode_brng "
                    + "inner join pegawai pg on pg.nik=up.nip where "
                    + "up.tanggal between ? and ? and up.kode_brng like ? or "
                    + "up.tanggal between ? and ? and ib.nama_brng like ? or "
                    + "up.tanggal between ? and ? and up.nip like ? or "
                    + "up.tanggal between ? and ? and pg.nama like ? or "
                    + "up.tanggal between ? and ? and up.keterangan like ? order by up.tanggal");
            try {
                subtotal = 0;
