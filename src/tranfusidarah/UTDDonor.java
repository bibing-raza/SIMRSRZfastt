...
public final class UTDDonor extends javax.swing.JDialog {
    ...
    public UTDDonor(java.awt.Frame parent, boolean modal) {
        ...
        tabModeTranfusi = new DefaultTableModel(null, new Object[]{
            ...
            "Spilis", "Malaria", "Petugas U.Saring", "petugas_aftap", "petugas_u_saring"
        }) {
            @Override
        ...
        NomorTelp.setDocument(new batasInput((byte) 15).getKata(NomorTelp));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Donor Darah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(237, 242, 232)), ".: Penggunaan BHP Medis ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        TCariMedis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(237, 242, 232)), ".: Penggunaan BHP Non Medis ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13))); // NOI18N
        ...
        TCariNonMedis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        label34.setBounds(0, 12, 122, 23);

        NomorDonor.setEditable(false);
        NomorDonor.setForeground(new java.awt.Color(0, 0, 0));
        NomorDonor.setName("NomorDonor"); // NOI18N
        panelisi4.add(NomorDonor);
        NomorDonor.setBounds(125, 12, 120, 23);
        ...
        label36.setBounds(0, 42, 122, 23);

        NamaPendonor.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaPendonor.setBounds(125, 42, 410, 23);
        ...
        label32.setBounds(250, 12, 57, 23);
        ...
        Tanggal.setBounds(310, 12, 90, 23);

        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("Dinas :");
        jLabel8.setName("jLabel8"); // NOI18N
        panelisi4.add(jLabel8);
        jLabel8.setBounds(407, 12, 50, 23);
        ...
        label35.setBounds(460, 72, 80, 23);
        ...
        label37.setBounds(306, 72, 80, 23);
        ...
        label38.setBounds(0, 102, 122, 23);
        ...
        Alamat.setBounds(125, 102, 410, 23);

        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("J.K. :");
        jLabel9.setName("jLabel9"); // NOI18N
        panelisi4.add(jLabel9);
        jLabel9.setBounds(0, 72, 122, 23);
        ...
        panelisi4.add(JK);
        JK.setBounds(125, 72, 90, 23);

        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Golongan Darah :");
        jLabel10.setName("jLabel10"); // NOI18N
        panelisi4.add(jLabel10);
        jLabel10.setBounds(0, 132, 122, 23);

        GolonganDarah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        GolonganDarah.setBounds(125, 132, 60, 23);
        ...
        Resus.setForeground(new java.awt.Color(0, 0, 0));
        ...
        label39.setBounds(372, 132, 60, 23);

        Tensi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        panelisi4.add(Tensi);
        Tensi.setBounds(435, 132, 100, 23);
        ...
        label40.setBounds(0, 162, 122, 23);

        NomorBag.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NomorBag.setBounds(125, 162, 60, 23);
        ...
        label41.setBounds(372, 162, 60, 23);

        NomorTelp.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NomorTelp.setBounds(435, 162, 100, 23);
        ...
        JenisBag.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel13.setBounds(0, 192, 122, 23);

        JenisDonor.setForeground(new java.awt.Color(0, 0, 0));
        ...
        JenisDonor.setBounds(125, 192, 60, 23);

        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setText("Tempat Aftap :");
        jLabel14.setName("jLabel14"); // NOI18N
        panelisi4.add(jLabel14);
        jLabel14.setBounds(330, 192, 100, 23);

        TempatAftap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TempatAftap.setBounds(435, 192, 105, 23);
        ...
        label17.setBounds(0, 250, 122, 23);

        KodePetugasAftap.setEditable(false);
        KodePetugasAftap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodePetugasAftap.setBounds(125, 222, 90, 23);

        NamaPetugasAftap.setEditable(false);
        NamaPetugasAftap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaPetugasAftap.setBounds(218, 222, 286, 23);
        ...
        btnPetugasAftap.setBounds(507, 222, 28, 23);
        ...
        label18.setBounds(0, 222, 122, 23);

        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("HBSAg :");
        jLabel15.setName("jLabel15"); // NOI18N
        panelisi4.add(jLabel15);
        jLabel15.setBounds(60, 272, 97, 23);

        HBSAg.setForeground(new java.awt.Color(0, 0, 0));
        ...
        panelisi4.add(HBSAg);
        HBSAg.setBounds(160, 272, 110, 23);

        HCV.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel17.setBounds(60, 302, 97, 23);

        HIV.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Spilis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        label19.setBounds(0, 362, 122, 23);

        KodePetugasUSaring.setEditable(false);
        KodePetugasUSaring.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KodePetugasUSaring.setBounds(125, 362, 90, 23);

        NamaPetugasUSaring.setEditable(false);
        NamaPetugasUSaring.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NamaPetugasUSaring.setBounds(218, 362, 286, 23);
        ...
        btnPetugasUSaring.setBounds(507, 362, 28, 23);

        jLabel19.setForeground(new java.awt.Color(0, 0, 0));
        jLabel19.setText("Malaria :");
        jLabel19.setName("jLabel19"); // NOI18N
        panelisi4.add(jLabel19);
        jLabel19.setBounds(60, 332, 97, 23);

        Malaria.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Malaria.setBounds(160, 332, 110, 23);
        ...
        TanggalCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-11-2025" }));
        TanggalCari1.setDisplayFormat("dd-MM-yyyy");
        TanggalCari1.setName("TanggalCari1"); // NOI18N
        TanggalCari1.setOpaque(false);
        TanggalCari1.setPreferredSize(new java.awt.Dimension(90, 23));
        ...
        TanggalCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-11-2025" }));
        TanggalCari2.setDisplayFormat("dd-MM-yyyy");
        TanggalCari2.setName("TanggalCari2"); // NOI18N
        TanggalCari2.setOpaque(false);
        TanggalCari2.setPreferredSize(new java.awt.Dimension(90, 23));
...
private void NamaPendonorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NamaPendonorKeyPressed
        ...
        if (tabModeTranfusi.getRowCount() == 0) {
            ...
            for (i = 0; i < jml; i++) {
                Sequel.menyimpan("temporary", "'0','"
                        ...
                        + tabModeTranfusi.getValueAt(i, 21).toString() + "','','','','','','','','','','','','','','',''", "Daftar Pendonor Darah");
            }
    ...
    */
            ...
            try {
                ...
                while (rstranfusi.next()) {
                    tabModeTranfusi.addRow(new Object[]{
                        rstranfusi.getString("no_donor"), 
                        rstranfusi.getString("nama"), 
                        rstranfusi.getString("tanggal"),
                        rstranfusi.getString("dinas"), 
                        rstranfusi.getString("jk"), 
                        rstranfusi.getString("umur"),
                        rstranfusi.getString("alamat"), 
                        rstranfusi.getString("golongan_darah"), 
                        rstranfusi.getString("resus"),
                        rstranfusi.getString("tensi"), 
                        rstranfusi.getString("no_bag"), 
                        rstranfusi.getString("no_telp"),
                        rstranfusi.getString("jenis_bag"), 
                        rstranfusi.getString("jenis_donor"), 
                        rstranfusi.getString("tempat_aftap"),
                        Sequel.cariIsi("select nama from pegawai where nik=?", rstranfusi.getString("petugas_aftap")), 
                        rstranfusi.getString("hbsag"), 
                        rstranfusi.getString("hcv"),
                        rstranfusi.getString("hiv"), 
                        rstranfusi.getString("spilis"), 
                        rstranfusi.getString("malaria"),
                        Sequel.cariIsi("select nama from pegawai where nik=?", rstranfusi.getString("petugas_u_saring")),
                        rstranfusi.getString("petugas_aftap"),
                        rstranfusi.getString("petugas_u_saring")
                    });
    ...
    private void tampilMedis() {
        ...
        try {
            ps = koneksi.prepareStatement("select db.kode_brng, db.nama_brng,u.hargaterakhir,db.kode_sat, u.stok "
                    + "from databarang db inner join utd_stok_medis u on db.kode_brng=u.kode_brng where "
                    + "db.status='1' and db.kode_brng like ? or "
                    + "db.status='1' and db.nama_brng like ? order by db.nama_brng");
            try {
                ps.setString(1, "%" + TCariMedis.getText().trim() + "%");
                ps.setString(2, "%" + TCariMedis.getText().trim() + "%");
                rs = ps.executeQuery();
                while (rs.next()) {                    
                    tabModeMedis.addRow(new Object[]{null, 
                        rs.getString(1), 
                        rs.getString(2), 
                        rs.getString(3), 
                        0, 
    ...
    private void tampilNonMedis() {
        ...
        try {
            ps2 = koneksi.prepareStatement("select ib.kode_brng, ib.nama_brng,u.hargaterakhir,ib.kode_sat, u.stok "
                    + "from ipsrsbarang ib inner join utd_stok_penunjang u on ib.kode_brng=u.kode_brng "
                    + "where ib.kode_brng like ? or ib.nama_brng like ? order by ib.nama_brng");
            try {
                ps2.setString(1, "%" + TCariNonMedis.getText().trim() + "%");
                ps2.setString(2, "%" + TCariNonMedis.getText().trim() + "%");
                rs2 = ps2.executeQuery();
                while (rs2.next()) {
                    tabModeNonMedis.addRow(new Object[]{null, 
                        rs2.getString(1), 
                        rs2.getString(2), 
                        rs2.getString(3), 
                        0, 
    ...
    private void getData() {
        if (tbTranfusiDarah.getSelectedRow() != -1) {
            ...
            Valid.SetTgl(Tanggal, tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 2).toString());
            Dinas.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 3).toString());
            JK.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 4).toString().replaceAll("L", "Laki-laki").replaceAll("P", "Perempuan"));
            Umur.setText(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 5).toString());
            Alamat.setText(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 6).toString());
            GolonganDarah.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 7).toString());
            Resus.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 8).toString());
            ...
            JenisDonor.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 13).toString());
            TempatAftap.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 14).toString());
            KodePetugasAftap.setText(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 22).toString());
            NamaPetugasAftap.setText(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 15).toString());
            HBSAg.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 16).toString());
            HIV.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 17).toString());
            Malaria.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 20).toString());
            HCV.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 17).toString());
            Spilis.setSelectedItem(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 19).toString());
            KodePetugasUSaring.setText(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 23).toString());
            NamaPetugasUSaring.setText(tbTranfusiDarah.getValueAt(tbTranfusiDarah.getSelectedRow(), 21).toString());
