...
public class UTDMedisRusak extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ BHP Medis Rusak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        panelisi2.setPreferredSize(new java.awt.Dimension(740, 48));
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (nmpetugas.getText().trim().equals("") || nip.getText().trim().equals("")) {
            ...
            i = JOptionPane.showConfirmDialog(rootPane, "Apakah yakin data mau disimpan..??", "Konfirmasi", JOptionPane.YES_NO_OPTION);
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    public void tampil2() {
        ...
        try {
            ps2 = koneksi.prepareStatement("select um.kode_brng,db.nama_brng,um.jml,um.hargabeli, um.total,um.nip, "
                    + "pg.nama,um.tanggal, um.keterangan,db.kode_sat from utd_medis_rusak um "
                    + "inner join databarang db on db.kode_brng=um.kode_brng inner join pegawai pg on pg.nik=um.nip where "
                    + "um.tanggal between ? and ? and um.kode_brng like ? or "
                    + "um.tanggal between ? and ? and db.nama_brng like ? or "
                    + "um.tanggal between ? and ? and um.nip like ? or "
                    + "um.tanggal between ? and ? and pg.nama like ? or "
                    + "um.tanggal between ? and ? and um.keterangan like ? order by um.tanggal");
            try {
                subtotal = 0;
