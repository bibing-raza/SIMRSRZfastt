...
public class DlgRHJmDokter extends javax.swing.JDialog {
    ...
    private String pilihancarabayar1="";
        ...
        carabayar.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(carabayar.getTable().getSelectedRow()!= -1){
                    ...
                    pilihancarabayar1=carabayar.getTable().getValueAt(carabayar.getTable().getSelectedRow(),2).toString();
                }     
                prosesCari();
            }
            @Override
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            param.put("carabayars",pilihancarabayar1); 
            Valid.MyReport("rptRHTindakanDokter.jasper","report","::[ Rekap Harian Tindakan Dokter ]::",
...
private void btnDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDokterActionPerformed
        int cekForm = Sequel.cekForm("DlgRHJmDokter_Buka");
    if (cekForm == 1) {
        if (akses.getnamauser().equals("Admin Utama")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "HAYO KEPO YA..... !!!");
        }
    } else {
        dokter.isCek();
        dokter.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
