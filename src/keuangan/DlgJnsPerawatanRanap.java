...
public final class DlgJnsPerawatanRanap extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"#","Kode Tindakan","Nama Tnd/Prw/Tagihan","Kategori",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tarif Tindakan/Perawatan/Tagihan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jLabel11.setText("Total Biaya Tarif : Rp.");
        ...
        NmKamar.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void TJmlKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TJmlKeyPressed
        Valid.pindah(evt,TJml,BtnSimpan);
        ...
        if (TKd.getText().trim().equals("")) {
            ...
            Sequel.mengedit("jns_perawatan_inap", "kd_jenis_prw=?", "kd_jenis_prw=?,nm_perawatan=?,kd_kategori=?,material=?,tarif_tindakandr=?,"
                    + "tarif_tindakanpr=?,total_byrdr=?,total_byrpr=?,kd_pj=?,kd_bangsal=?,total_byrdrpr=?,bhp=?,kso=?,menejemen=?,kelas=?", 16, new String[]{
                        TKd.getText(), TNm.getText(), KdKtg.getText(), BagianRs.getText(), TTndDr.getText(), TTndPr.getText(), TJml.getText(),
                        TJml.getText(), kdpnj.getText(), KdKamar.getText(), TJml.getText(), BhpMedis.getText(), KSO.getText(), Menejemen.getText(),
    ...
    */
    ...
    private void isjml(){
        ...
        if ((!BagianRs.getText().equals("")) && (!TTndDr.getText().equals(""))
            ...
            double r = Double.parseDouble(TTndPr.getText().trim());
            TJml.setText(df2.format(x + y + z + p + q + r));
        }
    }
