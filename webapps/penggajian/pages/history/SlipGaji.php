   ...
   <?php
        echo "<table  border='0' align='left'>
            <caption><center><font color='777777' size='1'  face='Arial'><b>
                           Slip Gaji Karyawan Tahun ".$tahun." Bulan ".$bulan." </b></font></center></caption>
             <tr>
             <td>
            ";
        $id=$_GET['id'];
			...
			echo "<table width='270px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
				...
				<tr class='isi6'>
				  ...
				  <td width='60px'>Index Kary</td><td width='3px'>:</td><td width='90px'>$totalind</td>
                                ...
                                <tr class='isi6'>
				  <td width='60px'>Stts.Kerja</td><td width='3px'>:</td><td width='90px' colspan=4>$baris[18]</td>
        ...
        if(mysql_num_rows($hasil)!=0) {	
			 ...
			 if($baris[13]==-1){
				...
				$jl   = $baris26[0]+$baris27[0]+$baris28[0]+$baris29[0]+$baris31[0];
                        ...
                        echo "     <table width='270px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
				      <caption><b><font size='1px' face='Arial' color='777777'>Kehadiran</font></b></caption>
                                        <TR class='isi6'>
					...
					<caption><font size='1px' face='Arial' color='777777'><b>Gaji & Tunjangan diterima</b></font></caption>
				       <tr class='isi6'>
			        ...
			        echo "<TR class='isi6'>
					     ...
					     echo "<tr class='isi6'><td width='130px'>&nbsp;&nbsp;- $baris30[0]</td><td width='3px'>:</td><td width='140px'>".formatDuit($baris30[1])."</td></tr>";
                                ...
                                while($barisjs = mysql_fetch_array($hasiljs)) {
				      echo" 
                                      <TR class='isi6'>
				...
				echo  "<TR class='isi6'>
					 ...
					 <td width='140px' align=right><i>".formatDuit($jmltmb)."</font></strong></b></i></td>
                                     ...
                                     <TR class='isi6'>
                                         <TD width='130px'>&nbsp;&nbsp;&nbsp;<i><b><strong><font size='2px' face='Arial' color='777777'>Total Gaji</i></TD>
					 <td width='3px'>:</td>
				 ...
				 echo "
					 ...
					 <td width='140px'><center>( dr Lily T S Siagian )</center></td>
				      ...
				      <center><font size='1px' face='Arial' color='777777'><b><i>..Terima kasih atas kerjasamanya <br>dalam memberikan pelayanan yang berkualitas..</i></b></font></center>
