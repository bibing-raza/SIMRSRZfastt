...
<html>
    ...
    <body>
   <?php
     echo  "<center><h2 class=title><font color='999999'>Laporan Penggajian Perbidang/Perbagian Karyawan Tahun ".$tahun." Bulan ".$bulan."</font></h2></center>";
     ...
     while($barisbid = mysql_fetch_array($hasilcaribid)) {
        ...
        if(mysql_num_rows($hasil)!=0) {
            echo "&nbsp;&nbsp;&nbsp;<h3 class=title><b><font color='999999'>Bagian/Bidang : $barisbid[0]</font></b><h3>
                    ...
                    <tr class='head'>
                         ...
                         <td width='90px'><div align='center'><font size='2' face='Verdana'><strong>Bidang</strong></font></div></td>
                         <td width='60px'><div align='center'><font size='2' face='Verdana'><strong>BPD</strong></font></div></td>
                         <td width='100px'><div align='center'><font size='2' face='Verdana' color='green'><strong>Total Gaji</strong></font></div></td>
                         <td width='870px'><div align='center'><font size='2' face='Verdana'><strong>Potongan Gaji</strong></font></div></td>
     ...
     echo "&nbsp;&nbsp;&nbsp;<h3 class=title><b><font color='999999'>Total Seluruh Gaji Karyawan : ".  formatDuit($semuanya)."</font></b><h3>";
    ?>
    </body>
</html>