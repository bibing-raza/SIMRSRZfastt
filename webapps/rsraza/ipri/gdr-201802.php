...
$m_anak=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Anak%' and kamar_inap.stts_pulang like '%Meninggal%'"));
$m_bedah=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Bedah%' and kamar_inap.stts_pulang like '%Meninggal%'"));
...
$m_rkpd=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Internist%' and bangsal.nm_bangsal not like '%Zaal%' and kamar_inap.stts_pulang like '%Meninggal%'"));
...
$m_arraudah=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Ar-Raudah%' and kamar_inap.stts_pulang like '%Meninggal%'"));
$m_bersalin=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Obgyn%' and kamar_inap.stts_pulang like '%Meninggal%'"));
$m_paru=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Paru%' and kamar_inap.stts_pulang like '%Meninggal%'"));

$m48_anak=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Anak%' and kamar_inap.stts_pulang like '%Meninggal >%'"));
$m48_bedah=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Bedah%' and kamar_inap.stts_pulang like '%Meninggal >%'"));
...
$m48_rkpd=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Internist%' and bangsal.nm_bangsal not like '%Zaal%' and kamar_inap.stts_pulang like '%Meninggal >%'"));
...
$m48_arraudah=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Ar-Raudah%' and kamar_inap.stts_pulang like '%Meninggal >%'"));
$m48_bersalin=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Obgyn%' and kamar_inap.stts_pulang like '%Meninggal >%'"));
$m48_paru=mysql_num_rows(mysql_query("select kamar_inap.no_rawat from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Paru%' and kamar_inap.stts_pulang like '%Meninggal >%'"));
...
?>				
		...
		<td align="center" style="vertical-align: middle;text-align: center;"><?php echo $m_arraudah; ?></td>		
...
<?php 
$m_total=$m_anak+$m_bedah+$m_icu+$m_assami+$m_vip+$m_rkpd+$m_zaal+$m_arraudah+$m_bersalin+$m_paru;
?>		
...
?>			
		...
		<td align="center" style="vertical-align: middle;text-align: center;"><?php echo $m48_arraudah; ?></td>		
...
<?php 
$m48_total=$m48_anak+$m48_bedah+$m48_icu+$m48_assami+$m48_vip+$m48_rkpd+$m48_zaal+$m48_arraudah+$m48_bersalin+$m48_paru;
?>		
...
?>		
		...
		<td align="center" style="vertical-align: middle;text-align: center;"><?php $gdr_arraudah=($m_arraudah/$out_arraudah)*1000; echo round($gdr_arraudah,2); ?></td>		
...
?>			
		...
		<td align="center" style="vertical-align: middle;text-align: center;"><?php $ndr_arraudah=($m48_arraudah/$out_arraudah)*1000; echo round($ndr_arraudah,2); ?></td>		
