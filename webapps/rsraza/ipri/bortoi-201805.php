...
$r_anak=mysql_num_rows(mysql_query("select kamar.kd_kamar,bangsal.nm_bangsal from kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where bangsal.nm_bangsal like '%Anak%' and kamar.statusdata='1'"));
$r_bedah=mysql_num_rows(mysql_query("select kamar.kd_kamar,bangsal.nm_bangsal from kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where bangsal.nm_bangsal like '%Bedah%' and kamar.statusdata='1'"));
...
$r_rkpd=mysql_num_rows(mysql_query("select kamar.kd_kamar,bangsal.nm_bangsal from kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where bangsal.nm_bangsal like '%internist%' and  bangsal.nm_bangsal not like '%Zaal%' and kamar.statusdata='1'"));
...
$r_arraudah=mysql_num_rows(mysql_query("select kamar.kd_kamar,bangsal.nm_bangsal from kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where bangsal.nm_bangsal like '%Ar-Raudah%' and kamar.statusdata='1'"));
$r_bersalin=mysql_num_rows(mysql_query("select kamar.kd_kamar,bangsal.nm_bangsal from kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where bangsal.nm_bangsal like '%Obgyn%' and kamar.statusdata='1'"));
$r_paru=mysql_num_rows(mysql_query("select kamar.kd_kamar,bangsal.nm_bangsal from kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where bangsal.nm_bangsal like '%Paru%' and kamar.statusdata='1'"));
...
where (kamar_inap.tgl_masuk <'".$tgl1."' and kamar_inap.tgl_keluar='0000-00-00' and bangsal.nm_bangsal like '%Anak%') 
or (kamar_inap.tgl_masuk <='".$tgl1."' and kamar_inap.tgl_keluar >'".$tgl1."' and bangsal.nm_bangsal like '%Anak%') 
...
left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar
left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal
where (kamar_inap.tgl_masuk <'".$tgl1."' and kamar_inap.tgl_keluar='0000-00-00' and bangsal.nm_bangsal like '%Bedah%') 
or (kamar_inap.tgl_masuk <='".$tgl1."' and kamar_inap.tgl_keluar >'".$tgl1."' and bangsal.nm_bangsal like '%Bedah%') 
...
left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar
left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal
where (kamar_inap.tgl_masuk <'".$tgl1."' and kamar_inap.tgl_keluar='0000-00-00' and nm_bangsal like '%internist%' and  bangsal.nm_bangsal not like '%Zaal%') 
or (kamar_inap.tgl_masuk <='".$tgl1."' and kamar_inap.tgl_keluar >'".$tgl1."' and nm_bangsal like '%internist%' and  bangsal.nm_bangsal not like '%Zaal%') 
...
left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar
left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal
where (kamar_inap.tgl_masuk <'".$tgl1."' and kamar_inap.tgl_keluar='0000-00-00' and bangsal.nm_bangsal like '%Ar-Raudah%') 
or (kamar_inap.tgl_masuk <='".$tgl1."' and kamar_inap.tgl_keluar >'".$tgl1."' and nm_bangsal like '%Ar-Raudah%') 
...
left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar
left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal
where (kamar_inap.tgl_masuk <'".$tgl1."' and kamar_inap.tgl_keluar='0000-00-00' and bangsal.nm_bangsal like '%Obgyn%') 
or (kamar_inap.tgl_masuk <='".$tgl1."' and kamar_inap.tgl_keluar >'".$tgl1."' and nm_bangsal like '%Obgyn%') 
...
left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar
left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal
where (kamar_inap.tgl_masuk <'".$tgl1."' and kamar_inap.tgl_keluar='0000-00-00' and bangsal.nm_bangsal like '%Paru%') 
or (kamar_inap.tgl_masuk <='".$tgl1."' and kamar_inap.tgl_keluar >'".$tgl1."' and nm_bangsal like '%Paru%') 
...
?>
		...
		<?php $qtybed=$r_anak+$r_bedah+$r_icu+$r_assami+$r_vip+$r_rkpd+$r_zaal+$r_arraudah+$r_bersalin+$r_paru; ?>
...
<?php 
$qhp_total=$qhp_anak+$qhp_bedah+$qhp_icu+$qhp_assami+$qhp_vip+$qhp_rkpd+$qhp_zaal+$qhp_arraudah+$qhp_bersalin+$qhp_paru;
?>		
