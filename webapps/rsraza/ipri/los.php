...
$qlos_anak=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Ar-Rahman%'");
$qlos_bedah=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Al-Muiz%'");
...
$qlos_rkpd=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Ar-Razaq%'");
...
$qlos_arraudah_mthtkl=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Ar-Raudah/Mata%'");
$qlos_arraudah_syrf=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Ar-Raudah/Sya%'");
$qlos_bersalin=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Al-Khaliq%'");
$qlos_paru=mysql_query("select sum(kamar_inap.lama) los from kamar_inap left join kamar on kamar_inap.kd_kamar=kamar.kd_kamar left join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.tgl_keluar between '".$tgl1."' and '".$tgl2."' and bangsal.nm_bangsal like '%Al-Hakim%'");
...
?>		
		...
		<td align="center" style="vertical-align: middle;text-align: center;"><?php $los_arraudah_mthtkl=mysql_fetch_row($qlos_arraudah_mthtkl); echo $los_arraudah_mthtkl[0]; ?></td>		
		<td align="center" style="vertical-align: middle;text-align: center;"><?php $los_arraudah_syrf=mysql_fetch_row($qlos_arraudah_syrf); echo $los_arraudah_syrf[0]; ?></td>	
...
<?php 
$los_total=$los_anak[0]+$los_bedah[0]+$los_icu[0]+$los_assami[0]+$los_vip[0]+$los_rkpd[0]+$los_zaal[0]+$los_arraudah_mthtkl[0]+$los_arraudah_syrf[0]+$los_bersalin[0]+$los_paru[0]; 
?>		
...
?>			
		...
		<td align="center" style="vertical-align: middle;text-align: center;"><?php $avlos_arraudah_mthtkl=$los_arraudah_mthtkl[0]/$out_arraudah_mthtkl; echo round($avlos_arraudah_mthtkl,2); ?></td>		
		<td align="center" style="vertical-align: middle;text-align: center;"><?php $avlos_arraudah_syrf=$los_arraudah_syrf[0]/$out_arraudah_syrf; echo round($avlos_arraudah_syrf,2); ?></td>
