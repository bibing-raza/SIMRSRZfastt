...
<div class="row">
	<div class="col-lg-3">
		...
		<label for="sel1">Pilih Ruangan:</label>
			...
			<option value="Ar-Rahman|Anak">Anak</option>
			<option value="Al-Muiz|Bedah">Bedah</option>
			<option value="ICCU|ICU">ICU</option>
			<option value="As-Sami|As-Sami">As-Sami</option>
			<option value="VIP-|VIP/SVIP">VIP/SVIP</option>
			<option value="Ar-Razaq|RKPD">RKPD</option>
			...
			<option value="Al-Khaliq|Bersalin">Bersalin</option>
			<option value="Al-Hakim|Paru">Paru</option>
			<option value="NICU|Perinatologi NICU">Perinatologi NICU</option>
			<option value="Bayi|Perinatologi Bayi">Perinatologi Bayi</option>
			</select>
		</div>	
	</div>	
