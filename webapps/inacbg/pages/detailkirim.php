<div id="post">
    ...
    <div class="entry">        
        <?php
            ...
            $_sql         = "SELECT rp.no_reg, rp.no_rawat, rp.tgl_registrasi, rp.jam_reg, rp.kd_dokter, d.nm_dokter, rp.no_rkm_medis, p.nm_pasien, p.jk, p.umur, p.tgl_lahir, pl.nm_poli,
							 rp.status_lanjut, rp.umurdaftar, rp.sttsumur, rp.p_jawab, rp.almt_pj, rp.hubunganpj, rp.biaya_reg, rp.stts_daftar, penjab.png_jawab
							 ...
							 INNER JOIN poliklinik pl ON rp.kd_poli = pl.kd_poli INNER JOIN penjab pj ON rp.kd_pj = pj.kd_pj WHERE rp.no_rawat = '$norawat'";
            ...
            $nm_dokter2   = getOne("select d.nm_dokter from dpjp_ranap dr inner join dokter d on dr.kd_dokter=d.kd_dokter where dr.no_rawat='$norawat'");
            if(!empty($nm_dokter2)){
        ...
        <table width="100%" align="center">
            ...
            <tr class="head">
                ...
                <td width="57%">
                    <select name="discharge_status" class="text2">
                        <?php 
                            if(getOne("select count(no_rawat) from kamar_inap where stts_pulang='Sembuh/BLPL' and no_rawat='".$norawat."'")>0){
                                echo "<option value='1'>Atas persetujuan dokter</option>";
                            }else if(getOne("select count(no_rawat) from kamar_inap where stts_pulang='Dirujuk' and no_rawat='".$norawat."'")>0){
                            ...
                            }else if(getOne("select count(no_rawat) from kamar_inap where stts_pulang='Meninggal >= 48 Jam' and no_rawat='".$norawat."'")>0){
                                echo "<option value='4'>Meninggal</option>";
                            }else if(getOne("select count(no_rawat) from kamar_inap where stts_pulang='Meninggal < 48 Jam' and no_rawat='".$norawat."'")>0){
                                echo "<option value='4'>Meninggal</option>";
                            }else if(getOne("select count(no_rawat) from kamar_inap where stts_pulang='Kabur' and no_rawat='".$norawat."'")>0){
                ...
                <td width="57%">
                    <select name="nama_dokter" class="text2">
                       ...
                       <?php        
                            ...
                            while($barisdokter = mysql_fetch_array($hasildokter)) {
            ...
            <?php
                if($corona=="PasienCorona"){
                    ...
                    while($bariscorona = mysql_fetch_array($hasilcorona)) {
                        echo "<tr class='head'>
